...
| Module | Description |
| -------- | ------------- |
| [Anim.Engine.CSS.Transitions](https://package.elm-lang.org/packages/phollyer/elm-animate/latest/Anim-Engine-CSS-Transitions) | CSS transitions for A→B animations |
