...
var $author$project$Anim$Internal$Builder$extractPerspectiveFromProperty = function (property) {
	switch (property.$) {
...
var $author$project$Anim$Internal$Builder$computePerspectiveStyles = function (processedData) {
	var propertyContainerIds = A2(
		$elm$core$List$map,
		function ($) {
			return $.containerId;
		},
		A2(
			...
			$author$project$Anim$Internal$Builder$extractPerspectiveFromProperty,
			A2(
	...
	var maybeGlobalContainerId = A2(
		$elm$core$Maybe$map,
		function ($) {
			return $.containerId;
		},
		processedData.globalPerspective);
	var allContainerIds = function () {
		if (maybeGlobalContainerId.$ === 'Just') {
			var globalId = maybeGlobalContainerId.a;
			return A2($elm$core$List$member, globalId, propertyContainerIds) ? propertyContainerIds : _Utils_ap(
				propertyContainerIds,
				_List_fromArray(
					[globalId]));
		} else {
			return propertyContainerIds;
		}
	}();
				...
				var propertyPerspective = A2(
					...
					$elm$core$List$head(
						A2(
							...
							function (p) {
								return _Utils_eq(p.containerId, containerId);
							},
							A2(
								$elm$core$List$filterMap,
								$author$project$Anim$Internal$Builder$extractPerspectiveFromProperty,
								A2(
									...
									$elm$core$Dict$values(processedData.elements))))));
				var maybePerspectiveValue = function () {
					if (propertyPerspective.$ === 'Just') {
						var value = propertyPerspective.a;
						return $elm$core$Maybe$Just(value);
					} else {
						return A2(
							$elm$core$Maybe$andThen,
							function (p) {
								return _Utils_eq(p.containerId, containerId) ? $elm$core$Maybe$Just(p.value) : $elm$core$Maybe$Nothing;
							},
							processedData.globalPerspective);
					}
				}();
						...
						return _Utils_Tuple2(
							...
							_List_fromArray(
								[
									...
									value: $elm$core$String$fromFloat(value) + 'px'
								},
...
var $author$project$Anim$Internal$Builder$ProcessedPositionConfig = function (a) {
	return {$: 'ProcessedPositionConfig', a: a};
};
...
var $author$project$Anim$Internal$Builder$resolvePerspective = F2(
...
var $author$project$Anim$Internal$Builder$createDirtyConfig = function (_v0) {
	var end = _v0.end;
	var propPerspective = _v0.propPerspective;
	var globalPerspective = _v0.globalPerspective;
	...
	return wrapper(
		{
			...
			perspective: A2($author$project$Anim$Internal$Builder$resolvePerspective, propPerspective, globalPerspective),
			speed: 0,
...
var $author$project$Anim$Internal$Properties$Position$default = $author$project$Anim$Internal$Properties$Position$Position(
	{x: 0, y: 0, z: 0});
var $author$project$Anim$Internal$Properties$Position$support = {
	add: F2(
		function (_v0, _v1) {
			var a = _v0.a;
			var b = _v1.a;
	...
	fromRecord: $author$project$Anim$Internal$Properties$Position$Position,
	scale: F2(
		function (factor, _v2) {
			var coords = _v2.a;
			return $author$project$Anim$Internal$Properties$Position$Position(
	...
	zero: $author$project$Anim$Internal$Properties$Position$default
};
var $author$project$Anim$Internal$Properties$Position$distance = $author$project$Anim$Internal$Builders$Coordinate3D$distance($author$project$Anim$Internal$Properties$Position$support);
...
var $author$project$Anim$Internal$Properties$Position$fromTuple = $author$project$Anim$Internal$Builders$Coordinate3D$fromTuple($author$project$Anim$Internal$Properties$Position$support);
	...
	return wrapper(
		{
			...
			perspective: A2($author$project$Anim$Internal$Builder$resolvePerspective, config.perspective, globalData.globalPerspective),
			speed: speed_,
			start: config.start,
	...
	function (globalData, property) {
		switch (property.$) {
			case 'PositionConfig':
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: globalData.globalPerspective, propPerspective: config.perspective, wrapper: $author$project$Anim$Internal$Builder$ProcessedPositionConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
							defaultStart: $author$project$Anim$Internal$Properties$Position$fromTuple(
								_Utils_Tuple2(0.0, 0.0)),
							distanceFn: $author$project$Anim$Internal$Properties$Position$distance,
							durationFn: $author$project$Anim$Internal$Properties$Position$duration,
							globalData: globalData,
							speedFn: $author$project$Anim$Internal$Properties$Position$speed,
							wrapper: $author$project$Anim$Internal$Builder$ProcessedPositionConfig
						}));
			case 'RotateConfig':
				var config = property.a;
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: globalData.globalPerspective, propPerspective: config.perspective, wrapper: $author$project$Anim$Internal$Builder$ProcessedRotateConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
			...
			case 'ScaleConfig':
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: globalData.globalPerspective, propPerspective: config.perspective, wrapper: $author$project$Anim$Internal$Builder$ProcessedScaleConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
			...
			case 'BackgroundColorConfig':
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: $elm$core$Maybe$Nothing, propPerspective: $elm$core$Maybe$Nothing, wrapper: $author$project$Anim$Internal$Builder$ProcessedBackgroundColorConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
			...
			case 'FontColorConfig':
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: $elm$core$Maybe$Nothing, propPerspective: $elm$core$Maybe$Nothing, wrapper: $author$project$Anim$Internal$Builder$ProcessedFontColorConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
							defaultStart: $author$project$Anim$Internal$Properties$Color$fromRGB(
			...
			case 'OpacityConfig':
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: $elm$core$Maybe$Nothing, propPerspective: $elm$core$Maybe$Nothing, wrapper: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
			...
			default:
				...
				return config.isDirty ? $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$createDirtyConfig(
						{end: config.end, globalPerspective: $elm$core$Maybe$Nothing, propPerspective: $elm$core$Maybe$Nothing, wrapper: $author$project$Anim$Internal$Builder$ProcessedSizeConfig})) : $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							config: config,
...
var $author$project$Anim$Internal$Builder$processAnimationData = function (_v0) {
	...
	var processedElements = A2(
		...
		data.elements);
	return {elements: processedElements, globalDelay: data.globalDelay, globalEasing: data.globalEasing, globalPerspective: data.globalPerspective, globalTiming: data.globalTiming};
};
var $author$project$Anim$Internal$Builder$computeAndCachePerspectiveStyles = function (builder) {
	var data = builder.a;
	var _v0 = data.perspectiveStylesCache;
	if (_v0.$ === 'Just') {
		return builder;
	} else {
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(builder);
		var cache = $author$project$Anim$Internal$Builder$computePerspectiveStyles(processedData);
		return $author$project$Anim$Internal$Builder$AnimBuilder(
			_Utils_update(
				data,
				{
					perspectiveStylesCache: $elm$core$Maybe$Just(cache)
				}));
	}
};
...
var $author$project$Anim$Internal$Sub$FontColorAnimation = function (a) {
	return {$: 'FontColorAnimation', a: a};
};
var $author$project$Anim$Internal$Sub$OpacityAnimation = function (a) {
	return {$: 'OpacityAnimation', a: a};
};
var $author$project$Anim$Internal$Sub$PositionAnimation = function (a) {
	return {$: 'PositionAnimation', a: a};
};
var $author$project$Anim$Internal$Sub$RotateAnimation = function (a) {
	return {$: 'RotateAnimation', a: a};
};
var $author$project$Anim$Internal$Sub$ScaleAnimation = function (a) {
	return {$: 'ScaleAnimation', a: a};
};
var $author$project$Anim$Internal$Sub$SizeAnimation = function (a) {
	return {$: 'SizeAnimation', a: a};
};
var $author$project$Anim$Internal$AnimationCore$animationStepsWithFrames = F4(
	function (frames, easing, start, stop) {
		...
		var finalSteps = function () {
			var _v0 = $elm$core$List$reverse(steps);
			if (!_v0.b) {
				return _List_Nil;
			} else {
				var rest = _v0.b;
				return $elm$core$List$reverse(
					A2($elm$core$List$cons, stop, rest));
			}
		}();
		return ((frames <= 0) || _Utils_eq(start, stop)) ? _List_Nil : finalSteps;
	});
...
var $author$project$Anim$Internal$Properties$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {b: rgba_.b, g: rgba_.g, r: rgba_.r};
	var hsla_ = $author$project$Anim$Internal$Properties$Color$rgbToHsl(rgb_);
	return {a: rgba_.a, h: hsla_.h, l: hsla_.l, s: hsla_.s};
};
var $author$project$Anim$Internal$Properties$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 'Hsla':
			...
			return {h: hslaValue.h, l: hslaValue.l, s: hslaValue.s};
		default:
...
var $author$project$Anim$Internal$Properties$Color$toHsla = function (color) {
	switch (color.$) {
		...
		case 'Rgba':
			var rgba_ = color.a;
			return $author$project$Anim$Internal$Properties$Color$rgbaToHsla(rgba_);
		default:
			var hslValue = $author$project$Anim$Internal$Properties$Color$toHsl(color);
			return {a: 1.0, h: hslValue.h, l: hslValue.l, s: hslValue.s};
	}
};
var $author$project$Anim$Internal$Properties$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Properties$Color$hslToRgb(
		{h: hslaValue.h, l: hslaValue.l, s: hslaValue.s});
	return {a: hslaValue.a, b: rgb_.b, g: rgb_.g, r: rgb_.r};
};
var $author$project$Anim$Internal$Properties$Color$toRgba = function (color) {
	switch (color.$) {
		...
		case 'Hsla':
			var hsla_ = color.a;
			return $author$project$Anim$Internal$Properties$Color$hslaToRgba(hsla_);
		case 'ElmColor':
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
		...
		default:
			var rgb_ = $author$project$Anim$Internal$Properties$Color$toRgb(color);
			return {a: 1.0, b: rgb_.b, g: rgb_.g, r: rgb_.r};
	}
};
var $author$project$Anim$Internal$Properties$Color$interpolate = F3(
	function (start, end, t) {
		...
		while (true) {
			...
			switch (_v1.b.$) {
				case 'Hsl':
					var startHsla = $author$project$Anim$Internal$Properties$Color$toHsla(start);
					var endHsla = $author$project$Anim$Internal$Properties$Color$toHsla(end);
					var $temp$start = $author$project$Anim$Internal$Properties$Color$Hsla(startHsla),
						$temp$end = $author$project$Anim$Internal$Properties$Color$Hsla(
						_Utils_update(
							endHsla,
							{a: startAlpha})),
						$temp$t = t;
				...
				case 'Hsla':
					var $temp$start = $author$project$Anim$Internal$Properties$Color$Hsla(
					...
					continue interpolate;
				case 'Rgb':
					var startRgba = $author$project$Anim$Internal$Properties$Color$toRgba(start);
					var endRgba = $author$project$Anim$Internal$Properties$Color$toRgba(end);
					var $temp$start = $author$project$Anim$Internal$Properties$Color$Rgba(startRgba),
						$temp$end = $author$project$Anim$Internal$Properties$Color$Rgba(
						_Utils_update(
							endRgba,
							{a: startAlpha})),
						$temp$t = t;
				...
				case 'Hex':
					...
					continue interpolate;
				case 'Rgba':
					var $temp$start = $author$project$Anim$Internal$Properties$Color$Rgba(
				...
				default:
					...
					var endRgba = $author$project$Anim$Internal$Properties$Color$toRgba(end);
					var $temp$start = $author$project$Anim$Internal$Properties$Color$Rgba(startRgba),
						$temp$end = $author$project$Anim$Internal$Properties$Color$Rgba(endRgba),
						$temp$t = t;
					start = $temp$start;
					end = $temp$end;
					t = $temp$t;
...
var $author$project$Anim$Internal$Sub$createBackgroundColorSteps = F4(
	function (start, target, frames, easingFunction) {
		var progressValues = function () {
			var _v0 = A4($author$project$Anim$Internal$AnimationCore$animationStepsWithFrames, frames, easingFunction, 0.0, 1.0);
			if (!_v0.b) {
				return A2($elm$core$List$repeat, frames, 1.0);
			} else {
				var vals = _v0;
				return vals;
			}
		...
		var steps = A2(
			$elm$core$List$map,
			A2($author$project$Anim$Internal$Properties$Color$interpolate, start, target),
			progressValues);
		return A2($elm$core$List$map, $author$project$Anim$Internal$Sub$BackgroundColorAnimation, steps);
	});
var $author$project$Anim$Internal$Sub$createFontColorSteps = F4(
	function (start, target, frames, easingFunction) {
		var progressValues = function () {
			var _v0 = A4($author$project$Anim$Internal$AnimationCore$animationStepsWithFrames, frames, easingFunction, 0.0, 1.0);
			if (!_v0.b) {
		...
		var steps = A2(
			...
			A2($author$project$Anim$Internal$Properties$Color$interpolate, start, target),
			progressValues);
		return A2($elm$core$List$map, $author$project$Anim$Internal$Sub$FontColorAnimation, steps);
	});
...
var $author$project$Anim$Internal$Sub$createOpacitySteps = F4(
	function (start, target, frames, easingFunction) {
...
var $author$project$Anim$Internal$Properties$Position$toTuple = $author$project$Anim$Internal$Builders$Coordinate3D$toTuple($author$project$Anim$Internal$Properties$Position$support);
var $author$project$Anim$Internal$Sub$createPositionSteps = F4(
	function (startPos, endPos, frames, easingFunction) {
		...
		return A2(
			$elm$core$List$map,
			A2($elm$core$Basics$composeL, $author$project$Anim$Internal$Sub$PositionAnimation, $author$project$Anim$Internal$Properties$Position$fromTuple),
			steps);
	});
...
var $author$project$Anim$Internal$Sub$createSizeSteps = F4(
	function (startSize, endSize, frames, easingFunction) {
		var _v0 = $author$project$Anim$Internal$Properties$Size$toTuple(startSize);
		var startWidth = _v0.a;
		var startHeight = _v0.b;
		var _v1 = $author$project$Anim$Internal$Properties$Size$toTuple(endSize);
		var endWidth = _v1.a;
		var endHeight = _v1.b;
		var stepsHeight = function () {
			var _v3 = A4($author$project$Anim$Internal$AnimationCore$animationStepsWithFrames, frames, easingFunction, startHeight, endHeight);
			if (!_v3.b) {
				return A2($elm$core$List$repeat, frames, endHeight);
			} else {
				var vals = _v3;
				return vals;
			}
		}();
		var stepsWidth = function () {
			var _v2 = A4($author$project$Anim$Internal$AnimationCore$animationStepsWithFrames, frames, easingFunction, startWidth, endWidth);
			if (!_v2.b) {
				return A2($elm$core$List$repeat, frames, endWidth);
			} else {
				var vals = _v2;
				return vals;
			}
		}();
		var steps = A3($elm$core$List$map2, $elm$core$Tuple$pair, stepsWidth, stepsHeight);
		return A2(
			$elm$core$List$map,
...
var $author$project$Anim$Internal$Sub$delayToFrames = function (delayMs) {
	return A2($elm$core$Basics$max, 0, (delayMs / $author$project$Anim$Internal$Sub$frameDurationMs) | 0);
};
var $author$project$Anim$Internal$Sub$durationToFrames = function (durationMs) {
	return (!durationMs) ? 1 : A2(
		$elm$core$Basics$max,
		1,
		$elm$core$Basics$round(durationMs / $author$project$Anim$Internal$Sub$frameDurationMs));
};
var $author$project$Anim$Internal$Builders$Coordinate3D$fromRecord = function (support) {
	return support.fromRecord;
};
var $author$project$Anim$Internal$Properties$Position$fromRecord = $author$project$Anim$Internal$Builders$Coordinate3D$fromRecord($author$project$Anim$Internal$Properties$Position$support);
...
var $author$project$Anim$Internal$Easing$toFunction = function (easing) {
	switch (easing.$) {
		case 'Bezier':
			var p1x = easing.a;
			var p1y = easing.b;
...
var $author$project$Anim$Internal$Sub$createPropertyAnimState = F2(
	function (startValues, property) {
		var buildPropertyAnimation = F8(
			function (propertyType, actualStart, end, duration_, delay_, easing_, stepCreator, wrapper) {
				var frames = (!duration_) ? 1 : $author$project$Anim$Internal$Sub$durationToFrames(duration_);
				var easeFunction = $author$project$Anim$Internal$Easing$toFunction(easing_);
				var steps = (!duration_) ? _List_fromArray(
					[
						wrapper(end)
					]) : A4(stepCreator, actualStart, end, frames, easeFunction);
				return {
					animationSteps: steps,
					currentDelayFrame: 0,
					currentStepIndex: 0,
					delayFrames: $author$project$Anim$Internal$Sub$delayToFrames(delay_),
					elapsedMs: 0.0,
					isComplete: false,
					propertyType: propertyType,
					totalDurationMs: duration_
				};
			});
		switch (property.$) {
			case 'ProcessedPositionConfig':
				...
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Position$fromRecord(startValues.position),
					config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'position', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createPositionSteps, $author$project$Anim$Internal$Sub$PositionAnimation));
			case 'ProcessedRotateConfig':
				var config = property.a;
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Rotate$fromRecord(startValues.rotate),
					config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'rotate', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createRotateSteps, $author$project$Anim$Internal$Sub$RotateAnimation));
			case 'ProcessedScaleConfig':
				var config = property.a;
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Scale$fromRecord(startValues.scale),
					config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'scale', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createScaleSteps, $author$project$Anim$Internal$Sub$ScaleAnimation));
			case 'ProcessedBackgroundColorConfig':
				var config = property.a;
				var actualStart = A2($elm$core$Maybe$withDefault, startValues.backgroundColor, config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'backgroundColor', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createBackgroundColorSteps, $author$project$Anim$Internal$Sub$BackgroundColorAnimation));
			case 'ProcessedFontColorConfig':
				var config = property.a;
				var actualStart = A2($elm$core$Maybe$withDefault, startValues.fontColor, config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'fontColor', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createFontColorSteps, $author$project$Anim$Internal$Sub$FontColorAnimation));
			case 'ProcessedOpacityConfig':
				var config = property.a;
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Opacity$fromFloat(startValues.opacity),
					config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'opacity', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createOpacitySteps, $author$project$Anim$Internal$Sub$OpacityAnimation));
			default:
				var config = property.a;
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Size$fromTuple(
						_Utils_Tuple2(startValues.size.width, startValues.size.height)),
					config.start);
				return $elm$core$Maybe$Just(
...
var $author$project$Anim$Internal$Properties$Color$black = $author$project$Anim$Internal$Properties$Color$Rgb(
	{b: 0, g: 0, r: 0});
...
var $author$project$Anim$Internal$Properties$Position$toRecord = $author$project$Anim$Internal$Builders$Coordinate3D$toRecord($author$project$Anim$Internal$Properties$Position$support);
...
var $author$project$Anim$Internal$Sub$extractFromProperty = F2(
		...
		switch (property.$) {
			case 'ProcessedBackgroundColorConfig':
				...
				return (!config.duration) ? _Utils_update(
					acc,
					{
						color: $elm$core$Maybe$Just(config.end)
					}) : acc;
			case 'ProcessedFontColorConfig':
				var config = property.a;
				return (!config.duration) ? _Utils_update(
				...
				return (!config.duration) ? _Utils_update(
					acc,
					{
						position: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Properties$Position$toRecord(config.end))
					}) : acc;
			case 'ProcessedRotateConfig':
				var config = property.a;
				return (!config.duration) ? _Utils_update(
					acc,
					{
						rotate: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Properties$Rotate$toRecord(config.end))
					}) : acc;
			case 'ProcessedScaleConfig':
				var config = property.a;
				return (!config.duration) ? _Utils_update(
					acc,
					{
						scale: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Properties$Scale$toRecord(config.end))
					}) : acc;
			default:
				var config = property.a;
				return (!config.duration) ? _Utils_update(
					acc,
					{
						size: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Properties$Size$toRecord(config.end))
					}) : acc;
		}
	});
var $author$project$Anim$Internal$Sub$propertyValuesEmpty = {color: $elm$core$Maybe$Nothing, fontColor: $elm$core$Maybe$Nothing, opacity: $elm$core$Maybe$Nothing, position: $elm$core$Maybe$Nothing, rotate: $elm$core$Maybe$Nothing, scale: $elm$core$Maybe$Nothing, size: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Sub$extractCurrentValuesFromBuilder = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Internal$Builder$processAnimationData,
	A2(
		$elm$core$Basics$composeR,
		function ($) {
			return $.elements;
...
var $author$project$Anim$Internal$Sub$animate = function (builder_) {
	var builderWithCache = $author$project$Anim$Internal$Builder$computeAndCachePerspectiveStyles(builder_);
	var currentValues = $author$project$Anim$Internal$Sub$extractCurrentValuesFromBuilder(builderWithCache);
	var startValues = {
		...
		fontColor: A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$FontColor$default, currentValues.fontColor),
		opacity: A2($elm$core$Maybe$withDefault, 1.0, currentValues.opacity),
		position: A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Properties$Position$toRecord($author$project$Anim$Internal$Properties$Position$default),
			currentValues.position),
		rotate: A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Properties$Rotate$toRecord($author$project$Anim$Internal$Properties$Rotate$default),
			currentValues.rotate),
		scale: A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Properties$Scale$toRecord($author$project$Anim$Internal$Properties$Scale$default),
			currentValues.scale),
		size: A2(
			$elm$core$Maybe$withDefault,
			$author$project$Anim$Internal$Properties$Size$toRecord($author$project$Anim$Internal$Properties$Size$default),
			currentValues.size)
	};
	var processedData = $author$project$Anim$Internal$Builder$processAnimationData(builderWithCache);
	...
	return $author$project$Anim$Internal$Sub$AnimState(
		{
			builder: $author$project$Anim$Internal$Builder$clearCurrentElement(
				$author$project$Anim$Internal$Builder$markDirty(builderWithCache)),
			elementAnimations: elementStates,
			isRunning: !$elm$core$Dict$isEmpty(elementStates)
		});
};
var $author$project$Anim$Engine$Sub$animate = $author$project$Anim$Internal$Sub$animate;
...
var $author$project$Anim$Internal$Sub$getLastStep = function (steps) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Anim$Internal$Sub$PositionAnimation(
			$author$project$Anim$Internal$Properties$Position$fromTuple(
				_Utils_Tuple2(0, 0))),
		$elm$core$List$head(
			$elm$core$List$reverse(steps)));
};
var $author$project$Anim$Internal$Sub$getCurrentValue = function (propertyState) {
	return A2(
		$elm$core$Maybe$withDefault,
...
var $author$project$Anim$Internal$Sub$getPosition = A2(
	$author$project$Anim$Internal$Sub$getPropertyValue,
	'position',
	function (anim) {
		if (anim.$ === 'PositionAnimation') {
			var pos = anim.a;
...
var $author$project$Anim$Internal$Builders$Property$upsert = F2(
	function (propertyConfig, builder) {
		var _v0 = A2(
			...
			builder);
		if (_v0.$ === 'Just') {
			return A2($author$project$Anim$Internal$Builders$Property$replace, propertyConfig, builder);
		} else {
			...
			var colorConfig = $author$project$Anim$Internal$Builder$BackgroundColorConfig(
				{
					...
					isDirty: false,
					perspective: $elm$core$Maybe$Nothing,
					speed: 0,
...
var $author$project$Anim$Internal$Sub$initPosition = F2(
	function (animBuilder, maybePos) {
		if (maybePos.$ === 'Just') {
			var pos = maybePos.a;
			var positionConfig = $author$project$Anim$Internal$Builder$PositionConfig(
				{
					delay: $elm$core$Maybe$Nothing,
					distance: 0,
					duration: 0,
			...
			return A2($author$project$Anim$Internal$Builders$Property$upsert, positionConfig, animBuilder);
		} else {
			return animBuilder;
		}
	});
...
var $author$project$Anim$Internal$Sub$setInitialValues = F4(
	function (animationState, elementId, _v0, builderAcc) {
		var funcList = _List_fromArray(
			[
				A2($author$project$Anim$Internal$Sub$mapCurrentValue, $author$project$Anim$Internal$Sub$getPosition, $author$project$Anim$Internal$Sub$initPosition),
...
var $author$project$Anim$Engine$Sub$builder = $author$project$Anim$Internal$Sub$builder;
var $author$project$ElmUI$Sub$Controls$Main$elementId = 'sub-controls-box';
var $author$project$Anim$Internal$Builder$init = $author$project$Anim$Internal$Builder$AnimBuilder(
	{animationHistories: $elm$core$Dict$empty, currentElementId: $elm$core$Maybe$Nothing, elements: $elm$core$Dict$empty, globalDelay: $elm$core$Maybe$Nothing, globalEasing: $elm$core$Maybe$Nothing, globalPerspective: $elm$core$Maybe$Nothing, globalTiming: $elm$core$Maybe$Nothing, nextAnimationId: 1, perspectiveStylesCache: $elm$core$Maybe$Nothing, scrollContainer: 'document', scrollTargets: _List_Nil});
var $author$project$Anim$Internal$Sub$init = $author$project$Anim$Internal$Sub$AnimState(
	{builder: $author$project$Anim$Internal$Builder$init, elementAnimations: $elm$core$Dict$empty, isRunning: false});
...
var $author$project$Anim$Internal$Builders$Position$build = function (_v0) {
	...
	return A2(
		...
		$author$project$Anim$Internal$Builder$PositionConfig(config),
		builder);
};
...
var $author$project$Anim$Internal$Builders$Property$createFor = F4(
	function (extractExisting, defaultConfig_, elementId, builder) {
		var existingConfig = A2(
			$elm$core$Maybe$andThen,
			function (_v1) {
				var properties = _v1.properties;
				return $elm$core$List$head(
			...
			return A2(
				...
				_Utils_update(
					config,
					{
						...
						perspective: $elm$core$Maybe$Nothing,
						speed: 0,
						start: $elm$core$Maybe$Just(config.end),
						timing: $elm$core$Maybe$Nothing
					}));
		} else {
...
var $author$project$Anim$Internal$Builders$Property$defaultConfig = function (defaultEnd) {
	return {delay: $elm$core$Maybe$Nothing, distance: 0, duration: 0, easing: $elm$core$Maybe$Nothing, end: defaultEnd, isDirty: false, perspective: $elm$core$Maybe$Nothing, speed: 0, start: $elm$core$Maybe$Nothing, timing: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Properties$Position$fromTriple = $author$project$Anim$Internal$Builders$Coordinate3D$fromTriple($author$project$Anim$Internal$Properties$Position$support);
var $author$project$Anim$Internal$Builders$Position$defaultConfig = $author$project$Anim$Internal$Builders$Property$defaultConfig(
	$author$project$Anim$Internal$Properties$Position$fromTriple(
		_Utils_Tuple3(0, 0, 0)));
var $author$project$Anim$Internal$Builders$Position$for = F2(
	function (elementId, builder) {
		var extractExisting = function (propertyConfig) {
			if (propertyConfig.$ === 'PositionConfig') {
		...
		var config = A4($author$project$Anim$Internal$Builders$Property$createFor, extractExisting, $author$project$Anim$Internal$Builders$Position$defaultConfig, elementId, builder);
		return A2(
...
var $author$project$Anim$Internal$Builders$Position$from = F2(
	function (position, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					start: $elm$core$Maybe$Just(position)
				}),
			builder);
	});
var $author$project$Anim$Internal$Builders$Position$fromXYZ = F3(
	function (x, y, z) {
		return $author$project$Anim$Internal$Builders$Position$from(
			$author$project$Anim$Internal$Properties$Position$fromTriple(
				_Utils_Tuple3(x, y, z)));
	});
var $author$project$Anim$Internal$Properties$Position$z = function (_v0) {
	var coords = _v0.a;
	return coords.z;
};
var $author$project$Anim$Internal$Builders$Position$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Position$z, config.start));
		return A4(
			$author$project$Anim$Internal$Builders$Position$fromXYZ,
			x,
			y,
			z,
			A2($author$project$Anim$Internal$Builders$Position$PositionBuilder, config, builder));
	});
var $author$project$Anim$Property$Position$fromXY = $author$project$Anim$Internal$Builders$Position$fromXY;
var $author$project$Anim$Internal$Builders$Position$to = F2(
	function (position, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = function () {
			...
			if (_v1.$ === 'Just') {
				...
				return $author$project$Anim$Internal$Properties$Position$fromTriple(
					_Utils_Tuple3(0, 0, 0));
			}
		}();
		return A2(
...
var $author$project$Anim$Internal$Builders$Position$toXYZ = F4(
	function (x, y, z, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Internal$Builders$Position$toXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Properties$Position$z(config.end);
		return A4(
			$author$project$Anim$Internal$Builders$Position$toXYZ,
			x,
			y,
			z,
			A2($author$project$Anim$Internal$Builders$Position$PositionBuilder, config, builder));
	});
var $author$project$Anim$Property$Position$initXY = F4(
	function (elementId, x, y, animBuilder) {
		return $author$project$Anim$Internal$Builders$Position$build(
			A3(
				$author$project$Anim$Internal$Builders$Position$toXY,
				x,
				y,
				A3(
					$author$project$Anim$Property$Position$fromXY,
					x,
					y,
					A2($author$project$Anim$Internal$Builders$Position$for, elementId, animBuilder))));
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$ElmUI$Sub$Controls$Main$init = function (_v0) {
	var initialAnimations = $author$project$Anim$Engine$Sub$animate(
		A4(
			$author$project$Anim$Property$Position$initXY,
			$author$project$ElmUI$Sub$Controls$Main$elementId,
			50,
			50,
			$author$project$Anim$Engine$Sub$builder($author$project$Anim$Engine$Sub$init)));
	return _Utils_Tuple2(
		{animations: initialAnimations, isAnimating: false, isPaused: false},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Sub$Controls$Main$AnimationMsg = function (a) {
...
var $author$project$Anim$Internal$Sub$subscriptions = F2(
	function (toMsg, _v0) {
		var state = _v0.a;
		return state.isRunning ? A2(
			$elm$core$Platform$Sub$map,
			toMsg,
			$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Anim$Internal$Sub$AnimationFrame)) : $elm$core$Platform$Sub$none;
	});
var $author$project$Anim$Engine$Sub$subscriptions = $author$project$Anim$Internal$Sub$subscriptions;
var $author$project$ElmUI$Sub$Controls$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$ElmUI$Sub$Controls$Main$AnimationMsg, model.animations);
};
...
var $author$project$Anim$Internal$Sub$duration = $author$project$Anim$Internal$Builder$duration;
var $author$project$Anim$Engine$Sub$duration = $author$project$Anim$Internal$Sub$duration;
var $author$project$Anim$Easing$EaseIn = {$: 'EaseIn'};
var $author$project$Anim$Property$Position$build = $author$project$Anim$Internal$Builders$Position$build;
...
var $author$project$Anim$Internal$Builders$Position$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Position$duration = $author$project$Anim$Internal$Builders$Position$duration;
...
var $author$project$Anim$Property$Position$easing = $author$project$Anim$Internal$Builders$Position$easing;
var $author$project$Anim$Property$Position$for = $author$project$Anim$Internal$Builders$Position$for;
var $author$project$Anim$Internal$Properties$Position$x = function (_v0) {
	var coords = _v0.a;
	return coords.x;
};
var $author$project$Anim$Internal$Builders$Position$toY = F2(
	function (y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Properties$Position$z(config.end);
		var x = $author$project$Anim$Internal$Properties$Position$x(config.end);
		return A4(
			$author$project$Anim$Internal$Builders$Position$toXYZ,
			x,
			y,
...
var $author$project$Anim$Property$Position$toY = $author$project$Anim$Internal$Builders$Position$toY;
var $author$project$Common$Animations$Position$moveDown = F2(
	function (elementId, builder) {
		return $author$project$Anim$Property$Position$build(
			A2(
				$author$project$Anim$Property$Position$easing,
				$author$project$Anim$Easing$EaseIn,
				A2(
					$author$project$Anim$Property$Position$duration,
					800,
					A2(
						$author$project$Anim$Property$Position$toY,
						300,
						A2($author$project$Anim$Property$Position$for, elementId, builder)))));
	});
...
var $author$project$Anim$Internal$Sub$pauseElement = F2(
	function (elementId, _v0) {
		var state = _v0.a;
...
var $author$project$Anim$Engine$Sub$pause = F2(
	function (elementId, animState) {
		return A2($author$project$Anim$Internal$Sub$pauseElement, elementId, animState);
	});
var $author$project$Anim$Internal$Sub$resetElement = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var _v1 = A2($elm$core$Dict$get, elementId, state.elementAnimations);
		if (_v1.$ === 'Nothing') {
			return $author$project$Anim$Internal$Sub$AnimState(state);
		} else {
			var elementAnim = _v1.a;
			var updatedProperties = A2(
				$elm$core$List$map,
				function (prop) {
					return _Utils_update(
						prop,
						{currentDelayFrame: 0, currentStepIndex: 0, elapsedMs: 0, isComplete: false});
				},
				elementAnim.properties);
			var updatedAnim = _Utils_update(
				elementAnim,
				{isComplete: false, isPaused: false, properties: updatedProperties});
			var updatedDict = A3($elm$core$Dict$insert, elementId, updatedAnim, state.elementAnimations);
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{elementAnimations: updatedDict}));
		}
	});
var $author$project$Anim$Engine$Sub$reset = F2(
	function (elementId, animState) {
		return A2($author$project$Anim$Internal$Sub$resetElement, elementId, animState);
	});
var $author$project$Anim$Internal$Sub$restartElement = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var _v1 = A2($elm$core$Dict$get, elementId, state.elementAnimations);
		if (_v1.$ === 'Nothing') {
...
var $author$project$Anim$Engine$Sub$restart = F2(
	function (elementId, animState) {
		return A2($author$project$Anim$Internal$Sub$restartElement, elementId, animState);
	});
var $author$project$Anim$Internal$Sub$resumeElement = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var updatedAnimations = A3(
			$elm$core$Dict$update,
...
var $author$project$Anim$Engine$Sub$resume = F2(
	function (elementId, animState) {
		return A2($author$project$Anim$Internal$Sub$resumeElement, elementId, animState);
	});
var $author$project$Anim$Internal$Sub$stopElement = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var _v1 = A2($elm$core$Dict$get, elementId, state.elementAnimations);
		if (_v1.$ === 'Nothing') {
			...
			var updatedProperties = A2(
				$elm$core$List$map,
				function (prop) {
					var lastFrameIndex = A2(
						$elm$core$Basics$max,
						0,
						$elm$core$List$length(prop.animationSteps) - 1);
					return _Utils_update(
						prop,
						{currentStepIndex: lastFrameIndex, elapsedMs: prop.totalDurationMs, isComplete: true});
				},
				elementAnim.properties);
			var updatedAnim = _Utils_update(
				elementAnim,
				{isComplete: true, isPaused: false, properties: updatedProperties});
			var updatedDict = A3($elm$core$Dict$insert, elementId, updatedAnim, state.elementAnimations);
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
...
var $author$project$Anim$Engine$Sub$stop = F2(
	function (elementId, animState) {
		return A2($author$project$Anim$Internal$Sub$stopElement, elementId, animState);
	});
...
var $author$project$Anim$Internal$Sub$updatePropertyAnimation = F2(
	function (deltaMs, propertyState) {
		if (propertyState.isComplete) {
			...
			var newElapsedMs = propertyState.elapsedMs + deltaMs;
			var delayMs = propertyState.delayFrames * $author$project$Anim$Internal$Sub$frameDurationMs;
			var isInDelayPeriod = _Utils_cmp(newElapsedMs, delayMs) < 0;
			var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - delayMs);
			var correctFrameIndex = function () {
				if (isInDelayPeriod || (propertyState.totalDurationMs <= 0)) {
					return 0;
				} else {
					var progress = A2($elm$core$Basics$min, 1.0, animationElapsedMs / propertyState.totalDurationMs);
					var maxIndex = $elm$core$List$length(propertyState.animationSteps) - 1;
					return A2(
						$elm$core$Basics$min,
						maxIndex,
						$elm$core$Basics$round(progress * maxIndex));
				}
			}();
			var isComplete_ = _Utils_cmp(animationElapsedMs, propertyState.totalDurationMs) > -1;
			return _Utils_update(
				propertyState,
...
var $author$project$Anim$Internal$Sub$updateElementAnimation = F3(
	function (deltaMs, _v0, elementState) {
		if (elementState.isPaused) {
			...
			var updatedProperties = A2(
				$elm$core$List$map,
				$author$project$Anim$Internal$Sub$updatePropertyAnimation(deltaMs),
...
var $author$project$Anim$Internal$Sub$update = F2(
	function (msg, _v0) {
		...
		return $author$project$Anim$Internal$Sub$AnimState(
			{builder: state.builder, elementAnimations: updatedElements, isRunning: stillRunning});
	});
var $author$project$Anim$Engine$Sub$update = $author$project$Anim$Internal$Sub$update;
var $author$project$ElmUI$Sub$Controls$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationMsg':
				var subMsg = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A2($author$project$Anim$Engine$Sub$update, subMsg, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Animate':
				var newAnimations = $author$project$Anim$Engine$Sub$animate(
					A2(
						$author$project$Common$Animations$Position$moveDown,
						$author$project$ElmUI$Sub$Controls$Main$elementId,
						A2(
							$author$project$Anim$Engine$Sub$duration,
							2000,
							$author$project$Anim$Engine$Sub$builder(model.animations))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isAnimating: true, isPaused: false}),
					$elm$core$Platform$Cmd$none);
			case 'Stop':
				var newAnimations = A2($author$project$Anim$Engine$Sub$stop, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isAnimating: false, isPaused: false}),
					$elm$core$Platform$Cmd$none);
			case 'Pause':
				var newAnimations = A2($author$project$Anim$Engine$Sub$pause, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isPaused: true}),
					$elm$core$Platform$Cmd$none);
			case 'Resume':
				var newAnimations = A2($author$project$Anim$Engine$Sub$resume, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isPaused: false}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				var newAnimations = A2($author$project$Anim$Engine$Sub$reset, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isAnimating: false, isPaused: false}),
					$elm$core$Platform$Cmd$none);
			default:
				var newAnimations = A2($author$project$Anim$Engine$Sub$restart, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations, isAnimating: true, isPaused: false}),
...
var $author$project$ElmUI$Sub$Controls$Main$Animate = {$: 'Animate'};
var $author$project$ElmUI$Sub$Controls$Main$Pause = {$: 'Pause'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$Sub$Controls$Main$Reset = {$: 'Reset'};
var $author$project$ElmUI$Sub$Controls$Main$Restart = {$: 'Restart'};
var $author$project$ElmUI$Sub$Controls$Main$Resume = {$: 'Resume'};
var $author$project$ElmUI$Sub$Controls$Main$Stop = {$: 'Stop'};
...
var $author$project$Common$UI$backButtonWithPath = function (path) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					angle: 0,
					steps: _List_fromArray(
						[$author$project$Common$Colors$primary, $author$project$Common$Colors$primaryLight])
				}),
		...
		switch (property.$) {
			case 'ProcessedPositionConfig':
				...
				return _Utils_update(
					acc,
					{
						position: 'translate3d(' + ($author$project$Anim$Internal$Properties$Position$toCssString(config.end) + ')')
					});
			case 'ProcessedRotateConfig':
				var config = property.a;
				return _Utils_update(
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {position: '', rotate: '', scale: ''};
...
var $author$project$Anim$Internal$Sub$getCurrentPropertyValue = function (propertyState) {
	var currentValue = $author$project$Anim$Internal$Sub$getCurrentValue(propertyState);
	switch (currentValue.$) {
		case 'PositionAnimation':
			var pos = currentValue.a;
			return $author$project$Anim$Internal$Builder$ProcessedPositionConfig(
				{
					delay: 0,
					distance: 0,
					duration: 0,
		...
		case 'BackgroundColorAnimation':
			var color = currentValue.a;
			return $author$project$Anim$Internal$Builder$ProcessedBackgroundColorConfig(
				{
					delay: 0,
					distance: 0,
					duration: 0,
		...
		case 'FontColorAnimation':
			var fontColor = currentValue.a;
			return $author$project$Anim$Internal$Builder$ProcessedFontColorConfig(
				{
					delay: 0,
					distance: 0,
					duration: 0,
					...
					perspective: $elm$core$Maybe$Nothing,
					speed: 0,
					start: $elm$core$Maybe$Just(fontColor),
					timing: $author$project$Anim$Internal$Timing$TimeSpec$Duration(0)
				});
		case 'OpacityAnimation':
			var opacity = currentValue.a;
...
var $author$project$Anim$Internal$Sub$getNonTransformStyleAttribute = function (propertyState) {
	var currentValue = A2(
		$elm$core$Maybe$withDefault,
		$author$project$Anim$Internal$Sub$getLastStep(propertyState.animationSteps),
		$elm$core$List$head(
	...
	switch (currentValue.$) {
		case 'BackgroundColorAnimation':
			var colorValue = currentValue.a;
			return $elm$core$Maybe$Just(
				A2(
					$elm$html$Html$Attributes$style,
					'background-color',
					$author$project$Anim$Internal$Properties$Color$toCssString(colorValue)));
		case 'OpacityAnimation':
			var opacity = currentValue.a;
			return $elm$core$Maybe$Just(
				A2(
					...
					'opacity',
					$elm$core$String$fromFloat(
						$author$project$Anim$Internal$Properties$Opacity$toFloat(opacity))));
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Anim$Internal$Sub$getSizeStyleAttributes = function (propertyState) {
	var currentValue = A2(
		$elm$core$Maybe$withDefault,
		$author$project$Anim$Internal$Sub$getLastStep(propertyState.animationSteps),
		$elm$core$List$head(
			A2($elm$core$List$drop, propertyState.currentStepIndex, propertyState.animationSteps)));
	if (currentValue.$ === 'SizeAnimation') {
		var size = currentValue.a;
		var _v1 = $author$project$Anim$Internal$Properties$Size$toTuple(size);
		var width = _v1.a;
		var height = _v1.b;
		return _List_fromArray(
			[
...
var $author$project$Anim$Internal$Sub$htmlAttributes = F2(
	function (elementId, _v0) {
		...
		if (_v1.$ === 'Nothing') {
			...
			var sizeStyles = A2($elm$core$List$concatMap, $author$project$Anim$Internal$Sub$getSizeStyleAttributes, elementAnimation.properties);
			...
			var transformString = $elm$core$String$trim(transformParts.position + (' ' + (transformParts.rotate + (' ' + transformParts.scale))));
...
var $author$project$ElmUI$Sub$Controls$Main$viewControlDescription = F2(
...
var $author$project$Common$UI$wrappedButtonRow = function (buttons) {
	var htmlButtons = A2($elm$core$List$map, $author$project$Common$UI$htmlButton, buttons);
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[$mdgriffith$elm_ui$Element$centerX]),
		$mdgriffith$elm_ui$Element$html(
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('ui-wrapped-row')
					]),
				htmlButtons)));
};
var $author$project$ElmUI$Sub$Controls$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButtonWithPath('../../../index.html'),
			$author$project$Common$UI$pageHeader('ElmUI & Subscription Engine Controls'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Demonstrating all subscription-based animation controls with frame-rate independence')),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							model.isPaused ? $author$project$Common$Colors$warning : (model.isAnimating ? $author$project$Common$Colors$primary : $author$project$Common$Colors$success)),
							$mdgriffith$elm_ui$Element$centerX,
							$mdgriffith$elm_ui$Element$Font$medium
						]),
					$mdgriffith$elm_ui$Element$text(
						model.isPaused ? '⏸️ Paused' : (model.isAnimating ? '🎬 Animating...' : '✅ Idle')))
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Sub$Controls$Main$Animate, '🌪️ Animate Down'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Controls$Main$Stop, '⏹️ Stop')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Controls$Main$Pause, '⏸️ Pause'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Controls$Main$Resume, '▶️ Resume')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Sub$Controls$Main$Reset, '⏮️ Reset'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Sub$Controls$Main$Restart, '🔄 Restart')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_Utils_ap(
				...
				A2(
					$elm$core$List$map,
					$mdgriffith$elm_ui$Element$htmlAttribute,
					A2($author$project$Anim$Engine$Sub$htmlAttributes, $author$project$ElmUI$Sub$Controls$Main$elementId, model.animations))),
			A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height(
						$mdgriffith$elm_ui$Element$px(50)),
						$mdgriffith$elm_ui$Element$Background$color($author$project$Common$Colors$warning),
						$mdgriffith$elm_ui$Element$Border$rounded(8),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id($author$project$ElmUI$Sub$Controls$Main$elementId)),
						$mdgriffith$elm_ui$Element$htmlAttribute(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '🌪️ Animate Down', 'Start smooth downward movement animation'),
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '⏹️ Stop', 'Jump instantly to end state and stop'),
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '⏸️ Pause', 'Pause animation at current position'),
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '▶️ Resume', 'Continue paused animation'),
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '⏮️ Reset', 'Jump instantly to start state and stop'),
							A2($author$project$ElmUI$Sub$Controls$Main$viewControlDescription, '🔄 Restart', 'Reset to start, then begin animation again')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
					...
					$mdgriffith$elm_ui$Element$text('💡 Subscription-based animations are frame-rate independent'))
				]))
		]);
};
var $author$project$ElmUI$Sub$Controls$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Engine.Sub Controls ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Controls$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Controls$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Controls$Main$init, subscriptions: $author$project$ElmUI$Sub$Controls$Main$subscriptions, update: $author$project$ElmUI$Sub$Controls$Main$update, view: $author$project$ElmUI$Sub$Controls$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Controls':{'Main':{'init':$author$project$ElmUI$Sub$Controls$Main$main(
