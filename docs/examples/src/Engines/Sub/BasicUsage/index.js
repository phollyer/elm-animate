...
var $author$project$Engines$Sub$BasicUsage$Main$slideIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for('hello-text'),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$fromX(-100),
		A2(
			$elm$core$Basics$composeR,
	...
	return _Utils_Tuple2(
		{
			animState: $author$project$Anim$Engine$Sub$animate(
				$author$project$Engines$Sub$BasicUsage$Main$slideIn(
