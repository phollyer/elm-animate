module Engines.Transitions.InterruptingAnimations.AddingProperties.Main exposing (..)
...
addExtras : Float -> Color.Color -> Transitions.AnimBuilder -> Transitions.AnimBuilder
addExtras rotateAmount color =
    rotateBox rotateAmount
        >> changeColor color


rotateBox : Float -> Transitions.AnimBuilder -> Transitions.AnimBuilder
rotateBox rotateAmount =
...
move : Direction -> Float -> Int -> (Translate.Builder -> Translate.Builder) -> Transitions.AnimBuilder -> Transitions.AnimBuilder
