...
moveBoxWithExtras : Float -> (Translate.Builder -> Translate.Builder) -> Color.Color -> Transitions.AnimBuilder -> Transitions.AnimBuilder
...
move : Direction -> Float -> State -> (Translate.Builder -> Translate.Builder) -> Transitions.AnimBuilder -> Transitions.AnimBuilder
