...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$waapiCommand = _Platform_outgoingPort('waapiCommand', $elm$core$Basics$identity);
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$waapiEvent = _Platform_incomingPort('waapiEvent', $elm$json$Json$Decode$value);
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$init = function (_v0) {
	var width = _v0.width;
	...
	return _Utils_Tuple2(
		{
			animState: A3(
				...
				$author$project$Engines$WAAPI$InterruptingAnimations$Main$waapiCommand,
				$author$project$Engines$WAAPI$InterruptingAnimations$Main$waapiEvent,
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Engines$WAAPI$InterruptingAnimations$Main$animGroup, 0, 0)
					])),
			height: height - 75,
			width: width - 20
		},
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$GotAnimationUpdate = function (a) {
	return {$: 'GotAnimationUpdate', a: a};
};
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Engines$WAAPI$InterruptingAnimations$Main$GotAnimationUpdate, model.animState);
};
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$moveBox = F2(
	function (moveFunc, animState) {
		return A2(
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GotAnimationUpdate':
				var animationMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, animationMsg, model.animState);
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'MoveLeft':
				var _v2 = $author$project$Engines$WAAPI$InterruptingAnimations$Main$moveLeft(model.animState);
				...
				return _Utils_Tuple2(
					...
					cmd);
			case 'MoveRight':
				var _v3 = A2($author$project$Engines$WAAPI$InterruptingAnimations$Main$moveRight, model.width, model.animState);
				...
				return _Utils_Tuple2(
					...
					cmd);
			case 'MoveUp':
				var _v4 = $author$project$Engines$WAAPI$InterruptingAnimations$Main$moveUp(model.animState);
				...
				return _Utils_Tuple2(
					...
					cmd);
			default:
				var _v5 = A2($author$project$Engines$WAAPI$InterruptingAnimations$Main$moveDown, model.height, model.animState);
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveDown = {$: 'MoveDown'};
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveRight = {$: 'MoveRight'};
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveUp = {$: 'MoveUp'};
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$view = function (model) {
	var button = F3(
		function (bgColor, label, onClick) {
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
	...
	var moveDownButton = A3(button, '#FFC107', 'Move Down', $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveDown);
	var moveLeftButton = A3(button, '#007BFF', 'Move Left', $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveLeft);
	var moveRightButton = A3(button, '#28A745', 'Move Right', $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveRight);
	var moveUpButton = A3(button, '#6F42C1', 'Move Up', $author$project$Engines$WAAPI$InterruptingAnimations$Main$MoveUp);
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Engines$WAAPI$InterruptingAnimations$Main$boxWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Engines$WAAPI$InterruptingAnimations$Main$boxWidth) + 'px'),
...
var $author$project$Engines$WAAPI$InterruptingAnimations$Main$main = $elm$browser$Browser$element(
	{init: $author$project$Engines$WAAPI$InterruptingAnimations$Main$init, subscriptions: $author$project$Engines$WAAPI$InterruptingAnimations$Main$subscriptions, update: $author$project$Engines$WAAPI$InterruptingAnimations$Main$update, view: $author$project$Engines$WAAPI$InterruptingAnimations$Main$view});
_Platform_export({'Engines':{'WAAPI':{'InterruptingAnimations':{'Main':{'init':$author$project$Engines$WAAPI$InterruptingAnimations$Main$main(
	A2(
