...
animationArea : WAAPI.AnimState Msg -> Element Msg
...
animatedBox : WAAPI.AnimState Msg -> Permutation -> Element Msg
animatedBox animState perm =
    el
        ...
        (el
            (List.map htmlAttribute (WAAPI.attributes (permutationKey perm) animState)
                ++ [ width (px 80)
                   , height (px 80)
