...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup = 'bouncingBall';
...
var $author$project$Anim$Internal$Sub$TranslateAnimation = function (a) {
	return {$: 'TranslateAnimation', a: a};
};
...
var $author$project$Anim$Internal$Properties$Translate$fromRecord = $author$project$Anim$Internal$Builders$Coordinate3D$fromRecord($author$project$Anim$Internal$Properties$Translate$support);
	...
	function (startValues, property) {
		var buildPropertyAnimation = F8(
			function (propertyType, actualStart, end, duration_, delay_, easing_, stepCreator, wrapper) {
				...
				var easeFunction = A2($author$project$Anim$Internal$Easing$toFunction, duration_, easing_);
		...
		switch (property.$) {
			case 'ProcessedTranslateConfig':
				...
				var actualStart = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Anim$Internal$Properties$Translate$fromRecord(startValues.translate),
					config.start);
				return $elm$core$Maybe$Just(
					A8(buildPropertyAnimation, 'translate', actualStart, config.end, config.duration, config.delay, config.easing, $author$project$Anim$Internal$Sub$createTranslateSteps, $author$project$Anim$Internal$Sub$TranslateAnimation));
...
var $author$project$Anim$Internal$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return $author$project$Anim$Internal$Sub$AnimState(
			{builder: $author$project$Anim$Internal$Builder$init, elementAnimations: $elm$core$Dict$empty, isRunning: false, pendingEvents: _List_Nil});
	} else {
		var startValues = {
			backgroundColor: $author$project$Anim$Internal$Properties$BackgroundColor$default,
			fontColor: $author$project$Anim$Internal$Properties$FontColor$default,
			opacity: 1.0,
			rotate: $author$project$Anim$Internal$Properties$Rotate$toRecord($author$project$Anim$Internal$Properties$Rotate$default),
			scale: $author$project$Anim$Internal$Properties$Scale$toRecord($author$project$Anim$Internal$Properties$Scale$default),
			size: $author$project$Anim$Internal$Properties$Size$toRecord($author$project$Anim$Internal$Properties$Size$default),
			translate: $author$project$Anim$Internal$Properties$Translate$toRecord($author$project$Anim$Internal$Properties$Translate$default)
		};
	...
	return _Utils_Tuple2(
		{
			...
			animState: $author$project$Anim$Engine$Sub$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, xPos, 50)
					]))
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$GotSubMsg = function (a) {
	return {$: 'GotSubMsg', a: a};
};
...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Concepts$ControllingAnimations$SubEngine$Main$GotSubMsg, model.animState);
};
...
var $author$project$Anim$Internal$Sub$getLastStep = function (steps) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Anim$Internal$Sub$TranslateAnimation(
			$author$project$Anim$Internal$Properties$Translate$fromTuple(
				_Utils_Tuple2(0, 0))),
		$elm$core$List$head(
				...
				return (!config.duration) ? _Utils_update(
					acc,
					{
						translate: $elm$core$Maybe$Just(
							$author$project$Anim$Internal$Properties$Translate$toRecord(config.end))
					}) : acc;
			case 'ProcessedRotateConfig':
				var config = property.a;
				return (!config.duration) ? _Utils_update(
...
var $author$project$Anim$Internal$Sub$animate = F2(
	function (_v0, transform) {
		...
		var startValues = {
			...
			translate: A2(
				$elm$core$Maybe$withDefault,
				$author$project$Anim$Internal$Properties$Translate$toRecord($author$project$Anim$Internal$Properties$Translate$default),
				currentValues.translate)
		};
...
var $author$project$Anim$Engine$Sub$animate = F2(
	function (animState, transform) {
		return A2($author$project$Anim$Internal$Sub$animate, animState, transform);
	});
...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Sub$pauseElement = F2(
	function (elementId, _v0) {
		...
		if (_v1.$ === 'Nothing') {
			...
			var wasRunning = (!elementAnim.isComplete) && (!elementAnim.isPaused);
			var updatedAnimations = A3(
				...
				state.elementAnimations);
			var newPendingEvents = wasRunning ? _Utils_ap(
				state.pendingEvents,
				_List_fromArray(
					[
						$author$project$Anim$Internal$Sub$Paused(elementId)
					])) : state.pendingEvents;
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{elementAnimations: updatedAnimations, pendingEvents: newPendingEvents}));
		}
	});
...
var $author$project$Anim$Internal$Sub$Cancelled = function (a) {
	...
	function (elementId, _v0) {
		...
		if (_v1.$ === 'Nothing') {
			...
			var newPendingEvents = wasRunning ? _Utils_ap(
				...
				_List_fromArray(
					[
						$author$project$Anim$Internal$Sub$Cancelled(elementId)
					])) : state.pendingEvents;
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{elementAnimations: updatedDict, isRunning: false, pendingEvents: newPendingEvents}));
		}
	});
...
var $author$project$Anim$Internal$Sub$Restarted = function (a) {
			...
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{
						...
						isRunning: true,
						pendingEvents: _Utils_ap(
							state.pendingEvents,
							_List_fromArray(
								[
									$author$project$Anim$Internal$Sub$Restarted(elementId)
								]))
					}));
		}
	});
...
var $author$project$Anim$Internal$Sub$Resumed = function (a) {
	return {$: 'Resumed', a: a};
};
var $author$project$Anim$Internal$Sub$resumeElement = F2(
	function (elementId, _v0) {
		...
		if (_v1.$ === 'Nothing') {
			...
			var elementAnim = _v1.a;
			var wasPaused = elementAnim.isPaused && (!elementAnim.isComplete);
			var updatedAnimations = A3(
				$elm$core$Dict$update,
				elementId,
				$elm$core$Maybe$map(
				...
				state.elementAnimations);
			var newPendingEvents = wasPaused ? _Utils_ap(
				state.pendingEvents,
				_List_fromArray(
					[
						$author$project$Anim$Internal$Sub$Resumed(elementId)
					])) : state.pendingEvents;
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{elementAnimations: updatedAnimations, isRunning: true, pendingEvents: newPendingEvents}));
		}
	});
	...
	function (elementId, _v0) {
		...
		if (_v1.$ === 'Nothing') {
			...
			return $author$project$Anim$Internal$Sub$AnimState(
				_Utils_update(
					state,
					{elementAnimations: updatedDict, pendingEvents: newPendingEvents}));
		}
	});
...
var $author$project$Anim$Engine$Sub$update = F2(
	function (msg, animState) {
		var _v0 = A2($author$project$Anim$Internal$Sub$update, msg, animState);
		var newState = _v0.a;
		var internalEvents = _v0.b;
		return _Utils_Tuple2(
			newState,
			A2($elm$core$List$filterMap, $author$project$Anim$Engine$Sub$toAnimEvent, internalEvents));
	});
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'GotSubMsg':
				var subMsg = msg.a;
			...
			case 'Stop':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$Sub$stop, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Pause':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$Sub$pause, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Resume':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$Sub$resume, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$Sub$reset, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$Sub$restart, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$Animate = {$: 'Animate'};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$Pause = {$: 'Pause'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$Reset = {$: 'Reset'};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$Restart = {$: 'Restart'};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$Resume = {$: 'Resume'};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {rotate: '', scale: '', translate: ''};
...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$animatedBall = function (animState) {
	return A2(
		...
		_Utils_ap(
			A2(
				$elm$core$List$map,
				$mdgriffith$elm_ui$Element$htmlAttribute,
				A2($author$project$Anim$Engine$Sub$attributes, $author$project$Concepts$ControllingAnimations$SubEngine$Main$animGroup, animState)),
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Animate, '🏀 Animate'),
						_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Stop, '⏹️ Stop')
					]),
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Success, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Pause, '⏸️ Pause'),
						_Utils_Tuple3($author$project$Common$UI$Success, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Resume, '▶️ Resume')
					]),
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Reset, '⏮️ Reset'),
						_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$Concepts$ControllingAnimations$SubEngine$Main$Restart, '🔄 Restart')
					])
				])),
			A2(
			$author$project$Common$View$Controls$animationArea,
			model.animAreaSize,
			$author$project$Concepts$ControllingAnimations$SubEngine$Main$animatedBall(model.animState))
		]);
};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Engine.Sub Controls ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$Concepts$ControllingAnimations$SubEngine$Main$viewContent(model));
};
var $author$project$Concepts$ControllingAnimations$SubEngine$Main$main = $elm$browser$Browser$document(
	{init: $author$project$Concepts$ControllingAnimations$SubEngine$Main$init, subscriptions: $author$project$Concepts$ControllingAnimations$SubEngine$Main$subscriptions, update: $author$project$Concepts$ControllingAnimations$SubEngine$Main$update, view: $author$project$Concepts$ControllingAnimations$SubEngine$Main$view});
_Platform_export({'Concepts':{'ControllingAnimations':{'SubEngine':{'Main':{'init':$author$project$Concepts$ControllingAnimations$SubEngine$Main$main(
	A2(
