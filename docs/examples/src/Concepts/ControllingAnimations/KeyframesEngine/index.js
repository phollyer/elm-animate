...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup = 'bouncingBall';
	...
	function (elementId, suffix, properties) {
		if ($elm$core$List$isEmpty(properties)) {
			...
			var processed = A2(
				...
				{animationDirection: $author$project$Anim$Internal$Builder$Normal, animationHistories: $elm$core$Dict$empty, currentElementId: $elm$core$Maybe$Nothing, discreteTransitions: false, elementBaselines: $elm$core$Dict$empty, elements: $elm$core$Dict$empty, globalDelay: $elm$core$Maybe$Nothing, globalEasing: $elm$core$Maybe$Nothing, globalTiming: $elm$core$Maybe$Nothing, globalTransformOrder: $elm$core$Maybe$Nothing, iterationCount: $author$project$Anim$Internal$Builder$Once, nextAnimationId: 0, scrollContainer: 'document', scrollTargets: _List_Nil, targetElement: $elm$core$Maybe$Nothing},
...
var $author$project$Anim$Internal$CSS$generateElementAnimationWithSuffix = F7(
	function (maybeOrder, discreteTransitions, iterationCount, direction, suffix, elementId, elementConfig) {
		...
		var processed = A2(
			$author$project$Anim$Internal$Builder$processElement,
			{animationDirection: direction, animationHistories: $elm$core$Dict$empty, currentElementId: $elm$core$Maybe$Nothing, discreteTransitions: discreteTransitions, elementBaselines: $elm$core$Dict$empty, elements: $elm$core$Dict$empty, globalDelay: $elm$core$Maybe$Nothing, globalEasing: $elm$core$Maybe$Nothing, globalTiming: $elm$core$Maybe$Nothing, globalTransformOrder: $elm$core$Maybe$Nothing, iterationCount: iterationCount, nextAnimationId: 0, scrollContainer: 'document', scrollTargets: _List_Nil, targetElement: $elm$core$Maybe$Nothing},
			elementConfig);
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{
			...
			animState: $author$project$Anim$Engine$CSS$Keyframes$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup, xPos, 50)
					]))
		},
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$CSS$pauseAnimation = F2(
	function (elementId, _v0) {
		var state = _v0.a;
					...
					return _Utils_update(
						element,
						{
							styles: _Utils_ap(
								...
								_List_fromArray(
									[
										_Utils_Tuple2('animation-play-state', 'paused')
									]))
						});
				}),
...
var $author$project$Anim$Internal$CSS$generateStylesOnly = F2(
...
var $author$project$Anim$Internal$CSS$reset = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var makeInstantConfig = function (value) {
			return {
				delay: $elm$core$Maybe$Nothing,
				distance: 0,
				duration: 0,
				easing: $elm$core$Maybe$Just($author$project$Anim$Extra$Easing$Linear),
				end: value,
				isDirty: true,
				speed: 0,
				start: $elm$core$Maybe$Just(value),
		...
		var maybeFromBuilder = A2(
							...
							case 'TranslateConfig':
								...
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$TranslateConfig(
										makeInstantConfig(
											A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$Translate$default, config.start))));
							case 'ScaleConfig':
								var config = prop.a;
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$ScaleConfig(
										makeInstantConfig(
											A2(
												$elm$core$Maybe$withDefault,
												$author$project$Anim$Internal$Properties$Scale$fromUniform(1.0),
												config.start))));
							case 'RotateConfig':
								var config = prop.a;
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$RotateConfig(
										makeInstantConfig(
											A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$Rotate$default, config.start))));
							case 'OpacityConfig':
								var config = prop.a;
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$OpacityConfig(
										makeInstantConfig(
											A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$Opacity$default, config.start))));
							case 'BackgroundColorConfig':
								var config = prop.a;
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$BackgroundColorConfig(
										makeInstantConfig(
											A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$BackgroundColor$default, config.start))));
							case 'SizeConfig':
								var config = prop.a;
								return $elm$core$Maybe$Just(
									$author$project$Anim$Internal$Builder$SizeConfig(
										makeInstantConfig(
											A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Properties$Size$default, config.start))));
							default:
								return $elm$core$Maybe$Nothing;
						}
					},
			...
			A2($author$project$Anim$Internal$Builder$getElementConfig, elementId, state.builder));
		var maybeFromHistory = A2(
			$elm$core$Maybe$map,
			function (processedElementConfig) {
				return A2(
					$elm$core$List$filterMap,
					function (prop) {
						switch (prop.$) {
			...
			A2(
				$elm$core$Maybe$andThen,
				function (entry) {
					return A2($elm$core$Dict$get, elementId, entry.processedData.elements);
				},
				A2($author$project$Anim$Internal$Builder$getCurrentAnimation, elementId, state.builder)));
		var properties = A2(
			$elm$core$Maybe$withDefault,
			A2($elm$core$Maybe$withDefault, _List_Nil, maybeFromBuilder),
			maybeFromHistory);
...
var $author$project$Anim$Internal$CSS$restartAnimation = F2(
	function (elementId, animState) {
		...
		var maybeFromHistory = A2(
			...
			A2($author$project$Anim$Internal$Builder$getCurrentAnimation, elementId, state.builder));
		var maybeFromBuilder = A2($author$project$Anim$Internal$Builder$getElementConfig, elementId, state.builder);
		var currentCounter = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, elementId, state.restartCounters));
		var newCounter = currentCounter + 1;
		var restartSuffix = 'r' + $elm$core$String$fromInt(newCounter);
		var applyRestart = function (elementAnimation) {
			var _v2 = A2($author$project$Anim$Internal$CSS$reset, elementId, animState);
			var resetStateData = _v2.a;
			return $author$project$Anim$Internal$CSS$AnimState(
				_Utils_update(
					resetStateData,
					{
...
var $author$project$Anim$Internal$CSS$resumeAnimation = F2(
	function (elementId, _v0) {
		...
		var updatedAnimations = A3(
			...
			$elm$core$Maybe$map(
				function (element) {
					var filteredStyles = A2(
						$elm$core$List$filter,
						function (_v1) {
							var key = _v1.a;
							return key !== 'animation-play-state';
						},
						element.styles);
					var newStyles = _Utils_ap(
						...
						_List_fromArray(
							[
								_Utils_Tuple2('animation-play-state', 'running')
							]));
					return _Utils_update(
						element,
						{styles: newStyles});
...
var $author$project$Anim$Internal$CSS$getBackgroundColorRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
			$elm$core$Maybe$andThen,
			function (elementConfig) {
				return $elm$core$List$head(
					A2(
						...
						function (prop) {
							if (prop.$ === 'ProcessedBackgroundColorConfig') {
								var config = prop.a;
								return $elm$core$Maybe$Just(
									{end: config.end, start: config.start});
							} else {
								return $elm$core$Maybe$Nothing;
							}
						},
...
var $author$project$Anim$Internal$CSS$getOpacityRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
...
var $author$project$Anim$Internal$CSS$getRotateRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
...
var $author$project$Anim$Internal$CSS$getScaleRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
...
var $author$project$Anim$Internal$CSS$getSizeRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
...
var $author$project$Anim$Internal$CSS$getTranslateRange = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var processedData = $author$project$Anim$Internal$Builder$processAnimationData(state.builder);
		return A2(
...
var $author$project$Anim$Internal$CSS$stopAnimation = F2(
	function (elementId, animState) {
		var makeInstantConfig = function (value) {
			return {
				delay: $elm$core$Maybe$Nothing,
		...
		var properties = A2(
			...
			_List_fromArray(
				[
					...
					function (range) {
						return $author$project$Anim$Internal$Builder$TranslateConfig(
							makeInstantConfig(range.end));
					},
					A2($author$project$Anim$Internal$CSS$getTranslateRange, elementId, animState)),
					A2(
					$elm$core$Maybe$map,
					function (range) {
						return $author$project$Anim$Internal$Builder$ScaleConfig(
					...
					A2($author$project$Anim$Internal$CSS$getScaleRange, elementId, animState)),
					A2(
					$elm$core$Maybe$map,
					function (range) {
						return $author$project$Anim$Internal$Builder$RotateConfig(
					...
					A2($author$project$Anim$Internal$CSS$getRotateRange, elementId, animState)),
					A2(
					$elm$core$Maybe$map,
					function (range) {
						return $author$project$Anim$Internal$Builder$OpacityConfig(
					...
					A2($author$project$Anim$Internal$CSS$getOpacityRange, elementId, animState)),
					A2(
					$elm$core$Maybe$map,
					function (range) {
						return $author$project$Anim$Internal$Builder$BackgroundColorConfig(
					...
					A2($author$project$Anim$Internal$CSS$getBackgroundColorRange, elementId, animState)),
					A2(
					$elm$core$Maybe$map,
					function (range) {
						return $author$project$Anim$Internal$Builder$SizeConfig(
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Animate':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$CSS$Keyframes$animate, model.animState, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$dropBall)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Stop':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$CSS$Keyframes$stop, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animState: A2($author$project$Anim$Engine$CSS$Keyframes$reset, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup, model.animState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Restart':
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Animate = {$: 'Animate'};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Pause = {$: 'Pause'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Reset = {$: 'Reset'};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Restart = {$: 'Restart'};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Resume = {$: 'Resume'};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Stop = {$: 'Stop'};
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animatedBall = function (animState) {
	return A2(
		...
		_Utils_ap(
			A2(
				$elm$core$List$map,
				$mdgriffith$elm_ui$Element$htmlAttribute,
				A2($author$project$Anim$Engine$CSS$Keyframes$attributes, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup, animState)),
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Anim$Internal$CSS$keyframesStyleNodeFor = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var _v1 = A2($elm$core$Dict$get, elementId, state.elementAnimations);
		if (_v1.$ === 'Just') {
			var elementAnimation = _v1.a;
			if ($elm$core$List$isEmpty(elementAnimation.animationLayers)) {
				return $elm$html$Html$text('');
			} else {
				var elementKeyframes = A2(
					$elm$core$String$join,
					'\n\n',
					A2(
						$elm$core$List$map,
				...
				return A3(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(elementKeyframes)
						]));
			}
		} else {
			return $elm$html$Html$text('');
...
var $author$project$Anim$Engine$CSS$Keyframes$styleNodeFor = $author$project$Anim$Internal$CSS$keyframesStyleNodeFor;
...
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$Engine$CSS$Keyframes$styleNodeFor, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animGroup, model.animState)),
			...
			_List_fromArray(
				[
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Animate, '🏀 Animate'),
						_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Stop, '⏹️ Stop')
					]),
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Success, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Pause, '⏸️ Pause'),
						_Utils_Tuple3($author$project$Common$UI$Success, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Resume, '▶️ Resume')
					]),
					_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Reset, '⏮️ Reset'),
						_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$Restart, '🔄 Restart')
					])
				])),
			A2(
			$author$project$Common$View$Controls$animationArea,
			model.animAreaSize,
			$author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$animatedBall(model.animState))
		]);
};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Keyframes Engine Controls Example - Elm Animate',
		$author$project$Common$UI$Basic,
		$author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$viewContent(model));
};
var $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$init,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$update,
		view: $author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$view
	});
_Platform_export({'Concepts':{'ControllingAnimations':{'KeyframesEngine':{'Main':{'init':$author$project$Concepts$ControllingAnimations$KeyframesEngine$Main$main(
	A2(
