...
var $author$project$Concepts$Animate3D$Main$Opening = {$: 'Opening'};
...
var $author$project$Concepts$Animate3D$Main$moveText = F2(
	function (textId, toZ) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$Main$textMoveAmount = 20;
var $author$project$Concepts$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Concepts$Animate3D$Main$moveText, 'front-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Concepts$Animate3D$Main$moveText, 'back-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount),
		A2(
			$elm$core$Basics$composeR,
			A2($author$project$Concepts$Animate3D$Main$moveText, 'right-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Concepts$Animate3D$Main$moveText, 'left-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount),
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Concepts$Animate3D$Main$moveText, 'top-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount),
					A2($author$project$Concepts$Animate3D$Main$moveText, 'bottom-face-text', $author$project$Concepts$Animate3D$Main$textMoveAmount))))));
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Concepts$Animate3D$Main$moveTopFaceOut,
					A2($elm$core$Basics$composeR, $author$project$Concepts$Animate3D$Main$moveBottomFaceOut, $author$project$Concepts$Animate3D$Main$moveTextsOut))))));
	...
	var initialAnimState = $author$project$Anim$Engine$CSS$Keyframes$init(
		_List_fromArray(
			[
				...
				A2($author$project$Anim$Property$Translate$initZ, 'front-face', $author$project$Concepts$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initZ, 'back-face', $author$project$Concepts$Animate3D$Main$depth * (-1)),
				A2($author$project$Anim$Property$Translate$initX, 'right-face', $author$project$Concepts$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initX, 'left-face', (-1) * $author$project$Concepts$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, 'top-face', (-1) * $author$project$Concepts$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, 'bottom-face', $author$project$Concepts$Animate3D$Main$depth),
...
var $author$project$Concepts$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Concepts$Animate3D$Main$moveText, 'front-face-text', 0),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Concepts$Animate3D$Main$moveText, 'back-face-text', 0),
		A2(
			$elm$core$Basics$composeR,
			A2($author$project$Concepts$Animate3D$Main$moveText, 'right-face-text', 0),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Concepts$Animate3D$Main$moveText, 'left-face-text', 0),
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Concepts$Animate3D$Main$moveText, 'top-face-text', 0),
					A2($author$project$Concepts$Animate3D$Main$moveText, 'bottom-face-text', 0))))));
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Concepts$Animate3D$Main$moveTopFaceIn,
					A2($elm$core$Basics$composeR, $author$project$Concepts$Animate3D$Main$moveBottomFaceIn, $author$project$Concepts$Animate3D$Main$moveTextsIn))))));
	...
	function (animEvent, model) {
		...
		while (true) {
			if (animEvent.$ === 'Ended') {
				switch (animEvent.a) {
					case 'cube':
						return (_Utils_eq(model.state, $author$project$Concepts$Animate3D$Main$RotatingOpen) || _Utils_eq(model.state, $author$project$Concepts$Animate3D$Main$RotatingClosed)) ? $author$project$Concepts$Animate3D$Main$cubeRotationEnded(model) : model;
					case 'front-face':
						return (_Utils_eq(model.state, $author$project$Concepts$Animate3D$Main$Opening) || _Utils_eq(model.state, $author$project$Concepts$Animate3D$Main$Closing)) ? $author$project$Concepts$Animate3D$Main$sidesMovementEnded(model) : model;
					default:
						break _v0$2;
				}
			} else {
...
var $author$project$Concepts$Animate3D$Main$NoOp = {$: 'NoOp'};
	...
	function (animState, listenForEvents, config) {
		...
		var eventAttributes = A2(
			...
			A2(
				...
				config.id,
				listenForEvents ? $author$project$Concepts$Animate3D$Main$GotKeyframeMsg : function (_v0) {
					return $author$project$Concepts$Animate3D$Main$NoOp;
				}));
		var baseAttributes = _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Concepts$Animate3D$Main$viewCube = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A3($author$project$Concepts$Animate3D$Main$viewFace, model.animState, true, $author$project$Concepts$Animate3D$Main$frontFace),
...
var $author$project$Concepts$Animate3D$Main$view = function (model) {
	return A3(
		...
		$author$project$Concepts$Animate3D$Main$viewContent(model));
};
var $author$project$Concepts$Animate3D$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$Concepts$Animate3D$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Concepts$Animate3D$Main$update,
		view: $author$project$Concepts$Animate3D$Main$view
	});
_Platform_export({'Concepts':{'Animate3D':{'Main':{'init':$author$project$Concepts$Animate3D$Main$main(
	A2(
