...
var $author$project$Concepts$Animate3D$Main$rotateLevel1To = function (angle) {
	return A2(
...
var $author$project$Concepts$Animate3D$Main$rotateLevel2To = function (angle) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$Main$translateLevel3To = function (z) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$Main$animateToEnd = A2(
	$elm$core$Basics$composeR,
	$author$project$Concepts$Animate3D$Main$rotateLevel1To(45),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Concepts$Animate3D$Main$rotateLevel2To(45),
		$author$project$Concepts$Animate3D$Main$translateLevel3To(60)));
...
var $author$project$Concepts$Animate3D$Main$init = function (_v0) {
	...
	return _Utils_Tuple2(
		{
			animState: A2(
				...
				A2(
					...
					A2($elm$core$Basics$composeR, $author$project$Anim$Engine$CSS$Keyframes$alternate, $author$project$Concepts$Animate3D$Main$animateToEnd)))
		},
...
var $author$project$Concepts$Animate3D$Main$viewInfo = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('What this tests:')
				])),
			A2(
			$elm$html$Html$ul,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Level 1 (Blue): ')
								])),
							$elm$html$Html$text('Rotates Y-axis to 45°')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Level 2 (Red): ')
								])),
							$elm$html$Html$text('Rotates X-axis to 45°')
						])),
					A2(
					$elm$html$Html$li,
					_List_Nil,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Level 3 (Green): ')
								])),
							$elm$html$Html$text('Translates Z-axis to 60px')
						]))
				])),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Expected behavior if 3D context works:')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('All three animations should be visible and combine in 3D space. '),
							$elm$html$Html$text('The green inner box should appear to move toward you while '),
							$elm$html$Html$text('the red middle rotates on X, and the blue outer rotates on Y.')
						]))
				]))
		]));
...
var $author$project$Concepts$Animate3D$Main$viewLevel3 = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background', 'rgba(46, 204, 113, 0.8)'),
					A2($elm$html$Html$Attributes$style, 'border', '3px solid rgb(39, 174, 96)'),
...
var $author$project$Concepts$Animate3D$Main$viewLevel2 = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background', 'rgba(231, 76, 60, 0.3)'),
					A2($elm$html$Html$Attributes$style, 'border', '3px solid rgb(231, 76, 60)'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
		...
		_List_fromArray(
			[
				$author$project$Concepts$Animate3D$Main$viewLevel3(model)
			]));
};
var $author$project$Concepts$Animate3D$Main$viewLevel1 = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background', 'rgba(52, 152, 219, 0.3)'),
					A2($elm$html$Html$Attributes$style, 'border', '3px solid rgb(52, 152, 219)'),
					A2($elm$html$Html$Attributes$style, 'display', 'flex'),
					A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
					A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
					$author$project$Anim$Extra$View3D$transformStyle($author$project$Anim$Extra$View3D$Preserve3D)
			...
			_Utils_ap(
				...
				A2($author$project$Anim$Engine$CSS$Keyframes$events, 'level-1', $author$project$Concepts$Animate3D$Main$GotKeyframeMsg))),
		_List_fromArray(
			[
				$author$project$Concepts$Animate3D$Main$viewLevel2(model)
			]));
};
var $author$project$Concepts$Animate3D$Main$viewScene = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Concepts$Animate3D$Main$viewLevel1(model)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Nested 3D Animation Test (Elm)')
					])),
				$author$project$Concepts$Animate3D$Main$viewScene(model),
				$author$project$Concepts$Animate3D$Main$viewInfo
			]));
};
var $author$project$Concepts$Animate3D$Main$main = $elm$browser$Browser$element(
	{
