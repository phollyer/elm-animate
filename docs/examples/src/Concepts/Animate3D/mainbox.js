	...
	return _Utils_Tuple2(
		{
			...
			animState: A2($author$project$Anim$Engine$CSS$Keyframes$animate, initialAnimState, $author$project$Concepts$Animate3D$MainBox$moveSidesOut),
			state: $author$project$Concepts$Animate3D$MainBox$Opening
		},
