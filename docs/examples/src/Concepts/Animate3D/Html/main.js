...
var $author$project$Concepts$Animate3D$Html$Main$Ready = {$: 'Ready'};
...
var $author$project$Concepts$Animate3D$Html$Main$cubeSize = 100;
var $author$project$Concepts$Animate3D$Html$Main$depth = $author$project$Concepts$Animate3D$Html$Main$cubeSize / 2;
...
var $author$project$Concepts$Animate3D$Html$Main$moveBottomFaceIn = A2(
	$author$project$Concepts$Animate3D$Html$Main$moveFace,
	'bottom-face',
	$author$project$Anim$Property$Translate$toY($author$project$Concepts$Animate3D$Html$Main$depth));
var $author$project$Concepts$Animate3D$Html$Main$moveFrontFaceIn = A2(
	$author$project$Concepts$Animate3D$Html$Main$moveFace,
	'front-face',
...
var $author$project$Concepts$Animate3D$Html$Main$moveLeftFaceIn = A2(
	$author$project$Concepts$Animate3D$Html$Main$moveFace,
	'left-face',
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Concepts$Animate3D$Html$Main$depth));
var $author$project$Concepts$Animate3D$Html$Main$moveRightFaceIn = A2(
	$author$project$Concepts$Animate3D$Html$Main$moveFace,
	'right-face',
...
var $author$project$Concepts$Animate3D$Html$Main$moveTopFaceIn = A2(
	$author$project$Concepts$Animate3D$Html$Main$moveFace,
	'top-face',
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Concepts$Animate3D$Html$Main$depth));
var $author$project$Concepts$Animate3D$Html$Main$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Concepts$Animate3D$Html$Main$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Concepts$Animate3D$Html$Main$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Concepts$Animate3D$Html$Main$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$Html$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$Html$Main$cubeRotationEnded = function (model) {
	var state = function () {
		...
		switch (_v0.$) {
			case 'RotatingOpen':
				return $author$project$Concepts$Animate3D$Html$Main$Closing;
			case 'RotatingClosed':
				return $author$project$Concepts$Animate3D$Html$Main$Opening;
			default:
				return model.state;
		}
	}();
...
var $author$project$Concepts$Animate3D$Html$Main$RotatingClosed = {$: 'RotatingClosed'};
var $author$project$Concepts$Animate3D$Html$Main$RotatingOpen = {$: 'RotatingOpen'};
var $author$project$Concepts$Animate3D$Html$Main$sidesMovementEnded = function (model) {
	var state = function () {
		var _v0 = model.state;
		switch (_v0.$) {
			case 'Ready':
				return $author$project$Concepts$Animate3D$Html$Main$RotatingOpen;
			case 'Opening':
				return $author$project$Concepts$Animate3D$Html$Main$RotatingOpen;
			case 'Closing':
				return $author$project$Concepts$Animate3D$Html$Main$RotatingClosed;
			default:
				return model.state;
		}
	}();
...
var $author$project$Concepts$Animate3D$Html$Main$handleKeyframeEvent = F2(
	function (animEvent, model) {
		...
		while (true) {
			if (animEvent.$ === 'Ended') {
				switch (animEvent.a) {
					case 'cube':
						return (!_Utils_eq(model.state, $author$project$Concepts$Animate3D$Html$Main$Ready)) ? $author$project$Concepts$Animate3D$Html$Main$cubeRotationEnded(model) : model;
					case 'front-face':
						return $author$project$Concepts$Animate3D$Html$Main$sidesMovementEnded(model);
					default:
						break _v0$2;
				}
			} else {
...
var $author$project$Concepts$Animate3D$Html$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'NoOp') {
			...
			return _Utils_Tuple2(
				A2(
					$author$project$Concepts$Animate3D$Html$Main$handleKeyframeEvent,
					animEvent,
					_Utils_update(
						model,
						{animState: animState})),
...
var $author$project$Concepts$Animate3D$Html$Main$GotKeyframeMsg = function (a) {
...
var $author$project$Concepts$Animate3D$Html$Main$backFace = {background: 'rgb(41, 128, 185)', borderColor: 'rgb(33, 97, 140)', id: 'back-face', label: 'BACK', textId: 'back-face-text'};
var $author$project$Concepts$Animate3D$Html$Main$bottomFace = {background: 'rgb(155, 89, 182)', borderColor: 'rgb(142, 68, 173)', id: 'bottom-face', label: 'BOTTOM', textId: 'bottom-face-text'};
...
var $author$project$Concepts$Animate3D$Html$Main$frontFace = {background: 'rgb(52, 152, 219)', borderColor: 'rgb(41, 128, 185)', id: 'front-face', label: 'FRONT', textId: 'front-face-text'};
var $author$project$Concepts$Animate3D$Html$Main$leftFace = {background: 'rgb(230, 126, 34)', borderColor: 'rgb(211, 84, 0)', id: 'left-face', label: 'LEFT', textId: 'left-face-text'};
var $author$project$Concepts$Animate3D$Html$Main$rightFace = {background: 'rgb(231, 76, 60)', borderColor: 'rgb(192, 57, 43)', id: 'right-face', label: 'RIGHT', textId: 'right-face-text'};
var $author$project$Concepts$Animate3D$Html$Main$topFace = {background: 'rgb(46, 204, 113)', borderColor: 'rgb(39, 174, 96)', id: 'top-face', label: 'TOP', textId: 'top-face-text'};
var $author$project$Concepts$Animate3D$Html$Main$NoOp = {$: 'NoOp'};
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Concepts$Animate3D$Html$Main$viewFace = F3(
	function (animState, listenForEvents, config) {
		var textEventAttributes = A2(
			...
			config.textId,
			function (_v1) {
				return $author$project$Concepts$Animate3D$Html$Main$NoOp;
			});
		var textAnimAttributes = A2($author$project$Anim$Engine$CSS$Keyframes$attributes, config.textId, animState);
		var eventAttributes = A2(
			$author$project$Anim$Engine$CSS$Keyframes$eventsStopPropagation,
			config.id,
			listenForEvents ? $author$project$Concepts$Animate3D$Html$Main$GotKeyframeMsg : function (_v0) {
				return $author$project$Concepts$Animate3D$Html$Main$NoOp;
			});
		var animAttributes = A2($author$project$Anim$Engine$CSS$Keyframes$attributes, config.id, animState);
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				animAttributes,
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'width',
							$elm$core$String$fromInt($author$project$Concepts$Animate3D$Html$Main$cubeSize) + 'px'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromInt($author$project$Concepts$Animate3D$Html$Main$cubeSize) + 'px'),
							A2($elm$html$Html$Attributes$style, 'background-color', config.background),
							A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.borderColor),
...
var $author$project$Concepts$Animate3D$Html$Main$viewCube = function (model) {
	var cubeEvents = A2($author$project$Anim$Engine$CSS$Keyframes$eventsStopPropagation, 'cube', $author$project$Concepts$Animate3D$Html$Main$GotKeyframeMsg);
	var cubeAttrs = A2($author$project$Anim$Engine$CSS$Keyframes$attributes, 'cube', model.animState);
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			cubeAttrs,
		...
		_List_fromArray(
			[
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, true, $author$project$Concepts$Animate3D$Html$Main$frontFace),
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, false, $author$project$Concepts$Animate3D$Html$Main$backFace),
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, false, $author$project$Concepts$Animate3D$Html$Main$rightFace),
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, false, $author$project$Concepts$Animate3D$Html$Main$leftFace),
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, false, $author$project$Concepts$Animate3D$Html$Main$topFace),
				A3($author$project$Concepts$Animate3D$Html$Main$viewFace, model.animState, false, $author$project$Concepts$Animate3D$Html$Main$bottomFace)
			]));
};
var $author$project$Concepts$Animate3D$Html$Main$viewAnimationArea = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromInt(model.animAreaSize.width) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'height',
				$elm$core$String$fromInt(model.animAreaSize.height) + 'px'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Concepts$Animate3D$Html$Main$viewCube(model)
					]))
			]));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$Concepts$Animate3D$Html$Main$viewExplanation = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('3D Cube Animation')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('This example demonstrates a 3D cube built with six positioned faces '),
					$elm$html$Html$text('that cycles through: expand sides → rotate → close sides → rotate back.')
				]))
		]));
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $author$project$Concepts$Animate3D$Html$Main$viewHeader = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Keyframes 3D Example - HTML')
				]))
		]));
var $author$project$Concepts$Animate3D$Html$Main$view = function (model) {
	return {
...
var $author$project$Concepts$Animate3D$Html$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$Concepts$Animate3D$Html$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Concepts$Animate3D$Html$Main$update,
		view: $author$project$Concepts$Animate3D$Html$Main$view
	});
_Platform_export({'Concepts':{'Animate3D':{'Html':{'Main':{'init':$author$project$Concepts$Animate3D$Html$Main$main(
	A2(
