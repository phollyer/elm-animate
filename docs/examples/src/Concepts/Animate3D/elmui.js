...
var $author$project$Anim$Extra$Easing$SineInOut = {$: 'SineInOut'};
...
var $author$project$Concepts$Animate3D$MainElmUI$rotateLevel1To = function (angle) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for('level-1'),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Rotate$to(angle),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Rotate$easing($author$project$Anim$Extra$Easing$SineInOut),
				A2(
					$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$MainElmUI$rotateLevel2To = function (angle) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for('level-2'),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Rotate$toX(angle),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Rotate$easing($author$project$Anim$Extra$Easing$SineInOut),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Rotate$duration(1500),
					$author$project$Anim$Property$Rotate$build))));
};
...
var $author$project$Concepts$Animate3D$MainElmUI$translateLevel3To = function (z) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for('level-3'),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Translate$toZ(z),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$easing($author$project$Anim$Extra$Easing$SineInOut),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$duration(1000),
					$author$project$Anim$Property$Translate$build))));
};
var $author$project$Concepts$Animate3D$MainElmUI$animateToEnd = A2(
	$elm$core$Basics$composeR,
	$author$project$Concepts$Animate3D$MainElmUI$rotateLevel1To(45),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Concepts$Animate3D$MainElmUI$rotateLevel2To(45),
		$author$project$Concepts$Animate3D$MainElmUI$translateLevel3To(60)));
...
var $author$project$Concepts$Animate3D$MainElmUI$init = function (_v0) {
	var initialAnimState = $author$project$Anim$Engine$CSS$Keyframes$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Rotate$initY, 'level-1', 0),
				A2($author$project$Anim$Property$Rotate$initX, 'level-2', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'level-3', 0)
			]));
	return _Utils_Tuple2(
		{
			animState: A2(
				...
				A2(
					...
					A2($elm$core$Basics$composeR, $author$project$Anim$Engine$CSS$Keyframes$alternate, $author$project$Concepts$Animate3D$MainElmUI$animateToEnd)))
		},
...
var $author$project$Concepts$Animate3D$MainElmUI$update = F2(
	function (msg, model) {
		var animMsg = msg.a;
...
var $author$project$Concepts$Animate3D$MainElmUI$viewInfo = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('What this tests:')),
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$Font$bold]),
					$mdgriffith$elm_ui$Element$text('Level 1 (Blue): ')),
					$mdgriffith$elm_ui$Element$text('Rotates Y-axis to 45°')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$Font$bold]),
					$mdgriffith$elm_ui$Element$text('Level 2 (Red): ')),
					$mdgriffith$elm_ui$Element$text('Rotates X-axis to 45°')
				])),
			A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$Font$bold]),
					$mdgriffith$elm_ui$Element$text('Level 3 (Green): ')),
					$mdgriffith$elm_ui$Element$text('Translates Z-axis to 60px')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 232, 245, 233)),
					...
					[
						...
						_List_fromArray(
							[
								...
								A3($mdgriffith$elm_ui$Element$rgb255, 46, 125, 50))
							]),
						$mdgriffith$elm_ui$Element$text('Expected behavior if 3D context works:')),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('All three animations should be visible and combine in 3D space. '),
								$mdgriffith$elm_ui$Element$text('The green inner box should appear to move toward you while '),
								$mdgriffith$elm_ui$Element$text('the red middle rotates on X, and the blue outer rotates on Y.')
							]))
					])))
		]));
...
var $author$project$Concepts$Animate3D$MainElmUI$GotKeyframeMsg = function (a) {
...
var $author$project$Concepts$Animate3D$MainElmUI$viewLevel3 = function (model) {
	var animAttributes = A2(
		$elm$core$List$map,
		$mdgriffith$elm_ui$Element$htmlAttribute,
		A2($author$project$Anim$Engine$CSS$Keyframes$attributes, 'level-3', model.animState));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$px(80)),
					$mdgriffith$elm_ui$Element$Background$color(
					A4($mdgriffith$elm_ui$Element$rgba255, 46, 204, 113, 0.8)),
					$mdgriffith$elm_ui$Element$Border$width(3),
					$mdgriffith$elm_ui$Element$Border$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 39, 174, 96)),
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$Font$color(
					A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
			...
			animAttributes),
		$mdgriffith$elm_ui$Element$text('INNER'));
};
var $author$project$Concepts$Animate3D$MainElmUI$viewLevel2 = function (model) {
	var animAttributes = A2(
		$elm$core$List$map,
		$mdgriffith$elm_ui$Element$htmlAttribute,
		A2($author$project$Anim$Engine$CSS$Keyframes$attributes, 'level-2', model.animState));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$px(140)),
					$mdgriffith$elm_ui$Element$Background$color(
					A4($mdgriffith$elm_ui$Element$rgba255, 231, 76, 60, 0.3)),
					$mdgriffith$elm_ui$Element$Border$width(3),
					$mdgriffith$elm_ui$Element$Border$color(
			...
			animAttributes),
		$author$project$Concepts$Animate3D$MainElmUI$viewLevel3(model));
};
var $author$project$Concepts$Animate3D$MainElmUI$viewLevel1 = function (model) {
	var eventAttributes = A2(
		$elm$core$List$map,
		$mdgriffith$elm_ui$Element$htmlAttribute,
		A2($author$project$Anim$Engine$CSS$Keyframes$events, 'level-1', $author$project$Concepts$Animate3D$MainElmUI$GotKeyframeMsg));
	var animAttributes = A2(
		$elm$core$List$map,
		$mdgriffith$elm_ui$Element$htmlAttribute,
		A2($author$project$Anim$Engine$CSS$Keyframes$attributes, 'level-1', model.animState));
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_Utils_ap(
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$px(200)),
					$mdgriffith$elm_ui$Element$Background$color(
					A4($mdgriffith$elm_ui$Element$rgba255, 52, 152, 219, 0.3)),
					$mdgriffith$elm_ui$Element$Border$width(3),
					$mdgriffith$elm_ui$Element$Border$color(
		...
		$author$project$Concepts$Animate3D$MainElmUI$viewLevel2(model));
};
var $author$project$Concepts$Animate3D$MainElmUI$viewScene = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$author$project$Anim$Extra$View3D$perspective(800)),
				$mdgriffith$elm_ui$Element$htmlAttribute(
		...
		$author$project$Concepts$Animate3D$MainElmUI$viewLevel1(model));
};
var $author$project$Concepts$Animate3D$MainElmUI$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Nested 3D Animation Test (Elm + elm-ui)')),
					$author$project$Concepts$Animate3D$MainElmUI$viewScene(model),
					$author$project$Concepts$Animate3D$MainElmUI$viewInfo
				])));
};
var $author$project$Concepts$Animate3D$MainElmUI$main = $elm$browser$Browser$element(
	{
		init: $author$project$Concepts$Animate3D$MainElmUI$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Concepts$Animate3D$MainElmUI$update,
		view: $author$project$Concepts$Animate3D$MainElmUI$view
	});
_Platform_export({'Concepts':{'Animate3D':{'MainElmUI':{'init':$author$project$Concepts$Animate3D$MainElmUI$main(
