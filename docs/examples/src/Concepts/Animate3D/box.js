...
var $author$project$Anim$Internal$Builder$Alternate = {$: 'Alternate'};
...
var $author$project$Anim$Internal$Builder$alternate = function (_v0) {
	...
	return $author$project$Anim$Internal$Builder$AnimBuilder(
		_Utils_update(
			data,
			{animationDirection: $author$project$Anim$Internal$Builder$Alternate}));
};
var $author$project$Anim$Engine$CSS$Keyframes$alternate = $author$project$Anim$Internal$Builder$alternate;
...
var $author$project$Anim$Internal$Properties$Opacity$default = $author$project$Anim$Internal$Properties$Opacity$Opacity(1);
...
var $author$project$Anim$Internal$Properties$Opacity$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0.a;
		var end = _v1.a;
		return $author$project$Anim$Internal$Properties$Opacity$Opacity(start + ((end - start) * t));
	});
var $author$project$Anim$Internal$Builders$Coordinate3D$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.toRecord(start);
		var endRecord = support.toRecord(end);
		return support.fromRecord(
			{x: startRecord.x + ((endRecord.x - startRecord.x) * t), y: startRecord.y + ((endRecord.y - startRecord.y) * t), z: startRecord.z + ((endRecord.z - startRecord.z) * t)});
	});
...
var $author$project$Anim$Internal$Properties$Size$interpolate = F3(
	function (t, _v0, _v1) {
		...
		return $author$project$Anim$Internal$Properties$Size$Size(
			{h: start.h + ((endSize.h - start.h) * t), w: start.w + ((endSize.w - start.w) * t)});
	});
...
var $author$project$Anim$Internal$Properties$Size$toString = function (size) {
	var _v0 = $author$project$Anim$Internal$Properties$Size$toTuple(size);
	var width = _v0.a;
	var height = _v0.b;
	return '(' + ($elm$core$String$fromFloat(width) + (', ' + ($elm$core$String$fromFloat(height) + ')')));
};
var $author$project$Anim$Internal$CSS$KeyframeAnimation$generateWithSuffixFromProcessed = F3(
	function (elementId, suffix, processedProps) {
		if ($elm$core$List$isEmpty(processedProps)) {
			return _List_Nil;
		} else {
			var maxDuration = A2(
				$elm$core$Maybe$withDefault,
			...
			var keyframeSteps = A2(
				$elm$core$List$map,
				function (i) {
					var globalProgress = i / keyframeCount;
					var totalTime = globalProgress * totalAnimationTime;
					var calculateProgress = F3(
						function (delay, duration, easing) {
							var linearProgress = function () {
								if (_Utils_cmp(totalTime, delay) < 0) {
									return 0;
								} else {
									if (!duration) {
										return 1.0;
									} else {
										var animationTime = totalTime - delay;
										return A3($elm$core$Basics$clamp, 0, 1, animationTime / duration);
									}
								}
							}();
							var easingFunction = A2($author$project$Anim$Internal$Easing$toFunction, duration, easing);
						...
						function (p) {
							switch (p.$) {
								case 'ProcessedBackgroundColorConfig':
									...
									var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
									var interpolatedColor = A3($author$project$Anim$Internal$Properties$Color$interpolate, startColor, cfg.end, progress);
									return $elm$core$Maybe$Just(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'background-color',
												$author$project$Anim$Internal$Properties$Color$toCssString(interpolatedColor))
											]));
								case 'ProcessedOpacityConfig':
									var cfg = p.a;
									var startOpacity = function () {
										var _v8 = cfg.start;
										if (_v8.$ === 'Just') {
											var s = _v8.a;
											return s;
										} else {
											return $author$project$Anim$Internal$Properties$Opacity$default;
										}
									}();
									var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
									var interpolatedOpacity = A3($author$project$Anim$Internal$Properties$Opacity$interpolate, progress, startOpacity, cfg.end);
									return $elm$core$Maybe$Just(
										_List_fromArray(
											[
												_Utils_Tuple2(
								...
								case 'ProcessedSizeConfig':
									...
									var startSize = function () {
										...
										if (_v10.$ === 'Just') {
											...
											return $author$project$Anim$Internal$Properties$Size$default;
										}
									}();
									var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
									var interpolated = A3($author$project$Anim$Internal$Properties$Size$interpolate, progress, startSize, cfg.end);
									var _v9 = $author$project$Anim$Internal$Properties$Size$toTuple(interpolated);
									var interpolatedW = _v9.a;
									var interpolatedH = _v9.b;
									return $elm$core$Maybe$Just(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'width',
												$elm$core$String$fromFloat(interpolatedW) + 'px'),
												_Utils_Tuple2(
												'height',
												$elm$core$String$fromFloat(interpolatedH) + 'px')
											]));
								default:
									return $elm$core$Maybe$Nothing;
							}
							...
							function (p, acc) {
								switch (p.$) {
									case 'ProcessedTranslateConfig':
										...
										var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
										var interpolatedPos = A3($author$project$Anim$Internal$Properties$Translate$interpolate, progress, startPos, cfg.end);
										return _Utils_update(
											acc,
											{
									...
									case 'ProcessedRotateConfig':
										var cfg = p.a;
										var startRot = function () {
											var _v4 = cfg.start;
											if (_v4.$ === 'Just') {
												var s = _v4.a;
												return s;
											} else {
												return $author$project$Anim$Internal$Properties$Rotate$default;
											}
										}();
										var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
										var interpolatedRot = A3($author$project$Anim$Internal$Properties$Rotate$interpolate, progress, startRot, cfg.end);
										return _Utils_update(
											acc,
											{
									...
									case 'ProcessedScaleConfig':
										...
										var startScale = function () {
											...
											if (_v5.$ === 'Just') {
												...
												return $author$project$Anim$Internal$Properties$Scale$default;
											}
										}();
										var progress = A3(calculateProgress, cfg.delay, cfg.duration, cfg.easing);
										var interpolatedScale = A3($author$project$Anim$Internal$Properties$Scale$interpolate, progress, startScale, cfg.end);
										return _Utils_update(
											acc,
											{
												scale: 'scale(' + ($author$project$Anim$Internal$Properties$Scale$toCssString(interpolatedScale) + ')')
											});
									default:
										return acc;
								}
					...
					var transformStyle = $elm$core$List$isEmpty(transformComponents) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						_Utils_Tuple2(
							'transform',
							A2($elm$core$String$join, ' ', transformComponents)));
					var styles = function () {
						if (transformStyle.$ === 'Just') {
							var t = transformStyle.a;
							return A2(
								$elm$core$List$cons,
								t,
								$elm$core$List$concat(otherStyles));
						} else {
							return $elm$core$List$concat(otherStyles);
						}
					}();
					return _Utils_Tuple2(globalProgress, styles);
				},
				A2($elm$core$List$range, 0, keyframeCount));
							...
							A2(
								...
								function (p) {
									switch (p.$) {
										case 'ProcessedTranslateConfig':
											var cfg = p.a;
											return 'pos-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Translate$toCssString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Translate$toCssString, cfg.start))))))));
										case 'ProcessedScaleConfig':
											var cfg = p.a;
											return 'scale-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Scale$toCssString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Scale$toCssString, cfg.start))))))));
										case 'ProcessedRotateConfig':
											var cfg = p.a;
											return 'rot-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Rotate$toCssString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Rotate$toCssString, cfg.start))))))));
										case 'ProcessedBackgroundColorConfig':
											var cfg = p.a;
											return 'bg-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Color$toCssString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Color$toCssString, cfg.start))))))));
										case 'ProcessedFontColorConfig':
											var cfg = p.a;
											return 'color-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Color$toCssString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Color$toCssString, cfg.start))))))));
										case 'ProcessedOpacityConfig':
											var cfg = p.a;
											return 'opacity-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Opacity$toString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Opacity$toString, cfg.start))))))));
										default:
											var cfg = p.a;
											return 'size-' + ($elm$core$String$fromInt(cfg.duration) + ('-' + ($elm$core$String$fromInt(cfg.delay) + ('-' + ($author$project$Anim$Internal$Properties$Size$toString(cfg.end) + ('-' + A2(
												$elm$core$Maybe$withDefault,
												'none',
												A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Size$toString, cfg.start))))))));
									}
								},
								processedProps)))));
			var betterHash = A3(
...
var $author$project$Concepts$Animate3D$MainBox$cubeSize = 100;
var $author$project$Concepts$Animate3D$MainBox$depth = $author$project$Concepts$Animate3D$MainBox$cubeSize / 2;
...
var $author$project$Anim$Internal$Builders$Rotate$fromXYZ = F3(
	function (x, y, z) {
		return $author$project$Anim$Internal$Builders$Rotate$from(
			$author$project$Anim$Internal$Properties$Rotate$fromTriple(
				_Utils_Tuple3(x, y, z)));
	});
var $author$project$Anim$Internal$Properties$Rotate$rotateY = function (_v0) {
	var angles = _v0.a;
	return angles.y;
};
var $author$project$Anim$Internal$Properties$Rotate$rotateZ = function (_v0) {
	var angles = _v0.a;
	return angles.z;
};
var $author$project$Anim$Internal$Builders$Rotate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Rotate$rotateZ, config.start));
		var y = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Rotate$rotateY, config.start));
		return A4(
			$author$project$Anim$Internal$Builders$Rotate$fromXYZ,
			x,
			y,
			z,
...
var $author$project$Anim$Internal$Builders$Rotate$toX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Properties$Rotate$rotateZ(config.end);
...
var $author$project$Anim$Internal$Builders$Rotate$fromY = F2(
	function (y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A2(
		...
		var x = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Maybe$map, $author$project$Anim$Internal$Properties$Rotate$rotateX, config.start));
		return A4(
			$author$project$Anim$Internal$Builders$Rotate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Property$Rotate$fromY = $author$project$Anim$Internal$Builders$Rotate$fromY;
var $author$project$Anim$Internal$Builders$Rotate$toY = F2(
	function (y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Properties$Rotate$rotateZ(config.end);
...
var $author$project$Anim$Internal$Builder$Infinite = {$: 'Infinite'};
var $author$project$Anim$Internal$Builder$loopForever = function (_v0) {
	var data = _v0.a;
	return $author$project$Anim$Internal$Builder$AnimBuilder(
		_Utils_update(
			data,
			{iterationCount: $author$project$Anim$Internal$Builder$Infinite}));
};
var $author$project$Anim$Engine$CSS$Keyframes$loopForever = $author$project$Anim$Internal$Builder$loopForever;
var $author$project$Concepts$Animate3D$MainBox$moveAmount = 50;
...
var $author$project$Concepts$Animate3D$MainBox$moveFace = F2(
...
var $author$project$Concepts$Animate3D$MainBox$moveBackFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'back-face',
	$author$project$Anim$Property$Translate$toZ(((-1) * $author$project$Concepts$Animate3D$MainBox$depth) - $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Anim$Property$Translate$toY = $author$project$Anim$Internal$Builders$Translate$toY;
var $author$project$Concepts$Animate3D$MainBox$moveBottomFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'bottom-face',
	$author$project$Anim$Property$Translate$toY($author$project$Concepts$Animate3D$MainBox$depth + $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Concepts$Animate3D$MainBox$moveFrontFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'front-face',
	$author$project$Anim$Property$Translate$toZ($author$project$Concepts$Animate3D$MainBox$depth + $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Anim$Property$Translate$toX = $author$project$Anim$Internal$Builders$Translate$toX;
var $author$project$Concepts$Animate3D$MainBox$moveLeftFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'left-face',
	$author$project$Anim$Property$Translate$toX(((-1) * $author$project$Concepts$Animate3D$MainBox$depth) - $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Concepts$Animate3D$MainBox$moveRightFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'right-face',
	$author$project$Anim$Property$Translate$toX($author$project$Concepts$Animate3D$MainBox$depth + $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Concepts$Animate3D$MainBox$moveText = F2(
	function (textId, toZ) {
		return A2(
			$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$MainBox$textMoveAmount = 20;
var $author$project$Concepts$Animate3D$MainBox$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Concepts$Animate3D$MainBox$moveText, 'front-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Concepts$Animate3D$MainBox$moveText, 'back-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount),
		A2(
			$elm$core$Basics$composeR,
			A2($author$project$Concepts$Animate3D$MainBox$moveText, 'right-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Concepts$Animate3D$MainBox$moveText, 'left-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount),
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Concepts$Animate3D$MainBox$moveText, 'top-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount),
					A2($author$project$Concepts$Animate3D$MainBox$moveText, 'bottom-face-text', $author$project$Concepts$Animate3D$MainBox$textMoveAmount))))));
var $author$project$Concepts$Animate3D$MainBox$moveTopFaceOut = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'top-face',
	$author$project$Anim$Property$Translate$toY(((-1) * $author$project$Concepts$Animate3D$MainBox$depth) - $author$project$Concepts$Animate3D$MainBox$moveAmount));
var $author$project$Concepts$Animate3D$MainBox$moveSidesOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Concepts$Animate3D$MainBox$moveFrontFaceOut,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Concepts$Animate3D$MainBox$moveBackFaceOut,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Concepts$Animate3D$MainBox$moveRightFaceOut,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Concepts$Animate3D$MainBox$moveLeftFaceOut,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Concepts$Animate3D$MainBox$moveTopFaceOut,
					A2($elm$core$Basics$composeR, $author$project$Concepts$Animate3D$MainBox$moveBottomFaceOut, $author$project$Concepts$Animate3D$MainBox$moveTextsOut))))));
...
var $author$project$Concepts$Animate3D$MainBox$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Concepts$Animate3D$MainBox$rotateCubeClockwise = $author$project$Concepts$Animate3D$MainBox$rotateCube(360);
var $author$project$Concepts$Animate3D$MainBox$init = function (flags) {
	var initialAnimState = $author$project$Anim$Engine$CSS$Keyframes$init(
		_List_fromArray(
			[
				...
				A2($author$project$Anim$Property$Translate$initX, 'left-face', (-1) * $author$project$Concepts$Animate3D$MainBox$depth),
				A2($author$project$Anim$Property$Translate$initY, 'top-face', (-1) * $author$project$Concepts$Animate3D$MainBox$depth),
				A2($author$project$Anim$Property$Translate$initY, 'bottom-face', $author$project$Concepts$Animate3D$MainBox$depth),
				...
				A2($author$project$Anim$Property$Translate$initZ, 'front-face-text', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'back-face-text', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'right-face-text', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'left-face-text', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'top-face-text', 0),
				A2($author$project$Anim$Property$Translate$initZ, 'bottom-face-text', 0)
			]));
	return _Utils_Tuple2(
		{
			animAreaSize: {
			...
			animState: A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Engine$CSS$Keyframes$loopForever,
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Engine$CSS$Keyframes$alternate,
						A2($elm$core$Basics$composeR, $author$project$Concepts$Animate3D$MainBox$moveSidesOut, $author$project$Concepts$Animate3D$MainBox$rotateCubeClockwise)))),
			state: $author$project$Concepts$Animate3D$MainBox$RotatingOpen
		},
...
var $author$project$Concepts$Animate3D$MainBox$Opening = {$: 'Opening'};
var $author$project$Concepts$Animate3D$MainBox$moveBackFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'back-face',
	$author$project$Anim$Property$Translate$toZ((-1) * $author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveBottomFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'bottom-face',
	$author$project$Anim$Property$Translate$toY($author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveFrontFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'front-face',
	$author$project$Anim$Property$Translate$toZ($author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveLeftFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'left-face',
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveRightFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'right-face',
	$author$project$Anim$Property$Translate$toX($author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Concepts$Animate3D$MainBox$moveText, 'front-face-text', 0),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Concepts$Animate3D$MainBox$moveText, 'back-face-text', 0),
		A2(
			$elm$core$Basics$composeR,
			A2($author$project$Concepts$Animate3D$MainBox$moveText, 'right-face-text', 0),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Concepts$Animate3D$MainBox$moveText, 'left-face-text', 0),
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Concepts$Animate3D$MainBox$moveText, 'top-face-text', 0),
					A2($author$project$Concepts$Animate3D$MainBox$moveText, 'bottom-face-text', 0))))));
var $author$project$Concepts$Animate3D$MainBox$moveTopFaceIn = A2(
	$author$project$Concepts$Animate3D$MainBox$moveFace,
	'top-face',
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Concepts$Animate3D$MainBox$depth));
var $author$project$Concepts$Animate3D$MainBox$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Concepts$Animate3D$MainBox$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Concepts$Animate3D$MainBox$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Concepts$Animate3D$MainBox$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Concepts$Animate3D$MainBox$moveLeftFaceIn,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Concepts$Animate3D$MainBox$moveTopFaceIn,
					A2($elm$core$Basics$composeR, $author$project$Concepts$Animate3D$MainBox$moveBottomFaceIn, $author$project$Concepts$Animate3D$MainBox$moveTextsIn))))));
var $author$project$Concepts$Animate3D$MainBox$rotateCubeAntiClockwise = $author$project$Concepts$Animate3D$MainBox$rotateCube((-1) * 360);
var $author$project$Concepts$Animate3D$MainBox$selectAnimation = function (state) {
	switch (state.$) {
		case 'Opening':
			return $author$project$Concepts$Animate3D$MainBox$moveSidesOut;
		case 'Closing':
			return $author$project$Concepts$Animate3D$MainBox$moveSidesIn;
		case 'RotatingOpen':
			return $author$project$Concepts$Animate3D$MainBox$rotateCubeClockwise;
		default:
			return $author$project$Concepts$Animate3D$MainBox$rotateCubeAntiClockwise;
	}
};
var $author$project$Concepts$Animate3D$MainBox$cubeRotationEnded = function (model) {
	var state = function () {
		var _v0 = model.state;
		switch (_v0.$) {
			case 'RotatingOpen':
				return $author$project$Concepts$Animate3D$MainBox$Closing;
			case 'RotatingClosed':
				return $author$project$Concepts$Animate3D$MainBox$Opening;
			default:
				return model.state;
		}
	}();
...
var $author$project$Concepts$Animate3D$MainBox$sidesMovementEnded = function (model) {
	var state = function () {
		...
		switch (_v0.$) {
			case 'Opening':
				return $author$project$Concepts$Animate3D$MainBox$RotatingOpen;
			case 'Closing':
				return $author$project$Concepts$Animate3D$MainBox$RotatingClosed;
			default:
				return model.state;
		}
	}();
...
var $author$project$Concepts$Animate3D$MainBox$backFace = {
...
var $author$project$Concepts$Animate3D$MainBox$bottomFace = {
...
var $author$project$Concepts$Animate3D$MainBox$frontFace = {
...
var $author$project$Concepts$Animate3D$MainBox$leftFace = {
...
var $author$project$Concepts$Animate3D$MainBox$rightFace = {
...
var $author$project$Concepts$Animate3D$MainBox$topFace = {
...
var $author$project$Concepts$Animate3D$MainBox$viewFace = F3(
	function (animState, listenForEvents, config) {
		var textAnimAttributes = A2(
			$elm$core$List$map,
			$mdgriffith$elm_ui$Element$htmlAttribute,
			A2($author$project$Anim$Engine$CSS$Keyframes$attributes, config.textId, animState));
		var eventAttributes = listenForEvents ? A2(
			$elm$core$List$map,
			$mdgriffith$elm_ui$Element$htmlAttribute,
			A2($author$project$Anim$Engine$CSS$Keyframes$events, config.id, $author$project$Concepts$Animate3D$MainBox$GotKeyframeMsg)) : _List_Nil;
		var baseAttributes = _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'position', 'absolute')),
				$mdgriffith$elm_ui$Element$width(
				$mdgriffith$elm_ui$Element$px($author$project$Concepts$Animate3D$MainBox$cubeSize)),
...
var $author$project$Concepts$Animate3D$MainBox$viewCube = function (model) {
	var shouldListenForSideEvents = _Utils_eq(model.state, $author$project$Concepts$Animate3D$MainBox$Opening) || _Utils_eq(model.state, $author$project$Concepts$Animate3D$MainBox$Closing);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A3($author$project$Concepts$Animate3D$MainBox$viewFace, model.animState, false, $author$project$Concepts$Animate3D$MainBox$topFace),
				A3($author$project$Concepts$Animate3D$MainBox$viewFace, model.animState, false, $author$project$Concepts$Animate3D$MainBox$bottomFace)
			]));
};
...
var $author$project$Concepts$Animate3D$MainBox$viewExplanation = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
...
var $author$project$Concepts$Animate3D$MainBox$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Concepts$Animate3D$MainBox$viewCube(model))
		]);
};
var $author$project$Concepts$Animate3D$MainBox$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Engine.Keyframes.Keyframes 3D Example',
		$author$project$Common$UI$Basic,
		$author$project$Concepts$Animate3D$MainBox$viewContent(model));
};
var $author$project$Concepts$Animate3D$MainBox$main = $elm$browser$Browser$document(
	{
		init: $author$project$Concepts$Animate3D$MainBox$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Concepts$Animate3D$MainBox$update,
		view: $author$project$Concepts$Animate3D$MainBox$view
	});
_Platform_export({'Concepts':{'Animate3D':{'MainBox':{'init':$author$project$Concepts$Animate3D$MainBox$main(
	A2(
