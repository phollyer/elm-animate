	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$CSS$Transitions$attributes, $author$project$GettingStarted$FirstAnimation$Main$animGroup, model.animState),
					_List_fromArray(
						[
...
var $author$project$GettingStarted$FirstAnimation$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$GettingStarted$FirstAnimation$Main$init,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$GettingStarted$FirstAnimation$Main$update,
		view: $author$project$GettingStarted$FirstAnimation$Main$view
	});
_Platform_export({'GettingStarted':{'FirstAnimation':{'Main':{'init':$author$project$GettingStarted$FirstAnimation$Main$main(
