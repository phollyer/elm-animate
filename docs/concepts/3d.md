...
[Examples →](../animation-examples.md){ .md-button .md-button--primary }

Or, learn how to scroll with Elm Animate.

[Scrolling →](../getting-started/first-scrolls.md){ .md-button .md-button--primary }
