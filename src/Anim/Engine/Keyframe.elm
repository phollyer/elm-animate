...
specific to the Keyframe Engine, or `AnimBuilder mode` from `Anim.Builder`
...
{-| Keyframe Engine-specific animation builder type.

A specialisation of `TimelineBuilder ForKeyframeEngine`. Use this as the
type annotation for animation helpers that use Keyframe-only features
