...
var $author$project$SmoothMoveStateUI$Multiple$init = function (_v0) {
	var initialState = A4(
...
var $author$project$SmoothMoveStateUI$Multiple$AnimationFrame = function (a) {
...
var $author$project$SmoothMoveStateUI$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$SmoothMoveStateUI$Multiple$AnimationFrame);
};
...
var $author$project$SmoothMoveStateUI$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$SmoothMoveStateUI$Multiple$view = function (model) {
	return A3(
		...
		$author$project$SmoothMoveStateUI$Multiple$viewContent(model));
};
var $author$project$SmoothMoveStateUI$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveStateUI$Multiple$init, subscriptions: $author$project$SmoothMoveStateUI$Multiple$subscriptions, update: $author$project$SmoothMoveStateUI$Multiple$update, view: $author$project$SmoothMoveStateUI$Multiple$view});
_Platform_export({'SmoothMoveStateUI':{'Multiple':{'init':$author$project$SmoothMoveStateUI$Multiple$main(
