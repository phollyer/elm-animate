...
var $author$project$SmoothMoveStateUI$Basic$init = function (_v0) {
...
var $author$project$SmoothMoveStateUI$Basic$AnimationFrame = function (a) {
...
var $author$project$SmoothMoveStateUI$Basic$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$SmoothMoveStateUI$Basic$AnimationFrame);
};
...
var $author$project$SmoothMoveStateUI$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$SmoothMoveStateUI$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$SmoothMoveStateUI$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$SmoothMoveStateUI$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$SmoothMoveStateUI$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$SmoothMoveStateUI$Basic$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$SmoothMoveStateUI$Basic$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$SmoothMoveStateUI$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$SmoothMoveStateUI$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveState Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$SmoothMoveStateUI$Basic$viewContent(model));
};
var $author$project$SmoothMoveStateUI$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveStateUI$Basic$init, subscriptions: $author$project$SmoothMoveStateUI$Basic$subscriptions, update: $author$project$SmoothMoveStateUI$Basic$update, view: $author$project$SmoothMoveStateUI$Basic$view});
_Platform_export({'SmoothMoveStateUI':{'Basic':{'init':$author$project$SmoothMoveStateUI$Basic$main(
