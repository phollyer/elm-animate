...
var $author$project$SmoothMoveCSSUI$Multiple$init = function (_v0) {
...
var $author$project$SmoothMoveCSSUI$Multiple$subscriptions = function (_v0) {
...
var $author$project$SmoothMoveCSSUI$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
...
var $author$project$SmoothMoveCSSUI$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$SmoothMoveCSSUI$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$SmoothMoveCSSUI$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$SmoothMoveCSSUI$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$SmoothMoveCSSUI$Multiple$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$SmoothMoveCSSUI$Multiple$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$SmoothMoveCSSUI$Multiple$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$SmoothMoveCSSUI$Multiple$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveCSS Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$SmoothMoveCSSUI$Multiple$viewContent(model));
};
var $author$project$SmoothMoveCSSUI$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveCSSUI$Multiple$init, subscriptions: $author$project$SmoothMoveCSSUI$Multiple$subscriptions, update: $author$project$SmoothMoveCSSUI$Multiple$update, view: $author$project$SmoothMoveCSSUI$Multiple$view});
_Platform_export({'SmoothMoveCSSUI':{'Multiple':{'init':$author$project$SmoothMoveCSSUI$Multiple$main(
