...
var $author$project$SmoothMoveCSSUI$Basic$init = function (_v0) {
...
var $author$project$SmoothMoveCSSUI$Basic$subscriptions = function (_v0) {
...
var $author$project$SmoothMoveCSSUI$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
...
var $author$project$SmoothMoveCSSUI$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$SmoothMoveCSSUI$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$SmoothMoveCSSUI$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$SmoothMoveCSSUI$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$SmoothMoveCSSUI$Basic$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$SmoothMoveCSSUI$Basic$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$SmoothMoveCSSUI$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$SmoothMoveCSSUI$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveCSS Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$SmoothMoveCSSUI$Basic$viewContent(model));
};
var $author$project$SmoothMoveCSSUI$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveCSSUI$Basic$init, subscriptions: $author$project$SmoothMoveCSSUI$Basic$subscriptions, update: $author$project$SmoothMoveCSSUI$Basic$update, view: $author$project$SmoothMoveCSSUI$Basic$view});
_Platform_export({'SmoothMoveCSSUI':{'Basic':{'init':$author$project$SmoothMoveCSSUI$Basic$main(
