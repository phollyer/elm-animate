...
moveLeft =
    moveToX 0 (BounceOutAdvanced { bounces = 10, amplitude = 0.9, decay = 0.9 })
...
moveRight =
    moveToX 450 (BounceInAdvanced { bounces = 10, amplitude = 0.9, decay = 0.9 })
...
moveUp =
    moveToY 0 (BounceInOutAdvanced { bounces = 5, amplitude = 0.9, decay = 0.1 })
