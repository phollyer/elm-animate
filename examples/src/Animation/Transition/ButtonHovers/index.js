...
{
	if (region.aU.aQ === region.c.aQ)
	{
		return 'on line ' + region.aU.aQ;
	}
	return 'on lines ' + region.aU.aQ + ' through ' + region.c.aQ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d6: 'hidden', dx: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d6: 'mozHidden', dx: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d6: 'msHidden', dx: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d6: 'webkitHidden', dx: 'webkitvisibilitychange' }
		: { d6: 'hidden', dx: 'visibilitychange' };
}
...
var $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight = 50;
var $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth = 160;
...
var $author$project$Anim$Internal$Builder$initAnimation = {x: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aD: $elm$core$Maybe$Nothing, ao: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			f: _Utils_update(
				pb,
				{aE: $elm$core$Dict$empty, aG: $elm$core$Dict$empty})
		});
};
...
var $author$project$Anim$Internal$Builder$initDefaults = {T: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, U: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {ah: 0, aE: $elm$core$Dict$empty, aG: $elm$core$Dict$empty, aP: false, ab: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Engine$Transition$Generator$nonTransformTransitionFromProcessed = function (property) {
	switch (property.$) {
		case 0:
			...
			return $elm$core$Maybe$Just(
				cssName + (' ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms')))))));
		case 1:
			var cssName = property.a;
		...
		case 2:
			...
			return $elm$core$Maybe$Just(
				'opacity ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))));
		case 3:
			var config = property.a;
			return $elm$core$Maybe$Just(
				'perspective-origin ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))));
		case 4:
			return $elm$core$Maybe$Nothing;
		case 5:
			var config = property.a;
			return $elm$core$Maybe$Just(
				'scale ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))));
		case 6:
			var config = property.a;
			return $elm$core$Maybe$Just(
				'width ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + ('ms, height ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))))))))));
		case 7:
			return $elm$core$Maybe$Nothing;
		default:
			var config = property.a;
			return $elm$core$Maybe$Just(
				'translate ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))));
	}
};
...
var $author$project$Anim$Internal$Engine$Transition$Generator$transformTransitionFromProcessed = function (properties) {
	...
	if (!_v0.a.$) {
		var config = _v0.a.a;
		return $elm$core$Maybe$Just(
			'transform ' + ($elm$core$String$fromInt(config.cc) + ('ms ' + (A2($author$project$Anim$Internal$Engine$Transition$Generator$timingFunction, config.aT, config.bc) + (' ' + ($elm$core$String$fromInt(config.ba) + 'ms'))))));
	} else {
		if (!_v0.b.$) {
			var _v1 = _v0.a;
			var config = _v0.b.a;
...
var $author$project$Anim$Internal$Property$Translate$toCssPropertyValue = function (_v0) {
	var coords = _v0;
	return $elm$core$String$fromFloat(coords.b$) + ('px ' + ($elm$core$String$fromFloat(coords.b0) + ('px ' + ($elm$core$String$fromFloat(coords.b1) + 'px'))));
};
...
var $author$project$Anim$Internal$Engine$Transition$Styles$extractTransformStyles = function (properties) {
						...
						return _Utils_update(
							acc,
							{
								bu: $elm$core$Maybe$Just(
									_Utils_Tuple2(
										'translate',
										$author$project$Anim$Internal$Property$Translate$toCssPropertyValue(config.c)))
							});
					case 4:
						var config = prop.a;
						return _Utils_update(
							acc,
							{
								bm: $author$project$Anim$Internal$Property$Rotate$toCssString(config.c)
							});
					case 7:
						var config = prop.a;
						return _Utils_update(
							acc,
							{
								bq: $author$project$Anim$Internal$Property$Skew$toCssString(config.c)
							});
					case 5:
						var config = prop.a;
						return _Utils_update(
							acc,
							{
								bp: $elm$core$Maybe$Just(
									_Utils_Tuple2(
										'scale',
										$author$project$Anim$Internal$Property$Scale$toCssPropertyValue(config.c)))
							});
					default:
						return acc;
				}
			}),
		{bm: '', bp: $elm$core$Maybe$Nothing, bq: '', bu: $elm$core$Maybe$Nothing},
		properties);
	...
	return A2(
		...
		$elm$core$Basics$identity,
		_List_fromArray(
			[collected.bu, transformStyle, collected.bp]));
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.s, dimensions.ci);
};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {am: $elm$core$Dict$empty, aF: $elm$core$Dict$empty, ad: 0, aV: _List_Nil, P: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
...
var $author$project$Anim$Internal$Property$Size$default = {ci: 0, s: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {b6: rgba_.b6, ch: rgba_.ch, cN: rgba_.cN};
		case 3:
			var hsl_ = color.a;
		...
		default:
			...
			return {
				b6: $elm$core$Basics$round(rgba_.bB * 255),
				ch: $elm$core$Basics$round(rgba_.bH * 255),
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fl(coord2);
		var record1 = support.fl(coord1);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	fu: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	fu: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fu: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var speedFn = _v0.N;
	var wrapper = _v0.Q;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.aU);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bG: 0,
					aT: $author$project$Motion$Internal$Spring$unwrap(s),
					bX: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			...
			bE: distance_,
			cc: $elm$core$Basics$round(duration_),
			bc: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bc, globalData.G, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			cU: speed_,
			aT: resolvedSpring,
			aU: config.aU,
	...
	function (globalData, property) {
		switch (property.$) {
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, D: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, E: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, F: globalData, N: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, Q: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Rotate$default, D: $author$project$Anim$Internal$Property$Rotate$distance, E: $author$project$Anim$Internal$Property$Rotate$duration, F: globalData, N: $author$project$Anim$Internal$Property$Rotate$speed, Q: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Scale$default, D: $author$project$Anim$Internal$Property$Scale$distance, E: $author$project$Anim$Internal$Property$Scale$duration, F: globalData, N: $author$project$Anim$Internal$Property$Scale$speed, Q: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Size$default, D: $author$project$Anim$Internal$Property$Size$distance, E: $author$project$Anim$Internal$Property$Size$duration, F: globalData, N: $author$project$Anim$Internal$Property$Size$speed, Q: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Skew$default, D: $author$project$Anim$Internal$Property$Skew$distance, E: $author$project$Anim$Internal$Property$Skew$duration, F: globalData, N: $author$project$Anim$Internal$Property$Skew$speed, Q: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Translate$default, D: $author$project$Anim$Internal$Property$Translate$distance, E: $author$project$Anim$Internal$Property$Translate$duration, F: globalData, N: $author$project$Anim$Internal$Property$Translate$speed, Q: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aD;
	if (_v1.$ === 1) {
		return {y: _List_Nil, p: data.b.aa};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{y: _List_Nil, p: data.b.aa},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {ba: $elm$core$Maybe$Nothing, bE: 0, bc: $elm$core$Maybe$Nothing, c: defaultEnd, aT: $elm$core$Maybe$Nothing, aU: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {ci: height, s: width};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.z.az);
	});
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								c: baseline,
								aU: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v1.a.a;
					var _v2 = _v1.b;
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								c: baseline,
								aU: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v4 = _v1.a;
					var _v5 = _v1.b;
...
var $author$project$Anim$Internal$Builder$Size$to = F2(
	function (size, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Size$default, config.aU);
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
			_Utils_update(
				config,
				{
					bE: A2($author$project$Anim$Internal$Property$Size$distance, start, size),
					c: size,
					aU: $elm$core$Maybe$Just(start)
				}),
			builder);
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$init = function () {
	var animState = $author$project$Anim$Engine$Transition$init(
		_List_fromArray(
			[
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$scaleButton, $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight, $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$sizeButton, $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight, $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Transition$ButtonHovers$Main$zButton, $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight, $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth)
			]));
	return _Utils_Tuple2(
		{j: animState},
...
var $author$project$Anim$Internal$Engine$CSS$CSS$animate = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var builder = transform(state.aB);
		...
		return A2(
			...
			setAllRunning(
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
					insertData(processedAnimData.bI),
					animGroups,
					A2(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
						F2(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var oldTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', existingGroup.P));
		...
		var newTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', newGroup.P));
		...
		var mergedDiscreteExit = A2($elm$core$Dict$union, newGroup.aF, existingGroup.aF);
		var mergedDiscreteEntry = A2($elm$core$Dict$union, newGroup.am, existingGroup.am);
		...
		var newPropertyStyles = A2(
			...
			newGroup.P);
		var hasTransitionBehavior = A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', existingGroup.P) || A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', newGroup.P);
		var existingStyles = A2(
			$author$project$Anim$Internal$Engine$CSS$Styles$remove,
			'transition-behavior',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$remove, 'transition', existingGroup.P));
		...
		return {am: mergedDiscreteEntry, aF: mergedDiscreteExit, ad: newGroup.ad, aV: newGroup.aV, P: styles};
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$for($author$project$Animation$Transition$ButtonHovers$Main$sizeButton),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight + 6, $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth + 20),
		A2(
			$elm$core$Basics$composeR,
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				return _Utils_update(
					config,
					{
						bE: A2(calcDistance, startVal, end),
						c: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Translate$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startVal = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Translate$default, config.aU);
		return A2(
			$author$project$Anim$Internal$Builder$Translate$TranslateBuilder,
			_Utils_update(
				config,
				{
					bE: A2($author$project$Anim$Internal$Property$Translate$distance, startVal, value),
					c: value,
					aU: $elm$core$Maybe$Just(startVal)
				}),
			builder);
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Transition$ButtonHovers$Main$zButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$Scale$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Scale$default, config.aU);
		return A2(
			$author$project$Anim$Internal$Builder$Scale$ScaleBuilder,
			_Utils_update(
				config,
				{
					bE: A2($author$project$Anim$Internal$Property$Scale$distance, startPos, endPos),
					c: endPos,
					aU: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Animation$Transition$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$for($author$project$Animation$Transition$ButtonHovers$Main$scaleButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Transition$ButtonHovers$Main$shrinkSize = A2(
	...
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Transition$ButtonHovers$Main$buttonHeight, $author$project$Animation$Transition$ButtonHovers$Main$buttonWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Transition$ButtonHovers$Main$hoverDuration),
			A2(
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$scaleUp)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$scaleDown)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$growSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$shrinkSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$liftUp)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							j: A2($author$project$Anim$Engine$Transition$animate, model.j, $author$project$Animation$Transition$ButtonHovers$Main$setDown)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.P, animGroup.am);
};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$isComplete = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(animGroup.ad);
};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {bR: true, bW: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {dE: contactDetails, ej: isPrimary, eC: pointer, eD: pointerId, eE: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cj: height, eF: pressure, fi: tiltX, fj: tiltY, c$: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dv: button, dz: clientPos, el: keys, es: offsetPos, eA: pagePos, eM: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {de: alt, dG: ctrl, eo: meta, eS: shift};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Scale', 0, 1, $author$project$Animation$Transition$ButtonHovers$Main$scaleButton, model.j),
						A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Size', 2, 3, $author$project$Animation$Transition$ButtonHovers$Main$sizeButton, model.j),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$Transition$ButtonHovers$Main$button, 'Translate Z', 4, 5, $author$project$Animation$Transition$ButtonHovers$Main$zButton, model.j)
							]))
					]))
			]));
};
var $author$project$Animation$Transition$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		fr: $author$project$Animation$Transition$ButtonHovers$Main$update,
		fs: $author$project$Animation$Transition$ButtonHovers$Main$view
	});
