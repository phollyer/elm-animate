...
var $author$project$Animation$Transition$BorderColor$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$Transition$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$Transition$BorderColor$Main$animGroup, $author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		...
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ag: A2($author$project$Anim$Engine$Transition$animate, model.ag, $author$project$Animation$Transition$BorderColor$Main$toRed)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ag: A2($author$project$Anim$Engine$Transition$animate, model.ag, $author$project$Animation$Transition$BorderColor$Main$toBlue)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$BorderColor$Main$animGroup, model.ag),
							_List_fromArray(
								[
...
var $author$project$Animation$Transition$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		fr: $author$project$Animation$Transition$BorderColor$Main$update,
		fs: $author$project$Animation$Transition$BorderColor$Main$view
	});
