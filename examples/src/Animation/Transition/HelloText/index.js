...
var $author$project$Animation$Transition$HelloText$Main$groupName = 'helloText';
...
var $author$project$Anim$Internal$Builder$initAnimation = {w: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aC: $elm$core$Maybe$Nothing, an: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			f: _Utils_update(
				pb,
				{aD: $elm$core$Dict$empty, aF: $elm$core$Dict$empty})
		});
};
...
var $author$project$Anim$Internal$Builder$initPlayback = {ag: 0, aD: $elm$core$Dict$empty, aF: $elm$core$Dict$empty, aP: false, aa: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Builder$initState = {ax: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ay: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bo: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {al: $elm$core$Dict$empty, aE: $elm$core$Dict$empty, ac: 0, aV: _List_Nil, O: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
...
var $author$project$Animation$Transition$HelloText$Main$init = _Utils_Tuple2(
	{
		aM: $author$project$Anim$Engine$Transition$init(
			_List_fromArray(
				[
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Transition$HelloText$Main$groupName, 0)
				]))
	},
	A2(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var mergedDiscreteExit = A2($elm$core$Dict$union, newGroup.aE, existingGroup.aE);
		var mergedDiscreteEntry = A2($elm$core$Dict$union, newGroup.al, existingGroup.al);
		...
		return {al: mergedDiscreteEntry, aE: mergedDiscreteExit, ac: newGroup.ac, aV: newGroup.aV, O: styles};
	});
...
var $author$project$Animation$Transition$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$Transition$HelloText$Main$groupName),
	A2(
		$elm$core$Basics$composeR,
	...
	function (msg, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					aM: A2($author$project$Anim$Engine$Transition$animate, model.aM, $author$project$Animation$Transition$HelloText$Main$fadeIn)
				}),
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.O, animGroup.al);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$HelloText$Main$groupName, model.aM),
				_List_fromArray(
					[
...
var $author$project$Animation$Transition$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		fr: $author$project$Animation$Transition$HelloText$Main$update,
		fs: $author$project$Animation$Transition$HelloText$Main$view
	});
