...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d7: 'hidden', dy: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d7: 'mozHidden', dy: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d7: 'msHidden', dy: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d7: 'webkitHidden', dy: 'webkitvisibilitychange' }
		: { d7: 'hidden', dy: 'visibilitychange' };
}
...
var $author$project$Anim$Internal$Builder$initDefaults = {T: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing, U: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing};
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$init = {am: $elm$core$Dict$empty, aF: $elm$core$Dict$empty, ad: 0, aV: _List_Nil, O: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	fv: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	fv: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fv: $author$project$Anim$Internal$Property$Translate$default
};
	...
	return wrapper(
		{
			...
			bc: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bc, globalData.F, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			cU: speed_,
			aT: resolvedSpring,
			aU: config.aU,
	...
	function (globalData, property) {
		switch (property.$) {
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, C: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, D: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, E: globalData, M: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, P: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Rotate$default, C: $author$project$Anim$Internal$Property$Rotate$distance, D: $author$project$Anim$Internal$Property$Rotate$duration, E: globalData, M: $author$project$Anim$Internal$Property$Rotate$speed, P: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Scale$default, C: $author$project$Anim$Internal$Property$Scale$distance, D: $author$project$Anim$Internal$Property$Scale$duration, E: globalData, M: $author$project$Anim$Internal$Property$Scale$speed, P: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Size$default, C: $author$project$Anim$Internal$Property$Size$distance, D: $author$project$Anim$Internal$Property$Size$duration, E: globalData, M: $author$project$Anim$Internal$Property$Size$speed, P: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Skew$default, C: $author$project$Anim$Internal$Property$Skew$distance, D: $author$project$Anim$Internal$Property$Skew$duration, E: globalData, M: $author$project$Anim$Internal$Property$Skew$speed, P: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Translate$default, C: $author$project$Anim$Internal$Property$Translate$distance, D: $author$project$Anim$Internal$Property$Translate$duration, E: globalData, M: $author$project$Anim$Internal$Property$Translate$speed, P: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aD;
	if (_v1.$ === 1) {
		return {x: _List_Nil, o: data.b.aa};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{x: _List_Nil, o: data.b.aa},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.y.az);
	});
...
var $author$project$Animation$Transition$ControllingAnimations$Main$init = function (_v0) {
	var window = _v0.c2;
	var animAreaWidth = A2($elm$core$Basics$min, 500, window.c$ - 40);
	var xPos = (animAreaWidth / 2) - 25;
	return _Utils_Tuple2(
		{
			Q: $author$project$Anim$Engine$Transition$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, xPos, 50)
					]))
		},
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$mergeStyles = F3(
	function (_v0, _v1, newCssProps) {
		...
		var oldTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', existingGroup.O));
		...
		var newTransitionValue = A2(
			$elm$core$Maybe$withDefault,
			'none',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$get, 'transition', newGroup.O));
		...
		var newPropertyStyles = A2(
			...
			newGroup.O);
		var hasTransitionBehavior = A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', existingGroup.O) || A2($author$project$Anim$Internal$Engine$CSS$Styles$member, 'transition-behavior', newGroup.O);
		var existingStyles = A2(
			$author$project$Anim$Internal$Engine$CSS$Styles$remove,
			'transition-behavior',
			A2($author$project$Anim$Internal$Engine$CSS$Styles$remove, 'transition', existingGroup.O));
		...
		return {am: mergedDiscreteEntry, aF: mergedDiscreteExit, ad: newGroup.ad, aV: newGroup.aV, O: styles};
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.aU);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.aU);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Animation$Transition$ControllingAnimations$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Transition$ControllingAnimations$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.y.ay));
	});
	...
	function (setPlayState, mapper, buildStyles, setStyles, animGroupName, animState) {
		...
		var getProcessedProperties = A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Builder$getCurrentAnimationConfig, animGroupName, state.aB)));
	...
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				ba: 0,
				bE: 0,
				bc: $author$project$Motion$Easing$Linear,
				c: value,
				aU: $elm$core$Maybe$Just(value),
				bt: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			bP: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			bQ: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			bm: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bp: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			bV: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bq: toStartOr($author$project$Anim$Internal$Property$Skew$default),
			bu: toStartOr($author$project$Anim$Internal$Property$Translate$default)
		});
	return A2(
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$isActive = function (_v0) {
	var animGroup = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isActive(animGroup.ad);
};
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					bQ: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					bm: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					bp: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($author$project$Anim$Engine$Transition$animate, model.Q, $author$project$Animation$Transition$ControllingAnimations$Main$dropBall)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($author$project$Anim$Engine$Transition$stop, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, model.Q)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: A2($author$project$Anim$Engine$Transition$reset, $author$project$Animation$Transition$ControllingAnimations$Main$animGroup, model.Q)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Anim$Internal$Engine$Transition$AnimGroup$getStyles = function (_v0) {
	var animGroup = _v0;
	return A3($elm$core$Dict$foldl, $author$project$Anim$Internal$Engine$CSS$Styles$insert, animGroup.O, animGroup.am);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Transition$ControllingAnimations$Main$animationArea(model.Q)
			]));
};
var $author$project$Animation$Transition$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		ee: $author$project$Animation$Transition$ControllingAnimations$Main$init,
		e1: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fs: $author$project$Animation$Transition$ControllingAnimations$Main$update,
		ft: $author$project$Animation$Transition$ControllingAnimations$Main$view
	});
