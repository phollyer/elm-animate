...
var $author$project$Animation$Transition$FadeInOut$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$Transition$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$for($author$project$Animation$Transition$FadeInOut$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
		...
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ag: A2($author$project$Anim$Engine$Transition$animate, model.ag, $author$project$Animation$Transition$FadeInOut$Main$fadeIn)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						ag: A2($author$project$Anim$Engine$Transition$animate, model.ag, $author$project$Animation$Transition$FadeInOut$Main$fadeOut)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Transition$attributes, $author$project$Animation$Transition$FadeInOut$Main$animGroup, model.ag),
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'height', '80vh'),
...
var $author$project$Animation$Transition$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		fr: $author$project$Animation$Transition$FadeInOut$Main$update,
		fs: $author$project$Animation$Transition$FadeInOut$Main$view
	});
