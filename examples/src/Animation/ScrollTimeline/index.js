...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d1: 'hidden', dt: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d1: 'mozHidden', dt: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d1: 'msHidden', dt: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d1: 'webkitHidden', dt: 'webkitvisibilitychange' }
		: { d1: 'hidden', dt: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cc: fragment, cj: host, cD: path, cF: port_, cI: protocol, cJ: query};
	});
...
var $author$project$Anim$Internal$Property$Rotate$default = {bY: 0, bZ: 0, b_: 0};
var $author$project$Anim$Internal$Property$Rotate$support = {
	c1: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {bY: a.bY + b.bY, bZ: a.bZ + b.bZ, b_: a.b_ + b.b_};
		}),
	dZ: $elm$core$Basics$identity,
	bn: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {bY: angles.bY * factor, bZ: angles.bZ * factor, b_: angles.b_ * factor};
		}),
	eZ: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fo: $author$project$Anim$Internal$Property$Rotate$default
};
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.ff(coord);
		return _Utils_Tuple3(record.bY, record.bZ, record.b_);
	});
...
var $author$project$Anim$Internal$Property$Scale$default = {bY: 1.0, bZ: 1.0, b_: 1.0};
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bn: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {bY: coords.bY * factor, bZ: coords.bZ * factor, b_: coords.b_ * factor};
		}),
	eZ: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fo: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$default = {bY: 0, bZ: 0, b_: 0};
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fo: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.r, dimensions.cf);
};
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.bY, values.bZ);
};
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'duration',
												$elm$json$Json$Encode$int(config.b9))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.b9, config.bb, config.aS))))))));
			case 1:
				var cssName = property.a;
...
var $author$project$Anim$Internal$Builder$getAnimTarget = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.k.aW);
	});
...
var $author$project$Anim$Internal$Property$Size$default = {cf: 0, r: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {bY: 0, bZ: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.cN / 100;
	var l = hslValue.co / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cf / 60, 2) - 1));
	var _v0 = (hslValue.cf < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cf < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cf < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cf < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cf < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {b3: rgba_.b3, ce: rgba_.ce, cK: rgba_.cK};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cf: hsla_.cf, co: hsla_.co, cN: hsla_.cN});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				b3: $elm$core$Basics$round(rgba_.bz * 255),
				ce: $elm$core$Basics$round(rgba_.bF * 255),
				cK: $elm$core$Basics$round(rgba_.bP * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.cK - rgb1.cK;
		var dg = rgb2.ce - rgb1.ce;
		var db = rgb2.b3 - rgb1.b3;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.ff(coord2);
		var record1 = support.ff(coord1);
		var dz = $elm$core$Basics$abs(record2.b_ - record1.b_);
		var dy = $elm$core$Basics$abs(record2.bZ - record1.bZ);
		var dx = $elm$core$Basics$abs(record2.bY - record1.bY);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	return wrapper(
		{
			a9: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.a9, globalData.S, 0),
			bC: distance_,
			b9: $elm$core$Basics$round(duration_),
			bb: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bb, globalData.F, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			cR: speed_,
			aS: resolvedSpring,
			aT: config.aT,
	...
	function (globalData, property) {
		switch (property.$) {
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, C: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, D: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, E: globalData, N: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, P: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Rotate$default, C: $author$project$Anim$Internal$Property$Rotate$distance, D: $author$project$Anim$Internal$Property$Rotate$duration, E: globalData, N: $author$project$Anim$Internal$Property$Rotate$speed, P: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Scale$default, C: $author$project$Anim$Internal$Property$Scale$distance, D: $author$project$Anim$Internal$Property$Scale$duration, E: globalData, N: $author$project$Anim$Internal$Property$Scale$speed, P: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Size$default, C: $author$project$Anim$Internal$Property$Size$distance, D: $author$project$Anim$Internal$Property$Size$duration, E: globalData, N: $author$project$Anim$Internal$Property$Size$speed, P: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Skew$default, C: $author$project$Anim$Internal$Property$Skew$distance, D: $author$project$Anim$Internal$Property$Skew$duration, E: globalData, N: $author$project$Anim$Internal$Property$Skew$speed, P: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{A: config, B: $author$project$Anim$Internal$Property$Translate$default, C: $author$project$Anim$Internal$Property$Translate$distance, D: $author$project$Anim$Internal$Property$Translate$duration, E: globalData, N: $author$project$Anim$Internal$Property$Translate$speed, P: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
			...
			return _Utils_Tuple2(
				...
				A5(
					...
					A2(
						$elm$core$Maybe$withDefault,
						animGroupName,
						A2($author$project$Anim$Internal$Builder$getAnimTarget, animGroupName, builder)),
					$elm$core$Maybe$Nothing,
					config.o,
					config.x));
		},
		$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.bG));
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'iterations',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeIterations(processed.aa)),
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.af))
				]),
...
var $author$project$Anim$Internal$Builder$initPlayback = {af: 0, aD: $elm$core$Dict$empty, aE: $elm$core$Dict$empty, aO: false, aa: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a1: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, aW: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bu: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aA: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bm: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Anim$Internal$Builder$getFrozenAxes = F2(
	function (propName, _v0) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, propName, data.e.an));
	});
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						bY: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.bY : endRecord.bY,
						bZ: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.bZ : endRecord.bZ,
						b_: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.b_ : endRecord.b_
					});
				return _Utils_update(
					config,
					{
						bC: A2(calcDistance, startVal, end),
						c: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {a9: $elm$core$Maybe$Nothing, bC: 0, bb: $elm$core$Maybe$Nothing, c: defaultEnd, aS: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, br: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.y.bm);
	});
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{b$: startAlpha, b3: rgb_.b3, ce: rgb_.ce, cK: rgb_.cK});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{b$: startAlpha, cf: hsl_.cf, co: hsl_.co, cN: hsl_.cN});
			default:
				return newColor;
		}
	});
...
var $author$project$Anim$Internal$Builder$Scale$fromX = F2(
	function (scaleX, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Scale$getZ, $author$project$Anim$Internal$Builder$Scale$default, config.aT);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Scale$getY, $author$project$Anim$Internal$Builder$Scale$default, config.aT);
		return A4(
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					bC: A2($author$project$Anim$Internal$Extra$Color$distance, startPos, colorWithPreservedAlpha),
	...
	function (endPos, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					bC: A2($author$project$Anim$Internal$Property$Scale$distance, startPos, endPos),
					c: endPos,
					aT: $elm$core$Maybe$Just(startPos)
				}),
			builder);
...
var $author$project$Anim$Internal$Builder$Scale$toX = F2(
	function (x, _v0) {
		...
		var y = $author$project$Anim$Internal$Property$Scale$getY(config.c);
		return A4(
...
var $author$project$Animation$ScrollTimeline$Main$scrollProgress = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$for($author$project$Animation$ScrollTimeline$Main$progressBarAnim),
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$ScrollTimeline$Main$progressBarAnim, $author$project$Anim$Property$CustomColor$BackgroundColor),
					A2(
						$elm$core$Basics$composeR,
...
var $author$project$Animation$ScrollTimeline$Main$cards = _List_fromArray(
	[
		{ah: 'The timeline starts at 0% at the top of the page and reaches 100% at the bottom.', aj: '#6366f1', ap: '01', aw: 'Top to bottom'},
		{ah: 'The same timeline drives both size and color, so one scroll gesture controls the whole bar.', aj: '#8b5cf6', ap: '02', aw: 'One scroll, two effects'},
		{ah: 'Short red bar means early in the page, long green bar means you are near the end.', aj: '#a78bfa', ap: '03', aw: 'Read progress at a glance'},
		{ah: 'Call ScrollTimeline.animate once in init, then the browser keeps everything in sync while you scroll.', aj: '#7c3aed', ap: '04', aw: 'Simple trigger'},
		{ah: 'Attach ScrollTimeline.attributes to any element and map scroll progress to the properties you want.', aj: '#5b21b6', ap: '05', aw: 'Easy to reuse'}
	]);
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'color', card.aj),
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'padding', '80px 40px 40px'),
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'gap', '60px')
					]),
...
var $author$project$Animation$ScrollTimeline$Main$main = $elm$browser$Browser$element(
	{
		...
		fm: $author$project$Animation$ScrollTimeline$Main$view
	});
