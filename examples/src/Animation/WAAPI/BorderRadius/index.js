...
var $author$project$Animation$WAAPI$BorderRadius$Main$animGroup = 'boxAnim';
...
var $author$project$Anim$Internal$Builder$initAnimation = {w: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aD: $elm$core$Maybe$Nothing, ap: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aD;
	if (_v1.$ === 1) {
		return {x: _List_Nil, o: data.b.ad};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{x: _List_Nil, o: data.b.ad},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.y.aA);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.y.bo);
	});
...
var $author$project$Animation$WAAPI$BorderRadius$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$BorderRadius$Main$GotWaapiMsg, model.z);
};
...
var $author$project$Animation$WAAPI$BorderRadius$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.z);
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$BorderRadius$Main$roundCorners);
				...
				return _Utils_Tuple2(
					...
					cmd);
			default:
				var _v3 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$BorderRadius$Main$squareCorners);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$BorderRadius$Main$animGroup, model.z),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$BorderRadius$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$BorderRadius$Main$update,
		fy: $author$project$Animation$WAAPI$BorderRadius$Main$view
	});
