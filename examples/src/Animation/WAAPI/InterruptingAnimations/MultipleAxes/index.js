...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth = 100;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$init = function (_v0) {
	var width = _v0.fz;
	var height = _v0.ea;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			o: A3(
				...
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup, (w - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2, (h - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2)
					])),
			ea: h,
			fz: w
		},
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate, model.o);
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveDown = function (height) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(height - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveLeft = $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
	$author$project$Anim$Property$Translate$toX(0));
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveRight = function (width) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toX(width - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveUp = $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveBox(
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, animationMsg, model.o);
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveLeft);
			...
			case 2:
				var _v3 = A2(
					...
					model.o,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveRight(model.fz));
				...
				return _Utils_Tuple2(
					...
					cmd);
			case 3:
				var _v4 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveUp);
			...
			default:
				var _v5 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.o,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$moveDown(model.ea));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	...
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$animGroup, model.o),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{ej: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$init, e7: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$subscriptions, fx: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$update, fy: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleAxes$Main$view});
