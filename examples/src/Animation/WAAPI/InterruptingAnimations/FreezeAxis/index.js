...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth = 100;
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$init = function (_v0) {
	var width = _v0.fz;
	var height = _v0.ea;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			o: A3(
				...
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup, (w - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth) / 2, (h - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth) / 2)
					])),
			ea: h,
			fz: w
		},
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$GotAnimationUpdate, model.o);
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveDown = function (height) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(height - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth));
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveLeft = $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
	$author$project$Anim$Property$Translate$toX(0));
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveRight = function (width) {
	return $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
		$author$project$Anim$Property$Translate$toX(width - $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth));
};
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveUp = $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveBox(
			...
			case 1:
				var _v2 = A2(
					...
					A2(
						...
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveLeft));
				...
				var _v3 = A2(
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$freezeY(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveRight(model.fz)));
				...
				var _v4 = A2(
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$freezeX(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveUp));
				...
				var _v5 = A2(
					...
					A2(
						...
						$author$project$Anim$Engine$WAAPI$freezeX(
							_List_fromArray(
								[$author$project$Anim$Engine$WAAPI$translate])),
						$author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$moveDown(model.ea)));
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$view = function (model) {
	...
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$animGroup, model.o),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$boxWidth) + 'px'),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$main = $elm$browser$Browser$element(
	{ej: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$init, e7: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$subscriptions, fx: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$update, fy: $author$project$Animation$WAAPI$InterruptingAnimations$FreezeAxis$Main$view});
