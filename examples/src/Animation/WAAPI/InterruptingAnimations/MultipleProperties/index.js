...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth = 100;
...
var $author$project$Anim$Internal$Property$Size$default = {ck: 0, r: 0};
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aD;
	if (_v1.$ === 1) {
		return {y: _List_Nil, o: data.b.ad};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{y: _List_Nil, o: data.b.ad},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$init = function (_v0) {
	var width = _v0.fz;
	var height = _v0.ea;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			s: A3(
				...
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName, (w - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth) / 2, (h - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth) / 2),
						A3(
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.r, dimensions.ck);
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$changeColor = function (color) {
	return A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName, $author$project$Anim$Property$CustomColor$BackgroundColor),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$animGroupName),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {ck: record.ea, r: record.fz};
};
		...
		switch (msg.$) {
			...
			case 1:
				var _v2 = A2(
					...
					model.s,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBox(
			...
			case 2:
				var _v3 = A2(
					...
					model.s,
					$author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$moveBox(
						$author$project$Anim$Property$Translate$toX(model.fz - $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth)));
...
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{ck: hslaValue.ck, ct: hslaValue.ct, cV: hslaValue.cV});
	return {b2: hslaValue.b2, b6: rgb_.b6, cj: rgb_.cj, cS: rgb_.cS};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b2: 1.0, b6: rgb_.b6, cj: rgb_.cj, cS: rgb_.cS};
	}
};
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'width',
							$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth) + 'px'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$boxWidth) + 'px'),
...
var $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{ej: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$init, e7: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$subscriptions, fx: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$update, fy: $author$project$Animation$WAAPI$InterruptingAnimations$MultipleProperties$Main$view});
