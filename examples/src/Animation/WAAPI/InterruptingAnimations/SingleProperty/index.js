...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate, model.o);
};
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$colorBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName, $author$project$Anim$Property$CustomColor$BackgroundColor),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor1);
				...
				return _Utils_Tuple2(
					...
					cmd);
			case 2:
				var _v3 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor2);
				...
				return _Utils_Tuple2(
					...
					cmd);
			case 3:
				var _v4 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor3);
				...
				return _Utils_Tuple2(
					...
					cmd);
			default:
				var _v5 = A2($author$project$Anim$Engine$WAAPI$animate, model.o, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$toColor4);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$animGroupName, model.o),
					_List_fromArray(
						[
...
var $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		ej: $elm$core$Basics$always($author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$init),
		e7: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$update,
		fy: $author$project$Animation$WAAPI$InterruptingAnimations$SingleProperty$Main$view
	});
