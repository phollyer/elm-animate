...
var $author$project$Animation$WAAPI$FadeInOut$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$WAAPI$FadeInOut$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$FadeInOut$Main$GotWaapiMsg, model.z);
};
...
var $author$project$Animation$WAAPI$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$for($author$project$Animation$WAAPI$FadeInOut$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$FadeInOut$Main$fadeIn);
				...
				return _Utils_Tuple2(
					...
					cmd);
			default:
				var _v3 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$FadeInOut$Main$fadeOut);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$FadeInOut$Main$animGroup, model.z),
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'height', '80vh'),
...
var $author$project$Animation$WAAPI$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$FadeInOut$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$FadeInOut$Main$update,
		fy: $author$project$Animation$WAAPI$FadeInOut$Main$view
	});
