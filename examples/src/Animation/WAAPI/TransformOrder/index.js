...
var $author$project$Animation$WAAPI$TransformOrder$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$TransformOrder$Main$GotWaapiMsg, model.o);
};
...
var $author$project$Animation$WAAPI$TransformOrder$Main$animatePermutation = function (perm) {
	var key = $author$project$Animation$WAAPI$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$TransformOrder$Main$resetPermutation = function (perm) {
	var key = $author$project$Animation$WAAPI$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for(key),
...
var $author$project$Animation$WAAPI$TransformOrder$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 4:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, subMsg, model.o);
			...
			case 0:
				...
				var _v2 = A2(
					...
					model.o,
					$author$project$Animation$WAAPI$TransformOrder$Main$animatePermutation(perm));
			...
			case 1:
				...
				var _v3 = A2(
					...
					A2(
						...
						$author$project$Animation$WAAPI$TransformOrder$Main$resetPermutation(perm)));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$WAAPI$TransformOrder$Main$animationArea(model.o)
			]));
};
var $author$project$Animation$WAAPI$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$TransformOrder$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$TransformOrder$Main$update,
		fy: $author$project$Animation$WAAPI$TransformOrder$Main$view
	});
