...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cm: fragment, cs: host, cO: path, cR: port_, cV: protocol, cW: query};
	});
...
var $author$project$Animation$WAAPI$Animate3D$Main$TriggerAnimation = {$: 1};
...
var $author$project$Animation$WAAPI$Animate3D$Main$backFace = {
	...
	i: 'back-face',
	q: 'BACK',
	d: {ag: 'rgb(0,0 ,0   )', a: 'backFaceTextAnim', i: 'back-face-text', q: 'BACK'}
};
var $author$project$Animation$WAAPI$Animate3D$Main$bottomFace = {
	...
	i: 'bottom-face',
	q: 'BOTTOM',
	d: {ag: 'rgb(0,0 ,0   )', a: 'bottomFaceTextAnim', i: 'bottom-face-text', q: 'BOTTOM'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$cube = {a: 'cubeAnim', i: 'cube', c2: 100};
var $author$project$Animation$WAAPI$Animate3D$Main$depth = $author$project$Animation$WAAPI$Animate3D$Main$cube.c2 / 2;
var $author$project$Animation$WAAPI$Animate3D$Main$frontFace = {
	...
	i: 'front-face',
	q: 'FRONT',
	d: {ag: 'rgb(0,0 ,0   )', a: 'frontFaceTextAnim', i: 'front-face-text', q: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initAnimation = {A: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $elm$core$Maybe$Nothing, av: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			h: _Utils_update(
				pb,
				{aJ: $elm$core$Dict$empty, aK: $elm$core$Dict$empty})
		});
};
...
var $author$project$Anim$Internal$Builder$initPlayback = {ap: 0, aJ: $elm$core$Dict$empty, aK: $elm$core$Dict$empty, aT: false, ak: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a8: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, a$: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aF: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aG: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bt: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{g: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: $author$project$Anim$Internal$Builder$initPlayback, o: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, C: $author$project$Anim$Internal$Builder$initState});
		...
		function (property, end) {
			switch (property.$) {
				case 0:
					...
					return A4($author$project$Anim$Internal$Builder$PropertyBaselines$setCustomProperty, cssName, config.e, unit, end);
				case 1:
					var cssName = property.a;
					var config = property.b;
					return A3($author$project$Anim$Internal$Builder$PropertyBaselines$setCustomColorProperty, cssName, config.e, end);
				case 2:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.e, end);
				case 3:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.e, end);
				case 4:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.e, end);
				case 5:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.e, end);
				case 6:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.e, end);
				case 7:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.e, end);
				default:
					var config = property.a;
					return A2($author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.e, end);
			}
		});
...
var $author$project$Anim$Extra$TransformOrder$default = _List_fromArray(
	[0, 1, 2, 3]);
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {ap: 0, bI: $elm$core$Dict$empty, bJ: $elm$core$Dict$empty, ak: $author$project$Anim$Internal$Builder$Once, bW: 0, eR: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, P: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, t: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Size$default = {cp: 0, w: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cb: rgba_.cb, co: rgba_.co, cX: rgba_.cX};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cp: hsla_.cp, cy: hsla_.cy, c_: hsla_.c_});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cb: $elm$core$Basics$round(rgba_.bH * 255),
				co: $elm$core$Basics$round(rgba_.bN * 255),
				cX: $elm$core$Basics$round(rgba_.bX * 255)
			};
	}
};
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	...
	fG: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	fG: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fG: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	return wrapper(
		{
			bg: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.bg, globalData.Y, 0),
			bK: distance_,
			cj: $elm$core$Basics$round(duration_),
			bi: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bi, globalData.K, $author$project$Motion$Easing$EaseInOut),
			e: config.e,
			c3: speed_,
			aX: resolvedSpring,
			aY: config.aY,
	...
	var newState = _Utils_update(
		state,
		{
			aG: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.aG),
...
var $author$project$Anim$Internal$Builder$getFrozenAxes = F2(
	function (propName, _v0) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, propName, data.g.av));
	});
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {bg: $elm$core$Maybe$Nothing, bK: 0, bi: $elm$core$Maybe$Nothing, e: defaultEnd, aX: $elm$core$Maybe$Nothing, aY: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.C.aG);
	});
...
var $author$project$Animation$WAAPI$Animate3D$Main$leftFace = {
	...
	i: 'left-face',
	q: 'LEFT',
	d: {ag: 'rgb(0,0 ,0   )', a: 'leftFaceTextAnim', i: 'left-face-text', q: 'LEFT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$rightFace = {
	...
	i: 'right-face',
	q: 'RIGHT',
	d: {ag: 'rgb(0,0 ,0   )', a: 'rightFaceTextAnim', i: 'right-face-text', q: 'RIGHT'}
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$topFace = {
	...
	i: 'top-face',
	q: 'TOP',
	d: {ag: 'rgb(0,0 ,0   )', a: 'topFaceTextAnim', i: 'top-face-text', q: 'TOP'}
};
var $author$project$Animation$WAAPI$Animate3D$Main$init = function (flags) {
	var initialAnimState = A3(
		...
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$WAAPI$Animate3D$Main$cube.a, 200),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$WAAPI$Animate3D$Main$frontFace.a, $author$project$Animation$WAAPI$Animate3D$Main$depth),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$WAAPI$Animate3D$Main$backFace.a, $author$project$Animation$WAAPI$Animate3D$Main$depth * (-1)),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$WAAPI$Animate3D$Main$backFace.a, 180)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.a, $author$project$Animation$WAAPI$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.a, 90)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.a, (-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.a, -90)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$WAAPI$Animate3D$Main$topFace.a, (-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$WAAPI$Animate3D$Main$topFace.a, 90)),
				A2(
				$elm$core$Basics$composeR,
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.a, $author$project$Animation$WAAPI$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.a, -90))
			]));
	var animAreaWidth = A2($elm$core$Basics$min, 500, flags.dd.fE - 40);
	var animAreaHeight = 350;
	return _Utils_Tuple2(
		{
			a7: {ef: animAreaHeight, fE: animAreaWidth},
			m: initialAnimState,
			C: 0
		},
		A2(
...
var $author$project$Animation$WAAPI$Animate3D$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$Animate3D$Main$GotWaapiMsg, model.m);
};
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aS: groupConfig, bk: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aS: groupConfig,
								bk: A2($elm$core$List$cons, existing.aS, existing.bk)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		...
		return _Utils_Tuple3(record.b4, record.b5, record.b6);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.w, dimensions.cp);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'endValue',
												$elm$json$Json$Encode$float(config.e)),
												_Utils_Tuple2(
												'duration',
												$elm$json$Json$Encode$int(config.cj))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.cj, config.bi, config.aX))))))));
			case 1:
				var cssName = property.a;
				var config = property.b;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.aY));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
							...
							_Utils_ap(
								_List_fromArray(
									[
										...
										'endValue',
										$elm$json$Json$Encode$float(
											$author$project$Anim$Internal$Property$Opacity$toFloat(config.e))),
										_Utils_Tuple2(
										'duration',
										$elm$json$Json$Encode$int(config.cj))
									]),
			...
			case 3:
				...
				var unitStr = function () {
					var _v3 = $author$project$Anim$Internal$Property$PerspectiveOrigin$getUnit(config.e);
					if (!_v3) {
						return '%';
					} else {
						return 'px';
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.aY));
				var startX = _v1.a;
				var startY = _v1.b;
				var _v2 = $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple(config.e);
				var endX = _v2.a;
				var endY = _v2.b;
				return $elm$json$Json$Encode$object(
					A2(
			...
			case 5:
				var config = property.a;
				var _v4 = $author$project$Anim$Internal$Property$Scale$toTriple(config.e);
				var endX = _v4.a;
				var endY = _v4.b;
				var endZ = _v4.c;
				return $elm$json$Json$Encode$object(
			...
			case 4:
				var config = property.a;
				var _v5 = $author$project$Anim$Internal$Property$Rotate$toTriple(config.e);
				var endX = _v5.a;
				var endY = _v5.b;
				var endZ = _v5.c;
				return $elm$json$Json$Encode$object(
			...
			case 7:
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v10 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.aY));
						var startX = _v10.a;
						var startY = _v10.b;
						return _List_fromArray(
							[
				...
				var _v6 = $author$project$Anim$Internal$Property$Skew$toTuple(config.e);
				var endX = _v6.a;
				var endY = _v6.b;
				return $elm$json$Json$Encode$object(
					A2(
			...
			case 6:
				...
				var _v11 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.aY));
				var startWidth = _v11.a;
				var startHeight = _v11.b;
				var _v12 = $author$project$Anim$Internal$Property$Size$toTuple(config.e);
				var endWidth = _v12.a;
			...
			default:
				var config = property.a;
				var _v13 = $author$project$Anim$Internal$Property$Translate$toTriple(config.e);
				var endX = _v13.a;
				var endY = _v13.b;
				var endZ = _v13.c;
				return $elm$json$Json$Encode$object(
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$encode = F2(
	function (animGroups, processed) {
		var elementsWithVersions = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.bO));
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					...
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.ap))
				]));
	});
		...
		function (property, _v1) {
			...
			switch (property.$) {
				case 0:
					...
					var config = property.c;
					return {
						e: A4($author$project$Anim$Internal$Builder$PropertyBaselines$setCustomProperty, cssName, config.e, unit, end),
						aY: A3(
				...
				case 1:
					...
					var config = property.b;
					return {
						e: A3($author$project$Anim$Internal$Builder$PropertyBaselines$setCustomColorProperty, cssName, config.e, end),
						aY: A3(
							$author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet,
				...
				case 2:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.aY, start)
					};
				case 3:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.aY, start)
					};
				case 4:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.aY, start)
					};
				case 5:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.aY, start)
					};
				case 6:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.aY, start)
					};
				case 7:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.aY, start)
					};
				default:
					var config = property.a;
					return {
						e: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.e, end),
						aY: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.aY, start)
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{e: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, aY: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
...
var $author$project$Anim$Internal$Engine$WAAPI$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					eR: $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$WAAPI$animate = F2(
	function (_v0, build) {
		...
		var processedAnimGroups = A3(
			...
			insertAnimGroup,
			animGroups,
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.bO));
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$WAAPI$AnimState,
				_Utils_update(
...
var $author$project$Animation$WAAPI$Animate3D$Main$moveBackFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Anim$Property$Translate$toY = $author$project$Anim$Internal$Builder$Translate$toY;
var $author$project$Animation$WAAPI$Animate3D$Main$moveBottomFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Animation$WAAPI$Animate3D$Main$moveFrontFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Anim$Property$Translate$toX = $author$project$Anim$Internal$Builder$Translate$toX;
var $author$project$Animation$WAAPI$Animate3D$Main$moveLeftFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Animation$WAAPI$Animate3D$Main$moveRightFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Animation$WAAPI$Animate3D$Main$moveTopFaceIn = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth));
var $author$project$Animation$WAAPI$Animate3D$Main$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$WAAPI$Animate3D$Main$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$WAAPI$Animate3D$Main$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$WAAPI$Animate3D$Main$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$WAAPI$Animate3D$Main$moveLeftFaceIn,
				A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$Animate3D$Main$moveTopFaceIn, $author$project$Animation$WAAPI$Animate3D$Main$moveBottomFaceIn)))));
var $author$project$Animation$WAAPI$Animate3D$Main$moveAmount = 50;
var $author$project$Animation$WAAPI$Animate3D$Main$moveBackFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ(((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth) - $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveBottomFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$WAAPI$Animate3D$Main$depth + $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveFrontFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$WAAPI$Animate3D$Main$depth + $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveLeftFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX(((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth) - $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveRightFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$WAAPI$Animate3D$Main$depth + $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveTopFaceOut = A2(
	$author$project$Animation$WAAPI$Animate3D$Main$moveFace,
	$author$project$Animation$WAAPI$Animate3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY(((-1) * $author$project$Animation$WAAPI$Animate3D$Main$depth) - $author$project$Animation$WAAPI$Animate3D$Main$moveAmount));
var $author$project$Animation$WAAPI$Animate3D$Main$moveSidesOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$WAAPI$Animate3D$Main$moveFrontFaceOut,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$WAAPI$Animate3D$Main$moveBackFaceOut,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$WAAPI$Animate3D$Main$moveRightFaceOut,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$WAAPI$Animate3D$Main$moveLeftFaceOut,
				A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$Animate3D$Main$moveTopFaceOut, $author$project$Animation$WAAPI$Animate3D$Main$moveBottomFaceOut)))));
...
var $author$project$Animation$WAAPI$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$frontFace.d, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$backFace.d, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.d, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.d, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$topFace.d, 0, 0),
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.d, 0, 0))))));
var $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount = 20;
var $author$project$Animation$WAAPI$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$frontFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$backFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$rightFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$leftFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$topFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$WAAPI$Animate3D$Main$moveText, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace.d, $author$project$Animation$WAAPI$Animate3D$Main$textMoveAmount, 360))))));
...
var $author$project$Animation$WAAPI$Animate3D$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for($author$project$Animation$WAAPI$Animate3D$Main$cube.a),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$Animate3D$Main$selectAnimation = function (state) {
	switch (state) {
		case 0:
			return A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$Animate3D$Main$moveSidesOut, $author$project$Animation$WAAPI$Animate3D$Main$moveTextsOut);
		case 1:
			return A2($elm$core$Basics$composeR, $author$project$Animation$WAAPI$Animate3D$Main$moveSidesIn, $author$project$Animation$WAAPI$Animate3D$Main$moveTextsIn);
		case 2:
...
var $author$project$Animation$WAAPI$Animate3D$Main$stateChanged = F2(
	function (state, model) {
		var _v0 = A2(
			...
			model.m,
			$author$project$Animation$WAAPI$Animate3D$Main$selectAnimation(state));
		var animState = _v0.a;
		var cmd = _v0.b;
		return _Utils_Tuple2(
			_Utils_update(
...
var $author$project$Animation$WAAPI$Animate3D$Main$handleMotionMsg = F2(
									...
									return function (customColorProperties) {
										return function (isAnimating) {
											return function (propertyVersions) {
												return {bG: animGroupName, cg: customColorProperties, ch: customProperties, cw: isAnimating, cJ: opacity, cP: perspectiveOrigin, bW: progress, cU: propertyVersions, br: rotate, bu: scale, c2: size, bz: translate};
											};
										};
									};
								};
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {cp: record.ef, w: record.fE};
};
		...
		if ((((!_v4.a.a.$) && (!_v4.a.b.$)) && (!_v4.a.c.$)) && (!_v4.b.$)) {
			...
			return $elm$core$Maybe$Just(
				$author$project$Anim$Internal$Extra$Color$fromHSLA(
					{b7: aVal, cp: hVal, cy: lVal, c_: sVal}));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	} else {
		...
		if ((((!_v4.a.a.$) && (!_v4.a.b.$)) && (!_v4.a.c.$)) && (!_v4.b.$)) {
			...
			return $elm$core$Maybe$Just(
				$author$project$Anim$Internal$Extra$Color$fromRGBA(
					{b7: aVal, cb: bVal, co: gVal, cX: rVal}));
		} else {
			return $elm$core$Maybe$Nothing;
		}
	} else {
	...
	function (animUpdate, animGroup) {
		var updateStatus = F2(
			function (propType, propAnim) {
				var _v1 = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, propType, animUpdate.cU);
				if (_v1.$ === 1) {
					return propAnim;
				} else {
					var currentVersion = _v1.a;
					return _Utils_eq(currentVersion, propAnim.a4) ? _Utils_update(
						propAnim,
						{
							aZ: animUpdate.cw ? 1 : 3
						}) : propAnim;
				}
			});
		var buildProp = F4(
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$WAAPI$AnimGroup$setProgress, animUpdate.bW, animGroup)));
	});
					...
					if (!_v4.$) {
						...
						return _Utils_Tuple2(
							A2(
								...
								updatedAnimations),
							$elm$core$Maybe$Just(
								A2($author$project$Anim$Internal$Engine$WAAPI$Progress, animUpdate.bG, animUpdate.bW)));
					} else {
						var error = _v4.a;
						return _Utils_Tuple2(
							animState,
		...
		switch (msg.$) {
			...
			case 1:
				var _v1 = A2(
					$author$project$Anim$Engine$WAAPI$animate,
					model.m,
					$author$project$Animation$WAAPI$Animate3D$Main$selectAnimation(model.C));
				var animState = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var animMsg = msg.a;
				var _v2 = A2($author$project$Anim$Engine$WAAPI$update, animMsg, model.m);
				var animState = _v2.a;
				var maybeAnimEvent = _v2.b;
				if (!maybeAnimEvent.$) {
					var animEvent = maybeAnimEvent.a;
					return A2(
						$author$project$Animation$WAAPI$Animate3D$Main$handleMotionMsg,
						animEvent,
						_Utils_update(
							model,
							{m: animState}));
...
var $author$project$Anim$Internal$Property$Size$heightToCssString = function (_v0) {
	var dimensions = _v0;
	return $elm$core$String$fromFloat(dimensions.cp) + 'px';
};
...
var $author$project$Animation$WAAPI$Animate3D$Main$viewFace = F2(
	function (animState, config) {
		var textAnimAttributes = A2($author$project$Anim$Engine$WAAPI$attributes, config.d.a, animState);
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt($author$project$Animation$WAAPI$Animate3D$Main$cube.c2) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt($author$project$Animation$WAAPI$Animate3D$Main$cube.c2) + 'px'),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.d.ag),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
							$elm$html$Html$text(config.d.q)
						]))
				]));
	});
var $author$project$Animation$WAAPI$Animate3D$Main$viewCube = function (model) {
	var cubeAttrs = A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$Animate3D$Main$cube.a, model.m);
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			cubeAttrs,
			_List_fromArray(
				[
					$author$project$Anim$Extra$View3D$transformStyle(1),
					$elm$html$Html$Attributes$id($author$project$Animation$WAAPI$Animate3D$Main$cube.i),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromInt($author$project$Animation$WAAPI$Animate3D$Main$cube.c2) + 'px'),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$frontFace),
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$backFace),
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$rightFace),
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$leftFace),
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$topFace),
				A2($author$project$Animation$WAAPI$Animate3D$Main$viewFace, model.m, $author$project$Animation$WAAPI$Animate3D$Main$bottomFace)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromInt(model.a7.fE) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'height',
				$elm$core$String$fromInt(model.a7.ef) + 'px'),
...
var $author$project$Animation$WAAPI$Animate3D$Main$main = $elm$browser$Browser$document(
	{eo: $author$project$Animation$WAAPI$Animate3D$Main$init, fc: $author$project$Animation$WAAPI$Animate3D$Main$subscriptions, fC: $author$project$Animation$WAAPI$Animate3D$Main$update, fD: $author$project$Animation$WAAPI$Animate3D$Main$view});
