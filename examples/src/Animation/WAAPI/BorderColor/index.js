...
var $author$project$Animation$WAAPI$BorderColor$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$WAAPI$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$BorderColor$Main$GotWaapiMsg, model.z);
};
...
var $author$project$Animation$WAAPI$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$WAAPI$BorderColor$Main$animGroup, $author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		...
		switch (msg.$) {
			case 0:
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$BorderColor$Main$toRed);
				...
				return _Utils_Tuple2(
					...
					cmd);
			default:
				var _v3 = A2($author$project$Anim$Engine$WAAPI$animate, model.z, $author$project$Animation$WAAPI$BorderColor$Main$toBlue);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$BorderColor$Main$animGroup, model.z),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$BorderColor$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$BorderColor$Main$update,
		fy: $author$project$Animation$WAAPI$BorderColor$Main$view
	});
