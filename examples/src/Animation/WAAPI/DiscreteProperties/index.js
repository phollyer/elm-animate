...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup = 'boxAnim';
		...
		z: A3(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup, 1))
				]))
	},
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$DiscreteProperties$Main$GotWaapiMsg, model.z);
};
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var waapiMsg = msg.a;
				var _v3 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.z);
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$DiscreteProperties$Main$animGroup, model.z),
							_List_fromArray(
								[
...
var $author$project$Animation$WAAPI$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$DiscreteProperties$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$DiscreteProperties$Main$update,
		fy: $author$project$Animation$WAAPI$DiscreteProperties$Main$view
	});
