...
var $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight = 50;
var $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth = 160;
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$init = function () {
	var animState = A3(
		...
		_List_fromArray(
			[
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$WAAPI$ButtonHovers$Main$zButton, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth)
			]));
	return _Utils_Tuple2(
		{g: animState},
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$WAAPI$subscriptions, $author$project$Animation$WAAPI$ButtonHovers$Main$GotWaapiMsg, model.g);
};
...
var $author$project$Anim$Internal$Engine$WAAPI$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					eM: $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$getPropertySnapshot(anim)
				};
			}),
		anims);
};
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$for($author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight + 6, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth + 20),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$WAAPI$ButtonHovers$Main$zButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$for($author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$shrinkSize = A2(
	...
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonHeight, $author$project$Animation$WAAPI$ButtonHovers$Main$buttonWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$WAAPI$ButtonHovers$Main$hoverDuration),
			A2(
...
var $author$project$Anim$Internal$Property$Size$fromRecord = function (record) {
	return {ck: record.ea, s: record.fz};
};
...
var $author$project$Animation$WAAPI$ButtonHovers$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var waapiMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$WAAPI$update, waapiMsg, model.g);
				var animState = _v1.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
					...
					$elm$core$Platform$Cmd$none);
			case 1:
				var _v2 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleUp);
				var animState = _v2.a;
				var cmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					cmd);
			case 2:
				var _v3 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleDown);
				var animState = _v3.a;
				var cmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					cmd);
			case 3:
				var _v4 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$growSize);
				var animState = _v4.a;
				var cmd = _v4.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					cmd);
			case 4:
				var _v5 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$shrinkSize);
				var animState = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					cmd);
			case 5:
				var _v6 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$liftUp);
				var animState = _v6.a;
				var cmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					cmd);
			default:
				var _v7 = A2($author$project$Anim$Engine$WAAPI$animate, model.g, $author$project$Animation$WAAPI$ButtonHovers$Main$setDown);
				var animState = _v7.a;
				var cmd = _v7.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {bQ: true, bV: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {dK: contactDetails, ep: isPrimary, eI: pointer, eJ: pointerId, eK: pointerType};
	});
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {ea: height, eL: pressure, fo: tiltX, fp: tiltY, fz: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dB: button, dF: clientPos, er: keys, ey: offsetPos, eG: pagePos, eS: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dk: alt, dM: ctrl, eu: meta, eY: shift};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Scale', $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleHover, $author$project$Animation$WAAPI$ButtonHovers$Main$ScaleUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$scaleButton, model.g),
						A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Size', $author$project$Animation$WAAPI$ButtonHovers$Main$SizeHover, $author$project$Animation$WAAPI$ButtonHovers$Main$SizeUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$sizeButton, model.g),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$WAAPI$ButtonHovers$Main$button, 'Translate Z', $author$project$Animation$WAAPI$ButtonHovers$Main$ZHover, $author$project$Animation$WAAPI$ButtonHovers$Main$ZUnhover, $author$project$Animation$WAAPI$ButtonHovers$Main$zButton, model.g)
							]))
					]))
			]));
};
var $author$project$Animation$WAAPI$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $author$project$Animation$WAAPI$ButtonHovers$Main$subscriptions,
		fx: $author$project$Animation$WAAPI$ButtonHovers$Main$update,
		fy: $author$project$Animation$WAAPI$ButtonHovers$Main$view
	});
