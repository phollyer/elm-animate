				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aM: groupConfig, bd: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aM: groupConfig,
								bd: A2($elm$core$List$cons, existing.aM, existing.bd)
							};
						}
					}();
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$addPropertyStates = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			newGroup,
			{
				L: A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$union, newGroup.L, existingGroup.L)
			});
	});
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $author$project$Anim$Internal$Engine$Shared$AnimGroups$init = $elm$core$Dict$empty;
var $author$project$Anim$Internal$Builder$initAnimation = {w: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aC: $elm$core$Maybe$Nothing, ao: $elm$core$Dict$empty};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{b2: x0, b6: (v0 + ((zeta * omega0) * x0)) / omegaD, J: omega0, bg: omegaD, a$: zeta});
		} else {
		...
		switch (property.$) {
							...
							A2(
								...
								_Utils_ap(
									...
									_Utils_ap(
										...
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.ce, config.bb, config.aR))))))));
			case 1:
				var cssName = property.a;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.aS));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.aS));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v10 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.aS));
						var startX = _v10.a;
						var startY = _v10.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v11 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.aS));
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'iterations',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeIterations(processed.ad)),
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.ai))
				]));
	});
...
var $author$project$Anim$Internal$Engine$WAAPI$AnimGroup$init = {ai: 0, bD: $elm$core$Dict$empty, bE: $elm$core$Dict$empty, ad: $author$project$Anim$Internal$Builder$Once, bR: 0, eM: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, L: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, o: $author$project$Anim$Extra$TransformOrder$default};
			...
			switch (property.$) {
				...
				case 2:
					...
					return {
						...
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setOpacity, config.aS, start)
					};
				case 3:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setPerspectiveOrigin, config.aS, start)
					};
				case 4:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setRotate, config.aS, start)
					};
				case 5:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setScale, config.aS, start)
					};
				case 6:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSize, config.aS, start)
					};
				case 7:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setSkew, config.aS, start)
					};
				default:
					var config = property.a;
					return {
						c: A2($author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.c, end),
						aS: A3($author$project$Anim$Internal$Engine$WAAPI$Generator$maybeSet, $author$project$Anim$Internal$Builder$PropertyBaselines$setTranslate, config.aS, start)
					};
			}
		});
	return A3(
		$elm$core$List$foldl,
		setBounds,
		{c: $author$project$Anim$Internal$Builder$PropertyBaselines$empty, aS: $author$project$Anim$Internal$Builder$PropertyBaselines$empty},
		properties);
};
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	return wrapper(
		{
			a9: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.a9, globalData.U, 0),
			bF: distance_,
			ce: $elm$core$Basics$round(duration_),
			bb: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bb, globalData.G, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			c_: speed_,
			aR: resolvedSpring,
			aS: config.aS,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							R: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
				var config = property.b;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							R: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							R: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, D: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, E: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, F: globalData, O: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, R: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Rotate$default, D: $author$project$Anim$Internal$Property$Rotate$distance, E: $author$project$Anim$Internal$Property$Rotate$duration, F: globalData, O: $author$project$Anim$Internal$Property$Rotate$speed, R: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Scale$default, D: $author$project$Anim$Internal$Property$Scale$distance, E: $author$project$Anim$Internal$Property$Scale$duration, F: globalData, O: $author$project$Anim$Internal$Property$Scale$speed, R: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Size$default, D: $author$project$Anim$Internal$Property$Size$distance, E: $author$project$Anim$Internal$Property$Size$duration, F: globalData, O: $author$project$Anim$Internal$Property$Size$speed, R: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Skew$default, D: $author$project$Anim$Internal$Property$Skew$distance, E: $author$project$Anim$Internal$Property$Skew$duration, F: globalData, O: $author$project$Anim$Internal$Property$Skew$speed, R: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Translate$default, D: $author$project$Anim$Internal$Property$Translate$distance, E: $author$project$Anim$Internal$Property$Translate$duration, F: globalData, O: $author$project$Anim$Internal$Property$Translate$speed, R: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aC;
	if (_v1.$ === 1) {
		return {x: _List_Nil, o: data.b.ac};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{x: _List_Nil, o: data.b.ac},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {a9: $elm$core$Maybe$Nothing, bF: 0, bb: $elm$core$Maybe$Nothing, c: defaultEnd, aR: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, bs: $elm$core$Maybe$Nothing};
};
...
var $author$project$Animation$WAAPI$HelloText$Main$groupName = 'helloText';
...
var $author$project$Animation$WAAPI$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$WAAPI$HelloText$Main$groupName),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$initDefaults = {U: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, V: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, ac: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {ai: 0, aD: $elm$core$Dict$empty, aE: $elm$core$Dict$empty, aN: false, ad: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a1: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, aV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ay: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, az: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bn: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
...
var $author$project$Animation$WAAPI$HelloText$Main$init = function () {
	var animState = A3(
		...
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$WAAPI$HelloText$Main$groupName, 0)
			]));
	var _v0 = A2($author$project$Anim$Engine$WAAPI$animate, animState, $author$project$Animation$WAAPI$HelloText$Main$fadeIn);
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				A2($author$project$Anim$Engine$WAAPI$attributes, $author$project$Animation$WAAPI$HelloText$Main$groupName, model.bB),
				_List_fromArray(
					[
...
var $author$project$Animation$WAAPI$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		e7: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fx: F2(
			function (_v1, model) {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			}),
		fy: $author$project$Animation$WAAPI$HelloText$Main$view
	});
