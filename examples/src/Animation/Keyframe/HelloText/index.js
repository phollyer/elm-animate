...
{
	if (region.aS.aO === region.c.aO)
	{
		return 'on line ' + region.aS.aO;
	}
	return 'on lines ' + region.aS.aO + ' through ' + region.c.aO;
}
		...
		return A3(
			...
			F3(
				function (animGroupName, groupConfig, _v1) {
					var accData = _v1;
					var state = accData.y;
					var existingHistory = A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, state.aw);
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aL: groupConfig, bc: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aL: groupConfig,
								bc: A2($elm$core$List$cons, existing.aL, existing.bc)
							};
						}
					}();
					return _Utils_update(
						accData,
						{
							y: _Utils_update(
								state,
								{
									aw: A3($author$project$Anim$Internal$Engine$Shared$AnimGroups$insert, animGroupName, updatedHistory, state.aw)
								})
						});
				}),
			data,
...
var $author$project$Anim$Internal$Builder$initAnimation = {w: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aB: $elm$core$Maybe$Nothing, al: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			f: _Utils_update(
				pb,
				{aC: $elm$core$Dict$empty, aD: $elm$core$Dict$empty})
		});
};
	...
	var newState = _Utils_update(
		state,
		{
			ax: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.ax),
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var k = A2($elm$core$Basics$max, 0, spring.at);
	var omega0 = $elm$core$Basics$sqrt(k / m);
	var c = A2($elm$core$Basics$max, 0, spring.ai);
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{b7: x0, cb: (v0 + ((zeta * omega0) * x0)) / omegaD, I: omega0, bg: omegaD, aZ: zeta});
		} else {
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var speedFn = _v0.M;
	var wrapper = _v0.O;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.aS);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bJ: 0,
					aR: $author$project$Motion$Internal$Spring$unwrap(s),
					b0: 1
				});
		} else {
			return rawDuration;
...
var $author$project$Anim$Internal$Engine$CSS$CSS$animate = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var builder = transform(state.az);
		...
		return A2(
			...
			{
				az: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.aS);
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {aN: 0, bf: $elm$core$Maybe$Nothing, ar: 0, bX: 0, ad: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {bA: '', bE: 0, ch: 0, _: $author$project$Anim$Internal$Builder$Once, bP: ''};
			...
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.ch) + ('-' + ($elm$core$String$fromInt(cfg.a8) + ('-' + (toCssString(cfg.c) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.aS))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.y.ax);
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$mergeStyles = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			_new,
			{
				ad: A2($author$project$Anim$Internal$Engine$CSS$Styles$merge, _new.ad, existing.ad)
			});
	});
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aB;
	if (_v1.$ === 1) {
		return {x: _List_Nil, o: data.b.Z};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{x: _List_Nil, o: data.b.Z},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {a8: $elm$core$Maybe$Nothing, bF: 0, ba: $elm$core$Maybe$Nothing, c: defaultEnd, aR: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, bs: $elm$core$Maybe$Nothing};
};
		...
		return _Utils_update(
			data,
			{
				e: _Utils_update(
					anim,
					{
						aB: $elm$core$Maybe$Just(elementId)
					})
			});
	});
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								c: baseline,
								aS: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v1.a.a;
					var _v2 = _v1.b;
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								c: baseline,
								aS: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v4 = _v1.a;
					var _v5 = _v1.b;
...
var $author$project$Animation$Keyframe$HelloText$Main$groupName = 'helloText';
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.aS);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					...
					c: endPos,
					aS: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Animation$Keyframe$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$Keyframe$HelloText$Main$groupName),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$initDefaults = {R: $elm$core$Maybe$Nothing, F: $elm$core$Maybe$Nothing, S: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, Z: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {af: 0, aC: $elm$core$Dict$empty, aD: $elm$core$Dict$empty, aM: false, _: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a0: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, aU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aw: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ax: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bn: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (initGroup, propertyInitializers) {
		if (!propertyInitializers.b) {
			return A2(
				$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
				{
					az: $author$project$Anim$Internal$Builder$init(_List_Nil)
				},
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
		} else {
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					aS: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
...
var $author$project$Animation$Keyframe$HelloText$Main$init = function () {
	var animState = $author$project$Anim$Engine$Keyframe$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Keyframe$HelloText$Main$groupName, 0)
			]));
	return _Utils_Tuple2(
		{
			a$: A2($author$project$Anim$Engine$Keyframe$animate, animState, $author$project$Animation$Keyframe$HelloText$Main$fadeIn)
		},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
				$elm$html$Html$div,
				A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$HelloText$Main$groupName, model.a$),
				_List_fromArray(
					[
...
var $author$project$Animation$Keyframe$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		fx: $author$project$Animation$Keyframe$HelloText$Main$view
	});
