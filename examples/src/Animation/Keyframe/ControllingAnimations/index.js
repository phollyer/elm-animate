...
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{e: $author$project$Anim$Internal$Builder$initAnimation, b: $author$project$Anim$Internal$Builder$initDefaults, f: $author$project$Anim$Internal$Builder$initPlayback, k: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, z: $author$project$Anim$Internal$Builder$initState});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.fr(start);
		var endRecord = support.fr(end);
		return support.d8(
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$init = function (_v0) {
	var window = _v0.c7;
	var animAreaWidth = A2($elm$core$Basics$min, 500, window.c4 - 40);
	...
	return _Utils_Tuple2(
		{
			l: $author$project$Anim$Engine$Keyframe$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, xPos, 50)
					]))
		},
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
		...
		switch (prop.$) {
			case 0:
				...
				return A3(
					...
					cssName,
					unit,
					A3(transforms.bD, cssName, unit, config));
			case 1:
				var cssName = prop.a;
				var config = prop.b;
				return A2(
					...
					cssName,
					A2(transforms.bC, cssName, config));
			case 2:
				var config = prop.a;
...
var $author$project$Anim$Internal$Builder$getCurrentAnimationConfig = F2(
	function (animGroupName, _v0) {
		...
		return A2(
			...
			A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.z.ax));
	});
var $author$project$Anim$Internal$Engine$CSS$CSS$simpleControl = F6(
	function (setPlayState, mapper, buildStyles, setStyles, animGroupName, animState) {
			...
			var animGroup = setPlayState(
				setStyles(
					A2(
						...
						A2($elm$core$List$map, mapper, properties))));
			return A2(
				$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
				state,
	...
	function (getValue, config) {
		...
		return _Utils_update(
			config,
			{
				a8: 0,
				bF: 0,
				ba: $author$project$Motion$Easing$Linear,
				c: value,
				aT: $elm$core$Maybe$Just(value),
				bs: $author$project$Shared$TimeSpec$Duration(0)
			});
	});
	...
	var toResetProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
		{
			...
			bT: toStartOr($author$project$Anim$Internal$Property$Opacity$default),
			bU: toStartOr($author$project$Anim$Internal$Property$PerspectiveOrigin$default),
			bl: toStartOr($author$project$Anim$Internal$Property$Rotate$default),
			bo: toStartOr($author$project$Anim$Internal$Property$Scale$default),
			b_: toStartOr($author$project$Anim$Internal$Property$Size$default),
			bp: toStartOr($author$project$Anim$Internal$Property$Skew$default),
			bt: toStartOr($author$project$Anim$Internal$Property$Translate$default)
		});
	return A2(
...
var $author$project$Anim$Internal$Engine$Keyframe$restartAnimation = F3(
	function (animGroupName, properties, _v0) {
		...
		var animGroups = _v0.b;
		var discrete = {
			bH: $author$project$Anim$Internal$Builder$getDiscreteEntryProperties(state.aA),
			bI: $author$project$Anim$Internal$Builder$getDiscreteExitProperties(state.aA)
		};
		var counter = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		var animGroup = A8(
			...
			counter,
			A2($author$project$Anim$Internal$Builder$getTransformOrder, animGroupName, state.aA),
			$author$project$Anim$Internal$Builder$getIterations(state.aA),
			$author$project$Anim$Internal$Builder$getAnimationDirection(state.aA),
			A2($author$project$Anim$Internal$Builder$getBaseline, animGroupName, state.aA),
			discrete,
			animGroupName,
			properties);
		return A3(
...
var $author$project$Anim$Internal$Engine$Keyframe$restart = F3(
	function (animGroupName, toMsg, animState) {
		var state = animState.a;
		var maybeFromHistory = A2($author$project$Anim$Internal$Builder$getCurrentAnimationConfig, animGroupName, state.aA);
		if (maybeFromHistory.$ === 1) {
			return _Utils_Tuple2(animState, $elm$core$Platform$Cmd$none);
		} else {
			var properties = maybeFromHistory.a.y;
			return _Utils_Tuple2(
			...
			var toStopProperty = $author$project$Anim$Internal$Engine$CSS$CSS$mapProcessedProperty(
				{
					...
					bl: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					bo: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					b_: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					bp: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
						function ($) {
							return $.c;
						}),
					bt: $author$project$Anim$Internal$Engine$CSS$CSS$snapTo(
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2($author$project$Anim$Engine$Keyframe$animate, model.l, $author$project$Animation$Keyframe$ControllingAnimations$Main$dropBall)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2($author$project$Anim$Engine$Keyframe$stop, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.l)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							l: A2($author$project$Anim$Engine$Keyframe$reset, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.l)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var _v1 = A3($author$project$Anim$Engine$Keyframe$restart, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.l);
				var newState = _v1.a;
				var eventCmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					eventCmd);
			case 4:
				var _v2 = A3($author$project$Anim$Engine$Keyframe$pause, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.l);
				var newState = _v2.a;
				var eventCmd = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
					...
					eventCmd);
			case 5:
				var _v3 = A3($author$project$Anim$Engine$Keyframe$resume, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, $author$project$Animation$Keyframe$ControllingAnimations$Main$GotAnimMsg, model.l);
				var newState = _v3.a;
				var eventCmd = _v3.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Pause = {$: 4};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Reset = {$: 2};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Restart = {$: 3};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$Resume = {$: 5};
				...
				function (anim) {
					return A3(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Anim$Internal$Engine$Keyframe$Animation$getKeyframes(anim))
							]));
				},
				A2(
					$elm$core$Maybe$andThen,
...
var $author$project$Animation$Keyframe$ControllingAnimations$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Anim$Engine$Keyframe$styleNodeFor, $author$project$Animation$Keyframe$ControllingAnimations$Main$animGroup, model.l),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				$author$project$Animation$Keyframe$ControllingAnimations$Main$animationArea(model.l)
			]));
};
var $author$project$Animation$Keyframe$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{
		ej: $author$project$Animation$Keyframe$ControllingAnimations$Main$init,
		e6: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fx: $author$project$Animation$Keyframe$ControllingAnimations$Main$update,
		fy: $author$project$Animation$Keyframe$ControllingAnimations$Main$view
	});
