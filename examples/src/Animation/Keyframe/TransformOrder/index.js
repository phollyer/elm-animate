...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.r, dimensions.cn);
};
...
var $author$project$Anim$Internal$Property$Size$default = {cn: 0, r: 0};
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cn: start.cn + ((endSize.cn - start.cn) * t), r: start.r + ((endSize.r - start.r) * t)};
	});
...
var $author$project$Anim$Internal$Property$Size$widthToCssString = function (_v0) {
	var dimensions = _v0;
	return $elm$core$String$fromFloat(dimensions.r) + 'px';
};
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aC;
	if (_v1.$ === 1) {
		return {y: _List_Nil, o: data.b._};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{y: _List_Nil, o: data.b._},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Skew$build = function (_v0) {
	...
	return A2(
		...
		$author$project$Anim$Internal$Builder$SkewConfig(config),
		builder);
};
var $author$project$Anim$Property$Skew$build = $author$project$Anim$Internal$Builder$Skew$build;
...
var $author$project$Anim$Internal$Builder$Skew$for = F2(
	function (animGroupName, builder) {
		...
		var config = A5($author$project$Anim$Internal$Builder$Property$for, animGroupName, $author$project$Anim$Internal$Builder$PropertyBaselines$getSkew, extractExisting, $author$project$Anim$Internal$Builder$Skew$defaultConfig, builder);
		return A2(
			$author$project$Anim$Internal$Builder$Skew$SkewBuilder,
			config,
			A2($author$project$Anim$Internal$Builder$for, animGroupName, builder));
	});
var $author$project$Anim$Property$Skew$for = $author$project$Anim$Internal$Builder$Skew$for;
...
var $author$project$Anim$Internal$Builder$Skew$to = F2(
	function (skew, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, config.aT);
		return A2(
			$author$project$Anim$Internal$Builder$Skew$SkewBuilder,
			_Utils_update(
				config,
				{
					bF: A2($author$project$Anim$Internal$Property$Skew$distance, start, skew),
					c: skew,
...
var $author$project$Anim$Property$Skew$initXY = F4(
	function (animationKey, x, y, animBuilder) {
		return $author$project$Anim$Property$Skew$build(
			A3(
				...
				A3(
					...
					x,
					y,
					A2($author$project$Anim$Property$Skew$for, animationKey, animBuilder))));
	});
...
var $author$project$Anim$Internal$Builder$Skew$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Skew$duration = $author$project$Anim$Internal$Builder$Skew$duration;
...
var $author$project$Anim$Internal$Builder$Skew$easing = F2(
	function (easing_, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Property$Skew$easing = $author$project$Anim$Internal$Builder$Skew$easing;
...
var $author$project$Anim$Internal$Builder$Scale$toXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = $author$project$Anim$Internal$Property$Scale$getZ(config.c);
		return A4(
			$author$project$Anim$Internal$Builder$Scale$toXYZ,
			x,
			y,
			z,
...
var $author$project$Anim$Internal$Builder$Rotate$toZ = F2(
	function (z, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var y = $author$project$Anim$Internal$Property$Rotate$getY(config.c);
		var x = $author$project$Anim$Internal$Property$Rotate$getX(config.c);
		return A4(
...
var $author$project$Animation$Keyframe$TransformOrder$Main$animatePermutation = function (perm) {
	var key = $author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for(key),
		A2(
			$elm$core$Basics$composeR,
			A2($author$project$Anim$Property$Translate$toXY, 120, 56),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$duration(2000),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$easing($author$project$Motion$Easing$EaseInOut),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Property$Translate$build,
						A2(
							$elm$core$Basics$composeR,
							$author$project$Anim$Property$Rotate$for(key),
							A2(
								$elm$core$Basics$composeR,
								$author$project$Anim$Property$Rotate$toZ(45),
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Rotate$duration(2000),
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Property$Rotate$easing($author$project$Motion$Easing$EaseInOut),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Property$Rotate$build,
											A2(
												$elm$core$Basics$composeR,
												$author$project$Anim$Property$Skew$for(key),
												A2(
													$elm$core$Basics$composeR,
													A2($author$project$Anim$Property$Skew$toXY, 15, 9),
													A2(
														$elm$core$Basics$composeR,
														$author$project$Anim$Property$Skew$duration(2000),
														A2(
															$elm$core$Basics$composeR,
															$author$project$Anim$Property$Skew$easing($author$project$Motion$Easing$EaseInOut),
															A2(
																$elm$core$Basics$composeR,
																$author$project$Anim$Property$Skew$build,
																A2(
																	$elm$core$Basics$composeR,
																	$author$project$Anim$Property$Scale$for(key),
																	A2(
																		$elm$core$Basics$composeR,
																		A2($author$project$Anim$Property$Scale$toXY, 1.5, 0.8),
																		A2(
																			$elm$core$Basics$composeR,
																			$author$project$Anim$Property$Scale$duration(2000),
																			A2(
																				$elm$core$Basics$composeR,
																				$author$project$Anim$Property$Scale$easing($author$project$Motion$Easing$EaseInOut),
...
var $author$project$Animation$Keyframe$TransformOrder$Main$resetPermutation = function (perm) {
	var key = $author$project$Animation$Keyframe$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for(key),
						...
						model,
						{
							s: A2(
								...
								A2(
									...
									$author$project$Animation$Keyframe$TransformOrder$Main$animatePermutation(perm)))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							s: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Keyframe$transformOrder(
										$author$project$Animation$Keyframe$TransformOrder$Main$permutationOrder(perm)),
									$author$project$Animation$Keyframe$TransformOrder$Main$resetPermutation(perm)))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'border', '2px solid rgb(' + (rgb + ')')),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Keyframe$TransformOrder$Main$animationArea(model.s)
			]));
};
var $author$project$Animation$Keyframe$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		fw: $author$project$Animation$Keyframe$TransformOrder$Main$update,
		fx: $author$project$Animation$Keyframe$TransformOrder$Main$view
	});
