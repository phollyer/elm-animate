...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth = 100;
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$init = function (_v0) {
	var width = _v0.c4;
	var height = _v0.co;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			o: $author$project$Anim$Engine$Keyframe$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName, (w - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2, (h - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2)
					])),
			co: h,
			c4: w
		},
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$speed(100),
				A2(
					$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveDown = function (height) {
	return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(height - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveLeft = $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
	$author$project$Anim$Property$Translate$toX(0));
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveRight = function (width) {
	return $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toX(width - $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveUp = $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveBox(
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animationMsg, model.o);
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Keyframe$animate, model.o, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveLeft)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2(
								...
								model.o,
								$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveRight(model.c4))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Keyframe$animate, model.o, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveUp)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2(
								$author$project$Anim$Engine$Keyframe$animate,
								model.o,
								$author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$moveDown(model.co))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	...
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$animGroupName, model.o),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.o),
				moveLeftButton,
				moveRightButton,
				moveUpButton,
				moveDownButton,
...
var $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{
		ei: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$init,
		e5: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fw: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$update,
		fx: $author$project$Animation$Keyframe$InterruptingAnimations$MultipleAxes$Main$view
	});
