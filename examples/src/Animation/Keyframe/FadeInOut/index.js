...
var $author$project$Animation$Keyframe$FadeInOut$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$Keyframe$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$for($author$project$Animation$Keyframe$FadeInOut$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Opacity$easing($author$project$Motion$Easing$CubicInOut),
		...
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						W: A2($author$project$Anim$Engine$Keyframe$animate, model.W, $author$project$Animation$Keyframe$FadeInOut$Main$fadeIn)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						W: A2($author$project$Anim$Engine$Keyframe$animate, model.W, $author$project$Animation$Keyframe$FadeInOut$Main$fadeOut)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$FadeInOut$Main$animGroup, model.W),
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'height', '80vh'),
...
var $author$project$Animation$Keyframe$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		fw: $author$project$Animation$Keyframe$FadeInOut$Main$update,
		fx: $author$project$Animation$Keyframe$FadeInOut$Main$view
	});
