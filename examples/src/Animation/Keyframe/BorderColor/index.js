...
var $author$project$Animation$Keyframe$BorderColor$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$Keyframe$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$Keyframe$BorderColor$Main$animGroup, $author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
		...
		if (!msg) {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						W: A2($author$project$Anim$Engine$Keyframe$animate, model.W, $author$project$Animation$Keyframe$BorderColor$Main$toRed)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						W: A2($author$project$Anim$Engine$Keyframe$animate, model.W, $author$project$Animation$Keyframe$BorderColor$Main$toBlue)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$BorderColor$Main$animGroup, model.W),
							_List_fromArray(
								[
...
var $author$project$Animation$Keyframe$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		fw: $author$project$Animation$Keyframe$BorderColor$Main$update,
		fx: $author$project$Animation$Keyframe$BorderColor$Main$view
	});
