...
{
	if (region.a_.aV === region.f.aV)
	{
		return 'on line ' + region.a_.aV;
	}
	return 'on lines ' + region.a_.aV + ' through ' + region.f.aV;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eh: 'hidden', dI: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eh: 'mozHidden', dI: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eh: 'msHidden', dI: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eh: 'webkitHidden', dI: 'webkitvisibilitychange' }
		: { eh: 'hidden', dI: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {co: fragment, cv: host, cP: path, cR: port_, cU: protocol, cV: query};
	});
...
var $author$project$Animation$Keyframe$Perspective3D$Main$MoveToBottomRight = 1;
var $author$project$Animation$Keyframe$Perspective3D$Main$MoveToTopRight = 0;
var $author$project$Animation$Keyframe$Perspective3D$Main$Opening = 0;
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aS: groupConfig, bj: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aS: groupConfig,
								bj: A2($elm$core$List$cons, existing.aS, existing.bj)
							};
						}
					}();
...
var $author$project$Anim$Internal$Builder$initAnimation = {A: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aH: $elm$core$Maybe$Nothing, as: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			i: _Utils_update(
				pb,
				{aI: $elm$core$Dict$empty, aJ: $elm$core$Dict$empty})
		});
};
	...
	var newState = _Utils_update(
		state,
		{
			aE: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.aE),
...
var $author$project$Anim$Internal$Property$Rotate$default = {dc: 0, dd: 0, ca: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {dc: 1.0, dd: 1.0, ca: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cr: 0, w: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {dc: 0, dd: 0};
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {dc: 0, dd: 0, ca: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	...
	var l = hslValue.cA / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.cr / 60, 2) - 1));
	var _v0 = (hslValue.cr < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.cr < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.cr < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.cr < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.cr < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {cf: rgba_.cf, cq: rgba_.cq, cW: rgba_.cW};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{cr: hsla_.cr, cA: hsla_.cA, cZ: hsla_.cZ});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				cf: $elm$core$Basics$round(rgba_.bH * 255),
				cq: $elm$core$Basics$round(rgba_.bQ * 255),
				cW: $elm$core$Basics$round(rgba_.b0 * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dg = rgb2.cq - rgb1.cq;
		var db = rgb2.cf - rgb1.cf;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		...
		var dz = $elm$core$Basics$abs(record2.ca - record1.ca);
		var dy = $elm$core$Basics$abs(record2.dd - record1.dd);
		var dx = $elm$core$Basics$abs(record2.dc - record1.dc);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	dg: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {dc: a.dc + b.dc, dd: a.dd + b.dd, ca: a.ca + b.ca};
		}),
	ed: $elm$core$Basics$identity,
	bu: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {dc: angles.dc * factor, dd: angles.dd * factor, ca: angles.ca * factor};
		}),
	fc: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fF: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bu: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {dc: coords.dc * factor, dd: coords.dd * factor, ca: coords.ca * factor};
		}),
	fc: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fF: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fF: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var k = A2($elm$core$Basics$max, 0, spring.aA);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	return wrapper(
		{
			bf: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.bf, globalData.V, 0),
			bL: distance_,
			cl: $elm$core$Basics$round(duration_),
			bh: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bh, globalData.J, $author$project$Motion$Easing$EaseInOut),
			f: config.f,
			c1: speed_,
			aZ: resolvedSpring,
			a_: config.a_,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							S: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							S: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							S: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, G: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, H: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, I: globalData, Q: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, S: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$Rotate$default, G: $author$project$Anim$Internal$Property$Rotate$distance, H: $author$project$Anim$Internal$Property$Rotate$duration, I: globalData, Q: $author$project$Anim$Internal$Property$Rotate$speed, S: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$Scale$default, G: $author$project$Anim$Internal$Property$Scale$distance, H: $author$project$Anim$Internal$Property$Scale$duration, I: globalData, Q: $author$project$Anim$Internal$Property$Scale$speed, S: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$Size$default, G: $author$project$Anim$Internal$Property$Size$distance, H: $author$project$Anim$Internal$Property$Size$duration, I: globalData, Q: $author$project$Anim$Internal$Property$Size$speed, S: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$Skew$default, G: $author$project$Anim$Internal$Property$Skew$distance, H: $author$project$Anim$Internal$Property$Skew$duration, I: globalData, Q: $author$project$Anim$Internal$Property$Skew$speed, S: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{E: config, F: $author$project$Anim$Internal$Property$Translate$default, G: $author$project$Anim$Internal$Property$Translate$distance, H: $author$project$Anim$Internal$Property$Translate$duration, I: globalData, Q: $author$project$Anim$Internal$Property$Translate$speed, S: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
...
var $author$project$Anim$Internal$Engine$CSS$CSS$animate = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var builder = transform(state.aG);
		...
		return A2(
			...
			{
				aG: $author$project$Anim$Internal$Builder$clearAnimData(
			...
			setAllRunning(
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
					insertData(processedAnimData.bR),
					animGroups,
					A2(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
						F2(
...
var $author$project$Anim$Internal$Property$Rotate$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!angles.dc)) ? $elm$core$Maybe$Just(
				'rotateX(' + ($elm$core$String$fromFloat(angles.dc) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.dd)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.dd) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.ca)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.ca) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
...
var $author$project$Anim$Internal$Property$Skew$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!values.dc)) ? $elm$core$Maybe$Just(
				'skewX(' + ($elm$core$String$fromFloat(values.dc) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.dd)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.dd) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = function (_v0) {
	var coords = _v0;
	return 'translate3d(' + ($elm$core$String$fromFloat(coords.dc) + ('px, ' + ($elm$core$String$fromFloat(coords.dd) + ('px, ' + ($elm$core$String$fromFloat(coords.ca) + 'px)')))));
};
		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						bz: $author$project$Anim$Internal$Property$Translate$toCssString(config.f)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						br: $author$project$Anim$Internal$Property$Rotate$toCssString(config.f)
					});
			case 7:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bv: $author$project$Anim$Internal$Property$Skew$toCssString(config.f)
					});
			case 5:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bu: $author$project$Anim$Internal$Property$Scale$toCssString(config.f)
					});
			default:
				return acc;
		}
	});
var $author$project$Anim$Internal$Builder$emptyTransformParts = {br: '', bu: '', bv: '', bz: ''};
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.bz, transformParts.br, transformParts.bv, transformParts.bu]);
				} else {
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.w, dimensions.cr);
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.a_);
		var linearProgress = function () {
			if (_Utils_cmp(totalTime, cfg.bf) < 0) {
				return 0;
			} else {
				if (!cfg.cl) {
					return 1.0;
				} else {
					var animationTime = totalTime - cfg.bf;
					return A3($elm$core$Basics$clamp, 0, 1, animationTime / cfg.cl);
				}
			}
		}();
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cr: hNormalized, cA: l * 100, cZ: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cf: rgba_.cf, cq: rgba_.cq, cW: rgba_.cW};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {cb: rgba_.cb, cr: hsla_.cr, cA: hsla_.cA, cZ: hsla_.cZ};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cr: hslaValue.cr, cA: hslaValue.cA, cZ: hslaValue.cZ};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cb: 1.0, cr: hslValue.cr, cA: hslValue.cA, cZ: hslValue.cZ};
	}
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cr: hslaValue.cr, cA: hslaValue.cA, cZ: hslaValue.cZ});
	return {cb: hslaValue.cb, cf: rgb_.cf, cq: rgb_.cq, cW: rgb_.cW};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {cb: 1.0, cf: rgb_.cf, cq: rgb_.cq, cW: rgb_.cW};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cq + ((endRgb.cq - startRgb.cq) * t));
							var r = $elm$core$Basics$round(startRgb.cW + ((endRgb.cW - startRgb.cW) * t));
							var b = $elm$core$Basics$round(startRgb.cf + ((endRgb.cf - startRgb.cf) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cf: b, cq: g, cW: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.cW + ((endRgba.cW - startRgba.cW) * t));
							var g = $elm$core$Basics$round(startRgba.cq + ((endRgba.cq - startRgba.cq) * t));
							var b = $elm$core$Basics$round(startRgba.cf + ((endRgba.cf - startRgba.cf) * t));
							var a = startRgba.cb + ((endRgba.cb - startRgba.cb) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.cZ + ((endHsl.cZ - startHsl.cZ) * t);
							var l = startHsl.cA + ((endHsl.cA - startHsl.cA) * t);
							var h = startHsl.cr + ((endHsl.cr - startHsl.cr) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.cZ + ((endHsla.cZ - startHsla.cZ) * t);
							var l = startHsla.cA + ((endHsla.cA - startHsla.cA) * t);
							var h = startHsla.cr + ((endHsla.cr - startHsla.cr) * t);
							var a = startHsla.cb + ((endHsla.cb - startHsla.cb) * t);
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cr: start.cr + ((endSize.cr - start.cr) * t), w: start.w + ((endSize.w - start.w) * t)};
	});
						...
						return $elm$core$Maybe$Just(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'opacity',
									A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Opacity$default, $author$project$Anim$Internal$Property$Opacity$interpolate, $author$project$Anim$Internal$Property$Opacity$toCssString, cfg))
								]));
					case 3:
						var cfg = p.a;
						return $elm$core$Maybe$Just(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'perspective-origin',
									A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$PerspectiveOrigin$default, $author$project$Anim$Internal$Property$PerspectiveOrigin$interpolate, $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString, cfg))
								]));
					case 4:
						return $elm$core$Maybe$Nothing;
					case 5:
						...
						return $elm$core$Maybe$Just(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'width',
									A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Size$default, $author$project$Anim$Internal$Property$Size$interpolate, $author$project$Anim$Internal$Property$Size$widthToCssString, cfg)),
									_Utils_Tuple2(
									'height',
									A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Size$default, $author$project$Anim$Internal$Property$Size$interpolate, $author$project$Anim$Internal$Property$Size$heightToCssString, cfg))
								]));
					case 7:
						return $elm$core$Maybe$Nothing;
					default:
...
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		...
		return support.ed(
			{dc: startRecord.dc + ((endRecord.dc - startRecord.dc) * t), dd: startRecord.dd + ((endRecord.dd - startRecord.dd) * t), ca: startRecord.ca + ((endRecord.ca - startRecord.ca) * t)});
	});
					...
					switch (p.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									bz: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Translate$default, $author$project$Anim$Internal$Property$Translate$interpolate, $author$project$Anim$Internal$Property$Translate$toCssString, cfg)
								});
						case 4:
							var cfg = p.a;
							return _Utils_update(
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateSteps = F6(
	function (maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		var totalSteps = $author$project$Shared$Easing$Keyframes$defaultKeyframeCount;
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.bO));
			var entryStyles = $elm$core$Dict$toList(discrete.bN);
			...
			A2(
				...
				function (p) {
					switch (p.$) {
						case 0:
							var cfg = p.c;
							return _Utils_Tuple2(cfg.cl, cfg.bf);
						case 1:
							var cfg = p.b;
							return _Utils_Tuple2(cfg.cl, cfg.bf);
						case 2:
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {aU: 0, bl: $elm$core$Maybe$Nothing, ay: 0, b1: 0, ak: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {bG: '', bK: 0, cl: 0, ag: $author$project$Anim$Internal$Builder$Once, bV: ''};
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F8(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, properties) {
		return function (animGroup) {
			if ($elm$core$List$isEmpty(properties) && ($elm$core$Dict$isEmpty(discrete.bN) && $elm$core$Dict$isEmpty(discrete.bO))) {
				return animGroup;
			} else {
				...
				var keyframesString = A2(
					...
					name,
					A6($author$project$Anim$Internal$Engine$Keyframe$Generator$generateSteps, maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, properties));
				return A2(
...
var $author$project$Anim$Internal$Property$Size$toCssString = function (size) {
	var _v0 = $author$project$Anim$Internal$Property$Size$toTuple(size);
	var width = _v0.a;
	var height = _v0.b;
	return 'width: ' + ($elm$core$String$fromFloat(width) + ('px; height: ' + ($elm$core$String$fromFloat(height) + 'px')));
};
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
		var stringifyConfig = function (p) {
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.cl) + ('-' + ($elm$core$String$fromInt(cfg.bf) + ('-' + (toCssString(cfg.f) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.a_))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
				...
				case 3:
					var cfg = p.a;
					return A3(s, 'perspOrigin-', $author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString, cfg);
				case 4:
					var cfg = p.a;
				...
				case 6:
					var cfg = p.a;
					return A3(s, 'size-', $author$project$Anim$Internal$Property$Size$toCssString, cfg);
				case 7:
					var cfg = p.a;
					return A3(s, 'skew-', $author$project$Anim$Internal$Property$Skew$toCssString, cfg);
				default:
					var cfg = p.a;
					return A3(s, 'pos-', $author$project$Anim$Internal$Property$Translate$toCssString, cfg);
			}
		};
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.bN),
				stringifyExitDict(discrete.bO));
		}();
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateAnimation = F7(
	function (maybeOrder, iterationCount, direction, maybeTargetValues, discrete, animGroupName, properties) {
		...
		return A8($author$project$Anim$Internal$Engine$Keyframe$Generator$generate, name, 0, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, properties);
	});
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.C.aE);
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$mergeStyles = F2(
	function (_v0, _v1) {
		...
		return _Utils_update(
			_new,
			{
				ak: A2($author$project$Anim$Internal$Engine$CSS$Styles$merge, _new.ak, existing.ak)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$animate = function () {
	var insertAnimGroup = F4(
		function (_v2, animGroupName, newAnimGroup, acc) {
	...
	var generateAnimGroup = F4(
		function (_v0, builder, animGroupName, config) {
			var discrete = {
				bN: $author$project$Anim$Internal$Builder$getDiscreteEntryProperties(builder),
				bO: $author$project$Anim$Internal$Builder$getDiscreteExitProperties(builder)
			};
			return A7(
				$author$project$Anim$Internal$Engine$Keyframe$Generator$generateAnimation,
				config.t,
	...
	return A3($author$project$Anim$Internal$Engine$CSS$CSS$animate, $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setPlayState, generateAnimGroup, insertAnimGroup);
}();
var $author$project$Anim$Engine$Keyframe$animate = $author$project$Anim$Internal$Engine$Keyframe$animate;
var $author$project$Animation$Keyframe$Perspective3D$Main$backFace = {
	aa: 'rgb(41, 128, 185)',
	ab: 'rgb(33, 97, 140)',
	a: 'backFaceAnim',
	d: 'back-face',
	q: 'BACK',
	e: {ac: 'rgb(0,0 ,0   )', a: 'backFaceTextAnim', d: 'back-face-text', q: 'BACK'}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace = {
	aa: 'rgb(155, 89, 182)',
	ab: 'rgb(142, 68, 173)',
	a: 'bottomFaceAnim',
	d: 'bottom-face',
	q: 'BOTTOM',
	e: {ac: 'rgb(0,0 ,0   )', a: 'bottomFaceTextAnim', d: 'bottom-face-text', q: 'BOTTOM'}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$cube = {a: 'cubeAnim', d: 'cube', b4: 100};
var $author$project$Animation$Keyframe$Perspective3D$Main$depth = $author$project$Animation$Keyframe$Perspective3D$Main$cube.b4 / 2;
var $author$project$Animation$Keyframe$Perspective3D$Main$frontFace = {
	aa: 'rgb(52, 152, 219)',
	ab: 'rgb(41, 128, 185)',
	a: 'frontFaceAnim',
	d: 'front-face',
	q: 'FRONT',
	e: {ac: 'rgb(0,0 ,0   )', a: 'frontFaceTextAnim', d: 'front-face-text', q: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initDefaults = {V: $elm$core$Maybe$Nothing, J: $elm$core$Maybe$Nothing, W: $elm$core$Maybe$Nothing, K: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {am: 0, aI: $elm$core$Dict$empty, aJ: $elm$core$Dict$empty, aT: false, ag: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a7: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing, a0: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bB: $elm$core$Maybe$Nothing, bC: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bt: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	function (initGroup, propertyInitializers) {
		if (!propertyInitializers.b) {
			return A2(
				$author$project$Anim$Internal$Engine$CSS$CSS$AnimState,
				{
					aG: $author$project$Anim$Internal$Builder$init(_List_Nil)
				},
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
		} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$init = F6(
	function (maybeOrder, iterationCount, direction, discrete, animGroupName, properties) {
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.h.aH;
	if (_v1.$ === 1) {
		return {B: _List_Nil, t: data.c.af};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{B: _List_Nil, t: data.c.af},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {bf: $elm$core$Maybe$Nothing, bL: 0, bh: $elm$core$Maybe$Nothing, f: defaultEnd, aZ: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing};
};
		...
		return _Utils_update(
			data,
			{
				h: _Utils_update(
					anim,
					{
						aH: $elm$core$Maybe$Just(elementId)
					})
			});
	});
...
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.C.bt);
	});
...
var $author$project$Anim$Internal$Builder$getFrozenAxes = F2(
	function (propName, _v0) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, propName, data.h.as));
	});
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						dc: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.dc : endRecord.dc,
						dd: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.dd : endRecord.dd,
						ca: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.ca : endRecord.ca
					});
				return _Utils_update(
					config,
					{
...
var $author$project$Animation$Keyframe$Perspective3D$Main$leftFace = {
	aa: 'rgb(230, 126, 34)',
	ab: 'rgb(211, 84, 0)',
	a: 'leftFaceAnim',
	d: 'left-face',
	q: 'LEFT',
	e: {ac: 'rgb(0,0 ,0   )', a: 'leftFaceTextAnim', d: 'left-face-text', q: 'LEFT'}
};
...
var $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveContainer = {a: 'perspectiveContainerAnim', d: 'perspective-container'};
...
var $author$project$Animation$Keyframe$Perspective3D$Main$vanishingPointDot = {a: 'vanishingPointDotAnim', d: 'vanishing-point-dot'};
var $author$project$Animation$Keyframe$Perspective3D$Main$movePerspectiveOrigin = F4(
	function (x, y, ms, areaSize) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$PerspectiveOrigin$for($author$project$Animation$Keyframe$Perspective3D$Main$perspectiveContainer.a),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$PerspectiveOrigin$percent,
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Translate$for($author$project$Animation$Keyframe$Perspective3D$Main$vanishingPointDot.a),
									A2(
										$elm$core$Basics$composeR,
										$author$project$Anim$Property$Translate$toX((x / 100) * areaSize.c8),
										A2(
											$elm$core$Basics$composeR,
											$author$project$Anim$Property$Translate$toY((y / 100) * areaSize.cs),
											A2(
												$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepDuration = 3000;
var $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveAnimation = F2(
	function (areaSize, step) {
		switch (step) {
			case 0:
				return A4($author$project$Animation$Keyframe$Perspective3D$Main$movePerspectiveOrigin, 100, 0, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepDuration, areaSize);
			case 1:
				return A4($author$project$Animation$Keyframe$Perspective3D$Main$movePerspectiveOrigin, 100, 100, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepDuration, areaSize);
			case 2:
				return A4($author$project$Animation$Keyframe$Perspective3D$Main$movePerspectiveOrigin, 0, 100, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepDuration, areaSize);
			default:
				return A4($author$project$Animation$Keyframe$Perspective3D$Main$movePerspectiveOrigin, 0, 0, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepDuration, areaSize);
		}
	});
var $author$project$Animation$Keyframe$Perspective3D$Main$rightFace = {
	aa: 'rgb(231, 76, 60)',
	ab: 'rgb(192, 57, 43)',
	a: 'rightFaceAnim',
	d: 'right-face',
	q: 'RIGHT',
	e: {ac: 'rgb(0,0 ,0   )', a: 'rightFaceTextAnim', d: 'right-face-text', q: 'RIGHT'}
};
...
var $author$project$Anim$Engine$Keyframe$duration = $author$project$Anim$Internal$Engine$CSS$CSS$duration;
...
var $author$project$Anim$Engine$Keyframe$easing = $author$project$Anim$Internal$Engine$CSS$CSS$easing;
var $author$project$Animation$Keyframe$Perspective3D$Main$sharedTiming = A2(
	$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Perspective3D$Main$moveFace = F2(
	function (_v0, moveToBuilder) {
		var groupName = _v0.a;
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Keyframe$Perspective3D$Main$sharedTiming,
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Perspective3D$Main$moveBackFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveBottomFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveFrontFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveLeftFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveRightFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$topFace = {
	aa: 'rgb(46, 204, 113)',
	ab: 'rgb(39, 174, 96)',
	a: 'topFaceAnim',
	d: 'top-face',
	q: 'TOP',
	e: {ac: 'rgb(0,0 ,0   )', a: 'topFaceTextAnim', d: 'top-face-text', q: 'TOP'}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$moveTopFaceIn = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Keyframe$Perspective3D$Main$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Keyframe$Perspective3D$Main$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Keyframe$Perspective3D$Main$moveLeftFaceIn,
				A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$Perspective3D$Main$moveTopFaceIn, $author$project$Animation$Keyframe$Perspective3D$Main$moveBottomFaceIn)))));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount = 50;
var $author$project$Animation$Keyframe$Perspective3D$Main$moveBackFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ(((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth) - $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveBottomFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Keyframe$Perspective3D$Main$depth + $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveFrontFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Keyframe$Perspective3D$Main$depth + $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveLeftFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX(((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth) - $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveRightFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Keyframe$Perspective3D$Main$depth + $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveTopFaceOut = A2(
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFace,
	$author$project$Animation$Keyframe$Perspective3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY(((-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth) - $author$project$Animation$Keyframe$Perspective3D$Main$moveAmount));
var $author$project$Animation$Keyframe$Perspective3D$Main$moveSidesOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Keyframe$Perspective3D$Main$moveFrontFaceOut,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Keyframe$Perspective3D$Main$moveBackFaceOut,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Keyframe$Perspective3D$Main$moveRightFaceOut,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Keyframe$Perspective3D$Main$moveLeftFaceOut,
				A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$Perspective3D$Main$moveTopFaceOut, $author$project$Animation$Keyframe$Perspective3D$Main$moveBottomFaceOut)))));
...
var $author$project$Animation$Keyframe$Perspective3D$Main$moveText = F3(
...
var $author$project$Animation$Keyframe$Perspective3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$frontFace.e, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$backFace.e, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$rightFace.e, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$leftFace.e, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$topFace.e, 0, 0),
					A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace.e, 0, 0))))));
var $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount = 20;
var $author$project$Animation$Keyframe$Perspective3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$frontFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$backFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$rightFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$leftFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$topFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$Keyframe$Perspective3D$Main$moveText, $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace.e, $author$project$Animation$Keyframe$Perspective3D$Main$textMoveAmount, 360))))));
...
var $author$project$Animation$Keyframe$Perspective3D$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for($author$project$Animation$Keyframe$Perspective3D$Main$cube.a),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Keyframe$Perspective3D$Main$rotateCubeAntiClockwise = $author$project$Animation$Keyframe$Perspective3D$Main$rotateCube(0);
var $author$project$Animation$Keyframe$Perspective3D$Main$rotateCubeClockwise = $author$project$Animation$Keyframe$Perspective3D$Main$rotateCube(360);
var $author$project$Animation$Keyframe$Perspective3D$Main$selectAnimation = function (state) {
	switch (state) {
		case 0:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$Perspective3D$Main$moveSidesOut, $author$project$Animation$Keyframe$Perspective3D$Main$moveTextsOut);
		case 1:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Keyframe$Perspective3D$Main$moveSidesIn, $author$project$Animation$Keyframe$Perspective3D$Main$moveTextsIn);
		case 2:
			return $author$project$Animation$Keyframe$Perspective3D$Main$rotateCubeClockwise;
		default:
			return $author$project$Animation$Keyframe$Perspective3D$Main$rotateCubeAntiClockwise;
	}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$init = function (flags) {
	var state = 0;
	var initialAnimState = $author$project$Anim$Engine$Keyframe$init(
		_List_fromArray(
			[
				A3($author$project$Anim$Property$PerspectiveOrigin$initPercent, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveContainer.a, 0, 0),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Keyframe$Perspective3D$Main$cube.a, 200),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Keyframe$Perspective3D$Main$frontFace.a, $author$project$Animation$Keyframe$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Keyframe$Perspective3D$Main$backFace.a, $author$project$Animation$Keyframe$Perspective3D$Main$depth * (-1)),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Perspective3D$Main$rightFace.a, $author$project$Animation$Keyframe$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Keyframe$Perspective3D$Main$leftFace.a, (-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Keyframe$Perspective3D$Main$topFace.a, (-1) * $author$project$Animation$Keyframe$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace.a, $author$project$Animation$Keyframe$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Keyframe$Perspective3D$Main$backFace.a, 180),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Keyframe$Perspective3D$Main$rightFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Keyframe$Perspective3D$Main$leftFace.a, -90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Keyframe$Perspective3D$Main$topFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace.a, -90)
			]));
	var animAreaWidth = A2($elm$core$Basics$min, 500, flags.db.c8 - 40);
	var animAreaHeight = 350;
	return _Utils_Tuple2(
		{
			aQ: {cs: animAreaHeight, c8: animAreaWidth},
			k: A2(
				$author$project$Anim$Engine$Keyframe$animate,
				initialAnimState,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Animation$Keyframe$Perspective3D$Main$selectAnimation(state),
					A2(
						$author$project$Animation$Keyframe$Perspective3D$Main$perspectiveAnimation,
						{cs: animAreaHeight, c8: animAreaWidth},
						0))),
			aW: 1,
			C: state
		},
...
var $author$project$Animation$Keyframe$Perspective3D$Main$Closing = 1;
var $author$project$Animation$Keyframe$Perspective3D$Main$stateChanged = F2(
...
var $author$project$Animation$Keyframe$Perspective3D$Main$cubeRotationEnded = function (model) {
	var _v0 = model.C;
	switch (_v0) {
		case 2:
			return A2($author$project$Animation$Keyframe$Perspective3D$Main$stateChanged, 1, model);
		case 3:
			return A2($author$project$Animation$Keyframe$Perspective3D$Main$stateChanged, 0, model);
		default:
			return model;
	}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$MoveToBottomLeft = 2;
var $author$project$Animation$Keyframe$Perspective3D$Main$MoveToTopLeft = 3;
var $author$project$Animation$Keyframe$Perspective3D$Main$nextPerspectiveStep = function (step) {
	switch (step) {
		case 0:
			return 1;
		case 1:
...
var $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepEnded = function (model) {
	return _Utils_update(
		model,
		{
			k: A2(
				$author$project$Anim$Engine$Keyframe$animate,
				model.k,
				A2($author$project$Animation$Keyframe$Perspective3D$Main$perspectiveAnimation, model.aQ, model.aW)),
			aW: $author$project$Animation$Keyframe$Perspective3D$Main$nextPerspectiveStep(model.aW)
		});
};
var $author$project$Animation$Keyframe$Perspective3D$Main$RotatingClosed = 3;
var $author$project$Animation$Keyframe$Perspective3D$Main$RotatingOpen = 2;
var $author$project$Animation$Keyframe$Perspective3D$Main$sidesMovementEnded = function (model) {
	var _v0 = model.C;
	switch (_v0) {
		case 0:
			return A2($author$project$Animation$Keyframe$Perspective3D$Main$stateChanged, 2, model);
		case 1:
			return A2($author$project$Animation$Keyframe$Perspective3D$Main$stateChanged, 3, model);
		default:
			return model;
	}
};
var $author$project$Animation$Keyframe$Perspective3D$Main$handleEvent = F2(
	function (animEvent, model) {
		...
		while (true) {
			if (animEvent.$ === 1) {
				switch (animEvent.c) {
					case 'cubeAnim':
						return $author$project$Animation$Keyframe$Perspective3D$Main$cubeRotationEnded(model);
					case 'frontFaceAnim':
						return $author$project$Animation$Keyframe$Perspective3D$Main$sidesMovementEnded(model);
					case 'vanishingPointDotAnim':
						return $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveStepEnded(model);
					default:
						break _v0$3;
				}
			} else {
...
var $author$project$Anim$Engine$Keyframe$Started = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
var $author$project$Anim$Engine$Keyframe$toAnimEvent = function (event) {
	switch (event.$) {
		case 0:
			...
			return A3($author$project$Anim$Engine$Keyframe$Started, currentTargetId, targetId, animGroup);
		case 1:
			var currentTargetId = event.a;
			var targetId = event.b;
			var animGroup = event.c;
			return A3($author$project$Anim$Engine$Keyframe$Ended, currentTargetId, targetId, animGroup);
		case 2:
			var currentTargetId = event.a;
			var targetId = event.b;
			var animGroup = event.c;
			return A3($author$project$Anim$Engine$Keyframe$Cancelled, currentTargetId, targetId, animGroup);
		case 3:
			var currentTargetId = event.a;
			var targetId = event.b;
			var animGroup = event.c;
			var iteration = event.d;
			return A4($author$project$Anim$Engine$Keyframe$Iteration, currentTargetId, targetId, animGroup, iteration);
		case 4:
			var animGroup = event.a;
			return $author$project$Anim$Engine$Keyframe$Paused(animGroup);
		case 5:
			var animGroup = event.a;
			return $author$project$Anim$Engine$Keyframe$Resumed(animGroup);
		default:
			var animGroup = event.a;
			return $author$project$Anim$Engine$Keyframe$Restarted(animGroup);
	}
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Started = F3(
	function (a, b, c) {
		return {$: 0, a: a, b: b, c: c};
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$update = F2(
	function (animMsg, animState) {
		switch (animMsg.$) {
			...
			case 0:
				var animGroupName = animMsg.a;
				var currentTargetId = animMsg.b.dS;
				var targetId = animMsg.b.fd;
				return _Utils_Tuple2(
					A3(
						...
						animState),
					A3($author$project$Anim$Internal$Engine$Keyframe$Started, currentTargetId, targetId, animGroupName));
			case 1:
				var animGroupName = animMsg.a;
				var currentTargetId = animMsg.b.dS;
				var targetId = animMsg.b.fd;
			...
			case 2:
				...
				return _Utils_Tuple2(
					A3(
						...
						animState),
					A3($author$project$Anim$Internal$Engine$Keyframe$Cancelled, currentTargetId, targetId, animGroupName));
			default:
				var animGroupName = animMsg.a;
				var currentTargetId = animMsg.b.dS;
				var targetId = animMsg.b.fd;
...
var $author$project$Anim$Engine$Keyframe$update = function (msg) {
	return A2(
		...
		$elm$core$Tuple$mapSecond($author$project$Anim$Engine$Keyframe$toAnimEvent));
};
var $author$project$Animation$Keyframe$Perspective3D$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var animMsg = msg.a;
			var _v1 = A2($author$project$Anim$Engine$Keyframe$update, animMsg, model.k);
			var animState = _v1.a;
			var animEvent = _v1.b;
			return _Utils_Tuple2(
				A2(
					$author$project$Animation$Keyframe$Perspective3D$Main$handleEvent,
					animEvent,
					_Utils_update(
						model,
						{k: animState})),
...
var $author$project$Animation$Keyframe$Perspective3D$Main$GotKeyframeMsg = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$toCssString = function (_v0) {
	...
	return animation.bG + (' ' + ($elm$core$String$fromInt(animation.cl) + ('ms linear 0ms ' + (iterationString + (' ' + (directionString + ' forwards'))))));
};
...
var $author$project$Anim$Internal$Engine$CSS$CSS$SourceEventData = F2(
	function (targetId, currentTargetId) {
		return {dS: currentTargetId, fd: targetId};
	});
...
var $author$project$Animation$Keyframe$Perspective3D$Main$viewFace = F2(
	function (animState, config) {
		var textAnimAttributes = A2($author$project$Anim$Engine$Keyframe$attributes, config.e.a, animState);
		var faceAnimAttributes = A2($author$project$Anim$Engine$Keyframe$attributes, config.a, animState);
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				faceAnimAttributes,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt($author$project$Animation$Keyframe$Perspective3D$Main$cube.b4) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt($author$project$Animation$Keyframe$Perspective3D$Main$cube.b4) + 'px'),
						A2($elm$html$Html$Attributes$style, 'background-color', config.aa),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.ab),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.e.ac),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
...
var $author$project$Animation$Keyframe$Perspective3D$Main$viewCube = function (model) {
	var cubeEvents = $author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$Perspective3D$Main$GotKeyframeMsg);
	var cubeAttrs = A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Perspective3D$Main$cube.a, model.k);
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			cubeAttrs,
			_Utils_ap(
				...
				_List_fromArray(
					[
						$author$project$Anim$Extra$View3D$transformStyle(1),
						$elm$html$Html$Attributes$id($author$project$Animation$Keyframe$Perspective3D$Main$cube.d),
						A2(
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt($author$project$Animation$Keyframe$Perspective3D$Main$cube.b4) + 'px'),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$frontFace),
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$backFace),
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$rightFace),
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$leftFace),
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$topFace),
				A2($author$project$Animation$Keyframe$Perspective3D$Main$viewFace, model.k, $author$project$Animation$Keyframe$Perspective3D$Main$bottomFace)
			]));
};
var $author$project$Animation$Keyframe$Perspective3D$Main$viewVanishingPoint = function (animState) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Perspective3D$Main$vanishingPointDot.a, animState),
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
...
var $author$project$Animation$Keyframe$Perspective3D$Main$viewAnimationArea = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Keyframe$attributes, $author$project$Animation$Keyframe$Perspective3D$Main$perspectiveContainer.a, model.k),
			_Utils_ap(
				$author$project$Anim$Engine$Keyframe$events($author$project$Animation$Keyframe$Perspective3D$Main$GotKeyframeMsg),
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id($author$project$Animation$Keyframe$Perspective3D$Main$perspectiveContainer.d),
						...
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt(model.aQ.c8) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt(model.aQ.cs) + 'px'),
		...
		_List_fromArray(
			[
				$author$project$Animation$Keyframe$Perspective3D$Main$viewVanishingPoint(model.k),
				$author$project$Animation$Keyframe$Perspective3D$Main$viewCube(model)
			]));
};
var $author$project$Animation$Keyframe$Perspective3D$Main$view = function (model) {
	return {
		dy: _List_fromArray(
			[
				$author$project$Anim$Engine$Keyframe$styleNode(model.k),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Animation$Keyframe$Perspective3D$Main$viewAnimationArea(model)
							]))
					]))
			]),
		fv: 'Keyframe Engine - 3D Perspective Origin Example'
	};
};
var $author$project$Animation$Keyframe$Perspective3D$Main$main = $elm$browser$Browser$document(
	{
		eo: $author$project$Animation$Keyframe$Perspective3D$Main$init,
		fb: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		fC: $author$project$Animation$Keyframe$Perspective3D$Main$update,
		fD: $author$project$Animation$Keyframe$Perspective3D$Main$view
	});
_Platform_export({'Animation':{'Keyframe':{'Perspective3D':{'Main':{'init':$author$project$Animation$Keyframe$Perspective3D$Main$main(
	A2(
