...
var $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight = 50;
var $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth = 160;
...
var $author$project$Anim$Internal$Builder$initAnimation = {x: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aC: $elm$core$Maybe$Nothing, am: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {S: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, T: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, _: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {ag: 0, aD: $elm$core$Dict$empty, aE: $elm$core$Dict$empty, aN: false, aa: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a0: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, aV: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bv: $elm$core$Maybe$Nothing, bw: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {ax: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, ay: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bn: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
	...
	var newState = _Utils_update(
		state,
		{
			ay: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.ay),
		...
		switch (property.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						bt: $author$project$Anim$Internal$Property$Translate$toCssString(config.c)
					});
			case 4:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bl: $author$project$Anim$Internal$Property$Rotate$toCssString(config.c)
					});
			case 7:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bp: $author$project$Anim$Internal$Property$Skew$toCssString(config.c)
					});
			case 5:
				var config = property.a;
				return _Utils_update(
					acc,
					{
						bo: $author$project$Anim$Internal$Property$Scale$toCssString(config.c)
					});
			default:
				return acc;
		}
	});
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bl: '', bo: '', bp: '', bt: ''};
	...
	function (maybeOrder, transformParts) {
		return A2(
			...
			function () {
				if (maybeOrder.$ === 1) {
					return _List_fromArray(
						[transformParts.bt, transformParts.bl, transformParts.bp, transformParts.bo]);
				} else {
						...
						function (o) {
							var part = function () {
								switch (o) {
									...
									case 1:
										return transformParts.bl;
									case 2:
										return transformParts.bp;
									default:
										return transformParts.bo;
								}
							}();
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.s, dimensions.cn);
};
			...
			case 2:
				...
				return _List_fromArray(
					[
						_Utils_Tuple2(
						'opacity',
						$author$project$Anim$Internal$Property$Opacity$toCssString(config.c))
					]);
			case 3:
				var config = prop.a;
				return _List_fromArray(
					[
						_Utils_Tuple2(
						'perspective-origin',
						$author$project$Anim$Internal$Property$PerspectiveOrigin$toCssString(config.c))
					]);
			default:
				var config = prop.a;
				var _v1 = $author$project$Anim$Internal$Property$Size$toTuple(config.c);
				var w = _v1.a;
				var h = _v1.b;
				return _List_fromArray(
					[
...
var $author$project$Anim$Internal$Property$Size$default = {cn: 0, s: 0};
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart = F5(
	function (totalTime, _default, interpolate, toCssString, cfg) {
		var start = A2($elm$core$Maybe$withDefault, _default, cfg.aT);
		var linearProgress = function () {
			if (_Utils_cmp(totalTime, cfg.a8) < 0) {
				return 0;
			} else {
				if (!cfg.ch) {
					return 1.0;
				} else {
					var animationTime = totalTime - cfg.a8;
					return A3($elm$core$Basics$clamp, 0, 1, animationTime / cfg.ch);
				}
			}
		}();
		var progress = function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					linearProgress * cfg.ch);
			} else {
				return A2($author$project$Shared$Easing$toFunction, cfg.ba, linearProgress);
			}
		}();
		return toCssString(
			A3(interpolate, progress, start, cfg.c));
	});
var $author$project$Anim$Internal$Property$Size$heightToCssString = function (_v0) {
	var dimensions = _v0;
	return $elm$core$String$fromFloat(dimensions.cn) + 'px';
};
...
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {cb: rgba_.cb, cm: rgba_.cm, cS: rgba_.cS};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {b7: rgba_.b7, cn: hsla_.cn, cw: hsla_.cw, cV: hsla_.cV};
};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {
				cb: $elm$core$Basics$round(rgba_.bB * 255),
				cm: $elm$core$Basics$round(rgba_.bK * 255),
				cS: $elm$core$Basics$round(rgba_.bW * 255)
			};
	}
};
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b7: 1.0, cn: hslValue.cn, cw: hslValue.cw, cV: hslValue.cV};
	}
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	...
	return {b7: hslaValue.b7, cb: rgb_.cb, cm: rgb_.cm, cS: rgb_.cS};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b7: 1.0, cb: rgb_.cb, cm: rgb_.cm, cS: rgb_.cS};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var b = $elm$core$Basics$round(startRgb.cb + ((endRgb.cb - startRgb.cb) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{cb: b, cm: g, cS: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var b = $elm$core$Basics$round(startRgba.cb + ((endRgba.cb - startRgba.cb) * t));
							var a = startRgba.b7 + ((endRgba.b7 - startRgba.b7) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var a = startHsla.b7 + ((endHsla.b7 - startHsla.b7) * t);
...
var $author$project$Anim$Internal$Property$Size$interpolate = F3(
	function (t, _v0, _v1) {
		var start = _v0;
		var endSize = _v1;
		return {cn: start.cn + ((endSize.cn - start.cn) * t), s: start.s + ((endSize.s - start.s) * t)};
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$interpolate = F4(
	function (support, t, start, end) {
		var startRecord = support.fq(start);
		var endRecord = support.fq(end);
		return support.d7(
			{b4: startRecord.b4 + ((endRecord.b4 - startRecord.b4) * t), b5: startRecord.b5 + ((endRecord.b5 - startRecord.b5) * t), b6: startRecord.b6 + ((endRecord.b6 - startRecord.b6) * t)});
	});
					...
					switch (p.$) {
						case 8:
							...
							return _Utils_update(
								acc,
								{
									bt: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Translate$default, $author$project$Anim$Internal$Property$Translate$interpolate, $author$project$Anim$Internal$Property$Translate$toCssString, cfg)
								});
						case 4:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bl: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Rotate$default, $author$project$Anim$Internal$Property$Rotate$interpolate, $author$project$Anim$Internal$Property$Rotate$toCssString, cfg)
								});
						case 5:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bo: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Scale$default, $author$project$Anim$Internal$Property$Scale$interpolate, $author$project$Anim$Internal$Property$Scale$toCssString, cfg)
								});
						case 7:
							var cfg = p.a;
							return _Utils_update(
								acc,
								{
									bp: A5($author$project$Anim$Internal$Engine$Keyframe$Generator$generateTransformPart, totalTime, $author$project$Anim$Internal$Property$Skew$default, $author$project$Anim$Internal$Property$Skew$interpolate, $author$project$Anim$Internal$Property$Skew$toCssString, cfg)
								});
						default:
							return acc;
					}
	...
	function (maybeOrder, maybeTargetValues, maxDuration, maxDelay, discrete, processedProps) {
		...
		var discreteStylesForStep = function (stepIndex) {
			var exitStyles = A2(
				...
				$elm$core$Dict$toList(discrete.bI));
			var entryStyles = $elm$core$Dict$toList(discrete.bH);
			...
			A2(
				...
				function (p) {
					switch (p.$) {
						case 0:
							var cfg = p.c;
							return _Utils_Tuple2(cfg.ch, cfg.a8);
						case 1:
							var cfg = p.b;
							return _Utils_Tuple2(cfg.ch, cfg.a8);
						case 2:
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$init = {aO: 0, bf: $elm$core$Maybe$Nothing, as: 0, bX: 0, ae: $author$project$Anim$Internal$Engine$CSS$Styles$empty};
var $author$project$Anim$Internal$Engine$Keyframe$Animation$Animation = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Engine$Keyframe$Animation$init = {bA: '', bE: 0, ch: 0, aa: $author$project$Anim$Internal$Builder$Once, bP: ''};
...
var $author$project$Anim$Internal$Engine$Keyframe$AnimGroup$setAnimation = F2(
	function (animation, _v0) {
		...
		return _Utils_update(
			animGroup,
			{
				bf: $elm$core$Maybe$Just(animation)
			});
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generate = F8(
	function (name, counter, maybeOrder, iterationCount, direction, maybeTargetValues, discrete, properties) {
		return function (animGroup) {
			if ($elm$core$List$isEmpty(properties) && ($elm$core$Dict$isEmpty(discrete.bH) && $elm$core$Dict$isEmpty(discrete.bI))) {
				return animGroup;
			} else {
...
var $author$project$Anim$Internal$Engine$Keyframe$Generator$generateHash = F6(
	function (maybeOrder, discrete, animGroupName, maxDuration, maxDelay, processedProps) {
		var stringifyConfig = function (p) {
			var s = F3(
				function (prefix, toCssString, cfg) {
					return prefix + ($elm$core$String$fromInt(cfg.ch) + ('-' + ($elm$core$String$fromInt(cfg.a8) + ('-' + (toCssString(cfg.c) + ('-' + A2(
						$elm$core$Maybe$withDefault,
						'none',
						A2($elm$core$Maybe$map, toCssString, cfg.aT))))))));
				});
			switch (p.$) {
				case 0:
					var cssName = p.a;
		...
		var discreteHash = function () {
			...
			return _Utils_ap(
				stringifyEntryDict(discrete.bH),
				stringifyExitDict(discrete.bI));
		}();
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var config = _v0.B;
	var globalData = _v0.F;
	var defaultStart = _v0.C;
	var distanceFn = _v0.D;
	var durationFn = _v0.E;
	var speedFn = _v0.N;
	var wrapper = _v0.P;
	...
	return wrapper(
		{
			a8: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.a8, globalData.S, 0),
			bF: distance_,
			ch: $elm$core$Basics$round(duration_),
			ba: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.ba, globalData.G, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			cZ: speed_,
			aS: resolvedSpring,
			aT: config.aT,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							E: $author$project$Shared$TimeSpec$duration,
							F: globalData,
							N: $author$project$Shared$TimeSpec$speed,
							P: A2($author$project$Anim$Internal$Builder$ProcessedCustomPropertyConfig, cssName, unit)
						}));
			case 1:
				var cssName = property.a;
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							B: config,
							C: $author$project$Anim$Internal$Extra$Color$transparent,
							D: $author$project$Anim$Internal$Extra$Color$distance,
							E: $author$project$Anim$Internal$Extra$Color$duration,
							F: globalData,
							N: $author$project$Anim$Internal$Extra$Color$speed,
							P: $author$project$Anim$Internal$Builder$ProcessedCustomColorPropertyConfig(cssName)
						}));
			case 2:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							B: config,
							C: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							D: $author$project$Anim$Internal$Property$Opacity$distance,
							E: $author$project$Anim$Internal$Property$Opacity$duration,
							F: globalData,
							N: $author$project$Anim$Internal$Property$Opacity$speed,
							P: $author$project$Anim$Internal$Builder$ProcessedOpacityConfig
						}));
			case 3:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, D: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, E: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, F: globalData, N: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, P: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Rotate$default, D: $author$project$Anim$Internal$Property$Rotate$distance, E: $author$project$Anim$Internal$Property$Rotate$duration, F: globalData, N: $author$project$Anim$Internal$Property$Rotate$speed, P: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Scale$default, D: $author$project$Anim$Internal$Property$Scale$distance, E: $author$project$Anim$Internal$Property$Scale$duration, F: globalData, N: $author$project$Anim$Internal$Property$Scale$speed, P: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Size$default, D: $author$project$Anim$Internal$Property$Size$distance, E: $author$project$Anim$Internal$Property$Size$duration, F: globalData, N: $author$project$Anim$Internal$Property$Size$speed, P: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Skew$default, D: $author$project$Anim$Internal$Property$Skew$distance, E: $author$project$Anim$Internal$Property$Skew$duration, F: globalData, N: $author$project$Anim$Internal$Property$Skew$speed, P: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{B: config, C: $author$project$Anim$Internal$Property$Translate$default, D: $author$project$Anim$Internal$Property$Translate$distance, E: $author$project$Anim$Internal$Property$Translate$duration, F: globalData, N: $author$project$Anim$Internal$Property$Translate$speed, P: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$init = function () {
	var initGroup = F3(
		function (builder, name, config) {
			...
			var discrete = {
				bH: $author$project$Anim$Internal$Builder$getDiscreteEntryProperties(builder),
				bI: $author$project$Anim$Internal$Builder$getDiscreteExitProperties(builder)
			};
			return A6(
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aC;
	if (_v1.$ === 1) {
		return {y: _List_Nil, p: data.b._};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{y: _List_Nil, p: data.b._},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {a8: $elm$core$Maybe$Nothing, bF: 0, ba: $elm$core$Maybe$Nothing, c: defaultEnd, aS: $elm$core$Maybe$Nothing, aT: $elm$core$Maybe$Nothing, bs: $elm$core$Maybe$Nothing};
};
var $author$project$Anim$Internal$Property$Size$fromTuple = function (_v0) {
	var width = _v0.a;
	var height = _v0.b;
	return {cn: height, s: width};
};
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.z.ay);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.z.bn);
	});
...
var $author$project$Anim$Property$Size$initHW = F4(
	function (animationKey, h, w, animBuilder) {
		return $author$project$Anim$Internal$Builder$Size$build(
			A3(
				$author$project$Anim$Internal$Builder$Size$toHW,
				h,
				w,
				A3(
					$author$project$Anim$Property$Size$fromHW,
					h,
					w,
					A2($author$project$Anim$Internal$Builder$Size$for, animationKey, animBuilder))));
	});
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$init = function () {
	var animState = $author$project$Anim$Engine$Keyframe$init(
		_List_fromArray(
			[
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Keyframe$ButtonHovers$Main$zButton, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth)
			]));
	return _Utils_Tuple2(
		{h: animState},
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aM: groupConfig, bc: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aM: groupConfig,
								bc: A2($elm$core$List$cons, existing.aM, existing.bc)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Engine$CSS$CSS$animate = F5(
	function (setPlayState, generateData, insertData, _v0, transform) {
		...
		var builder = transform(state.aA);
		...
		return A2(
			...
			setAllRunning(
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
					insertData(processedAnimData.bL),
					animGroups,
					A2(
						$author$project$Anim$Internal$Engine$Shared$AnimGroups$map,
						F2(
							function (animGroupName, config) {
								return A4(generateData, config.p, builder, animGroupName, config);
							}),
						processedAnimData.bL))));
	});
...
var $author$project$Anim$Property$Size$build = $author$project$Anim$Internal$Builder$Size$build;
...
var $author$project$Anim$Internal$Builder$Property$easing = F2(
	function (easing_, config) {
		return _Utils_update(
			config,
			{
				ba: $elm$core$Maybe$Just(easing_),
				aS: $elm$core$Maybe$Nothing
			});
	});
...
var $author$project$Anim$Property$Size$for = $author$project$Anim$Internal$Builder$Size$for;
var $author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration = 200;
var $author$project$Motion$Easing$CubicOut = {$: 14};
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$for($author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight + 6, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth + 20),
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				$author$project$Anim$Property$Size$build))));
...
var $author$project$Anim$Internal$Builder$getFrozenAxes = F2(
	function (propName, _v0) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, propName, data.e.am));
	});
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Keyframe$ButtonHovers$Main$zButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Property$Scale$build = $author$project$Anim$Internal$Builder$Scale$build;
...
var $author$project$Anim$Property$Scale$for = $author$project$Anim$Internal$Builder$Scale$for;
...
var $author$project$Motion$Easing$CubicIn = {$: 13};
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$for($author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton),
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				...
				$author$project$Anim$Property$Scale$build))));
...
var $author$project$Animation$Keyframe$ButtonHovers$Main$shrinkSize = A2(
	...
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonHeight, $author$project$Animation$Keyframe$ButtonHovers$Main$buttonWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Keyframe$ButtonHovers$Main$hoverDuration),
			A2(
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleUp)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleDown)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$growSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$shrinkSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$liftUp)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Keyframe$animate, model.h, $author$project$Animation$Keyframe$ButtonHovers$Main$setDown)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Anim$Internal$Engine$Keyframe$Animation$toCssString = function (_v0) {
	...
	return animation.bA + (' ' + ($elm$core$String$fromInt(animation.ch) + ('ms linear 0ms ' + (iterationString + (' ' + (directionString + ' forwards'))))));
};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {bV: true, b$: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {dJ: contactDetails, eo: isPrimary, eH: pointer, eI: pointerId, eJ: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {co: height, eK: pressure, fn: tiltX, fo: tiltY, c4: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dA: button, dE: clientPos, eq: keys, ex: offsetPos, eF: pagePos, eR: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {dj: alt, dL: ctrl, et: meta, eX: shift};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Scale', 0, 1, $author$project$Animation$Keyframe$ButtonHovers$Main$scaleButton, model.h),
						A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Size', 2, 3, $author$project$Animation$Keyframe$ButtonHovers$Main$sizeButton, model.h),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$Keyframe$ButtonHovers$Main$button, 'Translate Z', 4, 5, $author$project$Animation$Keyframe$ButtonHovers$Main$zButton, model.h)
							]))
					]))
			]));
};
var $author$project$Animation$Keyframe$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		e5: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		fw: $author$project$Animation$Keyframe$ButtonHovers$Main$update,
		fx: $author$project$Animation$Keyframe$ButtonHovers$Main$view
	});
