...
{
	if (region.aX.aT === region.f.aT)
	{
		return 'on line ' + region.aX.aT;
	}
	return 'on lines ' + region.aX.aT + ' through ' + region.f.aT;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ce: fragment, cj: host, cC: path, cE: port_, cH: protocol, cI: query};
	});
...
var $author$project$Motion$Easing$BounceInOut = {$: 8};
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$springKeyframes = F2(
	function (s, durationMs) {
		...
		var motion = {
			bI: 0,
			aW: $author$project$Motion$Internal$Spring$unwrap(s),
			bX: 1
		};
		return A2(
			$elm$core$List$map,
...
var $author$project$Anim$Internal$Property$Rotate$default = {b0: 0, b1: 0, b2: 0};
var $author$project$Anim$Internal$Property$Rotate$support = {
	c$: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {b0: a.b0 + b.b0, b1: a.b1 + b.b1, b2: a.b2 + b.b2};
		}),
	dY: $elm$core$Basics$identity,
	br: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {b0: angles.b0 * factor, b1: angles.b1 * factor, b2: angles.b2 * factor};
		}),
	e_: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fp: $author$project$Anim$Internal$Property$Rotate$default
};
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.fg(coord);
		return _Utils_Tuple3(record.b0, record.b1, record.b2);
	});
...
var $author$project$Anim$Internal$Property$Scale$default = {b0: 1.0, b1: 1.0, b2: 1.0};
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	br: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {b0: coords.b0 * factor, b1: coords.b1 * factor, b2: coords.b2 * factor};
		}),
	e_: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fp: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$default = {b0: 0, b1: 0, b2: 0};
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fp: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.u, dimensions.a);
};
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.b0, values.b1);
};
		...
		switch (property.$) {
									...
									_Utils_ap(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'duration',
												$elm$json$Json$Encode$int(config.cb))
											]),
										_Utils_ap(
											startValue,
											A3($author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeEasingWithKeyframes, config.cb, config.bf, config.aW))))))));
			case 1:
				var cssName = property.a;
			...
			case 2:
				...
				var startValue = A2(
					$elm$core$Maybe$withDefault,
					1.0,
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Opacity$toFloat, config.aX));
				return $elm$json$Json$Encode$object(
					A2(
						$elm$core$List$cons,
						_Utils_Tuple2(
			...
			case 3:
				...
				var _v1 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(50, 50),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$PerspectiveOrigin$toTuple, config.aX));
				var startX = _v1.a;
				var startY = _v1.b;
				...
				var startFields = function () {
					if (!maybeVersions.$) {
						...
						var _v10 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(0, 0),
							A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Skew$toTuple, config.aX));
						var startX = _v10.a;
						var startY = _v10.b;
						return _List_fromArray(
							[
			...
			case 6:
				...
				var _v11 = A2(
					$elm$core$Maybe$withDefault,
					_Utils_Tuple2(0, 0),
					A2($elm$core$Maybe$map, $author$project$Anim$Internal$Property$Size$toTuple, config.aX));
...
var $author$project$Anim$Internal$Builder$getAnimTarget = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.n.a_);
	});
...
var $author$project$Anim$Internal$Property$Size$default = {a: 0, u: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {b0: 0, b1: 0};
...
var $author$project$Anim$Internal$Extra$Color$hslToRgb = function (hslValue) {
	var s = hslValue.c / 100;
	var l = hslValue.b / 100;
	var c = (1 - $elm$core$Basics$abs((2 * l) - 1)) * s;
	var m = l - (c / 2);
	var x = c * (1 - $elm$core$Basics$abs(
		A2($author$project$Anim$Internal$Extra$Color$floatMod, hslValue.a / 60, 2) - 1));
	var _v0 = (hslValue.a < 60) ? _Utils_Tuple3(c, x, 0) : ((hslValue.a < 120) ? _Utils_Tuple3(x, c, 0) : ((hslValue.a < 180) ? _Utils_Tuple3(0, c, x) : ((hslValue.a < 240) ? _Utils_Tuple3(0, x, c) : ((hslValue.a < 300) ? _Utils_Tuple3(x, 0, c) : _Utils_Tuple3(c, 0, x)))));
	var r1 = _v0.a;
	var g1 = _v0.b;
	var b1 = _v0.c;
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {dd: rgba_.dd, d_: rgba_.d_, eC: rgba_.eC};
		case 3:
			var hsl_ = color.a;
		...
		case 4:
			...
			return $author$project$Anim$Internal$Extra$Color$hslToRgb(
				{a: hsla_.a, b: hsla_.b, c: hsla_.c});
		default:
			var elmColor_ = color.a;
			var rgba_ = $avh4$elm_color$Color$toRgba(elmColor_);
			return {
				dd: $elm$core$Basics$round(rgba_.bD * 255),
				d_: $elm$core$Basics$round(rgba_.bJ * 255),
				eC: $elm$core$Basics$round(rgba_.bT * 255)
			};
	}
};
var $author$project$Anim$Internal$Extra$Color$distance = F2(
	function (color1, color2) {
		...
		var dr = rgb2.eC - rgb1.eC;
		var dg = rgb2.d_ - rgb1.d_;
		var db = rgb2.dd - rgb1.dd;
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fg(coord2);
		var record1 = support.fg(coord1);
		var dz = $elm$core$Basics$abs(record2.b2 - record1.b2);
		var dy = $elm$core$Basics$abs(record2.b1 - record1.b1);
		var dx = $elm$core$Basics$abs(record2.b0 - record1.b0);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	var config = _v0.D;
	var globalData = _v0.H;
	var defaultStart = _v0.E;
	var distanceFn = _v0.F;
	var durationFn = _v0.G;
	var speedFn = _v0.Q;
	var wrapper = _v0.S;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.aX);
	...
	return wrapper(
		{
			bd: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.bd, globalData.W, 0),
			bG: distance_,
			cb: $elm$core$Basics$round(duration_),
			bf: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.bf, globalData.I, $author$project$Motion$Easing$EaseInOut),
			f: config.f,
			cO: speed_,
			aW: resolvedSpring,
			aX: config.aX,
	...
	function (globalData, property) {
		switch (property.$) {
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							G: $author$project$Shared$TimeSpec$duration,
							H: globalData,
			...
			case 1:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							D: config,
							E: $author$project$Anim$Internal$Extra$Color$transparent,
							F: $author$project$Anim$Internal$Extra$Color$distance,
							G: $author$project$Anim$Internal$Extra$Color$duration,
							H: globalData,
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							D: config,
							E: $author$project$Anim$Internal$Property$Opacity$fromFloat(1.0),
							F: $author$project$Anim$Internal$Property$Opacity$distance,
							G: $author$project$Anim$Internal$Property$Opacity$duration,
							H: globalData,
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, F: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, G: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, H: globalData, Q: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, S: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$Rotate$default, F: $author$project$Anim$Internal$Property$Rotate$distance, G: $author$project$Anim$Internal$Property$Rotate$duration, H: globalData, Q: $author$project$Anim$Internal$Property$Rotate$speed, S: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$Scale$default, F: $author$project$Anim$Internal$Property$Scale$distance, G: $author$project$Anim$Internal$Property$Scale$duration, H: globalData, Q: $author$project$Anim$Internal$Property$Scale$speed, S: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$Size$default, F: $author$project$Anim$Internal$Property$Size$distance, G: $author$project$Anim$Internal$Property$Size$duration, H: globalData, Q: $author$project$Anim$Internal$Property$Size$speed, S: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$Skew$default, F: $author$project$Anim$Internal$Property$Skew$distance, G: $author$project$Anim$Internal$Property$Skew$duration, H: globalData, Q: $author$project$Anim$Internal$Property$Skew$speed, S: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{D: config, E: $author$project$Anim$Internal$Property$Translate$default, F: $author$project$Anim$Internal$Property$Translate$distance, G: $author$project$Anim$Internal$Property$Translate$duration, H: globalData, Q: $author$project$Anim$Internal$Property$Translate$speed, S: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
	...
	return {
		...
		bK: A2(
			...
			F2(
				function (_v1, group) {
					return {
						A: A2($author$project$Anim$Internal$Builder$processProperties, data.e, group.A),
						r: function () {
							var _v2 = group.r;
							if (!_v2.$) {
								return group.r;
...
var $author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeView = function (builder) {
	...
	var elements = A2(
		...
		$author$project$Anim$Internal$Engine$Shared$AnimGroups$toList(processed.bK));
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'iterations',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeIterations(processed.ag)),
					_Utils_Tuple2(
					'direction',
					$author$project$Anim$Internal$Engine$WAAPI$Encoder$encodeAnimationDirection(processed.an))
				]),
...
var $author$project$Anim$Internal$Builder$initAnimation = {z: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aG: $elm$core$Maybe$Nothing, at: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$initDefaults = {W: $elm$core$Maybe$Nothing, I: $elm$core$Maybe$Nothing, X: $elm$core$Maybe$Nothing, J: $elm$core$Maybe$Nothing, af: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {an: 0, aH: $elm$core$Dict$empty, aI: $elm$core$Dict$empty, aS: false, ag: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a5: $elm$core$Maybe$Nothing, bt: $elm$core$Maybe$Nothing, a_: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {aD: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aE: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bq: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{h: $author$project$Anim$Internal$Builder$initAnimation, e: $author$project$Anim$Internal$Builder$initDefaults, i: $author$project$Anim$Internal$Builder$initPlayback, n: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, B: $author$project$Anim$Internal$Builder$initState});
...
var $author$project$Animation$ViewTimeline$Main$cards = _List_fromArray(
	[
		{T: 'view-card-1', ab: 'Each card uses a ViewTimeline tied to itself as the scroll subject. As the card enters the viewport, it fades in and slides upward.', ac: '#6366f1', ah: '01', al: 'Enter from below'},
		{T: 'view-card-2', ab: 'Every card has its own ViewTimeline. Animations are fully independent - each one triggers only when that specific card enters the viewport.', ac: '#8b5cf6', ah: '02', al: 'Independent timelines'},
		{T: 'view-card-3', ab: 'The rangeStart and rangeEnd functions define exactly when during the card\'s lifecycle the animation plays - entry, cover, contain, or exit.', ac: '#a78bfa', ah: '03', al: 'Range control'},
		{T: 'view-card-4', ab: 'View timeline animations are fire-and-forget. No AnimState required - just call ViewTimeline.animate in your init and the browser handles the rest.', ac: '#7c3aed', ah: '04', al: 'Fire and forget'},
		{T: 'view-card-5', ab: 'Combine opacity and translate in a single pipeline to create polished reveal effects with minimal code.', ac: '#5b21b6', ah: '05', al: 'Composable builders'},
		{T: 'view-card-6', ab: 'All animations run via the Web Animations API on the compositor thread - no JavaScript timers, no Elm subscriptions, maximum performance.', ac: '#4c1d95', ah: '06', al: 'WAAPI powered'}
	]);
		...
		return _Utils_update(
			data,
			{
				e: _Utils_update(
					defs,
					{
						I: $elm$core$Maybe$Just(easingValue),
						X: $elm$core$Maybe$Nothing
					})
			});
	});
var $author$project$Anim$Internal$Engine$ViewTimeline$easing = $author$project$Anim$Internal$Builder$easing;
var $author$project$Anim$Engine$ViewTimeline$easing = $author$project$Anim$Internal$Engine$ViewTimeline$easing;
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.h.aG;
	if (_v1.$ === 1) {
		return {A: _List_Nil, r: data.e.af};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{A: _List_Nil, r: data.e.af},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.h.z)));
	}
};
...
var $author$project$Anim$Internal$Builder$updateCurrentConfig = F2(
	function (config, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var animKey = _v1.a;
			var newPropertyTypes = A2($elm$core$List$map, $author$project$Anim$Internal$Builder$propertyType, config.A);
			var anim = data.h;
			var mergedConfig = function () {
				...
				if (!_v2.$) {
					...
					return _Utils_update(
						existing,
						{
							A: _Utils_ap(filteredExisting, config.A),
							r: mergedOrder
						});
				} else {
					return config;
...
var $author$project$Anim$Internal$Builder$getFrozenAxes = F2(
	function (propName, _v0) {
		...
		return A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2($elm$core$Dict$get, propName, data.h.at));
	});
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						b0: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.b0 : endRecord.b0,
						b1: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.b1 : endRecord.b1,
						b2: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.b2 : endRecord.b2
					});
				return _Utils_update(
					config,
					{
						bG: A2(calcDistance, startVal, end),
						f: end
					});
			}
		}
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {bd: $elm$core$Maybe$Nothing, bG: 0, bf: $elm$core$Maybe$Nothing, f: defaultEnd, aW: $elm$core$Maybe$Nothing, aX: $elm$core$Maybe$Nothing, bv: $elm$core$Maybe$Nothing};
};
		...
		return _Utils_update(
			data,
			{
				h: _Utils_update(
					anim,
					{
						aG: $elm$core$Maybe$Just(elementId)
					})
			});
	});
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.h.z);
	});
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.B.aE);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.B.bq);
	});
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								f: baseline,
								aX: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v1.a.a;
					var _v2 = _v1.b;
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								f: baseline,
								aX: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v4 = _v1.a;
					var _v5 = _v1.b;
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					aX: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.aX);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.aX);
		return A4(
...
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.aX);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					bG: A2($author$project$Anim$Internal$Property$Opacity$distance, startPos, endPos),
					f: endPos,
					aX: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Translate$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startVal = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Translate$default, config.aX);
		return A2(
			$author$project$Anim$Internal$Builder$Translate$TranslateBuilder,
			_Utils_update(
				config,
				{
					bG: A2($author$project$Anim$Internal$Property$Translate$distance, startVal, value),
					f: value,
					aX: $elm$core$Maybe$Just(startVal)
				}),
			builder);
	});
...
var $author$project$Animation$ViewTimeline$Main$revealCard = function (animGroupName) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$for(animGroupName),
		A2(
			$elm$core$Basics$composeR,
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						$author$project$Anim$Property$Translate$for(animGroupName),
						A2(
							$elm$core$Basics$composeR,
					...
					A2(
						...
						A2(
							...
							A2(
								...
								$author$project$Animation$ViewTimeline$Main$revealCard(card.T)))));
			},
...
var $author$project$Animation$ViewTimeline$Main$cardView = function (card) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			$author$project$Anim$Engine$ViewTimeline$attributes(card.T),
			_List_fromArray(
				[
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'color', card.ac),
...
var $author$project$Animation$ViewTimeline$Main$main = $elm$browser$Browser$element(
	{
		...
		fn: $author$project$Animation$ViewTimeline$Main$view
	});
