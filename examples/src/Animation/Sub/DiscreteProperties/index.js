...
var $author$project$Animation$Sub$DiscreteProperties$Main$animGroup = 'boxAnim';
		...
		A: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					...
					A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$DiscreteProperties$Main$animGroup, 1))
				]))
	},
...
var $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$DiscreteProperties$Main$GotSubMsg, model.A);
};
...
var $author$project$Animation$Sub$DiscreteProperties$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$Sub$DiscreteProperties$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$DiscreteProperties$Main$animGroup, model.A),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$DiscreteProperties$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$DiscreteProperties$Main$subscriptions,
		ft: $author$project$Animation$Sub$DiscreteProperties$Main$update,
		fu: $author$project$Animation$Sub$DiscreteProperties$Main$view
	});
