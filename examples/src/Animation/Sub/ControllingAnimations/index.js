...
{
	if (region.aS.aN === region.c.aN)
	{
		return 'on line ' + region.aS.aN;
	}
	return 'on lines ' + region.aS.aN + ' through ' + region.c.aN;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d6: 'hidden', dv: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d6: 'mozHidden', dv: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d6: 'msHidden', dv: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d6: 'webkitHidden', dv: 'webkitvisibilitychange' }
		: { d6: 'hidden', dv: 'visibilitychange' };
}
...
var $author$project$Anim$Internal$Builder$initAnimation = {y: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, az: $elm$core$Maybe$Nothing, an: $elm$core$Dict$empty};
var $author$project$Anim$Internal$Builder$clearAnimData = function (_v0) {
	...
	return _Utils_update(
		data,
		{
			...
			f: _Utils_update(
				pb,
				{aA: $elm$core$Dict$empty, aB: $elm$core$Dict$empty})
		});
};
...
var $author$project$Anim$Internal$Builder$initPlayback = {ah: 0, aA: $elm$core$Dict$empty, aB: $elm$core$Dict$empty, aM: false, ac: $author$project$Anim$Internal$Builder$Once};
var $author$project$Anim$Internal$Builder$initScrollDrivenConfig = {a$: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, aU: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bt: $elm$core$Maybe$Nothing, bu: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initState = {av: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aw: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, bl: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init};
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{e: $author$project$Anim$Internal$Builder$initAnimation, b: $author$project$Anim$Internal$Builder$initDefaults, f: $author$project$Anim$Internal$Builder$initPlayback, l: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, A: $author$project$Anim$Internal$Builder$initState});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {ah: 0, aJ: $author$project$Anim$Internal$Engine$Sub$Animations$init, bz: 0, bA: $elm$core$Dict$empty, bB: $elm$core$Dict$empty, ac: $author$project$Anim$Internal$Builder$Once, aO: 0, q: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Rotate$default = {bX: 0, bY: 0, bZ: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {bX: 1.0, bY: 1.0, bZ: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cf: 0, t: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {bX: 0, bY: 0};
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {bX: 0, bY: 0, bZ: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {b2: rgba_.b2, ce: rgba_.ce, cK: rgba_.cK};
		case 3:
			var hsl_ = color.a;
		...
		default:
			...
			return {
				b2: $elm$core$Basics$round(rgba_.by * 255),
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		...
		var dz = $elm$core$Basics$abs(record2.bZ - record1.bZ);
		var dy = $elm$core$Basics$abs(record2.bY - record1.bY);
		var dx = $elm$core$Basics$abs(record2.bX - record1.bX);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	c2: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {bX: a.bX + b.bX, bY: a.bY + b.bY, bZ: a.bZ + b.bZ};
		}),
	d2: $elm$core$Basics$identity,
	bm: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {bX: angles.bX * factor, bY: angles.bY * factor, bZ: angles.bZ * factor};
		}),
	e4: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fx: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bm: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {bX: coords.bX * factor, bY: coords.bY * factor, bZ: coords.bZ * factor};
		}),
	e4: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fx: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.bX, values.bY);
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fx: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var x0 = from - to;
	var v0 = spring.aD;
	var m = A2($elm$core$Basics$max, 1.0e-6, spring.eo);
	var k = A2($elm$core$Basics$max, 0, spring.e0);
	var omega0 = $elm$core$Basics$sqrt(k / m);
	var c = A2($elm$core$Basics$max, 0, spring.dH);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	return wrapper(
		{
			a7: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.a7, globalData.T, 0),
			bC: distance_,
			b8: $elm$core$Basics$round(duration_),
			a9: A3($author$project$Anim$Internal$Builder$resolveEasingWithDefault, config.a9, globalData.H, $author$project$Motion$Easing$EaseInOut),
			c: config.c,
			cR: speed_,
			aR: resolvedSpring,
			aS: config.aS,
			...
			function (_default, config) {
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.a9);
					}
				}();
				return {
					dJ: config.a7,
					...
					c: config.c,
					bK: isComplete,
					aS: A2($elm$core$Maybe$withDefault, _default, config.aS),
					fr: durationMs
				};
			});
	...
	var newState = _Utils_update(
		state,
		{
			aw: A6(
				...
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$toDict(state.aw),
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						bX: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.bX : endRecord.bX,
						bY: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.bY : endRecord.bY,
						bZ: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.bZ : endRecord.bZ
					});
				return _Utils_update(
					config,
					{
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {a7: $elm$core$Maybe$Nothing, bC: 0, a9: $elm$core$Maybe$Nothing, c: defaultEnd, aR: $elm$core$Maybe$Nothing, aS: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing};
};
		...
		return _Utils_update(
			data,
			{
				e: _Utils_update(
					anim,
					{
						az: $elm$core$Maybe$Just(elementId)
					})
			});
	});
...
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.A.aw);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.A.bl);
	});
...
var $author$project$Anim$Internal$Builder$Translate$fromXY = F3(
	function (x, y, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.aS);
		return A4(
...
var $author$project$Anim$Internal$Builder$Translate$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startVal = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Translate$default, config.aS);
		return A2(
			$author$project$Anim$Internal$Builder$Translate$TranslateBuilder,
			_Utils_update(
				config,
				{
					bC: A2($author$project$Anim$Internal$Property$Translate$distance, startVal, value),
					c: value,
					aS: $elm$core$Maybe$Just(startVal)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$ControllingAnimations$Main$init = function (_v0) {
	var window = _v0.c$;
	var animAreaWidth = A2($elm$core$Basics$min, 500, window.cY - 40);
	var xPos = (animAreaWidth / 2) - 25;
	return _Utils_Tuple2(
		{
			h: $author$project$Anim$Engine$Sub$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, xPos, 50)
					]))
		},
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bN: oldTime, cM: request, cS: subs};
	});
...
var $author$project$Animation$Sub$ControllingAnimations$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$ControllingAnimations$Main$GotSubMsg, model.h);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				aJ: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.aJ)
			});
	});
				...
				function (animGroupName, groupConfig, _v1) {
					...
					var updatedHistory = function () {
						if (existingHistory.$ === 1) {
							return {aL: groupConfig, bb: _List_Nil};
						} else {
							var existing = existingHistory.a;
							return {
								aL: groupConfig,
								bb: A2($elm$core$List$cons, existing.aL, existing.bb)
							};
						}
					}();
					return _Utils_update(
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cf: hNormalized, co: l * 100, cN: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {b2: rgba_.b2, ce: rgba_.ce, cK: rgba_.cK};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {b_: rgba_.b_, cf: hsla_.cf, co: hsla_.co, cN: hsla_.cN};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cf: hslaValue.cf, co: hslaValue.co, cN: hslaValue.cN};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b_: 1.0, cf: hslValue.cf, co: hslValue.co, cN: hslValue.cN};
	}
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cf: hslaValue.cf, co: hslaValue.co, cN: hslaValue.cN});
	return {b_: hslaValue.b_, b2: rgb_.b2, ce: rgb_.ce, cK: rgb_.cK};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b_: 1.0, b2: rgb_.b2, ce: rgb_.ce, cK: rgb_.cK};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.ce + ((endRgb.ce - startRgb.ce) * t));
							var r = $elm$core$Basics$round(startRgb.cK + ((endRgb.cK - startRgb.cK) * t));
							var b = $elm$core$Basics$round(startRgb.b2 + ((endRgb.b2 - startRgb.b2) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{b2: b, ce: g, cK: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.cK + ((endRgba.cK - startRgba.cK) * t));
							var g = $elm$core$Basics$round(startRgba.ce + ((endRgba.ce - startRgba.ce) * t));
							var b = $elm$core$Basics$round(startRgba.b2 + ((endRgba.b2 - startRgba.b2) * t));
							var a = startRgba.b_ + ((endRgba.b_ - startRgba.b_) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.cN + ((endHsl.cN - startHsl.cN) * t);
							var l = startHsl.co + ((endHsl.co - startHsl.co) * t);
							var h = startHsl.cf + ((endHsl.cf - startHsl.cf) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.cN + ((endHsla.cN - startHsla.cN) * t);
							var l = startHsla.co + ((endHsla.co - startHsla.co) * t);
							var h = startHsla.cf + ((endHsla.cf - startHsla.cf) * t);
							var a = startHsla.b_ + ((endHsla.b_ - startHsla.b_) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.bK || (timing.fr <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.b9 - timing.dJ);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.fr);
	}
};
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		var easedProgress = anim.dQ(
			$author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress(anim));
		return A3(interpolate, easedProgress, anim.aS, anim.c);
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		...
		return _Utils_Tuple3(record.bX, record.bY, record.bZ);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.t, dimensions.cf);
};
...
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var startedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.bG));
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aj: $author$project$Anim$Internal$Builder$clearAnimData(
			...
			A3(
				...
				insertAnimGroup,
				animGroups,
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$map, generateAnimGroup, processed.bG)));
	});
...
var $author$project$Motion$Spring$custom = function (_v0) {
	var stiffness = _v0.e0;
	var damping = _v0.dH;
	var mass = _v0.eo;
	return {
		dH: A2($elm$core$Basics$max, 0, damping),
		aD: 0,
		eo: A2($elm$core$Basics$max, 1.0e-6, mass),
		e0: A2($elm$core$Basics$max, 0, stiffness)
	};
};
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.aS);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.aS);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Internal$Builder$Property$spring = F2(
	function (spring_, config) {
		return _Utils_update(
			...
			{
				a9: $elm$core$Maybe$Nothing,
				aR: $elm$core$Maybe$Just(spring_)
			});
	});
...
var $author$project$Animation$Sub$ControllingAnimations$Main$dropBall = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Sub$ControllingAnimations$Main$animGroup),
	A2(
		$elm$core$Basics$composeR,
		...
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$Translate$speed(20),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Anim$Property$Translate$spring(
						$author$project$Motion$Spring$custom(
							{dH: 10, eo: 10, e0: 400})),
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(group.aO);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {dJ: anim.dJ, b9: anim.b9, bK: anim.bK, fr: anim.fr};
};
		...
		if (_v1.$ === 1) {
			...
			return A2(
				...
				_Utils_update(
					state,
					{
						p: $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning(animGroup) ? _Utils_ap(
							state.p,
							_List_fromArray(
								[
									A2(
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{dJ: timing.dJ, b9: timing.b9, bK: timing.bK, fr: timing.fr});
	});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(group.aO);
};
var $author$project$Anim$Internal$Engine$Sub$resume = F2(
	function (animGroupName, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var animGroup = _v1.a;
			var wasPaused = $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused(animGroup);
			var newPendingControlEvents = wasPaused ? _Utils_ap(
				state.p,
				_List_fromArray(
					[
			...
			return A2(
				...
				_Utils_update(
					state,
					{p: newPendingControlEvents, X: true}),
				A3(
					$author$project$Anim$Internal$Engine$Shared$AnimGroups$update,
					animGroupName,
					$elm$core$Maybe$map(
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.bK) {
				...
				var newElapsedMs = timing.b9 + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.dJ);
				return _Utils_update(
					timing,
					{
						b9: newElapsedMs,
						bK: _Utils_cmp(animationElapsedMs, timing.fr) > -1
					});
			}
		});
};
...
var $author$project$Animation$Sub$ControllingAnimations$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 6:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.h);
			...
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$animate, model.h, $author$project$Animation$Sub$ControllingAnimations$Main$dropBall)
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$stop, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, model.h)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$pause, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, model.h)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$resume, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, model.h)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$reset, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, model.h)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							h: A2($author$project$Anim$Engine$Sub$restart, $author$project$Animation$Sub$ControllingAnimations$Main$animGroup, model.h)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Anim$Internal$Property$Rotate$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!angles.bX)) ? $elm$core$Maybe$Just(
				'rotateX(' + ($elm$core$String$fromFloat(angles.bX) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.bY)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.bY) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.bZ)) ? $elm$core$Maybe$Just(
				'rotateZ(' + ($elm$core$String$fromFloat(angles.bZ) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
...
var $author$project$Anim$Internal$Property$Skew$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!values.bX)) ? $elm$core$Maybe$Just(
				'skewX(' + ($elm$core$String$fromFloat(values.bX) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.bY)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.bY) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = function (_v0) {
	var coords = _v0;
	return 'translate3d(' + ($elm$core$String$fromFloat(coords.bX) + ('px, ' + ($elm$core$String$fromFloat(coords.bY) + ('px, ' + ($elm$core$String$fromFloat(coords.bZ) + 'px)')))));
};
		...
		switch (anim.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						br: $author$project$Anim$Internal$Property$Translate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateTranslate, a))
					});
			case 4:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bj: $author$project$Anim$Internal$Property$Rotate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateRotate, a))
					});
			case 7:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bn: $author$project$Anim$Internal$Property$Skew$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateSkew, a))
					});
			case 5:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bm: $author$project$Anim$Internal$Property$Scale$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateScale, a))
					});
			default:
				return acc;
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isComplete = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(group.aO);
};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bj: '', bm: '', bn: '', br: ''};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Sub$ControllingAnimations$Main$animationArea(model.h)
			]));
};
var $author$project$Animation$Sub$ControllingAnimations$Main$main = $elm$browser$Browser$element(
	{ed: $author$project$Animation$Sub$ControllingAnimations$Main$init, e3: $author$project$Animation$Sub$ControllingAnimations$Main$subscriptions, fu: $author$project$Animation$Sub$ControllingAnimations$Main$update, fv: $author$project$Animation$Sub$ControllingAnimations$Main$view});
