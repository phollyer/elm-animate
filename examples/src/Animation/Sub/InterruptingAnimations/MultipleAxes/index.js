...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth = 100;
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$init = function (_v0) {
	var width = _v0.c$;
	var height = _v0.cj;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			o: $author$project$Anim$Engine$Sub$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName, (w - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2, (h - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth) / 2)
					])),
			cj: h,
			c$: w
		},
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$GotAnimationUpdate, model.o);
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveDown = function (height) {
	return $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toY(height - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveLeft = $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
	$author$project$Anim$Property$Translate$toX(0));
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveRight = function (width) {
	return $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
		$author$project$Anim$Property$Translate$toX(width - $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth));
};
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveUp = $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveBox(
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveLeft)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2(
								...
								model.o,
								$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveRight(model.c$))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveUp)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2(
								$author$project$Anim$Engine$Sub$animate,
								model.o,
								$author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$moveDown(model.cj))
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$view = function (model) {
	...
	var box = A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$animGroupName, model.o),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$boxWidth) + 'px'),
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$main = $elm$browser$Browser$element(
	{ee: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$init, e2: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$subscriptions, ft: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$update, fu: $author$project$Animation$Sub$InterruptingAnimations$MultipleAxes$Main$view});
