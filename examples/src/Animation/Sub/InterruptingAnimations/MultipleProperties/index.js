...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth = 100;
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aC;
	if (_v1.$ === 1) {
		return {z: _List_Nil, p: data.b.ab};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{z: _List_Nil, p: data.b.ab},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$init = function (_v0) {
	var width = _v0.c$;
	var height = _v0.cj;
	var w = width - 20;
	var h = height - 75;
	return _Utils_Tuple2(
		{
			t: $author$project$Anim$Engine$Sub$init(
				_List_fromArray(
					[
						A3($author$project$Anim$Property$Translate$initXY, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, (w - $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth) / 2, (h - $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth) / 2),
						A3(
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$GotAnimationUpdate, model.t);
};
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$changeColor = function (color) {
	return A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, $author$project$Anim$Property$CustomColor$BackgroundColor),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				...
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animationMsg, model.t);
					...
					_Utils_update(
						model,
						{
							t: A2(
								...
								model.t,
								$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBox(
					...
					_Utils_update(
						model,
						{
							t: A2(
								...
								model.t,
								$author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$moveBox(
									$author$project$Anim$Property$Translate$toX(model.c$ - $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth)))
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var color = msg.a;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$animGroupName, model.t),
					_List_fromArray(
						[
							A2(
							$elm$html$Html$Attributes$style,
							'width',
							$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth) + 'px'),
							A2(
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat($author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$boxWidth) + 'px'),
...
var $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$main = $elm$browser$Browser$element(
	{ee: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$init, e2: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$subscriptions, ft: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$update, fu: $author$project$Animation$Sub$InterruptingAnimations$MultipleProperties$Main$view});
