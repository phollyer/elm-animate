...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$GotAnimationUpdate, model.o);
};
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$colorBox = function (moveFunc) {
	return A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName, $author$project$Anim$Property$CustomColor$BackgroundColor),
		A2(
			$elm$core$Basics$composeR,
			moveFunc,
			A2(
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor1)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor2)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor3)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: A2($author$project$Anim$Engine$Sub$animate, model.o, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$toColor4)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$div,
				_Utils_ap(
					A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$animGroupName, model.o),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$main = $elm$browser$Browser$element(
	{
		ee: $elm$core$Basics$always($author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$init),
		e2: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$subscriptions,
		ft: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$update,
		fu: $author$project$Animation$Sub$InterruptingAnimations$SingleProperty$Main$view
	});
