...
{
	if (region.a_.aV === region.e.aV)
	{
		return 'on line ' + region.a_.aV;
	}
	return 'on lines ' + region.a_.aV + ' through ' + region.e.aV;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ec: 'hidden', dC: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ec: 'mozHidden', dC: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ec: 'msHidden', dC: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ec: 'webkitHidden', dC: 'webkitvisibilitychange' }
		: { ec: 'hidden', dC: 'visibilitychange' };
}
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				aR: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.aR)
			});
	});
...
var $author$project$Anim$Internal$Builder$initAnimation = {B: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aI: $elm$core$Maybe$Nothing, au: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {an: 0, aR: $author$project$Anim$Internal$Engine$Sub$Animations$init, bH: 0, bI: $elm$core$Dict$empty, bJ: $elm$core$Dict$empty, ai: $author$project$Anim$Internal$Builder$Once, aW: 0, u: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Rotate$default = {b3: 0, b4: 0, b5: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {b3: 1.0, b4: 1.0, b5: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cn: 0, x: 0};
var $author$project$Anim$Internal$Property$Skew$Skew = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Skew$default = {b3: 0, b4: 0};
var $author$project$Anim$Internal$Property$Translate$Translate = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Translate$default = {b3: 0, b4: 0, b5: 0};
	...
	if ($elm$core$Basics$abs(zeta - 1.0) < 1.0e-4) {
		...
		if (zeta < 1.0) {
			...
			return $author$project$Shared$Spring$Underdamped(
				{b6: x0, ca: (v0 + ((zeta * omega0) * x0)) / omegaD, N: omega0, bm: omegaD, a5: zeta});
		} else {
			...
			function (_default, config) {
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bi);
					}
				}();
				return {
					dP: config.bg,
					...
					e: config.e,
					bS: isComplete,
					a_: A2($elm$core$Maybe$withDefault, _default, config.a_),
					fv: durationMs
				};
			});
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {ca: rgba_.ca, cm: rgba_.cm, cS: rgba_.cS};
		case 3:
			var hsl_ = color.a;
		...
		default:
			...
			return {
				ca: $elm$core$Basics$round(rgba_.bG * 255),
				cm: $elm$core$Basics$round(rgba_.bN * 255),
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		...
		var dy = $elm$core$Basics$abs(record2.b4 - record1.b4);
		var dx = $elm$core$Basics$abs(record2.b3 - record1.b3);
		return A2(
			$elm$core$Basics$max,
			dx,
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	da: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {b3: a.b3 + b.b3, b4: a.b4 + b.b4, b5: a.b5 + b.b5};
		}),
	d8: $elm$core$Basics$identity,
	bu: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {b3: angles.b3 * factor, b4: angles.b4 * factor, b5: angles.b5 * factor};
		}),
	e8: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fB: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bu: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {b3: coords.b3 * factor, b4: coords.b4 * factor, b5: coords.b5 * factor};
		}),
	e8: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fB: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Skew$toTuple = function (_v0) {
	var values = _v0;
	return _Utils_Tuple2(values.b3, values.b4);
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fB: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cn: hNormalized, cw: l * 100, cV: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {ca: rgba_.ca, cm: rgba_.cm, cS: rgba_.cS};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {b6: rgba_.b6, cn: hsla_.cn, cw: hsla_.cw, cV: hsla_.cV};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cn: hslaValue.cn, cw: hslaValue.cw, cV: hslaValue.cV};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b6: 1.0, cn: hslValue.cn, cw: hslValue.cw, cV: hslValue.cV};
	}
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cn: hslaValue.cn, cw: hslaValue.cw, cV: hslaValue.cV});
	return {b6: hslaValue.b6, ca: rgb_.ca, cm: rgb_.cm, cS: rgb_.cS};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b6: 1.0, ca: rgb_.ca, cm: rgb_.cm, cS: rgb_.cS};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cm + ((endRgb.cm - startRgb.cm) * t));
							var r = $elm$core$Basics$round(startRgb.cS + ((endRgb.cS - startRgb.cS) * t));
							var b = $elm$core$Basics$round(startRgb.ca + ((endRgb.ca - startRgb.ca) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{ca: b, cm: g, cS: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.cS + ((endRgba.cS - startRgba.cS) * t));
							var g = $elm$core$Basics$round(startRgba.cm + ((endRgba.cm - startRgba.cm) * t));
							var b = $elm$core$Basics$round(startRgba.ca + ((endRgba.ca - startRgba.ca) * t));
							var a = startRgba.b6 + ((endRgba.b6 - startRgba.b6) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.cV + ((endHsl.cV - startHsl.cV) * t);
							var l = startHsl.cw + ((endHsl.cw - startHsl.cw) * t);
							var h = startHsl.cn + ((endHsl.cn - startHsl.cn) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.cV + ((endHsla.cV - startHsla.cV) * t);
							var l = startHsla.cw + ((endHsla.cw - startHsla.cw) * t);
							var h = startHsla.cn + ((endHsla.cn - startHsla.cn) * t);
							var a = startHsla.b6 + ((endHsla.b6 - startHsla.b6) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.bS || (timing.fv <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.ch - timing.dP);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.fv);
	}
};
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		var easedProgress = anim.dW(
			$author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress(anim));
		return A3(interpolate, easedProgress, anim.a_, anim.e);
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.fr(coord);
		return _Utils_Tuple3(record.b3, record.b4, record.b5);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.x, dimensions.cn);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					eM: $author$project$Anim$Internal$Engine$Sub$extractElementCurrentStates(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var startedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.bO));
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ap: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Animation$Sub$Animate3D$Main$backFace = {
	...
	i: 'back-face',
	p: 'BACK',
	d: {ae: 'rgb(0,0 ,0   )', a: 'backFaceTextAnim', i: 'back-face-text', p: 'BACK'}
};
var $author$project$Animation$Sub$Animate3D$Main$bottomFace = {
	...
	i: 'bottom-face',
	p: 'BOTTOM',
	d: {ae: 'rgb(0,0 ,0   )', a: 'bottomFaceTextAnim', i: 'bottom-face-text', p: 'BOTTOM'}
};
var $author$project$Animation$Sub$Animate3D$Main$cube = {a: 'cubeAnim', i: 'cube', aB: 100};
var $author$project$Animation$Sub$Animate3D$Main$depth = $author$project$Animation$Sub$Animate3D$Main$cube.aB / 2;
var $author$project$Animation$Sub$Animate3D$Main$frontFace = {
	...
	i: 'front-face',
	p: 'FRONT',
	d: {ae: 'rgb(0,0 ,0   )', a: 'frontFaceTextAnim', i: 'front-face-text', p: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initPlayback = {an: 0, aJ: $elm$core$Dict$empty, aK: $elm$core$Dict$empty, aU: false, ai: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{g: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, h: $author$project$Anim$Internal$Builder$initPlayback, n: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, D: $author$project$Anim$Internal$Builder$initState});
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ap: $author$project$Anim$Internal$Builder$init(_List_Nil),
				t: _List_Nil,
				_: false
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
	...
	function (propertyName, toRec, fromRec, calcDistance, builder, config) {
		...
		if ($elm$core$List$isEmpty(frozenAxes)) {
			...
			if (_v0.$ === 1) {
				...
				var end = fromRec(
					{
						b3: A2($elm$core$List$member, 'x', frozenAxes) ? startRecord.b3 : endRecord.b3,
						b4: A2($elm$core$List$member, 'y', frozenAxes) ? startRecord.b4 : endRecord.b4,
	...
	if (_v1.$ === 1) {
		...
		return A2(
			...
			A2(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.g.B)));
	}
};
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {bg: $elm$core$Maybe$Nothing, bK: 0, bi: $elm$core$Maybe$Nothing, e: defaultEnd, aZ: $elm$core$Maybe$Nothing, a_: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.g.B);
	});
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.D.aG);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.D.bt);
	});
...
var $author$project$Animation$Sub$Animate3D$Main$leftFace = {
	...
	i: 'left-face',
	p: 'LEFT',
	d: {ae: 'rgb(0,0 ,0   )', a: 'leftFaceTextAnim', i: 'left-face-text', p: 'LEFT'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$rightFace = {
	...
	i: 'right-face',
	p: 'RIGHT',
	d: {ae: 'rgb(0,0 ,0   )', a: 'rightFaceTextAnim', i: 'right-face-text', p: 'RIGHT'}
};
...
var $author$project$Animation$Sub$Animate3D$Main$moveBackFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ((-1) * $author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Anim$Property$Translate$toY = $author$project$Anim$Internal$Builder$Translate$toY;
var $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Animation$Sub$Animate3D$Main$moveFrontFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Anim$Property$Translate$toX = $author$project$Anim$Internal$Builder$Translate$toX;
var $author$project$Animation$Sub$Animate3D$Main$moveLeftFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Animation$Sub$Animate3D$Main$moveRightFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Animation$Sub$Animate3D$Main$topFace = {
	...
	i: 'top-face',
	p: 'TOP',
	d: {ae: 'rgb(0,0 ,0   )', a: 'topFaceTextAnim', i: 'top-face-text', p: 'TOP'}
};
var $author$project$Animation$Sub$Animate3D$Main$moveTopFaceIn = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Animation$Sub$Animate3D$Main$depth));
var $author$project$Animation$Sub$Animate3D$Main$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Sub$Animate3D$Main$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Animate3D$Main$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Animate3D$Main$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Animate3D$Main$moveLeftFaceIn,
				A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Animate3D$Main$moveTopFaceIn, $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceIn)))));
var $author$project$Animation$Sub$Animate3D$Main$moveAmount = 50;
var $author$project$Animation$Sub$Animate3D$Main$moveBackFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ(((-1) * $author$project$Animation$Sub$Animate3D$Main$depth) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Sub$Animate3D$Main$depth + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveFrontFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Sub$Animate3D$Main$depth + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveLeftFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX(((-1) * $author$project$Animation$Sub$Animate3D$Main$depth) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveRightFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Sub$Animate3D$Main$depth + $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveTopFaceOut = A2(
	$author$project$Animation$Sub$Animate3D$Main$moveFace,
	$author$project$Animation$Sub$Animate3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY(((-1) * $author$project$Animation$Sub$Animate3D$Main$depth) - $author$project$Animation$Sub$Animate3D$Main$moveAmount));
var $author$project$Animation$Sub$Animate3D$Main$moveSidesOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Sub$Animate3D$Main$moveFrontFaceOut,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Animate3D$Main$moveBackFaceOut,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Animate3D$Main$moveRightFaceOut,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Animate3D$Main$moveLeftFaceOut,
				A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Animate3D$Main$moveTopFaceOut, $author$project$Animation$Sub$Animate3D$Main$moveBottomFaceOut)))));
...
var $author$project$Animation$Sub$Animate3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.d, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.d, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.d, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.d, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.d, 0, 0),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.d, 0, 0))))));
var $author$project$Animation$Sub$Animate3D$Main$textMoveAmount = 20;
var $author$project$Animation$Sub$Animate3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$frontFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$backFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$rightFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$leftFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$topFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$Sub$Animate3D$Main$moveText, $author$project$Animation$Sub$Animate3D$Main$bottomFace.d, $author$project$Animation$Sub$Animate3D$Main$textMoveAmount, 360))))));
...
var $author$project$Animation$Sub$Animate3D$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for($author$project$Animation$Sub$Animate3D$Main$cube.a),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Animate3D$Main$selectAnimation = function (state) {
	switch (state) {
		case 0:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Animate3D$Main$moveSidesOut, $author$project$Animation$Sub$Animate3D$Main$moveTextsOut);
		case 1:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Animate3D$Main$moveSidesIn, $author$project$Animation$Sub$Animate3D$Main$moveTextsIn);
		case 2:
...
var $author$project$Animation$Sub$Animate3D$Main$init = function (flags) {
	var initialAnimState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$cube.a, 200),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$frontFace.a, $author$project$Animation$Sub$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Animate3D$Main$backFace.a, $author$project$Animation$Sub$Animate3D$Main$depth * (-1)),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Animate3D$Main$rightFace.a, $author$project$Animation$Sub$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Animate3D$Main$leftFace.a, (-1) * $author$project$Animation$Sub$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Animate3D$Main$topFace.a, (-1) * $author$project$Animation$Sub$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Animate3D$Main$bottomFace.a, $author$project$Animation$Sub$Animate3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$backFace.a, 180),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$rightFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Animate3D$Main$leftFace.a, -90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Animate3D$Main$topFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Animate3D$Main$bottomFace.a, -90)
			]));
	...
	return _Utils_Tuple2(
		{
			...
			s: A2(
				...
				initialAnimState,
				$author$project$Animation$Sub$Animate3D$Main$selectAnimation(0)),
			D: 0
		},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Animation$Sub$Animate3D$Main$GotSubMsg = $elm$core$Basics$identity;
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bV: oldTime, cU: request, c_: subs};
	});
...
var $author$project$Animation$Sub$Animate3D$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $elm$core$Basics$identity, model.s);
};
		...
		return _Utils_update(
			model,
			{
				s: A2(
					$author$project$Anim$Engine$Sub$animate,
					model.s,
					$author$project$Animation$Sub$Animate3D$Main$selectAnimation(state)),
				D: state
			});
	});
...
var $author$project$Animation$Sub$Animate3D$Main$handleEvent = F2(
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(group.aW);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {dP: anim.dP, ch: anim.ch, bS: anim.bS, fv: anim.fv};
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(group.aW);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{dP: timing.dP, ch: timing.ch, bS: timing.bS, fv: timing.fv});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.bS) {
				...
				var newElapsedMs = timing.ch + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.dP);
				return _Utils_update(
					timing,
					{
						ch: newElapsedMs,
						bS: _Utils_cmp(animationElapsedMs, timing.fv) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{ap: state.ap, t: _List_Nil, _: stillRunning},
				updatedGroups),
			_Utils_ap(
...
var $author$project$Animation$Sub$Animate3D$Main$update = F2(
	function (msg, model) {
		var animMsg = msg;
		var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.s);
		var animState = _v1.a;
		var animEvents = _v1.b;
		return _Utils_Tuple2(
			A3(
				$elm$core$List$foldl,
				$author$project$Animation$Sub$Animate3D$Main$handleEvent,
				_Utils_update(
					model,
					{s: animState}),
				animEvents),
...
var $author$project$Anim$Internal$Property$Rotate$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!angles.b3)) ? $elm$core$Maybe$Just(
				'rotateX(' + ($elm$core$String$fromFloat(angles.b3) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!angles.b4)) ? $elm$core$Maybe$Just(
				'rotateY(' + ($elm$core$String$fromFloat(angles.b4) + 'deg)')) : $elm$core$Maybe$Nothing,
...
var $author$project$Anim$Internal$Property$Skew$toCssString = function (_v0) {
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				(!(!values.b3)) ? $elm$core$Maybe$Just(
				'skewX(' + ($elm$core$String$fromFloat(values.b3) + 'deg)')) : $elm$core$Maybe$Nothing,
				(!(!values.b4)) ? $elm$core$Maybe$Just(
				'skewY(' + ($elm$core$String$fromFloat(values.b4) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
	if (!parts.b) {
...
var $author$project$Anim$Internal$Property$Translate$toCssString = function (_v0) {
	var coords = _v0;
	return 'translate3d(' + ($elm$core$String$fromFloat(coords.b3) + ('px, ' + ($elm$core$String$fromFloat(coords.b4) + ('px, ' + ($elm$core$String$fromFloat(coords.b5) + 'px)')))));
};
		...
		switch (anim.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						bz: $author$project$Anim$Internal$Property$Translate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateTranslate, a))
					});
			case 4:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						br: $author$project$Anim$Internal$Property$Rotate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateRotate, a))
					});
			case 7:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bv: $author$project$Anim$Internal$Property$Skew$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateSkew, a))
					});
			case 5:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bu: $author$project$Anim$Internal$Property$Scale$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateScale, a))
					});
			default:
				return acc;
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isComplete = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(group.aW);
};
...
var $author$project$Animation$Sub$Animate3D$Main$viewFace = F2(
	function (animState, config) {
		var textAnimAttributes = A2($author$project$Anim$Engine$Sub$attributes, config.d.a, animState);
			...
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt($author$project$Animation$Sub$Animate3D$Main$cube.aB) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt($author$project$Animation$Sub$Animate3D$Main$cube.aB) + 'px'),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.d.ae),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$Animate3D$Main$viewCube = function (model) {
	var cubeAttrs = A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Animate3D$Main$cube.a, model.s);
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			cubeAttrs,
			_List_fromArray(
				[
					$author$project$Anim$Extra$View3D$transformStyle(1),
					$elm$html$Html$Attributes$id($author$project$Animation$Sub$Animate3D$Main$cube.i),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromInt($author$project$Animation$Sub$Animate3D$Main$cube.aB) + 'px'),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$frontFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$backFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$rightFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$leftFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$topFace),
				A2($author$project$Animation$Sub$Animate3D$Main$viewFace, model.s, $author$project$Animation$Sub$Animate3D$Main$bottomFace)
			]));
};
...
var $author$project$Animation$Sub$Animate3D$Main$main = $elm$browser$Browser$document(
	{ej: $author$project$Animation$Sub$Animate3D$Main$init, e7: $author$project$Animation$Sub$Animate3D$Main$subscriptions, fy: $author$project$Animation$Sub$Animate3D$Main$update, fz: $author$project$Animation$Sub$Animate3D$Main$view});
