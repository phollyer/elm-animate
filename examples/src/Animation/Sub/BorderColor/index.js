...
var $author$project$Animation$Sub$BorderColor$Main$animGroup = 'boxAnim';
	...
	function (newColor, startColor) {
		...
		switch (newColor.$) {
			case 1:
				var rgb_ = newColor.a;
				return $author$project$Anim$Internal$Extra$Color$Rgba(
					{b1: startAlpha, b5: rgb_.b5, ch: rgb_.ch, cN: rgb_.cN});
			case 0:
				var hex_ = newColor.a;
			...
			case 3:
				...
				return $author$project$Anim$Internal$Extra$Color$Hsla(
					{b1: startAlpha, ci: hsl_.ci, cr: hsl_.cr, cQ: hsl_.cQ});
			default:
				return newColor;
		}
	});
	...
	function (color, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					aV: $elm$core$Maybe$Just(colorWithPreservedAlpha)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$BorderColor$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$BorderColor$Main$GotSubMsg, model.A);
};
...
var $author$project$Animation$Sub$BorderColor$Main$toBlue = A2(
	$elm$core$Basics$composeR,
	A2($author$project$Anim$Property$CustomColor$for, $author$project$Animation$Sub$BorderColor$Main$animGroup, $author$project$Anim$Property$CustomColor$BorderColor),
	A2(
		$elm$core$Basics$composeR,
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$BorderColor$Main$toRed)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$BorderColor$Main$toBlue)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$BorderColor$Main$animGroup, model.A),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$BorderColor$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$BorderColor$Main$subscriptions,
		ft: $author$project$Animation$Sub$BorderColor$Main$update,
		fu: $author$project$Animation$Sub$BorderColor$Main$view
	});
