...
{
	if (region.a0.aX === region.f.aX)
	{
		return 'on line ' + region.a0.aX;
	}
	return 'on lines ' + region.a0.aX + ' through ' + region.f.aX;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ed: 'hidden', dD: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ed: 'mozHidden', dD: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ed: 'msHidden', dD: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ed: 'webkitHidden', dD: 'webkitvisibilitychange' }
		: { ed: 'hidden', dD: 'visibilitychange' };
}
...
var $author$project$Animation$Sub$Perspective3D$Main$MoveToTopRight = 0;
var $author$project$Animation$Sub$Perspective3D$Main$Opening = 0;
var $author$project$Animation$Sub$Perspective3D$Main$TriggerAnimation = {$: 1};
var $elm$core$Basics$always = F2(
	function (a, _v0) {
		return a;
	});
var $author$project$Animation$Sub$Perspective3D$Main$backFace = {
	ac: 'rgb(41, 128, 185)',
	ad: 'rgb(33, 97, 140)',
	a: 'backFaceAnim',
	d: 'back-face',
	q: 'BACK',
	e: {ae: 'rgb(0,0 ,0   )', a: 'backFaceTextAnim', d: 'back-face-text', q: 'BACK'}
};
var $author$project$Animation$Sub$Perspective3D$Main$bottomFace = {
	ac: 'rgb(155, 89, 182)',
	ad: 'rgb(142, 68, 173)',
	a: 'bottomFaceAnim',
	d: 'bottom-face',
	q: 'BOTTOM',
	e: {ae: 'rgb(0,0 ,0   )', a: 'bottomFaceTextAnim', d: 'bottom-face-text', q: 'BOTTOM'}
};
var $author$project$Animation$Sub$Perspective3D$Main$cube = {a: 'cubeAnim', d: 'cube', aC: 100};
var $author$project$Animation$Sub$Perspective3D$Main$depth = $author$project$Animation$Sub$Perspective3D$Main$cube.aC / 2;
var $author$project$Animation$Sub$Perspective3D$Main$frontFace = {
	ac: 'rgb(52, 152, 219)',
	ad: 'rgb(41, 128, 185)',
	a: 'frontFaceAnim',
	d: 'front-face',
	q: 'FRONT',
	e: {ae: 'rgb(0,0 ,0   )', a: 'frontFaceTextAnim', d: 'front-face-text', q: 'FRONT'}
};
...
var $author$project$Anim$Internal$Builder$initAnimation = {B: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aK: $elm$core$Maybe$Nothing, av: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Builder$initDefaults = {W: $elm$core$Maybe$Nothing, K: $elm$core$Maybe$Nothing, X: $elm$core$Maybe$Nothing, L: $elm$core$Maybe$Nothing, ah: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$Normal = 0;
var $author$project$Anim$Internal$Builder$Once = {$: 0};
var $author$project$Anim$Internal$Builder$initPlayback = {ao: 0, aL: $elm$core$Dict$empty, aM: $elm$core$Dict$empty, aW: false, ai: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Builder$init = A2(
	...
	{h: $author$project$Anim$Internal$Builder$initAnimation, c: $author$project$Anim$Internal$Builder$initDefaults, i: $author$project$Anim$Internal$Builder$initPlayback, o: $author$project$Anim$Internal$Builder$initScrollDrivenConfig, D: $author$project$Anim$Internal$Builder$initState});
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {ao: 0, aT: $author$project$Anim$Internal$Engine$Sub$Animations$init, bI: 0, bJ: $elm$core$Dict$empty, bK: $elm$core$Dict$empty, ai: $author$project$Anim$Internal$Builder$Once, aY: 0, u: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Property$Rotate$default = {c7: 0, c8: 0, b4: 0};
var $author$project$Anim$Internal$Property$Scale$Scale = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Scale$default = {c7: 1.0, c8: 1.0, b4: 1.0};
var $author$project$Anim$Internal$Property$Size$Size = $elm$core$Basics$identity;
var $author$project$Anim$Internal$Property$Size$default = {cm: 0, x: 0};
...
var $author$project$Anim$Internal$Property$Translate$default = {c7: 0, c8: 0, b4: 0};
...
var $author$project$Anim$Internal$Extra$Color$toRgb = function (color) {
	switch (color.$) {
		...
		case 2:
			var rgba_ = color.a;
			return {b9: rgba_.b9, cl: rgba_.cl, cR: rgba_.cR};
		case 3:
			var hsl_ = color.a;
		...
		default:
			...
			return {
				b9: $elm$core$Basics$round(rgba_.bH * 255),
				cl: $elm$core$Basics$round(rgba_.bO * 255),
...
var $author$project$Anim$Internal$Property$Shared$Axis3$distance = F3(
	function (support, coord1, coord2) {
		var record2 = support.fs(coord2);
		var record1 = support.fs(coord1);
		var dz = $elm$core$Basics$abs(record2.b4 - record1.b4);
...
var $author$project$Anim$Internal$Property$Rotate$support = {
	db: F2(
		function (_v0, _v1) {
			var a = _v0;
			var b = _v1;
			return {c7: a.c7 + b.c7, c8: a.c8 + b.c8, b4: a.b4 + b.b4};
		}),
	d9: $elm$core$Basics$identity,
	bv: F2(
		function (factor, _v2) {
			var angles = _v2;
			return {c7: angles.c7 * factor, c8: angles.c8 * factor, b4: angles.b4 * factor};
		}),
	e9: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fC: $author$project$Anim$Internal$Property$Rotate$default
};
...
var $author$project$Anim$Internal$Property$Scale$support = {
	...
	bv: F2(
		function (factor, _v2) {
			var coords = _v2;
			return {c7: coords.c7 * factor, c8: coords.c8 * factor, b4: coords.b4 * factor};
		}),
	e9: F2(
		function (_v3, _v4) {
			var a = _v3;
	...
	fC: $author$project$Anim$Internal$Property$Scale$default
};
...
var $author$project$Anim$Internal$Property$Translate$support = {
	...
	fC: $author$project$Anim$Internal$Property$Translate$default
};
...
var $author$project$Shared$Spring$precompute = function (_v0) {
	...
	var c = A2($elm$core$Basics$max, 0, spring.as);
...
var $author$project$Anim$Internal$Builder$processStandardAnimation = function (_v0) {
	...
	var speedFn = _v0.R;
	var wrapper = _v0.T;
	var start = A2($elm$core$Maybe$withDefault, defaultStart, config.a0);
	...
	var duration_ = function () {
		if (!resolvedSpring.$) {
			...
			return $author$project$Shared$Spring$settleTimeMs(
				{
					bN: 0,
					a$: $author$project$Motion$Internal$Spring$unwrap(s),
					b0: 1
				});
		} else {
			return rawDuration;
	...
	return wrapper(
		{
			...
			bL: distance_,
			cf: $elm$core$Basics$round(duration_),
	...
	function (globalData, property) {
		switch (property.$) {
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							J: globalData,
							R: $author$project$Shared$TimeSpec$speed,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							J: globalData,
							R: $author$project$Anim$Internal$Extra$Color$speed,
					...
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{
							...
							J: globalData,
							R: $author$project$Anim$Internal$Property$Opacity$speed,
			...
			case 3:
				...
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$PerspectiveOrigin$default, H: $author$project$Anim$Internal$Property$PerspectiveOrigin$distance, I: $author$project$Anim$Internal$Property$PerspectiveOrigin$duration, J: globalData, R: $author$project$Anim$Internal$Property$PerspectiveOrigin$speed, T: $author$project$Anim$Internal$Builder$ProcessedPerspectiveOriginConfig}));
			case 4:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$Rotate$default, H: $author$project$Anim$Internal$Property$Rotate$distance, I: $author$project$Anim$Internal$Property$Rotate$duration, J: globalData, R: $author$project$Anim$Internal$Property$Rotate$speed, T: $author$project$Anim$Internal$Builder$ProcessedRotateConfig}));
			case 5:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$Scale$default, H: $author$project$Anim$Internal$Property$Scale$distance, I: $author$project$Anim$Internal$Property$Scale$duration, J: globalData, R: $author$project$Anim$Internal$Property$Scale$speed, T: $author$project$Anim$Internal$Builder$ProcessedScaleConfig}));
			case 6:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$Size$default, H: $author$project$Anim$Internal$Property$Size$distance, I: $author$project$Anim$Internal$Property$Size$duration, J: globalData, R: $author$project$Anim$Internal$Property$Size$speed, T: $author$project$Anim$Internal$Builder$ProcessedSizeConfig}));
			case 7:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$Skew$default, H: $author$project$Anim$Internal$Property$Skew$distance, I: $author$project$Anim$Internal$Property$Skew$duration, J: globalData, R: $author$project$Anim$Internal$Property$Skew$speed, T: $author$project$Anim$Internal$Builder$ProcessedSkewConfig}));
			default:
				var config = property.a;
				return $elm$core$Maybe$Just(
					$author$project$Anim$Internal$Builder$processStandardAnimation(
						{F: config, G: $author$project$Anim$Internal$Property$Translate$default, H: $author$project$Anim$Internal$Property$Translate$distance, I: $author$project$Anim$Internal$Property$Translate$duration, J: globalData, R: $author$project$Anim$Internal$Property$Translate$speed, T: $author$project$Anim$Internal$Builder$ProcessedTranslateConfig}));
		}
	});
			...
			function (_default, config) {
				...
				var easingFn = function () {
					...
					if (!_v1.$) {
						...
						return $author$project$Shared$Easing$toFunction(config.bj);
					}
				}();
				return {
					dQ: config.bh,
					...
					f: config.f,
					bT: isComplete,
					a0: A2($elm$core$Maybe$withDefault, _default, config.a0),
					fw: durationMs
				};
			});
...
var $author$project$Anim$Internal$Builder$extractBaselinesFromConfig = function (elementConfig) {
	return A3($elm$core$List$foldl, $author$project$Anim$Internal$Builder$extractPropertyBaseline, $author$project$Anim$Internal$Builder$PropertyBaselines$empty, elementConfig.C);
};
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			...
			{
				aq: $author$project$Anim$Internal$Builder$init(_List_Nil),
				t: _List_Nil,
				_: false
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
		...
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aq: $author$project$Anim$Internal$Builder$clearAnimData(
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.h.aK;
	if (_v1.$ === 1) {
		return {C: _List_Nil, u: data.c.ah};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{C: _List_Nil, u: data.c.ah},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
				...
				A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.h.B)));
	}
};
...
var $author$project$Anim$Internal$Builder$updateCurrentConfig = F2(
	function (config, _v0) {
		...
		if (_v1.$ === 1) {
			...
			var animKey = _v1.a;
			var newPropertyTypes = A2($elm$core$List$map, $author$project$Anim$Internal$Builder$propertyType, config.C);
			var anim = data.h;
			var mergedConfig = function () {
				...
				if (!_v2.$) {
					...
					return _Utils_update(
						existing,
						{
							C: _Utils_ap(filteredExisting, config.C),
							u: mergedOrder
						});
				} else {
					return config;
...
var $author$project$Anim$Internal$Builder$Property$defaultConfig = function (defaultEnd) {
	return {bh: $elm$core$Maybe$Nothing, bL: 0, bj: $elm$core$Maybe$Nothing, f: defaultEnd, a$: $elm$core$Maybe$Nothing, a0: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing};
};
...
var $author$project$Anim$Internal$Builder$getAnimGroupConfig = F2(
	function (animGroupName, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, animGroupName, data.h.B);
	});
var $author$project$Anim$Internal$Builder$getBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.D.aI);
	});
var $author$project$Anim$Internal$Builder$getRuntimeBaseline = F2(
	function (key, _v0) {
		var data = _v0;
		return A2($author$project$Anim$Internal$Engine$Shared$AnimGroups$get, key, data.D.bu);
	});
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								f: baseline,
								a0: $elm$core$Maybe$Just(runtime)
							}));
				} else {
					var runtime = _v1.a.a;
					var _v2 = _v1.b;
				...
				if (!_v1.b.$) {
					...
					return A2(
						...
						_Utils_update(
							...
							{
								f: baseline,
								a0: $elm$core$Maybe$Just(baseline)
							}));
				} else {
					var _v4 = _v1.a;
					var _v5 = _v1.b;
	...
	function (perspectiveOrigin, _v0) {
		...
		return A3(
			...
			_Utils_update(
				config,
				{
					a0: $elm$core$Maybe$Just(perspectiveOrigin)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$PerspectiveOrigin$to = F2(
	function (perspectiveOrigin, _v0) {
		...
		var config = _v0.b;
		var builder = _v0.c;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$PerspectiveOrigin$default, config.a0);
		return A3(
			$author$project$Anim$Internal$Builder$PerspectiveOrigin$PerspectiveOriginBuilder,
			unit,
			_Utils_update(
				...
				var end = fromRec(
					{
						...
						b4: A2($elm$core$List$member, 'z', frozenAxes) ? startRecord.b4 : endRecord.b4
					});
				return _Utils_update(
					config,
					{
...
var $author$project$Anim$Internal$Builder$Rotate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.a0);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getY, $author$project$Anim$Internal$Builder$Rotate$default, config.a0);
		return A4(
...
var $author$project$Anim$Internal$Builder$Rotate$to = F2(
	function (endRotate, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Rotate$default, config.a0);
		return A2(
			$author$project$Anim$Internal$Builder$Rotate$RotateBuilder,
			_Utils_update(
				config,
...
var $author$project$Anim$Internal$Builder$Translate$fromX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.a0);
		var y = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getY, $author$project$Anim$Internal$Builder$Translate$default, config.a0);
		return A4(
...
var $author$project$Anim$Internal$Builder$Translate$to = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startVal = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Translate$default, config.a0);
		return A2(
			$author$project$Anim$Internal$Builder$Translate$TranslateBuilder,
			_Utils_update(
				config,
				{
					...
					f: value,
					a0: $elm$core$Maybe$Just(startVal)
				}),
			builder);
	});
...
var $author$project$Anim$Internal$Builder$Rotate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getZ, $author$project$Anim$Internal$Builder$Rotate$default, config.a0);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Rotate$getX, $author$project$Anim$Internal$Builder$Rotate$default, config.a0);
		return A4(
			$author$project$Anim$Internal$Builder$Rotate$fromXYZ,
			x,
			y,
...
var $author$project$Anim$Internal$Builder$Translate$fromY = F2(
	function (y, _v0) {
		...
		var builder = _v0.b;
		var z = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getZ, $author$project$Anim$Internal$Builder$Translate$default, config.a0);
		var x = A3($author$project$Anim$Internal$Builder$Property$getFloat, $author$project$Anim$Internal$Property$Translate$getX, $author$project$Anim$Internal$Builder$Translate$default, config.a0);
		return A4(
			$author$project$Anim$Internal$Builder$Translate$fromXYZ,
			x,
			y,
...
var $author$project$Animation$Sub$Perspective3D$Main$leftFace = {
	ac: 'rgb(230, 126, 34)',
	ad: 'rgb(211, 84, 0)',
	a: 'leftFaceAnim',
	d: 'left-face',
	q: 'LEFT',
	e: {ae: 'rgb(0,0 ,0   )', a: 'leftFaceTextAnim', d: 'left-face-text', q: 'LEFT'}
};
var $author$project$Animation$Sub$Perspective3D$Main$perspectiveContainer = {a: 'perspectiveContainerAnim', d: 'perspective-container'};
var $author$project$Animation$Sub$Perspective3D$Main$rightFace = {
	ac: 'rgb(231, 76, 60)',
	ad: 'rgb(192, 57, 43)',
	a: 'rightFaceAnim',
	d: 'right-face',
	q: 'RIGHT',
	e: {ae: 'rgb(0,0 ,0   )', a: 'rightFaceTextAnim', d: 'right-face-text', q: 'RIGHT'}
};
var $elm$core$Process$sleep = _Process_sleep;
var $author$project$Animation$Sub$Perspective3D$Main$topFace = {
	ac: 'rgb(46, 204, 113)',
	ad: 'rgb(39, 174, 96)',
	a: 'topFaceAnim',
	d: 'top-face',
	q: 'TOP',
	e: {ae: 'rgb(0,0 ,0   )', a: 'topFaceTextAnim', d: 'top-face-text', q: 'TOP'}
};
var $author$project$Animation$Sub$Perspective3D$Main$init = function (flags) {
	var initialAnimState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A3($author$project$Anim$Property$PerspectiveOrigin$initPercent, $author$project$Animation$Sub$Perspective3D$Main$perspectiveContainer.a, 0, 0),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Perspective3D$Main$cube.a, 200),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Perspective3D$Main$frontFace.a, $author$project$Animation$Sub$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initZ, $author$project$Animation$Sub$Perspective3D$Main$backFace.a, $author$project$Animation$Sub$Perspective3D$Main$depth * (-1)),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Perspective3D$Main$rightFace.a, $author$project$Animation$Sub$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initX, $author$project$Animation$Sub$Perspective3D$Main$leftFace.a, (-1) * $author$project$Animation$Sub$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Perspective3D$Main$topFace.a, (-1) * $author$project$Animation$Sub$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Translate$initY, $author$project$Animation$Sub$Perspective3D$Main$bottomFace.a, $author$project$Animation$Sub$Perspective3D$Main$depth),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Perspective3D$Main$backFace.a, 180),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Perspective3D$Main$rightFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initY, $author$project$Animation$Sub$Perspective3D$Main$leftFace.a, -90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Perspective3D$Main$topFace.a, 90),
				A2($author$project$Anim$Property$Rotate$initX, $author$project$Animation$Sub$Perspective3D$Main$bottomFace.a, -90)
			]));
	var animAreaWidth = A2($elm$core$Basics$min, 500, flags.c6.c3 - 40);
	var animAreaHeight = 350;
	return _Utils_Tuple2(
		{
			aG: {cn: animAreaHeight, c3: animAreaWidth},
			j: initialAnimState,
			ak: 0,
			D: 0
		},
		A2(
			...
			$elm$core$Basics$always($author$project$Animation$Sub$Perspective3D$Main$TriggerAnimation),
			$elm$core$Process$sleep(500)));
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Animation$Sub$Perspective3D$Main$GotSubMsg = function (a) {
	return {$: 2, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bW: oldTime, cT: request, cZ: subs};
	});
...
var $author$project$Animation$Sub$Perspective3D$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$Perspective3D$Main$GotSubMsg, model.j);
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$addAnimation = F2(
	function (additional, _v0) {
		...
		return _Utils_update(
			group,
			{
				aT: A2($author$project$Anim$Internal$Engine$Sub$Animations$add, additional, group.aT)
			});
	});
	...
	return {
		...
		bP: A2(
			...
			F2(
				function (_v1, group) {
					return {
						C: A2($author$project$Anim$Internal$Builder$processProperties, data.c, group.C),
						u: function () {
							var _v2 = group.u;
							if (!_v2.$) {
								return group.u;
...
var $author$project$Anim$Internal$Extra$Color$rgbToHsl = function (rgb_) {
	...
	return {cm: hNormalized, cv: l * 100, cU: s * 100};
};
var $author$project$Anim$Internal$Extra$Color$rgbaToHsla = function (rgba_) {
	var rgb_ = {b9: rgba_.b9, cl: rgba_.cl, cR: rgba_.cR};
	var hsla_ = $author$project$Anim$Internal$Extra$Color$rgbToHsl(rgb_);
	return {b5: rgba_.b5, cm: hsla_.cm, cv: hsla_.cv, cU: hsla_.cU};
};
var $author$project$Anim$Internal$Extra$Color$toHsl = function (color) {
	switch (color.$) {
		...
		case 4:
			...
			return {cm: hslaValue.cm, cv: hslaValue.cv, cU: hslaValue.cU};
		default:
...
var $author$project$Anim$Internal$Extra$Color$toHsla = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b5: 1.0, cm: hslValue.cm, cv: hslValue.cv, cU: hslValue.cU};
	}
};
var $author$project$Anim$Internal$Extra$Color$hslaToRgba = function (hslaValue) {
	var rgb_ = $author$project$Anim$Internal$Extra$Color$hslToRgb(
		{cm: hslaValue.cm, cv: hslaValue.cv, cU: hslaValue.cU});
	return {b5: hslaValue.b5, b9: rgb_.b9, cl: rgb_.cl, cR: rgb_.cR};
};
var $author$project$Anim$Internal$Extra$Color$toRgba = function (color) {
	switch (color.$) {
		...
		default:
			...
			return {b5: 1.0, b9: rgb_.b9, cl: rgb_.cl, cR: rgb_.cR};
	}
};
				...
				switch (_v0.a.$) {
					case 0:
						if (!_v0.b.$) {
							...
							var g = $elm$core$Basics$round(startRgb.cl + ((endRgb.cl - startRgb.cl) * t));
							var r = $elm$core$Basics$round(startRgb.cR + ((endRgb.cR - startRgb.cR) * t));
							var b = $elm$core$Basics$round(startRgb.b9 + ((endRgb.b9 - startRgb.b9) * t));
							return $author$project$Anim$Internal$Extra$Color$Rgb(
								{b9: b, cl: g, cR: r});
						} else {
							break _v0$5;
					...
					case 2:
						if (_v0.b.$ === 2) {
							...
							var endRgba = _v0.b.a;
							var r = $elm$core$Basics$round(startRgba.cR + ((endRgba.cR - startRgba.cR) * t));
							var g = $elm$core$Basics$round(startRgba.cl + ((endRgba.cl - startRgba.cl) * t));
							var b = $elm$core$Basics$round(startRgba.b9 + ((endRgba.b9 - startRgba.b9) * t));
							var a = startRgba.b5 + ((endRgba.b5 - startRgba.b5) * t);
					...
					case 3:
						if (_v0.b.$ === 3) {
							...
							var endHsl = _v0.b.a;
							var s = startHsl.cU + ((endHsl.cU - startHsl.cU) * t);
							var l = startHsl.cv + ((endHsl.cv - startHsl.cv) * t);
							var h = startHsl.cm + ((endHsl.cm - startHsl.cm) * t);
					...
					case 4:
						if (_v0.b.$ === 4) {
							...
							var endHsla = _v0.b.a;
							var s = startHsla.cU + ((endHsla.cU - startHsla.cU) * t);
							var l = startHsla.cv + ((endHsla.cv - startHsla.cv) * t);
							var h = startHsla.cm + ((endHsla.cm - startHsla.cm) * t);
							var a = startHsla.b5 + ((endHsla.b5 - startHsla.b5) * t);
...
var $author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress = function (timing) {
	if (timing.bT || (timing.fw <= 0)) {
		return 1.0;
	} else {
		var animationElapsedMs = A2($elm$core$Basics$max, 0, timing.cg - timing.dQ);
		return (animationElapsedMs <= 0) ? 0.0 : A2($elm$core$Basics$min, 1.0, animationElapsedMs / timing.fw);
	}
};
var $author$project$Anim$Internal$Engine$Sub$Interpolation$interpolateEasedProgress = F2(
	function (interpolate, anim) {
		var easedProgress = anim.dX(
			$author$project$Anim$Internal$Engine$Sub$Interpolation$calculateProgress(anim));
		return A3(interpolate, easedProgress, anim.a0, anim.f);
	});
...
var $author$project$Anim$Internal$Property$Shared$Axis3$toTriple = F2(
	function (support, coord) {
		var record = support.fs(coord);
		return _Utils_Tuple3(record.c7, record.c8, record.b4);
	});
...
var $author$project$Anim$Internal$Property$Size$toTuple = function (_v0) {
	var dimensions = _v0;
	return _Utils_Tuple2(dimensions.x, dimensions.cm);
};
...
var $author$project$Anim$Internal$Engine$Sub$setSnapshot = function (anims) {
	return A2(
		...
		F2(
			function (_v0, anim) {
				return {
					eN: $author$project$Anim$Internal$Engine$Sub$extractElementCurrentStates(anim)
				};
			}),
		anims);
};
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		var startedEvents = A2(
			...
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$names(processed.bP));
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				aq: $author$project$Anim$Internal$Builder$clearAnimData(
				...
				t: _Utils_ap(state.t, startedEvents),
				_: true
			},
			A3(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
...
var $author$project$Animation$Sub$Perspective3D$Main$Closing = 1;
...
var $author$project$Anim$Internal$Engine$Sub$duration = $author$project$Anim$Internal$Builder$duration;
var $author$project$Anim$Engine$Sub$duration = $author$project$Anim$Internal$Engine$Sub$duration;
...
var $author$project$Anim$Internal$Engine$Sub$easing = $author$project$Anim$Internal$Builder$easing;
var $author$project$Anim$Engine$Sub$easing = $author$project$Anim$Internal$Engine$Sub$easing;
var $author$project$Animation$Sub$Perspective3D$Main$sharedTiming = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Engine$Sub$duration(1000),
	$author$project$Anim$Engine$Sub$easing($author$project$Motion$Easing$CircInOut));
var $author$project$Animation$Sub$Perspective3D$Main$moveFace = F2(
	function (_v0, moveToBuilder) {
		var groupName = _v0.a;
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Perspective3D$Main$sharedTiming,
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Perspective3D$Main$moveBackFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Anim$Property$Translate$toY = $author$project$Anim$Internal$Builder$Translate$toY;
var $author$project$Animation$Sub$Perspective3D$Main$moveBottomFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Animation$Sub$Perspective3D$Main$moveFrontFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Anim$Property$Translate$toX = $author$project$Anim$Internal$Builder$Translate$toX;
var $author$project$Animation$Sub$Perspective3D$Main$moveLeftFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Animation$Sub$Perspective3D$Main$moveRightFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Animation$Sub$Perspective3D$Main$moveTopFaceIn = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth));
var $author$project$Animation$Sub$Perspective3D$Main$moveSidesIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Sub$Perspective3D$Main$moveFrontFaceIn,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Perspective3D$Main$moveBackFaceIn,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Perspective3D$Main$moveRightFaceIn,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Perspective3D$Main$moveLeftFaceIn,
				A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Perspective3D$Main$moveTopFaceIn, $author$project$Animation$Sub$Perspective3D$Main$moveBottomFaceIn)))));
var $author$project$Animation$Sub$Perspective3D$Main$moveAmount = 50;
var $author$project$Animation$Sub$Perspective3D$Main$moveBackFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$backFace,
	$author$project$Anim$Property$Translate$toZ(((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth) - $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveBottomFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$bottomFace,
	$author$project$Anim$Property$Translate$toY($author$project$Animation$Sub$Perspective3D$Main$depth + $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveFrontFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$frontFace,
	$author$project$Anim$Property$Translate$toZ($author$project$Animation$Sub$Perspective3D$Main$depth + $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveLeftFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$leftFace,
	$author$project$Anim$Property$Translate$toX(((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth) - $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveRightFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$rightFace,
	$author$project$Anim$Property$Translate$toX($author$project$Animation$Sub$Perspective3D$Main$depth + $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveTopFaceOut = A2(
	$author$project$Animation$Sub$Perspective3D$Main$moveFace,
	$author$project$Animation$Sub$Perspective3D$Main$topFace,
	$author$project$Anim$Property$Translate$toY(((-1) * $author$project$Animation$Sub$Perspective3D$Main$depth) - $author$project$Animation$Sub$Perspective3D$Main$moveAmount));
var $author$project$Animation$Sub$Perspective3D$Main$moveSidesOut = A2(
	$elm$core$Basics$composeR,
	$author$project$Animation$Sub$Perspective3D$Main$moveFrontFaceOut,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Animation$Sub$Perspective3D$Main$moveBackFaceOut,
		A2(
			$elm$core$Basics$composeR,
			$author$project$Animation$Sub$Perspective3D$Main$moveRightFaceOut,
			A2(
				$elm$core$Basics$composeR,
				$author$project$Animation$Sub$Perspective3D$Main$moveLeftFaceOut,
				A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Perspective3D$Main$moveTopFaceOut, $author$project$Animation$Sub$Perspective3D$Main$moveBottomFaceOut)))));
...
var $author$project$Animation$Sub$Perspective3D$Main$moveText = F3(
...
var $author$project$Animation$Sub$Perspective3D$Main$moveTextsIn = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$frontFace.e, 0, 0),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$backFace.e, 0, 0),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$rightFace.e, 0, 0),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$leftFace.e, 0, 0),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$topFace.e, 0, 0),
					A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$bottomFace.e, 0, 0))))));
var $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount = 20;
var $author$project$Animation$Sub$Perspective3D$Main$moveTextsOut = A2(
	$elm$core$Basics$composeR,
	A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$frontFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360),
	A2(
		$elm$core$Basics$composeR,
		A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$backFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360),
		A2(
			$elm$core$Basics$composeR,
			A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$rightFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360),
			A2(
				$elm$core$Basics$composeR,
				A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$leftFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360),
				A2(
					$elm$core$Basics$composeR,
					A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$topFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360),
					A3($author$project$Animation$Sub$Perspective3D$Main$moveText, $author$project$Animation$Sub$Perspective3D$Main$bottomFace.e, $author$project$Animation$Sub$Perspective3D$Main$textMoveAmount, 360))))));
...
var $author$project$Animation$Sub$Perspective3D$Main$rotateCube = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Rotate$for($author$project$Animation$Sub$Perspective3D$Main$cube.a),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Perspective3D$Main$rotateCubeAntiClockwise = $author$project$Animation$Sub$Perspective3D$Main$rotateCube(0);
var $author$project$Animation$Sub$Perspective3D$Main$rotateCubeClockwise = $author$project$Animation$Sub$Perspective3D$Main$rotateCube(360);
var $author$project$Animation$Sub$Perspective3D$Main$selectAnimation = function (state) {
	switch (state) {
		case 0:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Perspective3D$Main$moveSidesOut, $author$project$Animation$Sub$Perspective3D$Main$moveTextsOut);
		case 1:
			return A2($elm$core$Basics$composeR, $author$project$Animation$Sub$Perspective3D$Main$moveSidesIn, $author$project$Animation$Sub$Perspective3D$Main$moveTextsIn);
		case 2:
			return $author$project$Animation$Sub$Perspective3D$Main$rotateCubeClockwise;
		default:
			return $author$project$Animation$Sub$Perspective3D$Main$rotateCubeAntiClockwise;
	}
};
var $author$project$Animation$Sub$Perspective3D$Main$stateChanged = F2(
		...
		return _Utils_update(
			model,
			{
				j: A2(
					...
					model.j,
					$author$project$Animation$Sub$Perspective3D$Main$selectAnimation(state)),
				D: state
			});
	});
var $author$project$Animation$Sub$Perspective3D$Main$cubeRotationEnded = function (model) {
	var _v0 = model.D;
	switch (_v0) {
		case 2:
			return A2($author$project$Animation$Sub$Perspective3D$Main$stateChanged, 1, model);
		case 3:
			return A2($author$project$Animation$Sub$Perspective3D$Main$stateChanged, 0, model);
		default:
			return model;
	}
};
var $author$project$Animation$Sub$Perspective3D$Main$MoveToBottomLeft = 2;
var $author$project$Animation$Sub$Perspective3D$Main$MoveToBottomRight = 1;
var $author$project$Animation$Sub$Perspective3D$Main$MoveToTopLeft = 3;
var $author$project$Animation$Sub$Perspective3D$Main$nextPerspectiveStep = function (step) {
	switch (step) {
		case 0:
			return 1;
		case 1:
...
var $author$project$Animation$Sub$Perspective3D$Main$vanishingPointDot = {a: 'vanishingPointDotAnim', d: 'vanishing-point-dot'};
var $author$project$Animation$Sub$Perspective3D$Main$movePerspectiveOrigin = F4(
	function (x, y, ms, areaSize) {
		return A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$PerspectiveOrigin$for($author$project$Animation$Sub$Perspective3D$Main$perspectiveContainer.a),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Anim$Property$PerspectiveOrigin$percent,
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Anim$Property$Translate$for($author$project$Animation$Sub$Perspective3D$Main$vanishingPointDot.a),
									A2(
										$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepDuration = 3000;
var $author$project$Animation$Sub$Perspective3D$Main$perspectiveAnimation = F2(
	function (areaSize, step) {
		switch (step) {
			case 0:
				return A4($author$project$Animation$Sub$Perspective3D$Main$movePerspectiveOrigin, 100, 0, $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepDuration, areaSize);
			case 1:
				return A4($author$project$Animation$Sub$Perspective3D$Main$movePerspectiveOrigin, 100, 100, $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepDuration, areaSize);
			case 2:
				return A4($author$project$Animation$Sub$Perspective3D$Main$movePerspectiveOrigin, 0, 100, $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepDuration, areaSize);
			default:
				return A4($author$project$Animation$Sub$Perspective3D$Main$movePerspectiveOrigin, 0, 0, $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepDuration, areaSize);
		}
	});
var $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepEnded = function (model) {
	return _Utils_update(
		model,
		{
			j: A2(
				$author$project$Anim$Engine$Sub$animate,
				model.j,
				A2($author$project$Animation$Sub$Perspective3D$Main$perspectiveAnimation, model.aG, model.ak)),
			ak: $author$project$Animation$Sub$Perspective3D$Main$nextPerspectiveStep(model.ak)
		});
};
var $author$project$Animation$Sub$Perspective3D$Main$RotatingClosed = 3;
var $author$project$Animation$Sub$Perspective3D$Main$RotatingOpen = 2;
var $author$project$Animation$Sub$Perspective3D$Main$sidesMovementEnded = function (model) {
	var _v0 = model.D;
	switch (_v0) {
		case 0:
			return A2($author$project$Animation$Sub$Perspective3D$Main$stateChanged, 2, model);
		case 1:
			return A2($author$project$Animation$Sub$Perspective3D$Main$stateChanged, 3, model);
		default:
			return model;
	}
};
var $author$project$Animation$Sub$Perspective3D$Main$handleSubEvent = F2(
	function (animEvent, model) {
		...
		while (true) {
			if (animEvent.$ === 1) {
				switch (animEvent.a) {
					case 'cubeAnim':
						return $author$project$Animation$Sub$Perspective3D$Main$cubeRotationEnded(model);
					case 'frontFaceAnim':
						return $author$project$Animation$Sub$Perspective3D$Main$sidesMovementEnded(model);
					case 'vanishingPointDotAnim':
						return $author$project$Animation$Sub$Perspective3D$Main$perspectiveStepEnded(model);
					default:
						break _v0$3;
				}
			} else {
...
var $author$project$Animation$Sub$Perspective3D$Main$handleSubEvents = $elm$core$List$foldl($author$project$Animation$Sub$Perspective3D$Main$handleSubEvent);
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isRunning = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isRunning(group.aY);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$toTiming = function (anim) {
	return {dQ: anim.dQ, cg: anim.cg, bT: anim.bT, fw: anim.fw};
};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isPaused = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isPaused(group.aY);
};
...
var $author$project$Anim$Internal$Engine$Sub$Animation$applyTiming = F2(
	function (timing, anim) {
		return _Utils_update(
			anim,
			{dQ: timing.dQ, cg: timing.cg, bT: timing.bT, fw: timing.fw});
	});
	...
	return $author$project$Anim$Internal$Engine$Sub$Animation$mapTiming(
		function (timing) {
			if (timing.bT) {
				...
				var newElapsedMs = timing.cg + deltaMs;
				var animationElapsedMs = A2($elm$core$Basics$max, 0, newElapsedMs - timing.dQ);
				return _Utils_update(
					timing,
					{
						cg: newElapsedMs,
						bT: _Utils_cmp(animationElapsedMs, timing.fw) > -1
					});
			}
		});
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{aq: state.aq, t: _List_Nil, _: stillRunning},
				updatedGroups),
			_Utils_ap(
				A2($elm$core$List$map, $author$project$Anim$Internal$Engine$Sub$Control, state.t),
...
var $author$project$Animation$Sub$Perspective3D$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
					...
					_Utils_update(
						model,
						{
							j: A2(
								...
								A2(
									$elm$core$Basics$composeR,
									$author$project$Animation$Sub$Perspective3D$Main$selectAnimation(model.D),
									A2($author$project$Animation$Sub$Perspective3D$Main$perspectiveAnimation, model.aG, model.ak))),
							ak: $author$project$Animation$Sub$Perspective3D$Main$nextPerspectiveStep(model.ak)
						}),
			...
			default:
				var animMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.j);
				var animState = _v1.a;
				var animEvents = _v1.b;
				return _Utils_Tuple2(
					A2(
						$author$project$Animation$Sub$Perspective3D$Main$handleSubEvents,
						_Utils_update(
							model,
							{j: animState}),
						animEvents),
	...
	var parts = A2(
		...
		_List_fromArray(
			[
				...
				'rotateZ(' + ($elm$core$String$fromFloat(angles.b4) + 'deg)')) : $elm$core$Maybe$Nothing
			]));
...
var $author$project$Anim$Internal$Property$Translate$toCssString = function (_v0) {
	var coords = _v0;
	return 'translate3d(' + ($elm$core$String$fromFloat(coords.c7) + ('px, ' + ($elm$core$String$fromFloat(coords.c8) + ('px, ' + ($elm$core$String$fromFloat(coords.b4) + 'px)')))));
};
		...
		switch (anim.$) {
			case 8:
				...
				return _Utils_update(
					acc,
					{
						bA: $author$project$Anim$Internal$Property$Translate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateTranslate, a))
					});
			case 4:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bs: $author$project$Anim$Internal$Property$Rotate$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateRotate, a))
					});
			case 7:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bw: $author$project$Anim$Internal$Property$Skew$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateSkew, a))
					});
			case 5:
				var a = anim.a;
				return _Utils_update(
					acc,
					{
						bv: $author$project$Anim$Internal$Property$Scale$toCssString(
							A2($author$project$Anim$Internal$Engine$Sub$interpolateEasedProgress, $author$project$Anim$Internal$Engine$Sub$interpolateScale, a))
					});
			default:
				return acc;
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$isComplete = function (_v0) {
	var group = _v0;
	return $author$project$Anim$Internal$Engine$Shared$PlayState$isComplete(group.aY);
};
...
var $author$project$Anim$Internal$Builder$emptyTransformParts = {bs: '', bv: '', bw: '', bA: ''};
...
var $author$project$Animation$Sub$Perspective3D$Main$viewFace = F2(
	function (animState, config) {
		var textAnimAttributes = A2($author$project$Anim$Engine$Sub$attributes, config.e.a, animState);
		var faceAnimAttributes = A2($author$project$Anim$Engine$Sub$attributes, config.a, animState);
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				faceAnimAttributes,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'width',
						$elm$core$String$fromInt($author$project$Animation$Sub$Perspective3D$Main$cube.aC) + 'px'),
						A2(
						$elm$html$Html$Attributes$style,
						'height',
						$elm$core$String$fromInt($author$project$Animation$Sub$Perspective3D$Main$cube.aC) + 'px'),
						A2($elm$html$Html$Attributes$style, 'background-color', config.ac),
						A2($elm$html$Html$Attributes$style, 'border', '2px solid ' + config.ad),
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'color', config.e.ae),
								A2($elm$html$Html$Attributes$style, 'position', 'absolute')
							])),
					_List_fromArray(
						[
...
var $author$project$Animation$Sub$Perspective3D$Main$viewCube = function (model) {
	var cubeAttrs = A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Perspective3D$Main$cube.a, model.j);
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			cubeAttrs,
			_List_fromArray(
				[
					$author$project$Anim$Extra$View3D$transformStyle(1),
					$elm$html$Html$Attributes$id($author$project$Animation$Sub$Perspective3D$Main$cube.d),
					A2(
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromInt($author$project$Animation$Sub$Perspective3D$Main$cube.aC) + 'px'),
		...
		_List_fromArray(
			[
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$frontFace),
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$backFace),
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$rightFace),
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$leftFace),
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$topFace),
				A2($author$project$Animation$Sub$Perspective3D$Main$viewFace, model.j, $author$project$Animation$Sub$Perspective3D$Main$bottomFace)
			]));
};
var $author$project$Animation$Sub$Perspective3D$Main$viewVanishingPoint = function (animState) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Perspective3D$Main$vanishingPointDot.a, animState),
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
...
var $author$project$Animation$Sub$Perspective3D$Main$viewAnimationArea = function (model) {
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
			A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$Perspective3D$Main$perspectiveContainer.a, model.j),
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id($author$project$Animation$Sub$Perspective3D$Main$perspectiveContainer.d),
					...
					$elm$html$Html$Attributes$style,
					'width',
					$elm$core$String$fromInt(model.aG.c3) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromInt(model.aG.cn) + 'px'),
		...
		_List_fromArray(
			[
				$author$project$Animation$Sub$Perspective3D$Main$viewVanishingPoint(model.j),
				$author$project$Animation$Sub$Perspective3D$Main$viewCube(model)
			]));
};
var $author$project$Animation$Sub$Perspective3D$Main$view = function (model) {
	return {
		dt: _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Animation$Sub$Perspective3D$Main$viewAnimationArea(model)
							]))
					]))
			]),
		fr: 'Sub Engine - 3D Perspective Origin Example'
	};
};
var $author$project$Animation$Sub$Perspective3D$Main$main = $elm$browser$Browser$document(
	{ek: $author$project$Animation$Sub$Perspective3D$Main$init, e8: $author$project$Animation$Sub$Perspective3D$Main$subscriptions, fz: $author$project$Animation$Sub$Perspective3D$Main$update, fA: $author$project$Animation$Sub$Perspective3D$Main$view});
_Platform_export({'Animation':{'Sub':{'Perspective3D':{'Main':{'init':$author$project$Animation$Sub$Perspective3D$Main$main(
	A2(
