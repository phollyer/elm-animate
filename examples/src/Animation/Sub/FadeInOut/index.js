...
var $author$project$Animation$Sub$FadeInOut$Main$animGroup = 'boxAnim';
...
var $author$project$Animation$Sub$FadeInOut$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$FadeInOut$Main$GotSubMsg, model.A);
};
...
var $author$project$Animation$Sub$FadeInOut$Main$fadeTo = function (to) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Opacity$for($author$project$Animation$Sub$FadeInOut$Main$animGroup),
		A2(
			$elm$core$Basics$composeR,
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$FadeInOut$Main$fadeIn)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$FadeInOut$Main$fadeOut)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$FadeInOut$Main$animGroup, model.A),
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'height', '80vh'),
...
var $author$project$Animation$Sub$FadeInOut$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$FadeInOut$Main$subscriptions,
		ft: $author$project$Animation$Sub$FadeInOut$Main$update,
		fu: $author$project$Animation$Sub$FadeInOut$Main$view
	});
