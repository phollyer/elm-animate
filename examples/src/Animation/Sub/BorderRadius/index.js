...
var $author$project$Animation$Sub$BorderRadius$Main$animGroup = 'boxAnim';
...
var $author$project$Anim$Internal$Builder$initAnimation = {x: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aC: $elm$core$Maybe$Nothing, ao: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {ah: 0, aM: $author$project$Anim$Internal$Engine$Sub$Animations$init, bC: 0, bD: $elm$core$Dict$empty, bE: $elm$core$Dict$empty, ac: $author$project$Anim$Internal$Builder$Once, aR: 0, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Builder$getCurrentAnimGroupConfig = function (_v0) {
	...
	var _v1 = data.e.aC;
	if (_v1.$ === 1) {
		return {y: _List_Nil, p: data.b.ab};
	} else {
		var animGroupName = _v1.a;
		return A2(
			$elm$core$Maybe$withDefault,
			{y: _List_Nil, p: data.b.ab},
			A2(
				$elm$core$Maybe$map,
				function (config) {
					return _Utils_update(
		...
		return A4(
			...
			_Utils_update(
				config,
				{
					...
					c: endValue,
					aV: $elm$core$Maybe$Just(startValue)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$BorderRadius$Main$init = _Utils_Tuple2(
	{
		A: $author$project$Anim$Engine$Sub$init(
			_List_fromArray(
				[
					A3(
...
var $author$project$Animation$Sub$BorderRadius$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$BorderRadius$Main$GotSubMsg, model.A);
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{aj: state.aj, o: _List_Nil, X: stillRunning},
				updatedGroups),
			_Utils_ap(
...
var $author$project$Animation$Sub$BorderRadius$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 0:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.A);
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$BorderRadius$Main$roundCorners)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							A: A2($author$project$Anim$Engine$Sub$animate, model.A, $author$project$Animation$Sub$BorderRadius$Main$squareCorners)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$div,
						_Utils_ap(
							A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$BorderRadius$Main$animGroup, model.A),
							_List_fromArray(
								[
...
var $author$project$Animation$Sub$BorderRadius$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$BorderRadius$Main$subscriptions,
		ft: $author$project$Animation$Sub$BorderRadius$Main$update,
		fu: $author$project$Animation$Sub$BorderRadius$Main$view
	});
