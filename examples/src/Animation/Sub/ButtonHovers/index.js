...
var $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight = 50;
var $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth = 160;
...
var $author$project$Anim$Internal$Builder$Size$to = F2(
	function (size, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Size$default, config.aV);
		return A2(
			$author$project$Anim$Internal$Builder$Size$SizeBuilder,
			_Utils_update(
				config,
...
var $author$project$Animation$Sub$ButtonHovers$Main$init = function () {
	var animState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$sizeButton, $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight, $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$scaleButton, $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight, $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth),
				A3($author$project$Anim$Property$Size$initHW, $author$project$Animation$Sub$ButtonHovers$Main$zButton, $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight, $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth)
			]));
	return _Utils_Tuple2(
		{g: animState},
...
var $author$project$Animation$Sub$ButtonHovers$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$ButtonHovers$Main$GotSubMsg, model.g);
};
...
var $author$project$Animation$Sub$ButtonHovers$Main$growSize = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Size$for($author$project$Animation$Sub$ButtonHovers$Main$sizeButton),
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight + 6, $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth + 20),
		A2(
			$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$ButtonHovers$Main$liftUp = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Translate$for($author$project$Animation$Sub$ButtonHovers$Main$zButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$Scale$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Scale$default, config.aV);
		return A2(
			$author$project$Anim$Internal$Builder$Scale$ScaleBuilder,
			_Utils_update(
				config,
...
var $author$project$Animation$Sub$ButtonHovers$Main$scaleDown = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Scale$for($author$project$Animation$Sub$ButtonHovers$Main$scaleButton),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$ButtonHovers$Main$shrinkSize = A2(
	...
	A2(
		$elm$core$Basics$composeR,
		A2($author$project$Anim$Property$Size$toHW, $author$project$Animation$Sub$ButtonHovers$Main$buttonHeight, $author$project$Animation$Sub$ButtonHovers$Main$buttonWidth),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$Property$Size$duration($author$project$Animation$Sub$ButtonHovers$Main$hoverDuration),
			A2(
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$scaleUp)
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$scaleDown)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$growSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$shrinkSize)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$liftUp)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							g: A2($author$project$Anim$Engine$Sub$animate, model.g, $author$project$Animation$Sub$ButtonHovers$Main$setDown)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$defaultOptions = {bR: true, bV: false};
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$Event = F5(
	function (pointerType, pointer, pointerId, isPrimary, contactDetails) {
		return {dE: contactDetails, ek: isPrimary, eD: pointer, eE: pointerId, eF: pointerType};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Pointer$ContactDetails = F5(
	function (width, height, pressure, tiltX, tiltY) {
		return {cj: height, eG: pressure, fj: tiltX, fk: tiltY, c$: width};
	});
...
var $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$Event = F6(
	function (keys, button, clientPos, offsetPos, pagePos, screenPos) {
		return {dv: button, dz: clientPos, em: keys, et: offsetPos, eB: pagePos, eN: screenPos};
	});
...
var $mpizenberg$elm_pointer_events$Internal$Decode$Keys = F4(
	function (alt, ctrl, meta, shift) {
		return {de: alt, dG: ctrl, ep: meta, eT: shift};
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Scale', $author$project$Animation$Sub$ButtonHovers$Main$ScaleHover, $author$project$Animation$Sub$ButtonHovers$Main$ScaleUnhover, $author$project$Animation$Sub$ButtonHovers$Main$scaleButton, model.g),
						A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Size', $author$project$Animation$Sub$ButtonHovers$Main$SizeHover, $author$project$Animation$Sub$ButtonHovers$Main$SizeUnhover, $author$project$Animation$Sub$ButtonHovers$Main$sizeButton, model.g),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								A5($author$project$Animation$Sub$ButtonHovers$Main$button, 'Translate Z', $author$project$Animation$Sub$ButtonHovers$Main$ZHover, $author$project$Animation$Sub$ButtonHovers$Main$ZUnhover, $author$project$Animation$Sub$ButtonHovers$Main$zButton, model.g)
							]))
					]))
			]));
};
var $author$project$Animation$Sub$ButtonHovers$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$ButtonHovers$Main$subscriptions,
		ft: $author$project$Animation$Sub$ButtonHovers$Main$update,
		fu: $author$project$Animation$Sub$ButtonHovers$Main$view
	});
