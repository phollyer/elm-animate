...
var $author$project$Anim$Internal$Builder$initAnimation = {x: $author$project$Anim$Internal$Engine$Shared$AnimGroups$init, aC: $elm$core$Maybe$Nothing, an: $elm$core$Dict$empty};
...
var $author$project$Anim$Internal$Engine$Sub$AnimGroup$init = {ag: 0, aM: $author$project$Anim$Internal$Engine$Sub$Animations$init, bC: 0, bD: $elm$core$Dict$empty, bE: $elm$core$Dict$empty, ab: $author$project$Anim$Internal$Builder$Once, aR: 0, p: $author$project$Anim$Extra$TransformOrder$default};
...
var $author$project$Anim$Internal$Engine$Sub$animate = F2(
	function (_v0, build) {
		...
		return A2(
			...
			{
				ai: $author$project$Anim$Internal$Builder$clearAnimData(
				...
				o: _Utils_ap(state.o, startedEvents),
				W: true
			},
			A3(
				$author$project$Anim$Internal$Engine$Shared$AnimGroups$foldl,
...
var $author$project$Animation$Sub$HelloText$Main$groupName = 'helloText';
var $author$project$Anim$Internal$Builder$Opacity$to = F2(
	function (endPos, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var startPos = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Opacity$default, config.aV);
		return A2(
			$author$project$Anim$Internal$Builder$Opacity$OpacityBuilder,
			_Utils_update(
				config,
				{
					...
					c: endPos,
					aV: $elm$core$Maybe$Just(startPos)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$HelloText$Main$fadeIn = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$Property$Opacity$for($author$project$Animation$Sub$HelloText$Main$groupName),
	A2(
		$elm$core$Basics$composeR,
...
var $author$project$Anim$Internal$Builder$initDefaults = {S: $elm$core$Maybe$Nothing, G: $elm$core$Maybe$Nothing, T: $elm$core$Maybe$Nothing, H: $elm$core$Maybe$Nothing, aa: $elm$core$Maybe$Nothing};
var $author$project$Anim$Internal$Builder$initPlayback = {ag: 0, aD: $elm$core$Dict$empty, aE: $elm$core$Dict$empty, aP: false, ab: $author$project$Anim$Internal$Builder$Once};
...
var $author$project$Anim$Internal$Engine$Sub$init = function (propertyInitializers) {
	if (!propertyInitializers.b) {
		return A2(
			$author$project$Anim$Internal$Engine$Sub$AnimState,
			{
				ai: $author$project$Anim$Internal$Builder$init(_List_Nil),
				o: _List_Nil,
				W: false
			},
			$author$project$Anim$Internal$Engine$Shared$AnimGroups$init);
	...
	function (opacity, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					aV: $elm$core$Maybe$Just(opacity)
				}),
			builder);
	});
...
var $author$project$Animation$Sub$HelloText$Main$init = function () {
	var animState = $author$project$Anim$Engine$Sub$init(
		_List_fromArray(
			[
				A2($author$project$Anim$Property$Opacity$init, $author$project$Animation$Sub$HelloText$Main$groupName, 0)
			]));
	return _Utils_Tuple2(
		{
			ax: A2($author$project$Anim$Engine$Sub$animate, animState, $author$project$Animation$Sub$HelloText$Main$fadeIn)
		},
...
var $author$project$Animation$Sub$HelloText$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $elm$core$Basics$identity, model.ax);
};
...
var $author$project$Anim$Internal$Engine$Sub$update = F2(
	function (msg, _v0) {
		...
		return _Utils_Tuple2(
			A2(
				$author$project$Anim$Internal$Engine$Sub$AnimState,
				{ai: state.ai, o: _List_Nil, W: stillRunning},
				updatedGroups),
			_Utils_ap(
				A2($elm$core$List$map, $author$project$Anim$Internal$Engine$Sub$Control, state.o),
...
var $author$project$Animation$Sub$HelloText$Main$update = F2(
	function (msg, model) {
		var animMsg = msg;
		var _v1 = A2($author$project$Anim$Engine$Sub$update, animMsg, model.ax);
		var animState = _v1.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$elm$html$Html$div,
				A2($author$project$Anim$Engine$Sub$attributes, $author$project$Animation$Sub$HelloText$Main$groupName, model.ax),
				_List_fromArray(
					[
...
var $author$project$Animation$Sub$HelloText$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$HelloText$Main$subscriptions,
		ft: $author$project$Animation$Sub$HelloText$Main$update,
		fu: $author$project$Animation$Sub$HelloText$Main$view
	});
