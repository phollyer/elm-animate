...
var $author$project$Anim$Internal$Builder$Skew$to = F2(
	function (skew, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Skew$default, config.aV);
		return A2(
			$author$project$Anim$Internal$Builder$Skew$SkewBuilder,
			_Utils_update(
				config,
...
var $author$project$Animation$Sub$TransformOrder$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Engine$Sub$subscriptions, $author$project$Animation$Sub$TransformOrder$Main$GotSubMsg, model.o);
};
...
var $author$project$Anim$Internal$Builder$Rotate$to = F2(
	function (endRotate, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		var start = A2($elm$core$Maybe$withDefault, $author$project$Anim$Internal$Property$Rotate$default, config.aV);
		return A2(
			$author$project$Anim$Internal$Builder$Rotate$RotateBuilder,
			_Utils_update(
				config,
...
var $author$project$Animation$Sub$TransformOrder$Main$animatePermutation = function (perm) {
	var key = $author$project$Animation$Sub$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
...
var $author$project$Animation$Sub$TransformOrder$Main$resetPermutation = function (perm) {
	var key = $author$project$Animation$Sub$TransformOrder$Main$permutationKey(perm);
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$Property$Translate$for(key),
...
var $author$project$Animation$Sub$TransformOrder$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 4:
				var subMsg = msg.a;
				var _v1 = A2($author$project$Anim$Engine$Sub$update, subMsg, model.o);
						...
						model,
						{
							o: A2(
								...
								A2(
									...
									$author$project$Animation$Sub$TransformOrder$Main$animatePermutation(perm)))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				var perm = msg.a;
						...
						model,
						{
							o: A2(
								...
								A2(
									...
									$author$project$Anim$Engine$Sub$transformOrder(
										$author$project$Animation$Sub$TransformOrder$Main$permutationOrder(perm)),
									$author$project$Animation$Sub$TransformOrder$Main$resetPermutation(perm)))
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
				return _Utils_Tuple2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Animation$Sub$TransformOrder$Main$animationArea(model.o)
			]));
};
var $author$project$Animation$Sub$TransformOrder$Main$main = $elm$browser$Browser$element(
	{
		...
		e2: $author$project$Animation$Sub$TransformOrder$Main$subscriptions,
		ft: $author$project$Animation$Sub$TransformOrder$Main$update,
		fu: $author$project$Animation$Sub$TransformOrder$Main$view
	});
