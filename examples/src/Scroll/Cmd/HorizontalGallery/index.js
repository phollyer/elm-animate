...
{
	if (region.a9.ar === region.bn.ar)
	{
		return 'on line ' + region.a9.ar;
	}
	return 'on lines ' + region.a9.ar + ' through ' + region.bn.ar;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cW: 'hidden', cx: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cW: 'mozHidden', cx: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cW: 'msHidden', cx: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cW: 'webkitHidden', cx: 'webkitvisibilitychange' }
		: { cW: 'hidden', cx: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bq: fragment, bu: host, bM: path, bO: port_, bR: protocol, bS: query};
	});
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$ScrollComplete = {$: 1};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {O: 0, ah: $elm$core$Maybe$Nothing, aQ: _List_Nil, av: $elm$core$Maybe$Nothing};
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ah,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.av, config.bW))));
};
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$scrollToCard = function (cardId) {
	return A2(
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var cardId = msg.a;
			return _Utils_Tuple2(
				...
				A2(
					...
					$author$project$Scroll$Cmd$HorizontalGallery$Main$ScrollComplete,
					$author$project$Scroll$Cmd$HorizontalGallery$Main$scrollToCard(cardId)));
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Scroll$Cmd$HorizontalGallery$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$navButton = function (photo) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Cmd$HorizontalGallery$Main$ScrollTo(photo.y)),
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$photos = _List_fromArray(
	[
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$buttonRow = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Cmd$HorizontalGallery$Main$navButton, $author$project$Scroll$Cmd$HorizontalGallery$Main$photos));
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$photoCard = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Scroll$Cmd$HorizontalGallery$Main$filmStrip = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Cmd$HorizontalGallery$Main$photoCard, $author$project$Scroll$Cmd$HorizontalGallery$Main$photos));
var $author$project$Scroll$Cmd$HorizontalGallery$Main$view = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[$author$project$Scroll$Cmd$HorizontalGallery$Main$buttonRow, $author$project$Scroll$Cmd$HorizontalGallery$Main$filmStrip]));
};
var $author$project$Scroll$Cmd$HorizontalGallery$Main$main = $elm$browser$Browser$element(
	{
		c1: function (_v0) {
			return _Utils_Tuple2(
				{},
		...
		dP: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		eb: $author$project$Scroll$Cmd$HorizontalGallery$Main$update,
		ec: $author$project$Scroll$Cmd$HorizontalGallery$Main$view
	});
_Platform_export({'Scroll':{'Cmd':{'HorizontalGallery':{'Main':{'init':$author$project$Scroll$Cmd$HorizontalGallery$Main$main(
