...
{
	if (region.bb.as === region.bp.as)
	{
		return 'on line ' + region.bb.as;
	}
	return 'on lines ' + region.bb.as + ' through ' + region.bp.as;
}
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$Idle = 0;
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$Arrived = 2;
var $author$project$Scroll$Cmd$Spreadsheet$Main$ScrollComplete = {$: 1};
var $author$project$Scroll$Cmd$Spreadsheet$Main$Scrolling = 1;
...
var $author$project$Scroll$Internal$Engine$Task$buildConfig = function (scrollBuilder) {
	return {
		...
		ax: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
	};
};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {K: 0, ai: $elm$core$Maybe$Nothing, aS: _List_Nil, ax: $elm$core$Maybe$Nothing};
		...
		switch (_v0) {
			...
			default:
				...
				var frames = A2(
					$elm$core$Basics$max,
					1,
					A2($author$project$Scroll$Internal$Engine$Task$timingToSpeed, config.ax, maxDistance));
...
var $author$project$Scroll$Internal$Engine$Task$getTargetPositions = F4(
	function (element, viewport, container, config) {
		...
		if (container.$ === 1) {
			...
			return _Utils_Tuple2(((viewport.s + element.s) - offsetX) - containerInfo.a$.s, ((viewport.t + element.t) - offsetY) - containerInfo.a$.t);
		}
	});
...
var $author$project$Scroll$Internal$Engine$Cmd$scroll = F2(
	function (completionMsg, buildAnimation) {
			...
			A2(
				...
				function (target) {
					return A2(
						...
						$elm$core$Basics$always(completionMsg),
						A2($author$project$Scroll$Internal$Engine$Task$routeScrollTarget, target, config));
				},
				$author$project$Scroll$Internal$ScrollBuilder$getScrollTargets(scrollBuilder)));
	});
var $author$project$Scroll$Engine$Cmd$scroll = $author$project$Scroll$Internal$Engine$Cmd$scroll;
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				aS: A2($elm$core$List$cons, scrollTarget, data.aS)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ai,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.ax, config.bY))));
};
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$scrollToRegion = function (regionId) {
	return A2(
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var regionId = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					...
					{au: 1}),
				A2(
					$author$project$Scroll$Engine$Cmd$scroll,
					$author$project$Scroll$Cmd$Spreadsheet$Main$ScrollComplete,
					$author$project$Scroll$Cmd$Spreadsheet$Main$scrollToRegion(regionId)));
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$NavigateTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$regionButton = function (region) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Cmd$Spreadsheet$Main$NavigateTo(region.N)),
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$regions = _List_fromArray(
	[
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$navButtons = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Cmd$Spreadsheet$Main$regionButton, $author$project$Scroll$Cmd$Spreadsheet$Main$regions));
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$findRegion = F2(
	function (col, row) {
		return $elm$core$List$head(
			A2(
				...
				$author$project$Scroll$Cmd$Spreadsheet$Main$regions));
	});
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$dataCell = F2(
	function (row, col) {
		var _v0 = A2($author$project$Scroll$Cmd$Spreadsheet$Main$findRegion, col, row);
		if (!_v0.$) {
			var region = _v0.a;
			return A2(
				$elm$html$Html$div,
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$numCols = 16;
var $author$project$Scroll$Cmd$Spreadsheet$Main$rowNumCell = function (row) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$dataRow = function (row) {
	return A2(
		$elm$core$List$cons,
		$author$project$Scroll$Cmd$Spreadsheet$Main$rowNumCell(row),
		A2(
			$elm$core$List$map,
			$author$project$Scroll$Cmd$Spreadsheet$Main$dataCell(row),
			A2($elm$core$List$range, 1, $author$project$Scroll$Cmd$Spreadsheet$Main$numCols)));
};
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$colLabel = function (i) {
	return $elm$core$String$fromChar(
		$elm$core$Char$fromCode(64 + i));
};
var $author$project$Scroll$Cmd$Spreadsheet$Main$colHeaderCell = function (col) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Scroll$Cmd$Spreadsheet$Main$colLabel(col))
			]));
};
var $author$project$Scroll$Cmd$Spreadsheet$Main$cornerCell = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'sticky'),
	...
	_List_Nil);
var $author$project$Scroll$Cmd$Spreadsheet$Main$headerRow = A2(
	$elm$core$List$cons,
	$author$project$Scroll$Cmd$Spreadsheet$Main$cornerCell,
	A2(
		$elm$core$List$map,
		$author$project$Scroll$Cmd$Spreadsheet$Main$colHeaderCell,
		A2($elm$core$List$range, 1, $author$project$Scroll$Cmd$Spreadsheet$Main$numCols)));
var $author$project$Scroll$Cmd$Spreadsheet$Main$numRows = 35;
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$spreadsheet = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					'48px ' + A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$repeat, $author$project$Scroll$Cmd$Spreadsheet$Main$numCols, '96px'))),
					A2($elm$html$Html$Attributes$style, 'width', 'max-content')
				]),
			_Utils_ap(
				$author$project$Scroll$Cmd$Spreadsheet$Main$headerRow,
				A2(
					$elm$core$List$concatMap,
					$author$project$Scroll$Cmd$Spreadsheet$Main$dataRow,
					A2($elm$core$List$range, 1, $author$project$Scroll$Cmd$Spreadsheet$Main$numRows))))
		]));
var $author$project$Scroll$Cmd$Spreadsheet$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status) {
			case 0:
...
var $author$project$Scroll$Cmd$Spreadsheet$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Scroll$Cmd$Spreadsheet$Main$navButtons,
				$author$project$Scroll$Cmd$Spreadsheet$Main$statusBar(model.au),
				$author$project$Scroll$Cmd$Spreadsheet$Main$spreadsheet
			]));
};
var $author$project$Scroll$Cmd$Spreadsheet$Main$main = $elm$browser$Browser$element(
	{
		c2: function (_v0) {
			return _Utils_Tuple2(
				{au: 0},
		...
		ec: $author$project$Scroll$Cmd$Spreadsheet$Main$update,
		ed: $author$project$Scroll$Cmd$Spreadsheet$Main$view
	});
_Platform_export({'Scroll':{'Cmd':{'Spreadsheet':{'Main':{'init':$author$project$Scroll$Cmd$Spreadsheet$Main$main(
