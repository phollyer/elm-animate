...
{
	if (region.a8.ao === region.bm.ao)
	{
		return 'on line ' + region.a8.ao;
	}
	return 'on lines ' + region.a8.ao + ' through ' + region.bm.ao;
}
...
var $author$project$Scroll$Cmd$FirstScroll$Main$Idle = 0;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Scroll$Cmd$FirstScroll$Main$init = function (_v0) {
...
var $author$project$Scroll$Cmd$FirstScroll$Main$Arrived = 2;
var $author$project$Scroll$Cmd$FirstScroll$Main$ScrollComplete = {$: 1};
var $author$project$Scroll$Cmd$FirstScroll$Main$Scrolling = 1;
...
var $author$project$Scroll$Internal$Engine$Task$buildConfig = function (scrollBuilder) {
	return {
		...
		at: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
	};
};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {K: 0, ae: $elm$core$Maybe$Nothing, aP: _List_Nil, at: $elm$core$Maybe$Nothing};
		...
		switch (_v0) {
			...
			default:
				...
				var frames = A2(
					$elm$core$Basics$max,
					1,
					A2($author$project$Scroll$Internal$Engine$Task$timingToSpeed, config.at, maxDistance));
...
var $author$project$Scroll$Internal$Engine$Task$getTargetPositions = F4(
	function (element, viewport, container, config) {
		...
		if (container.$ === 1) {
			...
			return _Utils_Tuple2(((viewport.s + element.s) - offsetX) - containerInfo.aY.s, ((viewport.t + element.t) - offsetY) - containerInfo.aY.t);
		}
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ae,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.at, config.bV))));
};
...
var $author$project$Scroll$Cmd$FirstScroll$Main$scrollToElement = function (targetId) {
	return A2(
...
var $author$project$Scroll$Cmd$FirstScroll$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var targetId = msg.a;
			return _Utils_Tuple2(
				...
				A2(
					...
					$author$project$Scroll$Cmd$FirstScroll$Main$ScrollComplete,
					$author$project$Scroll$Cmd$FirstScroll$Main$scrollToElement(targetId)));
		} else {
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$Scroll$Cmd$FirstScroll$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Cmd$FirstScroll$Main$spacer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$Scroll$Cmd$FirstScroll$Main$targetElement = F3(
...
var $author$project$Scroll$Cmd$FirstScroll$Main$scrollContent = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A3($author$project$Scroll$Cmd$FirstScroll$Main$targetElement, 'top-element', 'Top Section', '#4CAF50'),
			$author$project$Scroll$Cmd$FirstScroll$Main$spacer,
			A3($author$project$Scroll$Cmd$FirstScroll$Main$targetElement, 'middle-element', 'Middle Section', '#2196F3'),
			$author$project$Scroll$Cmd$FirstScroll$Main$spacer,
			A3($author$project$Scroll$Cmd$FirstScroll$Main$targetElement, 'bottom-element', 'Bottom Section', '#9C27B0')
		]));
var $author$project$Scroll$Cmd$FirstScroll$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status) {
			case 0:
...
var $author$project$Scroll$Cmd$FirstScroll$Main$styledButton = F2(
	function (msg, label) {
		return A2(
...
var $author$project$Scroll$Cmd$FirstScroll$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2(
						$author$project$Scroll$Cmd$FirstScroll$Main$styledButton,
						$author$project$Scroll$Cmd$FirstScroll$Main$ScrollTo('top-element'),
						'Scroll to Top'),
						A2(
						$author$project$Scroll$Cmd$FirstScroll$Main$styledButton,
						$author$project$Scroll$Cmd$FirstScroll$Main$ScrollTo('middle-element'),
						'Scroll to Middle'),
						A2(
						$author$project$Scroll$Cmd$FirstScroll$Main$styledButton,
						$author$project$Scroll$Cmd$FirstScroll$Main$ScrollTo('bottom-element'),
						'Scroll to Bottom')
					])),
				$author$project$Scroll$Cmd$FirstScroll$Main$statusBar(model.aq),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[$author$project$Scroll$Cmd$FirstScroll$Main$scrollContent]))
			]));
};
var $author$project$Scroll$Cmd$FirstScroll$Main$main = $elm$browser$Browser$element(
	{
		c0: $author$project$Scroll$Cmd$FirstScroll$Main$init,
		dO: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		ea: $author$project$Scroll$Cmd$FirstScroll$Main$update,
		eb: $author$project$Scroll$Cmd$FirstScroll$Main$view
	});
_Platform_export({'Scroll':{'Cmd':{'FirstScroll':{'Main':{'init':$author$project$Scroll$Cmd$FirstScroll$Main$main(
