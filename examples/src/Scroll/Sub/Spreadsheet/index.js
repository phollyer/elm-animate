...
{
	if (region.bo.aG === region.bC.aG)
	{
		return 'on line ' + region.bo.aG;
	}
	return 'on lines ' + region.bo.aG + ' through ' + region.bC.aG;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bF: fragment, bK: host, b0: path, b2: port_, b5: protocol, b6: query};
	});
...
var $author$project$Scroll$Sub$Spreadsheet$Main$Idle = {$: 0};
...
var $author$project$Scroll$Sub$Spreadsheet$Main$init = {ap: $author$project$Scroll$Engine$Sub$init, aI: $author$project$Scroll$Sub$Spreadsheet$Main$Idle};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Scroll$Sub$Spreadsheet$Main$GotScrollMsg = function (a) {
	return {$: 1, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bj: oldTime, b8: request, cd: subs};
	});
...
var $author$project$Scroll$Sub$Spreadsheet$Main$subscriptions = function (model) {
	return A2($author$project$Scroll$Engine$Sub$subscriptions, $author$project$Scroll$Sub$Spreadsheet$Main$GotScrollMsg, model.ap);
};
var $author$project$Scroll$Sub$Spreadsheet$Main$Arrived = {$: 2};
var $author$project$Scroll$Sub$Spreadsheet$Main$Scrolling = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Scroll$Sub$Spreadsheet$Main$applyEvent = F2(
	function (event, _v0) {
		switch (event.$) {
			case 6:
				var pos = event.b;
				var progress = event.c;
				return A2($author$project$Scroll$Sub$Spreadsheet$Main$Scrolling, pos, progress);
			case 1:
				return $author$project$Scroll$Sub$Spreadsheet$Main$Arrived;
			default:
				return $author$project$Scroll$Sub$Spreadsheet$Main$Idle;
		}
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {bB: 0, bb: $elm$core$Maybe$Nothing, a3: _List_Nil, aa: $elm$core$Maybe$Nothing};
							...
							A4(
								...
								F3(
									function (viewport, containerEl, element) {
										return {
											aS: containerEl,
											a4: $elm$core$Maybe$Just(element),
											s: viewport
										};
									}),
							...
							A3(
								...
								F2(
									function (viewport, containerEl) {
										return {aS: containerEl, a4: $elm$core$Maybe$Nothing, s: viewport};
									}),
								$author$project$Scroll$Internal$Shared$Dom$getViewport(container),
								$author$project$Scroll$Internal$Shared$Dom$getContainerInfo(container)));
					}
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				a3: A2($elm$core$List$cons, scrollTarget, data.a3)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				bb: $elm$core$Maybe$Just(easingFn)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.bb,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.aa, config.cb))));
};
		...
		return _Utils_update(
			config,
			{
				a: _Utils_update(
					targetData,
					{
						aH: _Utils_Tuple2(offsetX, offsetY)
					})
			});
	});
var $author$project$Scroll$Builder$withOffsetXY = $author$project$Scroll$Internal$ScrollBuilder$withOffsetXY;
var $author$project$Scroll$Sub$Spreadsheet$Main$scrollToRegion = function (regionId) {
	return A2(
...
var $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault = function (_v0) {
	var data = _v0;
	return A2($elm$core$Maybe$withDefault, $author$project$Motion$Easing$QuintOut, data.bb);
};
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationConfig = F2(
	function (scrollBuilder, scrollTarget) {
		return {
			ad: $author$project$Scroll$Internal$Shared$ScrollTarget$getAxis(scrollTarget),
			h: $author$project$Scroll$Internal$Shared$Container$toContainer(
				$author$project$Scroll$Internal$Shared$ScrollTarget$getContainerId(scrollTarget)),
			bB: $author$project$Scroll$Internal$ScrollBuilder$getDelayWithDefault(scrollBuilder),
			bb: $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault(scrollBuilder),
			aA: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetX(scrollTarget),
			aB: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetY(scrollTarget),
			cf: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
		};
	});
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromDom = F4(
	function (scrollBuilder, scrollTarget, domResult, element) {
		...
		var elementContentPosition = function () {
			var _v3 = domResult.aS;
			if (!_v3.$) {
				var containerEl = _v3.a;
				return {d: ((element.av.d - containerEl.av.d) + viewport.s.d) - offsetX, e: ((element.av.e - containerEl.av.e) + viewport.s.e) - offsetY};
			} else {
				return {d: (element.av.d + viewport.s.d) - offsetX, e: (element.av.e + viewport.s.e) - offsetY};
			}
		}();
		...
		var clampedTarget = {
			d: A3($elm$core$Basics$clamp, 0, viewport.ca.cj - viewport.s.cj, targetPosition.d),
			e: A3($elm$core$Basics$clamp, 0, viewport.ca.bH - viewport.s.bH, targetPosition.e)
		};
		var config = _Utils_update(
			baseConfig,
			{aA: clampedTarget.d, aB: clampedTarget.e});
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ad, startPosition.d, startPosition.e, clampedTarget.d, clampedTarget.e);
		...
		return {c: config, K: startPosition.d, L: startPosition.e, ah: delayMs === 0.0, au: delayMs, aX: actualDuration, E: 0.0, y: false, Z: 0.0, B: startPosition.d, C: startPosition.e};
	});
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromViewport = F3(
	function (scrollBuilder, scrollTarget, viewport) {
		...
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ad, startPosition.d, startPosition.e, targetPosition.d, targetPosition.e);
		var actualDuration = function () {
...
var $author$project$Scroll$Internal$Engine$Sub$updateScrollAnimation = F2(
	function (deltaMs, animation) {
		if (!animation.ah) {
			var newElapsedMs = animation.E + deltaMs;
			return (_Utils_cmp(newElapsedMs, animation.au) > -1) ? _Utils_update(
				animation,
				{ah: true, E: 0.0}) : _Utils_update(
				animation,
				{E: newElapsedMs});
		} else {
			var newElapsedMs = animation.E + deltaMs;
			var progress = A2($elm$core$Basics$min, 1.0, newElapsedMs / animation.aX);
			var easingFunction = $author$project$Shared$Easing$toFunction(animation.c.bb);
			var easedProgress = easingFunction(progress);
			var newCurrentX = function () {
				var _v1 = animation.c.ad;
				if (_v1 === 1) {
					return animation.B;
				} else {
					return animation.B + ((animation.c.aA - animation.B) * easedProgress);
				}
			}();
			var newCurrentY = function () {
				var _v0 = animation.c.ad;
				if (!_v0) {
					return animation.C;
				} else {
					return animation.C + ((animation.c.aB - animation.C) * easedProgress);
				}
			}();
			return _Utils_update(
				animation,
				{K: newCurrentX, L: newCurrentY, E: newElapsedMs, Z: progress});
		}
	});
	...
	function (fromInternalEvent, toMsg, msg, _v0) {
		...
		switch (msg.$) {
						...
						function (scrollId, scrollAnim, _v3) {
							...
							if (scrollAnim.y) {
								...
								var scrollCmd = A2(
									...
									A3($author$project$Scroll$Internal$Shared$Dom$setViewport, updatedScroll.c.h, updatedScroll.K, updatedScroll.L));
								...
								var progressEvent = A3(
									...
									cid,
									{d: updatedScroll.K, e: updatedScroll.L},
									updatedScroll.Z);
								if (updatedScroll.Z < 1.0) {
									return _Utils_Tuple3(
			...
			case 1:
				...
				var hasDistance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, scrollAnimation.c.ad, scrollAnimation.B, scrollAnimation.C, scrollAnimation.c.aA, scrollAnimation.c.aB) > 0;
...
var $author$project$Scroll$Sub$Spreadsheet$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var regionId = msg.a;
			var _v1 = A3(
				$author$project$Scroll$Engine$Sub$scroll,
				$author$project$Scroll$Sub$Spreadsheet$Main$GotScrollMsg,
				model.ap,
				$author$project$Scroll$Sub$Spreadsheet$Main$scrollToRegion(regionId));
			...
			var scrollMsg = msg.a;
			var _v2 = A3($author$project$Scroll$Engine$Sub$update, $author$project$Scroll$Sub$Spreadsheet$Main$GotScrollMsg, scrollMsg, model.ap);
			...
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						ap: newScrollState,
						aI: A3($elm$core$List$foldl, $author$project$Scroll$Sub$Spreadsheet$Main$applyEvent, model.aI, events)
					}),
				scrollCmd);
		}
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Scroll$Sub$Spreadsheet$Main$NavigateTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Sub$Spreadsheet$Main$regionButton = function (region) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Sub$Spreadsheet$Main$NavigateTo(region.V)),
				A2($elm$html$Html$Attributes$style, 'padding', '8px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2($elm$html$Html$Attributes$style, 'background-color', region.R),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(region.U + (' ' + region.W))
			]));
};
var $author$project$Scroll$Sub$Spreadsheet$Main$regions = _List_fromArray(
	[
		{af: 4, R: '#3b6fa0', U: '💰', V: 'region-revenue', W: 'Revenue', ao: 5},
		{af: 10, R: '#a03b3b', U: '📉', V: 'region-expenses', W: 'Expenses', ao: 13},
		{af: 7, R: '#3b8050', U: '📈', V: 'region-forecast', W: 'Forecast', ao: 22},
		{af: 13, R: '#7a6b30', U: '📊', V: 'region-summary', W: 'Summary', ao: 30},
		{af: 16, R: '#6b3a8b', U: '🚀', V: 'region-growth', W: 'YoY Growth', ao: 35}
	]);
var $author$project$Scroll$Sub$Spreadsheet$Main$navButtons = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Sub$Spreadsheet$Main$regionButton, $author$project$Scroll$Sub$Spreadsheet$Main$regions));
...
var $author$project$Scroll$Sub$Spreadsheet$Main$findRegion = F2(
	function (col, row) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (r) {
					return _Utils_eq(r.af, col) && _Utils_eq(r.ao, row);
				},
				$author$project$Scroll$Sub$Spreadsheet$Main$regions));
	});
...
var $author$project$Scroll$Sub$Spreadsheet$Main$dataCell = F2(
	function (row, col) {
		var _v0 = A2($author$project$Scroll$Sub$Spreadsheet$Main$findRegion, col, row);
		if (!_v0.$) {
			var region = _v0.a;
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id(region.V),
						A2($elm$html$Html$Attributes$style, 'background-color', region.R),
						A2($elm$html$Html$Attributes$style, 'color', 'white'),
...
var $author$project$Scroll$Sub$Spreadsheet$Main$numCols = 16;
var $author$project$Scroll$Sub$Spreadsheet$Main$rowNumCell = function (row) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Scroll$Sub$Spreadsheet$Main$dataRow = function (row) {
	return A2(
		$elm$core$List$cons,
		$author$project$Scroll$Sub$Spreadsheet$Main$rowNumCell(row),
		A2(
			$elm$core$List$map,
			$author$project$Scroll$Sub$Spreadsheet$Main$dataCell(row),
			A2($elm$core$List$range, 1, $author$project$Scroll$Sub$Spreadsheet$Main$numCols)));
};
...
var $author$project$Scroll$Sub$Spreadsheet$Main$colLabel = function (i) {
	return $elm$core$String$fromChar(
		$elm$core$Char$fromCode(64 + i));
};
var $author$project$Scroll$Sub$Spreadsheet$Main$colHeaderCell = function (col) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Scroll$Sub$Spreadsheet$Main$colLabel(col))
			]));
};
var $author$project$Scroll$Sub$Spreadsheet$Main$cornerCell = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'sticky'),
	...
	_List_Nil);
var $author$project$Scroll$Sub$Spreadsheet$Main$headerRow = A2(
	$elm$core$List$cons,
	$author$project$Scroll$Sub$Spreadsheet$Main$cornerCell,
	A2(
		$elm$core$List$map,
		$author$project$Scroll$Sub$Spreadsheet$Main$colHeaderCell,
		A2($elm$core$List$range, 1, $author$project$Scroll$Sub$Spreadsheet$Main$numCols)));
var $author$project$Scroll$Sub$Spreadsheet$Main$numRows = 35;
...
var $author$project$Scroll$Sub$Spreadsheet$Main$spreadsheet = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					'48px ' + A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$repeat, $author$project$Scroll$Sub$Spreadsheet$Main$numCols, '96px'))),
					A2($elm$html$Html$Attributes$style, 'width', 'max-content')
				]),
			_Utils_ap(
				$author$project$Scroll$Sub$Spreadsheet$Main$headerRow,
				A2(
					$elm$core$List$concatMap,
					$author$project$Scroll$Sub$Spreadsheet$Main$dataRow,
					A2($elm$core$List$range, 1, $author$project$Scroll$Sub$Spreadsheet$Main$numRows))))
		]));
var $author$project$Scroll$Sub$Spreadsheet$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status.$) {
			case 0:
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					'x = ' + ($elm$core$String$fromInt(
						$elm$core$Basics$round(pos.d)) + ('px  y = ' + ($elm$core$String$fromInt(
						$elm$core$Basics$round(pos.e)) + ('px  (' + ($elm$core$String$fromInt(
...
var $author$project$Scroll$Sub$Spreadsheet$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Scroll$Sub$Spreadsheet$Main$navButtons,
				$author$project$Scroll$Sub$Spreadsheet$Main$statusBar(model.aI),
				$author$project$Scroll$Sub$Spreadsheet$Main$spreadsheet
			]));
};
var $author$project$Scroll$Sub$Spreadsheet$Main$main = $elm$browser$Browser$element(
	{
		dj: function (_v0) {
			return _Utils_Tuple2($author$project$Scroll$Sub$Spreadsheet$Main$init, $elm$core$Platform$Cmd$none);
		},
		d5: $author$project$Scroll$Sub$Spreadsheet$Main$subscriptions,
		et: $author$project$Scroll$Sub$Spreadsheet$Main$update,
		eu: $author$project$Scroll$Sub$Spreadsheet$Main$view
	});
_Platform_export({'Scroll':{'Sub':{'Spreadsheet':{'Main':{'init':$author$project$Scroll$Sub$Spreadsheet$Main$main(
