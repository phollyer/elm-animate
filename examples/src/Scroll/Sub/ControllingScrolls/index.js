...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c9: 'hidden', cM: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c9: 'mozHidden', cM: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c9: 'msHidden', cM: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c9: 'webkitHidden', cM: 'webkitvisibilitychange' }
		: { c9: 'hidden', cM: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bB: fragment, bG: host, bY: path, b_: port_, b1: protocol, b2: query};
	});
...
var $author$project$Scroll$Internal$Engine$Sub$init = {r: _List_Nil, f: $elm$core$Dict$empty};
var $author$project$Scroll$Engine$Sub$init = $author$project$Scroll$Internal$Engine$Sub$init;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Scroll$Sub$ControllingScrolls$Main$init = _Utils_Tuple2(
	{n: $author$project$Scroll$Engine$Sub$init},
	$elm$core$Platform$Cmd$none);
var $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg = function (a) {
	return {$: 6, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bf: oldTime, b4: request, b9: subs};
	});
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$subscriptions = function (model) {
	return A2($author$project$Scroll$Engine$Sub$subscriptions, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, model.n);
};
var $author$project$Scroll$Engine$Sub$containerToId = function (container) {
	if (!container.$) {
		return 'document';
	} else {
...
var $author$project$Scroll$Internal$Engine$Sub$Paused = function (a) {
	return {$: 4, a: a};
};
var $author$project$Scroll$Internal$Engine$Sub$containerMatches = F2(
...
var $author$project$Scroll$Internal$Engine$Sub$pause = F2(
	function (containerId, _v0) {
		var scrollData = _v0;
		var _v1 = A3(
			$elm$core$Dict$foldl,
			F3(
				function (scrollId, scrollAnim, _v2) {
					var accScrolls = _v2.a;
					var accEvents = _v2.b;
					return (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h) && (!scrollAnim.z)) ? _Utils_Tuple2(
						A3(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									$author$project$Scroll$Internal$Engine$Sub$Paused(
									$author$project$Scroll$Internal$Engine$Sub$containerToString(scrollAnim.c.h))
								]))) : _Utils_Tuple2(
						A3($elm$core$Dict$insert, scrollId, scrollAnim, accScrolls),
						accEvents);
				}),
			_Utils_Tuple2($elm$core$Dict$empty, scrollData.r),
			scrollData.f);
		var updatedScrolls = _v1.a;
		var newPendingEvents = _v1.b;
		return _Utils_update(
			scrollData,
			{r: newPendingEvents, f: updatedScrolls});
	});
var $author$project$Scroll$Engine$Sub$pause = function (container) {
	return $author$project$Scroll$Internal$Engine$Sub$pause(
		$author$project$Scroll$Engine$Sub$containerToId(container));
};
...
var $author$project$Scroll$Internal$Engine$Sub$reset = F3(
		...
		var _v1 = A3(
			...
			F3(
				function (scrollId, scrollAnim, _v2) {
					var accScrolls = _v2.a;
					var accCmds = _v2.b;
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var updatedScroll = _Utils_update(
							scrollAnim,
							{M: scrollAnim.C, N: scrollAnim.D, ae: scrollAnim.aq === 0.0, F: 0.0, z: true, X: 0.0});
						var scrollCmd = A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return toMsg($author$project$Scroll$Internal$Engine$Sub$NoOp);
							},
							A3($author$project$Scroll$Internal$Shared$Dom$setViewport, scrollAnim.c.h, scrollAnim.C, scrollAnim.D));
...
var $author$project$Scroll$Engine$Sub$reset = F3(
	function (container, toMsg, scrollState) {
		return A3(
			$author$project$Scroll$Internal$Engine$Sub$reset,
			$author$project$Scroll$Engine$Sub$containerToId(container),
			toMsg,
			scrollState);
	});
var $author$project$Scroll$Internal$Engine$Sub$Restarted = function (a) {
	return {$: 6, a: a};
};
var $author$project$Scroll$Internal$Engine$Sub$restart = F3(
	function (containerId, toMsg, _v0) {
		var scrollData = _v0;
		var _v1 = A3(
			$elm$core$Dict$foldl,
			F3(
				function (scrollId, scrollAnim, _v2) {
					...
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var updatedScroll = _Utils_update(
							scrollAnim,
							{M: scrollAnim.C, N: scrollAnim.D, ae: scrollAnim.aq === 0.0, F: 0.0, z: false, X: 0.0});
						var scrollCmd = A2(
							$elm$core$Task$attempt,
							function (_v3) {
								return toMsg($author$project$Scroll$Internal$Engine$Sub$NoOp);
						...
						return _Utils_Tuple3(
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										$author$project$Scroll$Internal$Engine$Sub$Restarted(
										$author$project$Scroll$Internal$Engine$Sub$containerToString(scrollAnim.c.h))
									])));
					} else {
						return _Utils_Tuple3(
			...
			_Utils_Tuple3($elm$core$Dict$empty, _List_Nil, scrollData.r),
			scrollData.f);
		var updatedScrolls = _v1.a;
		var scrollCmds = _v1.b;
		var newPendingEvents = _v1.c;
		return _Utils_Tuple2(
			_Utils_update(
				scrollData,
				{r: newPendingEvents, f: updatedScrolls}),
...
var $author$project$Scroll$Engine$Sub$restart = F3(
	function (container, toMsg, scrollState) {
		return A3(
			$author$project$Scroll$Internal$Engine$Sub$restart,
			$author$project$Scroll$Engine$Sub$containerToId(container),
			toMsg,
			scrollState);
	});
var $author$project$Scroll$Internal$Engine$Sub$Resumed = function (a) {
	return {$: 5, a: a};
};
var $author$project$Scroll$Internal$Engine$Sub$resume = F2(
	function (containerId, _v0) {
		var scrollData = _v0;
		var _v1 = A3(
			$elm$core$Dict$foldl,
				...
				function (scrollId, scrollAnim, _v2) {
					...
					return (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h) && scrollAnim.z) ? _Utils_Tuple2(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									$author$project$Scroll$Internal$Engine$Sub$Resumed(
									$author$project$Scroll$Internal$Engine$Sub$containerToString(scrollAnim.c.h))
								]))) : _Utils_Tuple2(
						A3($elm$core$Dict$insert, scrollId, scrollAnim, accScrolls),
						accEvents);
...
var $author$project$Scroll$Engine$Sub$resume = function (container) {
	return $author$project$Scroll$Internal$Engine$Sub$resume(
		$author$project$Scroll$Engine$Sub$containerToId(container));
};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {bx: 0, a7: $elm$core$Maybe$Nothing, a$: _List_Nil, Z: $elm$core$Maybe$Nothing};
...
var $author$project$Scroll$Internal$Engine$Sub$scroll = F3(
	function (toMsg, _v0, buildAnimation) {
		...
		var initScrollState = {r: _List_Nil, f: $elm$core$Dict$empty};
		var domQueries = A2(
							...
							A4(
								...
								F3(
									function (viewport, containerEl, element) {
										return {
											aN: containerEl,
											a0: $elm$core$Maybe$Just(element),
											t: viewport
										};
									}),
							...
							A3(
								...
								F2(
									function (viewport, containerEl) {
										return {aN: containerEl, a0: $elm$core$Maybe$Nothing, t: viewport};
									}),
								$author$project$Scroll$Internal$Shared$Dom$getViewport(container),
								$author$project$Scroll$Internal$Shared$Dom$getContainerInfo(container)));
					}
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				a$: A2($elm$core$List$cons, scrollTarget, data.a$)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				a7: $elm$core$Maybe$Just(easingFn)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.a7,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.Z, config.b7))));
};
var $author$project$Scroll$Builder$build = $author$project$Scroll$Internal$ScrollBuilder$build;
var $author$project$Scroll$Sub$ControllingScrolls$Main$containerId = 'scroll-container';
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$for = function (containerId) {
	return {
		...
		o: A2($author$project$Scroll$Internal$Shared$ScrollTarget$Coordinates, 0, 0)
	};
};
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$targetId = 'scroll-target';
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$toElement = F2(
	function (elementId, _v0) {
		...
		return _Utils_update(
			data,
			{
				o: $author$project$Scroll$Internal$Shared$ScrollTarget$Element(elementId)
			});
	});
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$scrollAnimation = A2(
	$elm$core$Basics$composeR,
	$author$project$Scroll$Builder$forContainer($author$project$Scroll$Sub$ControllingScrolls$Main$containerId),
	A2(
		$elm$core$Basics$composeR,
		$author$project$Scroll$Builder$toElement($author$project$Scroll$Sub$ControllingScrolls$Main$targetId),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Scroll$Builder$speed(200),
			A2(
				$elm$core$Basics$composeR,
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer = $author$project$Scroll$Engine$Sub$Container($author$project$Scroll$Sub$ControllingScrolls$Main$containerId);
var $author$project$Scroll$Internal$Engine$Sub$Stopped = function (a) {
	return {$: 3, a: a};
};
var $author$project$Scroll$Internal$Engine$Sub$stop = F3(
	function (containerId, toMsg, _v0) {
		var scrollData = _v0;
		var _v1 = A3(
			$elm$core$Dict$foldl,
				...
				function (scrollId, scrollAnim, _v2) {
					...
					if (A2($author$project$Scroll$Internal$Engine$Sub$containerMatches, containerId, scrollAnim.c.h)) {
						var scrollCmd = A2(
							...
							A3($author$project$Scroll$Internal$Shared$Dom$setViewport, scrollAnim.c.h, scrollAnim.c.aw, scrollAnim.c.ax));
						var cid = $author$project$Scroll$Internal$Engine$Sub$containerToString(scrollAnim.c.h);
						return _Utils_Tuple3(
							accScrolls,
							A2($elm$core$List$cons, scrollCmd, accCmds),
							_Utils_ap(
								...
								_List_fromArray(
									[
										$author$project$Scroll$Internal$Engine$Sub$Stopped(cid)
									])));
					} else {
						return _Utils_Tuple3(
							A3($elm$core$Dict$insert, scrollId, scrollAnim, accScrolls),
...
var $author$project$Scroll$Engine$Sub$stop = F3(
	function (container, toMsg, scrollState) {
		return A3(
			$author$project$Scroll$Internal$Engine$Sub$stop,
			$author$project$Scroll$Engine$Sub$containerToId(container),
			toMsg,
			scrollState);
	});
...
var $author$project$Motion$Easing$QuintOut = {$: 34};
var $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault = function (_v0) {
	var data = _v0;
	return A2($elm$core$Maybe$withDefault, $author$project$Motion$Easing$QuintOut, data.a7);
};
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationConfig = F2(
	function (scrollBuilder, scrollTarget) {
		return {
			ab: $author$project$Scroll$Internal$Shared$ScrollTarget$getAxis(scrollTarget),
			h: $author$project$Scroll$Internal$Shared$Container$toContainer(
				$author$project$Scroll$Internal$Shared$ScrollTarget$getContainerId(scrollTarget)),
			bx: $author$project$Scroll$Internal$ScrollBuilder$getDelayWithDefault(scrollBuilder),
			a7: $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault(scrollBuilder),
			aw: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetX(scrollTarget),
			ax: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetY(scrollTarget),
			cb: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
		};
	});
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromDom = F4(
	function (scrollBuilder, scrollTarget, domResult, element) {
		var viewport = domResult.t;
		var startPosition = {d: viewport.t.d, e: viewport.t.e};
		...
		var elementContentPosition = function () {
			var _v3 = domResult.aN;
			if (!_v3.$) {
				var containerEl = _v3.a;
				return {d: ((element.ar.d - containerEl.ar.d) + viewport.t.d) - offsetX, e: ((element.ar.e - containerEl.ar.e) + viewport.t.e) - offsetY};
			} else {
				return {d: (element.ar.d + viewport.t.d) - offsetX, e: (element.ar.e + viewport.t.e) - offsetY};
			}
		}();
		...
		var clampedTarget = {
			d: A3($elm$core$Basics$clamp, 0, viewport.b6.cf - viewport.t.cf, targetPosition.d),
			e: A3($elm$core$Basics$clamp, 0, viewport.b6.bD - viewport.t.bD, targetPosition.e)
		};
		var config = _Utils_update(
			baseConfig,
			{aw: clampedTarget.d, ax: clampedTarget.e});
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ab, startPosition.d, startPosition.e, clampedTarget.d, clampedTarget.e);
		...
		return {c: config, M: startPosition.d, N: startPosition.e, ae: delayMs === 0.0, aq: delayMs, aS: actualDuration, F: 0.0, z: false, X: 0.0, C: startPosition.d, D: startPosition.e};
	});
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromViewport = F3(
	function (scrollBuilder, scrollTarget, viewport) {
		...
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ab, startPosition.d, startPosition.e, targetPosition.d, targetPosition.e);
		var actualDuration = function () {
...
var $author$project$Scroll$Internal$Engine$Sub$updateScrollAnimation = F2(
	function (deltaMs, animation) {
		if (!animation.ae) {
			var newElapsedMs = animation.F + deltaMs;
			return (_Utils_cmp(newElapsedMs, animation.aq) > -1) ? _Utils_update(
				animation,
				{ae: true, F: 0.0}) : _Utils_update(
				animation,
				{F: newElapsedMs});
		} else {
			var newElapsedMs = animation.F + deltaMs;
			var progress = A2($elm$core$Basics$min, 1.0, newElapsedMs / animation.aS);
			var easingFunction = $author$project$Shared$Easing$toFunction(animation.c.a7);
			var easedProgress = easingFunction(progress);
			var newCurrentX = function () {
				var _v1 = animation.c.ab;
				if (_v1 === 1) {
					return animation.C;
				} else {
					return animation.C + ((animation.c.aw - animation.C) * easedProgress);
				}
			}();
			var newCurrentY = function () {
				var _v0 = animation.c.ab;
				if (!_v0) {
					return animation.D;
				} else {
					return animation.D + ((animation.c.ax - animation.D) * easedProgress);
				}
			}();
			return _Utils_update(
				animation,
				{M: newCurrentX, N: newCurrentY, F: newElapsedMs, X: progress});
		}
	});
						...
						function (scrollId, scrollAnim, _v3) {
							...
							if (scrollAnim.z) {
								...
								var scrollCmd = A2(
									...
									A3($author$project$Scroll$Internal$Shared$Dom$setViewport, updatedScroll.c.h, updatedScroll.M, updatedScroll.N));
								...
								var progressEvent = A3(
									...
									cid,
									{d: updatedScroll.M, e: updatedScroll.N},
									updatedScroll.X);
								if (updatedScroll.X < 1.0) {
									return _Utils_Tuple3(
										A3($elm$core$Dict$insert, scrollId, updatedScroll, accScrolls),
										A2($elm$core$List$cons, scrollCmd, accCmds),
			...
			case 1:
				...
				var scrollAnimation = function () {
					...
					if (!_v6.$) {
						...
						return A3($author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromViewport, scrollBuilder, scrollTarget, domResult.t);
					}
				}();
				var hasDistance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, scrollAnimation.c.ab, scrollAnimation.C, scrollAnimation.D, scrollAnimation.c.aw, scrollAnimation.c.ax) > 0;
				...
				var _v5 = hasDistance ? _Utils_Tuple2(
					...
					_Utils_ap(
						...
						_List_fromArray(
							...
							]))) : _Utils_Tuple2(scrollData.f, scrollData.r);
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 7:
			...
			case 6:
				var scrollMsg = msg.a;
				var _v1 = A3($author$project$Scroll$Engine$Sub$update, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, scrollMsg, model.n);
				...
				return _Utils_Tuple2(
					...
					scrollCmd);
			case 0:
				var _v2 = A3($author$project$Scroll$Engine$Sub$scroll, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, model.n, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollAnimation);
				...
				return _Utils_Tuple2(
					...
					scrollCmd);
			case 1:
				var _v3 = A3($author$project$Scroll$Engine$Sub$stop, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, model.n);
			...
			case 2:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A2($author$project$Scroll$Engine$Sub$pause, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer, model.n)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							n: A2($author$project$Scroll$Engine$Sub$resume, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer, model.n)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				var _v4 = A3($author$project$Scroll$Engine$Sub$reset, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, model.n);
				...
				return _Utils_Tuple2(
					...
					scrollCmd);
			default:
				var _v5 = A3($author$project$Scroll$Engine$Sub$restart, $author$project$Scroll$Sub$ControllingScrolls$Main$scrollContainer, $author$project$Scroll$Sub$ControllingScrolls$Main$GotScrollMsg, model.n);
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$Pause = {$: 2};
var $author$project$Scroll$Sub$ControllingScrolls$Main$Reset = {$: 4};
var $author$project$Scroll$Sub$ControllingScrolls$Main$Restart = {$: 5};
var $author$project$Scroll$Sub$ControllingScrolls$Main$Resume = {$: 3};
var $author$project$Scroll$Sub$ControllingScrolls$Main$ScrollAnimate = {$: 0};
var $author$project$Scroll$Sub$ControllingScrolls$Main$Stop = {$: 1};
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$contentSection = F3(
	function (title, description, color) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Scroll$Sub$ControllingScrolls$Main$targetSection = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$id($author$project$Scroll$Sub$ControllingScrolls$Main$targetId),
			A2($elm$html$Html$Attributes$style, 'padding', '12px 16px'),
			A2($elm$html$Html$Attributes$style, 'background', '#fff3e0'),
			A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
			A2($elm$html$Html$Attributes$style, 'border', '2px solid #ff9800')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('🎯 Target Section')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('This is the scroll target. The scroll animation will bring this section into view.')
				]))
		]));
var $author$project$Scroll$Sub$ControllingScrolls$Main$contentSections = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	$elm$core$List$concat(
		_List_fromArray(
			[
				_List_fromArray(
				[
					A3($author$project$Scroll$Sub$ControllingScrolls$Main$contentSection, '📍 Start', 'This is the beginning of the scrollable content.', '#3b82f6')
				]),
				A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, _v0) {
						return A3(
							$author$project$Scroll$Sub$ControllingScrolls$Main$contentSection,
							'Section ' + $elm$core$String$fromInt(i + 1),
							'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
							'#475569');
					}),
				A2($elm$core$List$repeat, 5, 0)),
				_List_fromArray(
				[$author$project$Scroll$Sub$ControllingScrolls$Main$targetSection]),
				A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, _v1) {
				...
				A2($elm$core$List$repeat, 3, 0)),
				_List_fromArray(
				[
					A3($author$project$Scroll$Sub$ControllingScrolls$Main$contentSection, '📍 End', 'This is the end of the scrollable content.', '#3b82f6')
				])
			])));
var $author$project$Scroll$Sub$ControllingScrolls$Main$scrollableContainer = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id($author$project$Scroll$Sub$ControllingScrolls$Main$containerId),
					A2($elm$html$Html$Attributes$style, 'width', '100%'),
					A2($elm$html$Html$Attributes$style, 'height', '350px'),
					A2($elm$html$Html$Attributes$style, 'border', '2px solid #cbd5e1'),
			...
			_List_fromArray(
				[$author$project$Scroll$Sub$ControllingScrolls$Main$contentSections]))
		]));
var $author$project$Scroll$Sub$ControllingScrolls$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$ScrollAnimate),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$Stop),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$Pause),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$Resume),
								$elm$html$Html$Attributes$class('ui-action-button success')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$Reset),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Scroll$Sub$ControllingScrolls$Main$Restart),
								$elm$html$Html$Attributes$class('ui-action-button purple')
							]),
						_List_fromArray(
							[
				...
				$author$project$Scroll$Sub$ControllingScrolls$Main$scrollableContainer
			]));
};
var $author$project$Scroll$Sub$ControllingScrolls$Main$main = $elm$browser$Browser$element(
	{
		dg: $elm$core$Basics$always($author$project$Scroll$Sub$ControllingScrolls$Main$init),
		d2: $author$project$Scroll$Sub$ControllingScrolls$Main$subscriptions,
		eq: $author$project$Scroll$Sub$ControllingScrolls$Main$update,
		er: $author$project$Scroll$Sub$ControllingScrolls$Main$view
	});
_Platform_export({'Scroll':{'Sub':{'ControllingScrolls':{'Main':{'init':$author$project$Scroll$Sub$ControllingScrolls$Main$main(
