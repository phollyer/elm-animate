...
{
	if (region.bn.aF === region.bB.aF)
	{
		return 'on line ' + region.bn.aF;
	}
	return 'on lines ' + region.bn.aF + ' through ' + region.bB.aF;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { dc: 'hidden', cP: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { dc: 'mozHidden', cP: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { dc: 'msHidden', cP: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { dc: 'webkitHidden', cP: 'webkitvisibilitychange' }
		: { dc: 'hidden', cP: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bE: fragment, bJ: host, b$: path, b1: port_, b4: protocol, b5: query};
	});
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$Idle = {$: 0};
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$init = {ao: $author$project$Scroll$Engine$Sub$init, aH: $author$project$Scroll$Sub$HorizontalGallery$Main$Idle};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Scroll$Sub$HorizontalGallery$Main$GotScrollMsg = function (a) {
	return {$: 1, a: a};
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {bi: oldTime, b7: request, cc: subs};
	});
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$subscriptions = function (model) {
	return A2($author$project$Scroll$Engine$Sub$subscriptions, $author$project$Scroll$Sub$HorizontalGallery$Main$GotScrollMsg, model.ao);
};
var $author$project$Scroll$Sub$HorizontalGallery$Main$Arrived = {$: 2};
var $author$project$Scroll$Sub$HorizontalGallery$Main$Scrolling = F2(
	function (a, b) {
		return {$: 1, a: a, b: b};
	});
var $author$project$Scroll$Sub$HorizontalGallery$Main$applyEvent = F2(
	function (event, _v0) {
		switch (event.$) {
			case 6:
				var pos = event.b;
				var progress = event.c;
				return A2($author$project$Scroll$Sub$HorizontalGallery$Main$Scrolling, pos.d, progress);
			case 1:
				return $author$project$Scroll$Sub$HorizontalGallery$Main$Arrived;
			default:
				return $author$project$Scroll$Sub$HorizontalGallery$Main$Idle;
		}
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {bA: 0, ba: $elm$core$Maybe$Nothing, a2: _List_Nil, ab: $elm$core$Maybe$Nothing};
							...
							A4(
								...
								F3(
									function (viewport, containerEl, element) {
										return {
											aR: containerEl,
											a3: $elm$core$Maybe$Just(element),
											s: viewport
										};
									}),
							...
							A3(
								...
								F2(
									function (viewport, containerEl) {
										return {aR: containerEl, a3: $elm$core$Maybe$Nothing, s: viewport};
									}),
								$author$project$Scroll$Internal$Shared$Dom$getViewport(container),
								$author$project$Scroll$Internal$Shared$Dom$getContainerInfo(container)));
					}
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				a2: A2($elm$core$List$cons, scrollTarget, data.a2)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				ba: $elm$core$Maybe$Just(easingFn)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ba,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.ab, config.ca))));
};
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$scrollToCard = function (cardId) {
	return A2(
...
var $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault = function (_v0) {
	var data = _v0;
	return A2($elm$core$Maybe$withDefault, $author$project$Motion$Easing$QuintOut, data.ba);
};
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationConfig = F2(
	function (scrollBuilder, scrollTarget) {
		return {
			ae: $author$project$Scroll$Internal$Shared$ScrollTarget$getAxis(scrollTarget),
			h: $author$project$Scroll$Internal$Shared$Container$toContainer(
				$author$project$Scroll$Internal$Shared$ScrollTarget$getContainerId(scrollTarget)),
			bA: $author$project$Scroll$Internal$ScrollBuilder$getDelayWithDefault(scrollBuilder),
			ba: $author$project$Scroll$Internal$ScrollBuilder$getEasingWithDefault(scrollBuilder),
			az: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetX(scrollTarget),
			aA: $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetY(scrollTarget),
			ce: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
		};
	});
...
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromDom = F4(
	function (scrollBuilder, scrollTarget, domResult, element) {
		...
		var elementContentPosition = function () {
			var _v3 = domResult.aR;
			if (!_v3.$) {
				var containerEl = _v3.a;
				return {d: ((element.au.d - containerEl.au.d) + viewport.s.d) - offsetX, e: ((element.au.e - containerEl.au.e) + viewport.s.e) - offsetY};
			} else {
				return {d: (element.au.d + viewport.s.d) - offsetX, e: (element.au.e + viewport.s.e) - offsetY};
			}
		}();
		...
		var clampedTarget = {
			d: A3($elm$core$Basics$clamp, 0, viewport.b9.ci - viewport.s.ci, targetPosition.d),
			e: A3($elm$core$Basics$clamp, 0, viewport.b9.bG - viewport.s.bG, targetPosition.e)
		};
		var config = _Utils_update(
			baseConfig,
			{az: clampedTarget.d, aA: clampedTarget.e});
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ae, startPosition.d, startPosition.e, clampedTarget.d, clampedTarget.e);
		...
		return {c: config, P: startPosition.d, Q: startPosition.e, ah: delayMs === 0.0, at: delayMs, aW: actualDuration, F: 0.0, y: false, _: 0.0, B: startPosition.d, C: startPosition.e};
	});
var $author$project$Scroll$Internal$Engine$Sub$createScrollAnimationFromViewport = F3(
	function (scrollBuilder, scrollTarget, viewport) {
		...
		var distance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, config.ae, startPosition.d, startPosition.e, targetPosition.d, targetPosition.e);
		var actualDuration = function () {
...
var $author$project$Scroll$Internal$Engine$Sub$updateScrollAnimation = F2(
	function (deltaMs, animation) {
		if (!animation.ah) {
			...
			return (_Utils_cmp(newElapsedMs, animation.at) > -1) ? _Utils_update(
				animation,
				{ah: true, F: 0.0}) : _Utils_update(
				animation,
				{F: newElapsedMs});
		} else {
			var newElapsedMs = animation.F + deltaMs;
			var progress = A2($elm$core$Basics$min, 1.0, newElapsedMs / animation.aW);
			var easingFunction = $author$project$Shared$Easing$toFunction(animation.c.ba);
			var easedProgress = easingFunction(progress);
			var newCurrentX = function () {
				var _v1 = animation.c.ae;
				if (_v1 === 1) {
					return animation.B;
				} else {
					return animation.B + ((animation.c.az - animation.B) * easedProgress);
				}
			}();
			var newCurrentY = function () {
				var _v0 = animation.c.ae;
				if (!_v0) {
					return animation.C;
				} else {
					return animation.C + ((animation.c.aA - animation.C) * easedProgress);
				}
			}();
			return _Utils_update(
				animation,
				{P: newCurrentX, Q: newCurrentY, F: newElapsedMs, _: progress});
		}
	});
	...
	function (fromInternalEvent, toMsg, msg, _v0) {
		...
		switch (msg.$) {
						...
						function (scrollId, scrollAnim, _v3) {
							...
							if (scrollAnim.y) {
								...
								var scrollCmd = A2(
									...
									A3($author$project$Scroll$Internal$Shared$Dom$setViewport, updatedScroll.c.h, updatedScroll.P, updatedScroll.Q));
								...
								var progressEvent = A3(
									...
									cid,
									{d: updatedScroll.P, e: updatedScroll.Q},
									updatedScroll._);
								if (updatedScroll._ < 1.0) {
									return _Utils_Tuple3(
			...
			case 1:
				...
				var hasDistance = A5($author$project$Scroll$Internal$Engine$Sub$calculateDistance, scrollAnimation.c.ae, scrollAnimation.B, scrollAnimation.C, scrollAnimation.c.az, scrollAnimation.c.aA) > 0;
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var cardId = msg.a;
			var _v1 = A3(
				$author$project$Scroll$Engine$Sub$scroll,
				$author$project$Scroll$Sub$HorizontalGallery$Main$GotScrollMsg,
				model.ao,
				$author$project$Scroll$Sub$HorizontalGallery$Main$scrollToCard(cardId));
			...
			var scrollMsg = msg.a;
			var _v2 = A3($author$project$Scroll$Engine$Sub$update, $author$project$Scroll$Sub$HorizontalGallery$Main$GotScrollMsg, scrollMsg, model.ao);
			...
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						ao: newScrollState,
						aH: A3($elm$core$List$foldl, $author$project$Scroll$Sub$HorizontalGallery$Main$applyEvent, model.aH, events)
					}),
				scrollCmd);
		}
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Scroll$Sub$HorizontalGallery$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$navButton = function (photo) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Sub$HorizontalGallery$Main$ScrollTo(photo.H)),
				A2($elm$html$Html$Attributes$style, 'padding', '8px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2($elm$html$Html$Attributes$style, 'background-color', photo.E),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(photo.G + (' ' + photo.I))
			]));
};
var $author$project$Scroll$Sub$HorizontalGallery$Main$photos = _List_fromArray(
	[
		{E: '#4a6f8a', G: '🏔️', H: 'photo-mountains', I: 'Mountains'},
		{E: '#1a7a6e', G: '🌊', H: 'photo-ocean', I: 'Ocean'},
		{E: '#c47b3a', G: '🏜️', H: 'photo-desert', I: 'Desert'},
		{E: '#3a7a45', G: '🌲', H: 'photo-forest', I: 'Forest'},
		{E: '#5b7fa6', G: '🧊', H: 'photo-arctic', I: 'Arctic'},
		{E: '#8b3a3a', G: '🌋', H: 'photo-volcano', I: 'Volcano'},
		{E: '#8b7a3a', G: '🦁', H: 'photo-savanna', I: 'Savanna'},
		{E: '#2a7a8b', G: '🐠', H: 'photo-reef', I: 'Reef'}
	]);
var $author$project$Scroll$Sub$HorizontalGallery$Main$buttonRow = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Sub$HorizontalGallery$Main$navButton, $author$project$Scroll$Sub$HorizontalGallery$Main$photos));
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$photoCard = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id(photo.H),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(photo.I)
					]))
			]));
};
var $author$project$Scroll$Sub$HorizontalGallery$Main$filmStrip = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Sub$HorizontalGallery$Main$photoCard, $author$project$Scroll$Sub$HorizontalGallery$Main$photos));
var $author$project$Scroll$Sub$HorizontalGallery$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status.$) {
			case 0:
			...
			case 1:
				...
				return _Utils_Tuple2(
					...
					'x = ' + ($elm$core$String$fromInt(
						$elm$core$Basics$round(xPos)) + ('px  (' + ($elm$core$String$fromInt(
...
var $author$project$Scroll$Sub$HorizontalGallery$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Scroll$Sub$HorizontalGallery$Main$buttonRow,
				$author$project$Scroll$Sub$HorizontalGallery$Main$statusBar(model.aH),
				$author$project$Scroll$Sub$HorizontalGallery$Main$filmStrip
			]));
};
var $author$project$Scroll$Sub$HorizontalGallery$Main$main = $elm$browser$Browser$element(
	{
		dj: function (_v0) {
			return _Utils_Tuple2($author$project$Scroll$Sub$HorizontalGallery$Main$init, $elm$core$Platform$Cmd$none);
		},
		d5: $author$project$Scroll$Sub$HorizontalGallery$Main$subscriptions,
		et: $author$project$Scroll$Sub$HorizontalGallery$Main$update,
		eu: $author$project$Scroll$Sub$HorizontalGallery$Main$view
	});
_Platform_export({'Scroll':{'Sub':{'HorizontalGallery':{'Main':{'init':$author$project$Scroll$Sub$HorizontalGallery$Main$main(
