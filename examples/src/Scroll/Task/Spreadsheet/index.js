...
{
	if (region.ba.as === region.bp.as)
	{
		return 'on line ' + region.ba.as;
	}
	return 'on lines ' + region.ba.as + ' through ' + region.bp.as;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cX: 'hidden', cz: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cX: 'mozHidden', cz: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cX: 'msHidden', cz: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cX: 'webkitHidden', cz: 'webkitvisibilitychange' }
		: { cX: 'hidden', cz: 'visibilitychange' };
}
...
var $author$project$Scroll$Task$Spreadsheet$Main$Idle = {$: 0};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bs: fragment, bw: host, bO: path, bQ: port_, bT: protocol, bU: query};
	});
...
var $author$project$Scroll$Task$Spreadsheet$Main$Arrived = {$: 2};
var $author$project$Scroll$Task$Spreadsheet$Main$Failed = function (a) {
	return {$: 3, a: a};
};
var $author$project$Scroll$Task$Spreadsheet$Main$ScrollResult = function (a) {
	return {$: 1, a: a};
};
var $author$project$Scroll$Task$Spreadsheet$Main$Scrolling = {$: 1};
...
var $author$project$Scroll$Internal$Engine$Task$ScrollError = $elm$core$Basics$identity;
var $author$project$Scroll$Internal$Engine$Task$Both = {$: 2};
var $author$project$Motion$Easing$Linear = {$: 26};
var $author$project$Scroll$Internal$ScrollBuilder$getEasing = function (_v0) {
	var data = _v0;
	return data.ai;
};
...
var $author$project$Scroll$Internal$Engine$Task$buildConfig = function (scrollBuilder) {
	return {
		G: $author$project$Scroll$Internal$Engine$Task$Both,
		ai: $author$project$Shared$Easing$toFunction(
			A2(
				$elm$core$Maybe$withDefault,
				$author$project$Motion$Easing$Linear,
				$author$project$Scroll$Internal$ScrollBuilder$getEasing(scrollBuilder))),
		aw: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
	};
};
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetElement = function (_v0) {
	var data = _v0;
	var _v1 = data.i;
	if (_v1.$ === 1) {
		var elementId = _v1.a;
		return $elm$core$Maybe$Just(elementId);
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Scroll$Internal$ScrollBuilder$ScrollBuilder = $elm$core$Basics$identity;
var $author$project$Scroll$Internal$ScrollBuilder$init = {K: 0, ai: $elm$core$Maybe$Nothing, aQ: _List_Nil, aw: $elm$core$Maybe$Nothing};
...
var $author$project$Scroll$Internal$Engine$Task$getOffsetX = function (axis) {
	switch (axis.$) {
		case 0:
			return 0.0;
		case 1:
...
var $author$project$Scroll$Internal$Engine$Task$getOffsetY = function (axis) {
	switch (axis.$) {
		case 0:
			return 0.0;
		case 1:
...
var $author$project$Scroll$Internal$Engine$Task$offsets = F2(
	function (container, axis) {
		if (!container.$) {
			return _Utils_Tuple2(
				$author$project$Scroll$Internal$Engine$Task$getOffsetX(axis),
				$author$project$Scroll$Internal$Engine$Task$getOffsetY(axis));
		} else {
...
var $author$project$Scroll$Internal$Engine$Task$createSteps = F4(
	function (frames, easing, start, stop) {
		...
		var weights = A2(
			...
			function (i) {
				return easing(
					i / A2($elm$core$Basics$max, 1.0, framesFloat - 1));
			},
		...
		var finalSteps = function () {
			var _v0 = $elm$core$List$reverse(steps_);
			if (!_v0.b) {
				return _List_Nil;
			} else {
				var rest = _v0.b;
		...
		return _Utils_eq(start, stop) ? _List_Nil : finalSteps;
	});
var $author$project$Scroll$Internal$Engine$Task$BothDirections = 2;
var $author$project$Scroll$Internal$Engine$Task$XDirection = 0;
var $author$project$Scroll$Internal$Engine$Task$YDirection = 1;
var $author$project$Scroll$Internal$Engine$Task$getAxisDirection = function (axis) {
	switch (axis.$) {
		case 0:
			return 0;
		case 1:
...
var $author$project$Scroll$Internal$Engine$Task$timingToSpeed = F2(
...
var $author$project$Scroll$Internal$Engine$Task$scrollToPosition = F5(
	function (container, config, viewport, targetX, targetY) {
		var _v0 = $author$project$Scroll$Internal$Engine$Task$getAxisDirection(config.G);
		switch (_v0) {
			case 0:
				return $elm$core$Task$sequence(
					A2(
						$elm$core$List$map,
						function (x) {
							return A3($author$project$Scroll$Internal$Shared$Dom$setViewport, container, x, viewport.t);
						},
						A4(
							$author$project$Scroll$Internal$Engine$Task$createSteps,
							A2(
								$author$project$Scroll$Internal$Engine$Task$timingToSpeed,
								config.aw,
								$elm$core$Basics$abs(targetX - viewport.s)),
							config.ai,
							viewport.s,
							targetX)));
			case 1:
				return $elm$core$Task$sequence(
					A2(
						$elm$core$List$map,
						function (y) {
							return A3($author$project$Scroll$Internal$Shared$Dom$setViewport, container, viewport.s, y);
						},
						A4(
							$author$project$Scroll$Internal$Engine$Task$createSteps,
							A2(
								$author$project$Scroll$Internal$Engine$Task$timingToSpeed,
								config.aw,
								$elm$core$Basics$abs(targetY - viewport.t)),
							config.ai,
							viewport.t,
							targetY)));
			default:
				var yDistance = $elm$core$Basics$abs(viewport.t - targetY);
				var xDistance = $elm$core$Basics$abs(viewport.s - targetX);
				var maxDistance = A2($elm$core$Basics$max, xDistance, yDistance);
				var frames = A2(
					$elm$core$Basics$max,
					1,
					A2($author$project$Scroll$Internal$Engine$Task$timingToSpeed, config.aw, maxDistance));
				var xSteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.ai, viewport.s, targetX);
				var ySteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.ai, viewport.t, targetY);
					...
					if (!_v1.b.b) {
						...
						return $elm$core$Task$sequence(
							A3(
								...
								F2(
									function (x, y) {
										return A3($author$project$Scroll$Internal$Shared$Dom$setViewport, container, x, y);
									}),
								xSteps,
								ySteps));
					}
...
var $author$project$Scroll$Internal$Engine$Task$scrollBy = F4(
	function (container, deltaX, deltaY, config) {
		return A2(
			$elm$core$Task$andThen,
			function (_v0) {
				var scene = _v0.aP;
				var viewport = _v0.aT;
				var _v1 = A2($author$project$Scroll$Internal$Engine$Task$offsets, container, config.G);
				var offsetX = _v1.a;
				var offsetY = _v1.b;
				var targetX = A2(
					$elm$core$Basics$min,
					scene.T - viewport.T,
					A2($elm$core$Basics$max, 0, (viewport.s + deltaX) + offsetX));
				var targetY = A2(
					$elm$core$Basics$min,
					scene.M - viewport.M,
					A2($elm$core$Basics$max, 0, (viewport.t + deltaY) + offsetY));
				return A5($author$project$Scroll$Internal$Engine$Task$scrollToPosition, container, config, viewport, targetX, targetY);
			},
			$author$project$Scroll$Internal$Shared$Dom$getViewport(container));
	});
var $author$project$Scroll$Internal$Engine$Task$scrollToCoordinates = F4(
	function (container, x, y, config) {
		return A2(
			$elm$core$Task$andThen,
			function (_v0) {
				var scene = _v0.aP;
				var viewport = _v0.aT;
				var maxY = scene.M - viewport.M;
				var maxX = scene.T - viewport.T;
				var _v1 = A2($author$project$Scroll$Internal$Engine$Task$offsets, container, config.G);
				var offsetX = _v1.a;
				var offsetY = _v1.b;
				var targetX = A2(
					$elm$core$Basics$min,
					maxX,
					A2($elm$core$Basics$max, 0, x + offsetX));
				var targetY = A2(
					$elm$core$Basics$min,
					maxY,
					A2($elm$core$Basics$max, 0, y + offsetY));
				return A5($author$project$Scroll$Internal$Engine$Task$scrollToPosition, container, config, viewport, targetX, targetY);
			},
			$author$project$Scroll$Internal$Shared$Dom$getViewport(container));
	});
var $author$project$Scroll$Internal$Engine$Task$applyDirectionalOffset = F3(
	function (maxScroll, percentage, offset) {
		return (percentage <= 0.5) ? ((maxScroll * percentage) + offset) : ((maxScroll * percentage) - offset);
	});
var $author$project$Scroll$Internal$Engine$Task$scrollToPercentage = F5(
	function (container, percentageX, percentageY, _v0, config) {
		var offsetX = _v0.a;
		var offsetY = _v0.b;
		return A2(
			$elm$core$Task$andThen,
			function (_v1) {
				...
				var targetY = A2(
					...
					A2(
						$elm$core$Basics$max,
						0,
						A3($author$project$Scroll$Internal$Engine$Task$applyDirectionalOffset, maxY, percentageY, offsetY)));
				var maxX = scene.T - viewport.T;
				var targetX = A2(
					$elm$core$Basics$min,
					maxX,
					A2(
						$elm$core$Basics$max,
						0,
						A3($author$project$Scroll$Internal$Engine$Task$applyDirectionalOffset, maxX, percentageX, offsetX)));
				return A5($author$project$Scroll$Internal$Engine$Task$scrollToPosition, container, config, viewport, targetX, targetY);
			},
			$author$project$Scroll$Internal$Shared$Dom$getViewport(container));
	});
var $author$project$Scroll$Internal$Engine$Task$getTargetPositions = F4(
	function (element, viewport, container, config) {
		var offsetY = $author$project$Scroll$Internal$Engine$Task$getOffsetY(config.G);
		var offsetX = $author$project$Scroll$Internal$Engine$Task$getOffsetX(config.G);
		if (container.$ === 1) {
			return _Utils_Tuple2((viewport.s + element.s) - offsetX, (viewport.t + element.t) - offsetY);
		} else {
			var containerInfo = container.a;
			return _Utils_Tuple2(((viewport.s + element.s) - offsetX) - containerInfo.a_.s, ((viewport.t + element.t) - offsetY) - containerInfo.a_.t);
		}
	});
var $author$project$Scroll$Internal$Engine$Task$getClampedPositions = F5(
	function (element, viewport, scene, container, config) {
		var _v0 = A4($author$project$Scroll$Internal$Engine$Task$getTargetPositions, element, viewport, container, config);
		var targetX = _v0.a;
		var targetY = _v0.b;
		return _Utils_Tuple2(
			A2(
				$elm$core$Basics$max,
				0,
				A2($elm$core$Basics$min, scene.T - viewport.T, targetX)),
			A2(
				$elm$core$Basics$max,
				0,
				A2($elm$core$Basics$min, scene.M - viewport.M, targetY)));
	});
...
var $author$project$Scroll$Internal$Engine$Task$scrollToTarget = F3(
	function (container, elementId, config) {
		var performScrollTask = F3(
			function (_v1, _v2, containerInfo) {
				var scene = _v1.aP;
				var viewport = _v1.aT;
				var element = _v2.a_;
				var _v0 = A5($author$project$Scroll$Internal$Engine$Task$getClampedPositions, element, viewport, scene, containerInfo, config);
				var clampedX = _v0.a;
				var clampedY = _v0.b;
				return A5($author$project$Scroll$Internal$Engine$Task$scrollToPosition, container, config, viewport, clampedX, clampedY);
			});
		var getViewport_ = $author$project$Scroll$Internal$Shared$Dom$getViewport(container);
		var getContainerInfo_ = $author$project$Scroll$Internal$Shared$Dom$getContainerInfo(container);
		return A2(
			$elm$core$Task$andThen,
...
var $author$project$Scroll$Internal$Engine$Task$BothWithOffset = F2(
	function (a, b) {
		return {$: 5, a: a, b: b};
	});
var $author$project$Scroll$Internal$Engine$Task$XWithOffset = function (a) {
	return {$: 3, a: a};
};
var $author$project$Scroll$Internal$Engine$Task$YWithOffset = function (a) {
	return {$: 4, a: a};
};
var $author$project$Scroll$Internal$Engine$Task$targetAxisToConfig = F3(
	function (targetAxis, offsetX, offsetY) {
		switch (targetAxis) {
			case 0:
				return $author$project$Scroll$Internal$Engine$Task$XWithOffset(offsetX);
			case 1:
				return $author$project$Scroll$Internal$Engine$Task$YWithOffset(offsetY);
			default:
				return A2($author$project$Scroll$Internal$Engine$Task$BothWithOffset, offsetX, offsetY);
		}
	});
...
var $author$project$Scroll$Internal$Engine$Task$routeScrollTarget = F2(
	function (target, config) {
		var container = $author$project$Scroll$Internal$Shared$Container$toContainer(
			$author$project$Scroll$Internal$Shared$ScrollTarget$getContainerId(target));
		var _v0 = $author$project$Scroll$Internal$Shared$ScrollTarget$getOffset(target);
		var offsetX = _v0.a;
		var offsetY = _v0.b;
		var updatedConfig = _Utils_update(
			...
			{
				G: A3(
					$author$project$Scroll$Internal$Engine$Task$targetAxisToConfig,
					$author$project$Scroll$Internal$Shared$ScrollTarget$getAxis(target),
					offsetX,
					offsetY)
			});
		var _v1 = $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetType(target);
		switch (_v1.$) {
			case 1:
				var elementId = _v1.a;
				return A3($author$project$Scroll$Internal$Engine$Task$scrollToTarget, container, elementId, updatedConfig);
			case 0:
				var x = _v1.a;
				var y = _v1.b;
				return A4($author$project$Scroll$Internal$Engine$Task$scrollToCoordinates, container, x, y, updatedConfig);
			case 3:
				var dx = _v1.a;
				var dy = _v1.b;
				return A4($author$project$Scroll$Internal$Engine$Task$scrollBy, container, dx, dy, updatedConfig);
			default:
				var px = _v1.a;
				var py = _v1.b;
				return A5(
					$author$project$Scroll$Internal$Engine$Task$scrollToPercentage,
					container,
					px,
					py,
...
var $author$project$Scroll$Internal$Engine$Task$scroll = function (buildAnimation) {
	var sequenceFailFast = function (tasks) {
		if (!tasks.b) {
			...
			return A2(
				...
				function (result) {
					return A2(
						$elm$core$Task$map,
						function (remaining) {
							return A2($elm$core$List$cons, result, remaining);
						},
	...
	var config = $author$project$Scroll$Internal$Engine$Task$buildConfig(scrollBuilder);
	var createScrollTask = function (target) {
		var targetElementId = $author$project$Scroll$Internal$Shared$ScrollTarget$getTargetElement(target);
		var containerId = $author$project$Scroll$Internal$Shared$ScrollTarget$getContainerId(target);
		var scrollResult = {bl: containerId, av: targetElementId};
		return A2(
			$elm$core$Task$mapError,
			function (domError) {
				return {bl: containerId, bo: domError, av: targetElementId};
			},
			A2(
				$elm$core$Task$map,
				function (_v1) {
				...
				A2($author$project$Scroll$Internal$Engine$Task$routeScrollTarget, target, config)));
	};
	return sequenceFailFast(
		A2($elm$core$List$map, createScrollTask, scrollTargets));
};
var $author$project$Scroll$Engine$Task$ScrollError = $elm$core$Basics$identity;
var $author$project$Scroll$Engine$Task$Container = function (a) {
	return {$: 1, a: a};
};
var $author$project$Scroll$Engine$Task$Document = {$: 0};
var $author$project$Scroll$Engine$Task$containerFromId = function (containerId) {
	return (containerId === 'document') ? $author$project$Scroll$Engine$Task$Document : $author$project$Scroll$Engine$Task$Container(containerId);
};
var $author$project$Scroll$Engine$Task$toPublicError = function (error) {
	var containerId = error.bl;
	var targetElementId = error.av;
	var domError = error.bo;
	return {
		aY: $author$project$Scroll$Engine$Task$containerFromId(containerId),
		bo: domError,
		av: targetElementId
	};
};
var $author$project$Scroll$Engine$Task$toPublicOk = function (ok) {
	return {
		aY: $author$project$Scroll$Engine$Task$containerFromId(ok.bl),
		av: ok.av
	};
};
var $author$project$Scroll$Engine$Task$scroll = A2(
	$elm$core$Basics$composeR,
	$author$project$Scroll$Internal$Engine$Task$scroll,
	A2(
		$elm$core$Basics$composeR,
		$elm$core$Task$mapError($author$project$Scroll$Engine$Task$toPublicError),
		$elm$core$Task$map(
			$elm$core$List$map($author$project$Scroll$Engine$Task$toPublicOk))));
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				aQ: A2($elm$core$List$cons, scrollTarget, data.aQ)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				ai: $elm$core$Maybe$Just(easingFn)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ai,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.aw, config.bY))));
};
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$for = function (containerId) {
	return {
		...
		i: A2($author$project$Scroll$Internal$Shared$ScrollTarget$Coordinates, 0, 0)
	};
};
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$toElement = F2(
	function (elementId, _v0) {
		...
		return _Utils_update(
			data,
			{
				i: $author$project$Scroll$Internal$Shared$ScrollTarget$Element(elementId)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$withOffsetXY = F3(
		...
		return _Utils_update(
			config,
			{
				a: _Utils_update(
					targetData,
					{
						at: _Utils_Tuple2(offsetX, offsetY)
					})
			});
	});
var $author$project$Scroll$Builder$withOffsetXY = $author$project$Scroll$Internal$ScrollBuilder$withOffsetXY;
var $author$project$Scroll$Task$Spreadsheet$Main$scrollToRegion = function (regionId) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Scroll$Builder$forContainer('spreadsheet'),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Scroll$Builder$toElement(regionId),
			A2(
				$elm$core$Basics$composeR,
				A2($author$project$Scroll$Builder$withOffsetXY, 48, 32),
				A2(
					$elm$core$Basics$composeR,
					$author$project$Scroll$Builder$speed(400),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Scroll$Builder$easing($author$project$Motion$Easing$EaseInOut),
						$author$project$Scroll$Builder$build)))));
};
var $author$project$Scroll$Task$Spreadsheet$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var regionId = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{an: $author$project$Scroll$Task$Spreadsheet$Main$Scrolling}),
				A2(
					$elm$core$Task$attempt,
					$author$project$Scroll$Task$Spreadsheet$Main$ScrollResult,
					$author$project$Scroll$Engine$Task$scroll(
						$author$project$Scroll$Task$Spreadsheet$Main$scrollToRegion(regionId))));
		} else {
			if (!msg.a.$) {
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{an: $author$project$Scroll$Task$Spreadsheet$Main$Arrived}),
					$elm$core$Platform$Cmd$none);
			} else {
				var err = msg.a.a;
				var containerLabel = function () {
					var _v1 = err.aY;
					if (!_v1.$) {
						return 'document';
					} else {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							an: $author$project$Scroll$Task$Spreadsheet$Main$Failed('Could not scroll: ' + containerLabel)
						}),
					$elm$core$Platform$Cmd$none);
			}
		}
...
var $author$project$Scroll$Task$Spreadsheet$Main$NavigateTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Task$Spreadsheet$Main$regionButton = function (region) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Task$Spreadsheet$Main$NavigateTo(region.N)),
				A2($elm$html$Html$Attributes$style, 'padding', '8px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2($elm$html$Html$Attributes$style, 'background-color', region.H),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(region.L + (' ' + region.O))
			]));
};
var $author$project$Scroll$Task$Spreadsheet$Main$regions = _List_fromArray(
	[
		{W: 4, H: '#3b6fa0', L: '💰', N: 'region-revenue', O: 'Revenue', ad: 5},
		{W: 10, H: '#a03b3b', L: '📉', N: 'region-expenses', O: 'Expenses', ad: 13},
		{W: 7, H: '#3b8050', L: '📈', N: 'region-forecast', O: 'Forecast', ad: 22},
		{W: 13, H: '#7a6b30', L: '📊', N: 'region-summary', O: 'Summary', ad: 30},
		{W: 16, H: '#6b3a8b', L: '🚀', N: 'region-growth', O: 'YoY Growth', ad: 35}
	]);
var $author$project$Scroll$Task$Spreadsheet$Main$navButtons = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Task$Spreadsheet$Main$regionButton, $author$project$Scroll$Task$Spreadsheet$Main$regions));
...
var $author$project$Scroll$Task$Spreadsheet$Main$findRegion = F2(
	function (col, row) {
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (r) {
					return _Utils_eq(r.W, col) && _Utils_eq(r.ad, row);
				},
				$author$project$Scroll$Task$Spreadsheet$Main$regions));
	});
...
var $author$project$Scroll$Task$Spreadsheet$Main$dataCell = F2(
	function (row, col) {
		var _v0 = A2($author$project$Scroll$Task$Spreadsheet$Main$findRegion, col, row);
		if (!_v0.$) {
			var region = _v0.a;
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id(region.N),
						A2($elm$html$Html$Attributes$style, 'background-color', region.H),
						A2($elm$html$Html$Attributes$style, 'color', 'white'),
						A2($elm$html$Html$Attributes$style, 'border-right', '1px solid rgba(255,255,255,0.3)'),
						A2($elm$html$Html$Attributes$style, 'border-bottom', '1px solid rgba(255,255,255,0.3)'),
			...
			return A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'border-right', '1px solid #e8e8e8'),
						A2($elm$html$Html$Attributes$style, 'border-bottom', '1px solid #e8e8e8'),
						A2($elm$html$Html$Attributes$style, 'height', '32px'),
						A2(
						$elm$html$Html$Attributes$style,
						'background-color',
						(!A2($elm$core$Basics$modBy, 2, row)) ? '#fafafa' : 'white')
					]),
				_List_Nil);
		}
	});
var $author$project$Scroll$Task$Spreadsheet$Main$numCols = 16;
var $author$project$Scroll$Task$Spreadsheet$Main$rowNumCell = function (row) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', '#e8e8e8'),
				A2($elm$html$Html$Attributes$style, 'border-right', '2px solid #aaa'),
...
var $author$project$Scroll$Task$Spreadsheet$Main$dataRow = function (row) {
	return A2(
		$elm$core$List$cons,
		$author$project$Scroll$Task$Spreadsheet$Main$rowNumCell(row),
		A2(
			$elm$core$List$map,
			$author$project$Scroll$Task$Spreadsheet$Main$dataCell(row),
			A2($elm$core$List$range, 1, $author$project$Scroll$Task$Spreadsheet$Main$numCols)));
};
...
var $author$project$Scroll$Task$Spreadsheet$Main$colLabel = function (i) {
	return $elm$core$String$fromChar(
		$elm$core$Char$fromCode(64 + i));
};
var $author$project$Scroll$Task$Spreadsheet$Main$colHeaderCell = function (col) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'background-color', '#e8e8e8'),
				A2($elm$html$Html$Attributes$style, 'border-right', '1px solid #ccc'),
				A2($elm$html$Html$Attributes$style, 'border-bottom', '2px solid #aaa'),
				A2($elm$html$Html$Attributes$style, 'height', '32px'),
				A2($elm$html$Html$Attributes$style, 'display', 'flex'),
				A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
				A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Scroll$Task$Spreadsheet$Main$colLabel(col))
			]));
};
var $author$project$Scroll$Task$Spreadsheet$Main$cornerCell = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'position', 'sticky'),
	...
	_List_Nil);
var $author$project$Scroll$Task$Spreadsheet$Main$headerRow = A2(
	$elm$core$List$cons,
	$author$project$Scroll$Task$Spreadsheet$Main$cornerCell,
	A2(
		$elm$core$List$map,
		$author$project$Scroll$Task$Spreadsheet$Main$colHeaderCell,
		A2($elm$core$List$range, 1, $author$project$Scroll$Task$Spreadsheet$Main$numCols)));
var $author$project$Scroll$Task$Spreadsheet$Main$numRows = 35;
...
var $author$project$Scroll$Task$Spreadsheet$Main$spreadsheet = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					'48px ' + A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$repeat, $author$project$Scroll$Task$Spreadsheet$Main$numCols, '96px'))),
					A2($elm$html$Html$Attributes$style, 'width', 'max-content')
				]),
			_Utils_ap(
				$author$project$Scroll$Task$Spreadsheet$Main$headerRow,
				A2(
					$elm$core$List$concatMap,
					$author$project$Scroll$Task$Spreadsheet$Main$dataRow,
					A2($elm$core$List$range, 1, $author$project$Scroll$Task$Spreadsheet$Main$numRows))))
		]));
var $author$project$Scroll$Task$Spreadsheet$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status.$) {
			case 0:
				return _Utils_Tuple2('#94a3b8', 'Click a region to navigate');
			case 1:
				return _Utils_Tuple2('#3b82f6', 'Scrolling...');
			case 2:
				return _Utils_Tuple2('#22c55e', '✓ Arrived');
			default:
				var err = status.a;
...
var $author$project$Scroll$Task$Spreadsheet$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Scroll$Task$Spreadsheet$Main$navButtons,
				$author$project$Scroll$Task$Spreadsheet$Main$statusBar(model.an),
				$author$project$Scroll$Task$Spreadsheet$Main$spreadsheet
			]));
};
var $author$project$Scroll$Task$Spreadsheet$Main$main = $elm$browser$Browser$element(
	{
		c2: function (_v0) {
			return _Utils_Tuple2(
				{an: $author$project$Scroll$Task$Spreadsheet$Main$Idle},
				$elm$core$Platform$Cmd$none);
		},
		dQ: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		ec: $author$project$Scroll$Task$Spreadsheet$Main$update,
		ed: $author$project$Scroll$Task$Spreadsheet$Main$view
	});
_Platform_export({'Scroll':{'Task':{'Spreadsheet':{'Main':{'init':$author$project$Scroll$Task$Spreadsheet$Main$main(
