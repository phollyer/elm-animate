...
{
	if (region.a9.ar === region.bo.ar)
	{
		return 'on line ' + region.a9.ar;
	}
	return 'on lines ' + region.a9.ar + ' through ' + region.bo.ar;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cX: 'hidden', cy: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cX: 'mozHidden', cy: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cX: 'msHidden', cy: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cX: 'webkitHidden', cy: 'webkitvisibilitychange' }
		: { cX: 'hidden', cy: 'visibilitychange' };
}
...
var $author$project$Scroll$Task$HorizontalGallery$Main$Idle = {$: 0};
...
var $author$project$Scroll$Task$HorizontalGallery$Main$Arrived = {$: 2};
var $author$project$Scroll$Task$HorizontalGallery$Main$Failed = function (a) {
	return {$: 3, a: a};
};
var $author$project$Scroll$Task$HorizontalGallery$Main$ScrollResult = function (a) {
	return {$: 1, a: a};
};
var $author$project$Scroll$Task$HorizontalGallery$Main$Scrolling = {$: 1};
...
var $author$project$Scroll$Internal$Engine$Task$buildConfig = function (scrollBuilder) {
	return {
		L: $author$project$Scroll$Internal$Engine$Task$Both,
		ah: $author$project$Shared$Easing$toFunction(
			A2(
				$elm$core$Maybe$withDefault,
				$author$project$Motion$Easing$Linear,
				$author$project$Scroll$Internal$ScrollBuilder$getEasing(scrollBuilder))),
		av: $author$project$Scroll$Internal$ScrollBuilder$getTimeSpecWithDefault(scrollBuilder)
	};
};
...
var $author$project$Scroll$Internal$ScrollBuilder$init = {O: 0, ah: $elm$core$Maybe$Nothing, aP: _List_Nil, av: $elm$core$Maybe$Nothing};
...
var $author$project$Scroll$Internal$Engine$Task$scrollToPosition = F5(
	function (container, config, viewport, targetX, targetY) {
		var _v0 = $author$project$Scroll$Internal$Engine$Task$getAxisDirection(config.L);
		switch (_v0) {
			case 0:
			...
			default:
				...
				var frames = A2(
					$elm$core$Basics$max,
					1,
					A2($author$project$Scroll$Internal$Engine$Task$timingToSpeed, config.av, maxDistance));
				var xSteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.ah, viewport.s, targetX);
				var ySteps = A4($author$project$Scroll$Internal$Engine$Task$createSteps, frames, config.ah, viewport.t, targetY);
	...
	function (container, deltaX, deltaY, config) {
		return A2(
			...
			function (_v0) {
				var scene = _v0.aO;
				var viewport = _v0.aS;
				var _v1 = A2($author$project$Scroll$Internal$Engine$Task$offsets, container, config.L);
				var offsetX = _v1.a;
				var offsetY = _v1.b;
				var targetX = A2(
					$elm$core$Basics$min,
	...
	function (container, x, y, config) {
		return A2(
			...
			function (_v0) {
				var scene = _v0.aO;
				var viewport = _v0.aS;
				var maxY = scene.P - viewport.P;
				var maxX = scene.U - viewport.U;
				var _v1 = A2($author$project$Scroll$Internal$Engine$Task$offsets, container, config.L);
				var offsetX = _v1.a;
				var offsetY = _v1.b;
				var targetX = A2(
...
var $author$project$Scroll$Internal$Engine$Task$getTargetPositions = F4(
	function (element, viewport, container, config) {
		var offsetY = $author$project$Scroll$Internal$Engine$Task$getOffsetY(config.L);
		var offsetX = $author$project$Scroll$Internal$Engine$Task$getOffsetX(config.L);
		if (container.$ === 1) {
			return _Utils_Tuple2((viewport.s + element.s) - offsetX, (viewport.t + element.t) - offsetY);
		} else {
			var containerInfo = container.a;
			return _Utils_Tuple2(((viewport.s + element.s) - offsetX) - containerInfo.aZ.s, ((viewport.t + element.t) - offsetY) - containerInfo.aZ.t);
		}
	});
	...
	function (element, viewport, scene, container, config) {
		...
		return _Utils_Tuple2(
			A2(
				$elm$core$Basics$max,
				0,
				A2($elm$core$Basics$min, scene.U - viewport.U, targetX)),
			A2(
				$elm$core$Basics$max,
				0,
				A2($elm$core$Basics$min, scene.P - viewport.P, targetY)));
	});
...
var $author$project$Scroll$Internal$Engine$Task$scroll = function (buildAnimation) {
	...
	var createScrollTask = function (target) {
		...
		var scrollResult = {bk: containerId, au: targetElementId};
		return A2(
			$elm$core$Task$mapError,
			function (domError) {
				return {bk: containerId, bn: domError, au: targetElementId};
			},
			A2(
				$elm$core$Task$map,
				function (_v1) {
...
var $author$project$Scroll$Engine$Task$toPublicError = function (error) {
	var containerId = error.bk;
	var targetElementId = error.au;
	var domError = error.bn;
	return {
		aX: $author$project$Scroll$Engine$Task$containerFromId(containerId),
		bn: domError,
		au: targetElementId
	};
};
var $author$project$Scroll$Engine$Task$toPublicOk = function (ok) {
	return {
		aX: $author$project$Scroll$Engine$Task$containerFromId(ok.bk),
		au: ok.au
	};
};
...
var $author$project$Scroll$Internal$ScrollBuilder$addScrollTarget = F2(
	function (scrollTarget, _v0) {
		...
		return _Utils_update(
			data,
			{
				aP: A2($elm$core$List$cons, scrollTarget, data.aP)
			});
	});
...
var $author$project$Scroll$Internal$ScrollBuilder$setEasing = F2(
	function (easingFn, _v0) {
		...
		return _Utils_update(
			data,
			{
				ah: $elm$core$Maybe$Just(easingFn)
			});
	});
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				config.ah,
				A2($author$project$Scroll$Internal$ScrollBuilder$applyTiming, config.av, config.bX))));
};
...
var $author$project$Scroll$Internal$Shared$ScrollTarget$X = 0;
var $author$project$Scroll$Internal$ScrollBuilder$onXAxis = function (_v0) {
	var config = _v0;
	var _v1 = config.a;
	var targetData = _v1;
	return _Utils_update(
...
var $author$project$Scroll$Builder$onXAxis = $author$project$Scroll$Internal$ScrollBuilder$onXAxis;
...
var $author$project$Scroll$Task$HorizontalGallery$Main$scrollToCard = function (cardId) {
	return A2(
		$elm$core$Basics$composeR,
		$author$project$Scroll$Builder$forContainer('gallery'),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Scroll$Builder$toElement(cardId),
			A2(
				$elm$core$Basics$composeR,
				$author$project$Scroll$Builder$onXAxis,
				A2(
					$elm$core$Basics$composeR,
					$author$project$Scroll$Builder$speed(500),
					A2(
						$elm$core$Basics$composeR,
						$author$project$Scroll$Builder$easing($author$project$Motion$Easing$EaseInOut),
						$author$project$Scroll$Builder$build)))));
};
var $author$project$Scroll$Task$HorizontalGallery$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			var cardId = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{am: $author$project$Scroll$Task$HorizontalGallery$Main$Scrolling}),
				A2(
					$elm$core$Task$attempt,
					$author$project$Scroll$Task$HorizontalGallery$Main$ScrollResult,
					$author$project$Scroll$Engine$Task$scroll(
						$author$project$Scroll$Task$HorizontalGallery$Main$scrollToCard(cardId))));
		} else {
			if (!msg.a.$) {
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{am: $author$project$Scroll$Task$HorizontalGallery$Main$Arrived}),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							am: $author$project$Scroll$Task$HorizontalGallery$Main$Failed('Could not scroll: ' + containerLabel)
						}),
					$elm$core$Platform$Cmd$none);
			}
		}
...
var $author$project$Scroll$Task$HorizontalGallery$Main$ScrollTo = function (a) {
	return {$: 0, a: a};
};
...
var $author$project$Scroll$Task$HorizontalGallery$Main$navButton = function (photo) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Scroll$Task$HorizontalGallery$Main$ScrollTo(photo.y)),
				A2($elm$html$Html$Attributes$style, 'padding', '8px 14px'),
				A2($elm$html$Html$Attributes$style, 'border', 'none'),
				A2($elm$html$Html$Attributes$style, 'border-radius', '6px'),
				A2($elm$html$Html$Attributes$style, 'background-color', photo.w),
		...
		_List_fromArray(
			[
				$elm$html$Html$text(photo.x + (' ' + photo.z))
			]));
};
var $author$project$Scroll$Task$HorizontalGallery$Main$photos = _List_fromArray(
	[
		{w: '#4a6f8a', x: '🏔️', y: 'photo-mountains', z: 'Mountains'},
		{w: '#1a7a6e', x: '🌊', y: 'photo-ocean', z: 'Ocean'},
		{w: '#c47b3a', x: '🏜️', y: 'photo-desert', z: 'Desert'},
		{w: '#3a7a45', x: '🌲', y: 'photo-forest', z: 'Forest'},
		{w: '#5b7fa6', x: '🧊', y: 'photo-arctic', z: 'Arctic'},
		{w: '#8b3a3a', x: '🌋', y: 'photo-volcano', z: 'Volcano'},
		{w: '#8b7a3a', x: '🦁', y: 'photo-savanna', z: 'Savanna'},
		{w: '#2a7a8b', x: '🐠', y: 'photo-reef', z: 'Reef'}
	]);
var $author$project$Scroll$Task$HorizontalGallery$Main$buttonRow = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Task$HorizontalGallery$Main$navButton, $author$project$Scroll$Task$HorizontalGallery$Main$photos));
...
var $author$project$Scroll$Task$HorizontalGallery$Main$photoCard = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id(photo.y),
...
var $author$project$Scroll$Task$HorizontalGallery$Main$filmStrip = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	A2($elm$core$List$map, $author$project$Scroll$Task$HorizontalGallery$Main$photoCard, $author$project$Scroll$Task$HorizontalGallery$Main$photos));
var $author$project$Scroll$Task$HorizontalGallery$Main$statusBar = function (status) {
	var _v0 = function () {
		switch (status.$) {
			case 0:
				return _Utils_Tuple2('#94a3b8', 'Click a photo to navigate');
			case 1:
...
var $author$project$Scroll$Task$HorizontalGallery$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Scroll$Task$HorizontalGallery$Main$buttonRow,
				$author$project$Scroll$Task$HorizontalGallery$Main$statusBar(model.am),
				$author$project$Scroll$Task$HorizontalGallery$Main$filmStrip
			]));
};
var $author$project$Scroll$Task$HorizontalGallery$Main$main = $elm$browser$Browser$element(
	{
		c2: function (_v0) {
			return _Utils_Tuple2(
				{am: $author$project$Scroll$Task$HorizontalGallery$Main$Idle},
				$elm$core$Platform$Cmd$none);
		},
		dQ: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		ec: $author$project$Scroll$Task$HorizontalGallery$Main$update,
		ed: $author$project$Scroll$Task$HorizontalGallery$Main$view
	});
_Platform_export({'Scroll':{'Task':{'HorizontalGallery':{'Main':{'init':$author$project$Scroll$Task$HorizontalGallery$Main$main(
