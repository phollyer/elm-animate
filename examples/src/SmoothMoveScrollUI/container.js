...
var $author$project$SmoothMoveScrollUI$Container$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$SmoothMoveScrollUI$Container$ScrollToTop, 'Scroll to Top'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$SmoothMoveScrollUI$Container$ScrollToMiddle, 'Scroll to Middle'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$SmoothMoveScrollUI$Container$ScrollToBottom, 'Scroll to Bottom')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$SmoothMoveScrollUI$Container$view = function (model) {
	return A3(
		...
		$author$project$SmoothMoveScrollUI$Container$viewContent(model));
};
