...
var $author$project$HTML$SmoothMovePorts$Basic$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$HTML$SmoothMovePorts$Basic$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$HTML$SmoothMovePorts$Basic$subscriptions = function (model) {
	return $author$project$HTML$SmoothMovePorts$Basic$positionUpdates($author$project$HTML$SmoothMovePorts$Basic$PositionUpdateMsg);
};
...
var $author$project$HTML$SmoothMovePorts$Basic$stopElementAnimation = _Platform_outgoingPort('stopElementAnimation', $elm$json$Json$Encode$string);
var $author$project$HTML$SmoothMovePorts$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				...
				return _Utils_Tuple2(
					...
					$author$project$HTML$SmoothMovePorts$Basic$animateElement(
						$author$project$SmoothMovePorts$encodeAnimationCommand(command)));
			case 'MoveToCenter':
				var _v2 = A4($author$project$SmoothMovePorts$animateTo, 'box', 175, 125, model.animations);
				...
				if (maybeElementId.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newAnimations}),
						$author$project$HTML$SmoothMovePorts$Basic$stopElementAnimation(
			...
			default:
				var value = msg.a;
				var _v5 = A2($author$project$SmoothMovePorts$handlePositionUpdateFromJson, value, model.animations);
				if (_v5.$ === 'Ok') {
...
var $author$project$HTML$SmoothMovePorts$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$HTML$SmoothMovePorts$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$HTML$SmoothMovePorts$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$HTML$SmoothMovePorts$Basic$view = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Basic$MoveToCorner)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Basic$MoveToCenter),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Basic$StopAnimation),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[
...
var $author$project$HTML$SmoothMovePorts$Basic$main = $elm$browser$Browser$element(
	{init: $author$project$HTML$SmoothMovePorts$Basic$init, subscriptions: $author$project$HTML$SmoothMovePorts$Basic$subscriptions, update: $author$project$HTML$SmoothMovePorts$Basic$update, view: $author$project$HTML$SmoothMovePorts$Basic$view});
_Platform_export({'HTML':{'SmoothMovePorts':{'Basic':{'init':$author$project$HTML$SmoothMovePorts$Basic$main(
