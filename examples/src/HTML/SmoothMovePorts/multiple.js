...
var $author$project$HTML$SmoothMovePorts$Multiple$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$HTML$SmoothMovePorts$Multiple$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$HTML$SmoothMovePorts$Multiple$subscriptions = function (_v0) {
	return $author$project$HTML$SmoothMovePorts$Multiple$positionUpdates($author$project$HTML$SmoothMovePorts$Multiple$PositionUpdateMsg);
};
...
var $author$project$HTML$SmoothMovePorts$Multiple$animateElement = _Platform_outgoingPort('animateElement', $elm$json$Json$Encode$string);
...
var $author$project$HTML$SmoothMovePorts$Multiple$stopElementAnimation = _Platform_outgoingPort('stopElementAnimation', $elm$json$Json$Encode$string);
var $author$project$HTML$SmoothMovePorts$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimateToCorners':
				...
				var _v1 = A3($author$project$SmoothMovePorts$animateBatchWithPort, $author$project$HTML$SmoothMovePorts$Multiple$animateElement, animationSpecs, model.animations);
			...
			case 'AnimateToCenter':
				...
				var _v2 = A3($author$project$SmoothMovePorts$animateBatchWithPort, $author$project$HTML$SmoothMovePorts$Multiple$animateElement, animationSpecs, model.animations);
			...
			case 'AnimateInSequence':
				...
				var _v3 = A3($author$project$SmoothMovePorts$animateBatchWithPort, $author$project$HTML$SmoothMovePorts$Multiple$animateElement, animationSpecs, model.animations);
			...
			case 'StopAll':
				var _v4 = A3(
					...
					$author$project$HTML$SmoothMovePorts$Multiple$stopElementAnimation,
					_List_fromArray(
						['box1', 'box2', 'box3', 'box4']),
					model.animations);
...
var $author$project$HTML$SmoothMovePorts$Multiple$AnimateInSequence = {$: 'AnimateInSequence'};
var $author$project$HTML$SmoothMovePorts$Multiple$AnimateToCenter = {$: 'AnimateToCenter'};
var $author$project$HTML$SmoothMovePorts$Multiple$AnimateToCorners = {$: 'AnimateToCorners'};
var $author$project$HTML$SmoothMovePorts$Multiple$StopAll = {$: 'StopAll'};
...
var $author$project$HTML$SmoothMovePorts$Multiple$animatedBox = F3(
	function (elementId, color, animations) {
		var position = A2($author$project$SmoothMovePorts$getPosition, elementId, animations);
		var isAnimating = $author$project$SmoothMovePorts$isAnimating(animations);
		var borderStyle = isAnimating ? '3px solid #FFD700' : ('2px solid ' + color);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					'transform',
					A2($author$project$SmoothMovePorts$transformElement, elementId, animations))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
					A2($elm$core$String$right, 1, elementId))
				]));
	});
...
var $author$project$HTML$SmoothMovePorts$Multiple$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('SmoothMovePorts - Multiple Animations')
					])),
				A2(
				$elm$html$Html$h2,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('JavaScript Web Animations API Integration')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Multiple$AnimateToCorners),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Animate to Corners')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Multiple$AnimateToCenter),
								A2($elm$html$Html$Attributes$style, 'margin-right', '10px'),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Animate to Center')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Multiple$AnimateInSequence),
								A2($elm$html$Html$Attributes$style, 'margin-right', '10px'),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Sequential Animation')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMovePorts$Multiple$StopAll),
								A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
				...
				_List_fromArray(
					[
						...
						_List_Nil),
						A3($author$project$HTML$SmoothMovePorts$Multiple$animatedBox, 'box1', '#FF6B6B', model.animations),
						A3($author$project$HTML$SmoothMovePorts$Multiple$animatedBox, 'box2', '#4ECDC4', model.animations),
						A3($author$project$HTML$SmoothMovePorts$Multiple$animatedBox, 'box3', '#45B7D1', model.animations),
						A3($author$project$HTML$SmoothMovePorts$Multiple$animatedBox, 'box4', '#96CEB4', model.animations)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This example demonstrates multiple simultaneous animations using the Web Animations API.'),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('• Different easing functions and durations for each element')
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('• Hardware-accelerated performance via JavaScript')
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text('• Requires smooth-move-ports.js to be included in your HTML')
							]))
					]))
			]));
};
var $author$project$HTML$SmoothMovePorts$Multiple$main = $elm$browser$Browser$element(
	{init: $author$project$HTML$SmoothMovePorts$Multiple$init, subscriptions: $author$project$HTML$SmoothMovePorts$Multiple$subscriptions, update: $author$project$HTML$SmoothMovePorts$Multiple$update, view: $author$project$HTML$SmoothMovePorts$Multiple$view});
_Platform_export({'HTML':{'SmoothMovePorts':{'Multiple':{'init':$author$project$HTML$SmoothMovePorts$Multiple$main(
