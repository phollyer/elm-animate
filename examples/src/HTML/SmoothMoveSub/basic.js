...
var $author$project$HTML$SmoothMoveSub$Basic$AnimationFrame = function (a) {
...
var $author$project$HTML$SmoothMoveSub$Basic$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$HTML$SmoothMoveSub$Basic$AnimationFrame);
};
...
var $author$project$HTML$SmoothMoveSub$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartMove':
				var targetX = msg.a;
				var targetY = msg.b;
				var newSmoothMove = A4($author$project$SmoothMoveSub$animateTo, $author$project$HTML$SmoothMoveSub$Basic$elementId, targetX, targetY, model.smoothMove);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$HTML$SmoothMoveSub$Basic$StartMove = F2(
	function (a, b) {
...
var $author$project$HTML$SmoothMoveSub$Basic$view = function (model) {
	var currentPos = A2(
		$elm$core$Maybe$withDefault,
		{x: 200, y: 150},
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($author$project$HTML$SmoothMoveSub$Basic$StartMove, 100, 100)),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										A2($author$project$HTML$SmoothMoveSub$Basic$StartMove, 300, 150)),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										A2($author$project$HTML$SmoothMoveSub$Basic$StartMove, 200, 250)),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										A2($author$project$HTML$SmoothMoveSub$Basic$StartMove, 0, 0)),
...
var $author$project$HTML$SmoothMoveSub$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$HTML$SmoothMoveSub$Basic$init, subscriptions: $author$project$HTML$SmoothMoveSub$Basic$subscriptions, update: $author$project$HTML$SmoothMoveSub$Basic$update, view: $author$project$HTML$SmoothMoveSub$Basic$view});
_Platform_export({'HTML':{'SmoothMoveSub':{'Basic':{'init':$author$project$HTML$SmoothMoveSub$Basic$main(
