...
var $author$project$HTML$SmoothMoveSub$Multiple$init = function (_v0) {
	var initialSmoothMove = A4(
		...
		A4(
			...
			400,
			180,
			A4($author$project$SmoothMoveSub$setPosition, 'element-a', 300, 120, $author$project$SmoothMoveSub$init)));
	return _Utils_Tuple2(
		{smoothMove: initialSmoothMove},
		$elm$core$Platform$Cmd$none);
};
var $author$project$HTML$SmoothMoveSub$Multiple$AnimationFrame = function (a) {
...
var $author$project$HTML$SmoothMoveSub$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartElementA':
...
var $author$project$HTML$SmoothMoveSub$Multiple$StartAll = {$: 'StartAll'};
var $author$project$HTML$SmoothMoveSub$Multiple$StartElementA = {$: 'StartElementA'};
var $author$project$HTML$SmoothMoveSub$Multiple$StartElementB = {$: 'StartElementB'};
var $author$project$HTML$SmoothMoveSub$Multiple$StartElementC = {$: 'StartElementC'};
...
var $author$project$HTML$SmoothMoveSub$Multiple$view = function (model) {
	var getTransform = F3(
		function (elementId, defaultX, defaultY) {
			var _v0 = A2($author$project$SmoothMoveSub$getPosition, elementId, model.smoothMove);
			if (_v0.$ === 'Just') {
				var pos = _v0.a;
				return A2($author$project$SmoothMoveSub$transform, pos.x, pos.y);
			} else {
				return A2($author$project$SmoothMoveSub$transform, defaultX, defaultY);
			}
		});
	return {
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveSub$Multiple$StartElementA),
												A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveSub$Multiple$StartElementB),
												A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveSub$Multiple$StartElementC),
												A2($elm$html$Html$Attributes$style, 'padding', '10px 15px'),
										...
										_List_fromArray(
											[
												$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveSub$Multiple$StartAll),
...
var $author$project$HTML$SmoothMoveSub$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$HTML$SmoothMoveSub$Multiple$init, subscriptions: $author$project$HTML$SmoothMoveSub$Multiple$subscriptions, update: $author$project$HTML$SmoothMoveSub$Multiple$update, view: $author$project$HTML$SmoothMoveSub$Multiple$view});
_Platform_export({'HTML':{'SmoothMoveSub':{'Multiple':{'init':$author$project$HTML$SmoothMoveSub$Multiple$main(
