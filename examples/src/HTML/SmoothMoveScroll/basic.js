...
var $author$project$HTML$SmoothMoveScroll$Basic$init = function (_v0) {
...
var $author$project$HTML$SmoothMoveScroll$Basic$NoOp = {$: 'NoOp'};
...
var $author$project$SmoothMoveScroll$scrollCmd = F2(
	function (msg, elementId) {
		return A3($author$project$SmoothMoveScroll$scrollCmdWithConfig, msg, elementId, $author$project$SmoothMoveScroll$defaultConfig);
	});
var $author$project$HTML$SmoothMoveScroll$Basic$update = F2(
	function (msg, model) {
		if (msg.$ === 'NoOp') {
			...
			return _Utils_Tuple2(
				model,
				A2($author$project$SmoothMoveScroll$scrollCmd, $author$project$HTML$SmoothMoveScroll$Basic$NoOp, id));
		}
	});
var $author$project$HTML$SmoothMoveScroll$Basic$SmoothScroll = function (a) {
...
var $author$project$HTML$SmoothMoveScroll$Basic$view = function (model) {
	return {
		body: _Utils_ap(
			_List_fromArray(
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$HTML$SmoothMoveScroll$Basic$SmoothScroll('p-two'))
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onClick(
									$author$project$HTML$SmoothMoveScroll$Basic$SmoothScroll('p-one'))
								]),
							_List_fromArray(
								[
...
var $author$project$HTML$SmoothMoveScroll$Basic$main = $elm$browser$Browser$document(
	{
		init: $author$project$HTML$SmoothMoveScroll$Basic$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HTML$SmoothMoveScroll$Basic$update,
		view: $author$project$HTML$SmoothMoveScroll$Basic$view
	});
_Platform_export({'HTML':{'SmoothMoveScroll':{'Basic':{'init':$author$project$HTML$SmoothMoveScroll$Basic$main(
