...
var $author$project$HTML$SmoothMoveScroll$Container$init = function (_v0) {
...
var $author$project$HTML$SmoothMoveScroll$Container$NoOp = {$: 'NoOp'};
...
var $author$project$HTML$SmoothMoveScroll$Container$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToTop':
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$HTML$SmoothMoveScroll$Container$NoOp,
						'top-element',
...
var $author$project$HTML$SmoothMoveScroll$Container$ScrollToBottom = {$: 'ScrollToBottom'};
var $author$project$HTML$SmoothMoveScroll$Container$ScrollToMiddle = {$: 'ScrollToMiddle'};
var $author$project$HTML$SmoothMoveScroll$Container$ScrollToTop = {$: 'ScrollToTop'};
...
var $author$project$HTML$SmoothMoveScroll$Container$view = function (model) {
	return {
		body: _List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveScroll$Container$ScrollToTop),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveScroll$Container$ScrollToMiddle),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveScroll$Container$ScrollToBottom),
				...
				_List_fromArray(
					[
						$elm$html$Html$text($author$project$HTML$SmoothMoveScroll$Container$css)
					]))
			]),
		title: 'SmoothMoveScroll - Container Scrolling'
	};
};
var $author$project$HTML$SmoothMoveScroll$Container$main = $elm$browser$Browser$document(
	{
		init: $author$project$HTML$SmoothMoveScroll$Container$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$HTML$SmoothMoveScroll$Container$update,
		view: $author$project$HTML$SmoothMoveScroll$Container$view
	});
_Platform_export({'HTML':{'SmoothMoveScroll':{'Container':{'init':$author$project$HTML$SmoothMoveScroll$Container$main(
