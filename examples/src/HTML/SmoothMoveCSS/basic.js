...
var $author$project$HTML$SmoothMoveCSS$Basic$init = function (_v0) {
	var initialAnimations = A4($author$project$SmoothMoveCSS$setInitialPosition, 'box', 50, 50, $author$project$SmoothMoveCSS$init);
...
var $author$project$HTML$SmoothMoveCSS$Basic$subscriptions = function (model) {
...
var $author$project$HTML$SmoothMoveCSS$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
			...
			case 'MoveToCenter':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A4($author$project$SmoothMoveCSS$animateTo, 'box', 150, 100, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A2($author$project$SmoothMoveCSS$stopAnimation, 'box', model.animations)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$HTML$SmoothMoveCSS$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$HTML$SmoothMoveCSS$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$HTML$SmoothMoveCSS$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$HTML$SmoothMoveCSS$Basic$view = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
		A2($author$project$SmoothMoveCSS$getPosition, 'box', model.animations));
	var animatingText = $author$project$SmoothMoveCSS$isAnimating(model.animations) ? 'Animating with CSS transitions...' : 'Idle';
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('SmoothMoveCSS Example - Native CSS Transitions')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveCSS$Basic$MoveToCorner)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveCSS$Basic$MoveToCenter),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$HTML$SmoothMoveCSS$Basic$StopAnimation),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$style,
								'transition',
								A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'box', model.animations)),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This example uses native CSS transitions instead of JavaScript animation frames.'),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$elm$html$Html$text('The browser handles all the smooth interpolation automatically!')
					]))
			]));
};
var $author$project$HTML$SmoothMoveCSS$Basic$main = $elm$browser$Browser$element(
	{init: $author$project$HTML$SmoothMoveCSS$Basic$init, subscriptions: $author$project$HTML$SmoothMoveCSS$Basic$subscriptions, update: $author$project$HTML$SmoothMoveCSS$Basic$update, view: $author$project$HTML$SmoothMoveCSS$Basic$view});
_Platform_export({'HTML':{'SmoothMoveCSS':{'Basic':{'init':$author$project$HTML$SmoothMoveCSS$Basic$main(
