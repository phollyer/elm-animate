...
var $author$project$ElmUI$Scroll$Container$Main$init = function (_v0) {
...
var $author$project$ElmUI$Scroll$Container$Main$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$Scroll$Container$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToTop':
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$Scroll$Container$Main$NoOp,
						A2(
...
var $author$project$ElmUI$Scroll$Container$Main$ScrollToBottom = {$: 'ScrollToBottom'};
var $author$project$ElmUI$Scroll$Container$Main$ScrollToMiddle = {$: 'ScrollToMiddle'};
var $author$project$ElmUI$Scroll$Container$Main$ScrollToTop = {$: 'ScrollToTop'};
...
var $author$project$ElmUI$Scroll$Container$Main$bulletPoint = function (text_) {
	return A2(
...
var $author$project$ElmUI$Scroll$Container$Main$contentBlock = F2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$ElmUI$Scroll$Container$Main$bulletPoint('Each block adds to the scrollable height'),
								$author$project$ElmUI$Scroll$Container$Main$bulletPoint('The gradient background shows scroll position'),
								$author$project$ElmUI$Scroll$Container$Main$bulletPoint('Smooth scrolling animates between positions')
							]))
					])));
	});
...
var $author$project$ElmUI$Scroll$Container$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$Container$Main$ScrollToTop, 'Scroll to Top'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Container$Main$ScrollToMiddle, 'Scroll to Middle'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Container$Main$ScrollToBottom, 'Scroll to Bottom')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 1, 'This is content block 1. Each block adds to the scrollable height and demonstrates ElmUI styling.'),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 2, 'Content block 2 continues the gradient transition from white to dark with ElmUI elements.'),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 3, 'Content block 3 shows the middle section of our scrollable content using ElmUI layout.'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$ElmUI$Scroll$Container$Main$bulletPoint('This block serves as the middle anchor point'),
												$author$project$ElmUI$Scroll$Container$Main$bulletPoint('The gradient background shows scroll position'),
												$author$project$ElmUI$Scroll$Container$Main$bulletPoint('Smooth scrolling animates between positions')
											]))
									]))),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 5, 'Content block 5 continues toward the bottom of the container with ElmUI.'),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 6, 'Content block 6 shows we\'re getting closer to the bottom using ElmUI layout.'),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 7, 'Content block 7 is near the end with darker background colors in ElmUI.'),
							A2($author$project$ElmUI$Scroll$Container$Main$contentBlock, 8, 'Content block 8 is almost at the bottom of the scrollable ElmUI content.'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
...
var $author$project$ElmUI$Scroll$Container$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveScroll - Container Scrolling (ElmUI)',
		$author$project$Common$UI$Container,
		$author$project$ElmUI$Scroll$Container$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$Container$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$Scroll$Container$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$Scroll$Container$Main$update,
		view: $author$project$ElmUI$Scroll$Container$Main$view
	});
_Platform_export({'ElmUI':{'Scroll':{'Container':{'Main':{'init':$author$project$ElmUI$Scroll$Container$Main$main(
