...
var $author$project$ElmUI$Scroll$PageXY$Main$init = function (_v0) {
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						_Utils_update(
							...
							{axis: $author$project$SmoothMoveScroll$Both, offsetX: 20, offsetY: 20})));
...
var $author$project$ElmUI$Scroll$PageXY$Main$ScrollToBottomLeft = {$: 'ScrollToBottomLeft'};
var $author$project$ElmUI$Scroll$PageXY$Main$ScrollToBottomRight = {$: 'ScrollToBottomRight'};
var $author$project$ElmUI$Scroll$PageXY$Main$ScrollToCenter = {$: 'ScrollToCenter'};
var $author$project$ElmUI$Scroll$PageXY$Main$ScrollToTopLeft = {$: 'ScrollToTopLeft'};
var $author$project$ElmUI$Scroll$PageXY$Main$ScrollToTopRight = {$: 'ScrollToTopRight'};
...
var $author$project$ElmUI$Scroll$PageXY$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$PageXY$Main$ScrollToTopLeft, '↖ Top Left'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$PageXY$Main$ScrollToTopRight, '↗ Top Right'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$PageXY$Main$ScrollToCenter, '🎯 Center'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$PageXY$Main$ScrollToBottomLeft, '↙ Bottom Left'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$PageXY$Main$ScrollToBottomRight, '↘ Bottom Right')
						]))
				])),
			$author$project$ElmUI$Scroll$PageXY$Main$viewSimpleGrid
		]);
};
var $author$project$ElmUI$Scroll$PageXY$Main$view = function (model) {
	return A3(
