...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$initialModel = function (flags) {
	return {status: 'Ready to scroll elements into view', windowHeight: flags.windowHeight, windowWidth: flags.windowWidth};
};
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$TaskCompleted = {$: 'TaskCompleted'};
...
var $author$project$Scroll$Internal$calculateScrollIntoView = F5(
	function (element, viewport, scene, containerInfo, config) {
		...
		var _v0 = _Utils_Tuple2(viewportX, viewportY);
		var currentScrollX = _v0.a;
		var currentScrollY = _v0.b;
		var _v1 = function () {
			if (containerInfo.$ === 'Nothing') {
				return _Utils_Tuple2(elementX, elementY);
			} else {
				var containerEl = containerInfo.a;
				return _Utils_Tuple2(elementX - containerEl.element.x, elementY - containerEl.element.y);
			}
		}();
		var adjustedElementX = _v1.a;
		var adjustedElementY = _v1.b;
		var newScrollX = function () {
			if (_Utils_cmp(elementWidth, viewportWidth) > -1) {
				return adjustedElementX;
			} else {
				var viewportRight = currentScrollX + viewportWidth;
				var viewportLeft = currentScrollX;
				var elementRight = adjustedElementX + elementWidth;
				var elementLeft = adjustedElementX;
		...
		var newScrollY = function () {
			if (_Utils_cmp(elementHeight, viewportHeight) > -1) {
				...
				var viewportBottom = currentScrollY + viewportHeight;
				var topEdge = adjustedElementY;
				var bottomEdge = adjustedElementY + elementHeight;
...
var $author$project$Scroll$Document$Task$jumpIntoView = function (elementId) {
	return A2(
		$author$project$Scroll$Document$Task$jumpIntoViewWithConfig,
		elementId,
		_Utils_update(
...
var $author$project$Scroll$Document$Task$scrollIntoViewWithConfig = F2(
	function (elementId, config) {
		var performScrollTask = F3(
			function (_v4, _v5, containerInfo) {
				var scene = _v4.scene;
				var viewport = _v4.viewport;
				var element = _v5.element;
				var _v0 = A5($author$project$Scroll$Internal$calculateScrollIntoView, element, viewport, scene, containerInfo, config);
				var targetX = _v0.a;
				var targetY = _v0.b;
				var _v1 = A2(
...
var $author$project$Scroll$Document$Task$scrollIntoView = function (elementId) {
	return A2(
		$author$project$Scroll$Document$Task$scrollIntoViewWithConfig,
		elementId,
		_Utils_update(
			$author$project$Scroll$defaultConfig,
		...
		switch (msg.$) {
			case 'ScrollToElement':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: 'Scrolling to ' + (elementId + '...')}),
					A2(
						$elm$core$Task$attempt,
						function (_v1) {
							return $author$project$ElmUI$Scroll$ScrollIntoView$Main$TaskCompleted;
						},
						$author$project$Scroll$Document$Task$scrollIntoView(elementId)));
			case 'JumpToElement':
				var elementId = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: 'Jumping to ' + (elementId + '...')}),
					A2(
						$elm$core$Task$attempt,
						function (_v2) {
							return $author$project$ElmUI$Scroll$ScrollIntoView$Main$TaskCompleted;
						},
						$author$project$Scroll$Document$Task$jumpIntoView(elementId)));
			case 'TaskCompleted':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: 'Scroll completed!'}),
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$contentPanel = F5(
	function (_v0, panelHeight, bgColor, elements, _v1) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$viewContent = function (model) {
	var containerWidth = model.windowWidth * 3;
	var containerHeight = model.windowHeight * 4;
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text(
						'Window: ' + ($elm$core$String$fromInt(model.windowWidth) + ('x' + $elm$core$String$fromInt(model.windowHeight))))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
			...
			A2(
				...
				_List_fromArray(
					[
						A5(
						$author$project$ElmUI$Scroll$ScrollIntoView$Main$contentPanel,
						'Top Section',
						model.windowHeight,
						A3($mdgriffith$elm_ui$Element$rgb, 1.0, 0.95, 0.95),
						_List_fromArray(
							[
								A6(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$height(
								$mdgriffith$elm_ui$Element$px(model.windowHeight * 2)),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
							]),
						A2(
							$mdgriffith$elm_ui$Element$row,
							...
							_List_fromArray(
								[
									...
									A3($mdgriffith$elm_ui$Element$rgb, 0.95, 1.0, 0.95),
									_List_fromArray(
										[
											A6(
											$author$project$ElmUI$Scroll$ScrollIntoView$Main$targetElementWithButtons,
									...
									'Right Panel',
									model.windowHeight * 2,
									A3($mdgriffith$elm_ui$Element$rgb, 1.0, 0.95, 1.0),
									_List_fromArray(
										[
											A6(
											$author$project$ElmUI$Scroll$ScrollIntoView$Main$targetElementWithButtons,
						...
						'Bottom Section',
						model.windowHeight,
						A3($mdgriffith$elm_ui$Element$rgb, 0.98, 0.95, 1.0),
						_List_fromArray(
							[
								A6(
								$author$project$ElmUI$Scroll$ScrollIntoView$Main$targetElementWithButtons,
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'ScrollIntoView Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Scroll$ScrollIntoView$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$main = $elm$browser$Browser$document(
	{
		init: function (flags) {
			return _Utils_Tuple2(
				$author$project$ElmUI$Scroll$ScrollIntoView$Main$initialModel(flags),
				$elm$core$Platform$Cmd$none);
		},
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$Scroll$ScrollIntoView$Main$update,
		view: $author$project$ElmUI$Scroll$ScrollIntoView$Main$view
	});
_Platform_export({'ElmUI':{'Scroll':{'ScrollIntoView':{'Main':{'init':$author$project$ElmUI$Scroll$ScrollIntoView$Main$main(
	A2(
