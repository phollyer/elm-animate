...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$OnResize = F2(
	function (a, b) {
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$subscriptions = function (model) {
	return $elm$browser$Browser$Events$onResize($author$project$ElmUI$Scroll$ScrollIntoView$Main$OnResize);
};
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Common$UI$wrappedButtonRow(buttons)
							]))
					])));
	});
...
var $author$project$ElmUI$Scroll$ScrollIntoView$Main$main = $elm$browser$Browser$document(
	{
		...
		subscriptions: $author$project$ElmUI$Scroll$ScrollIntoView$Main$subscriptions,
