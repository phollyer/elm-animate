...
var $author$project$ElmUI$Scroll$ScrollToTop$Main$init = function (_v0) {
	...
	function (msg, model) {
		switch (msg.$) {
			case 'ScrollToTop':
				return _Utils_Tuple2(
					model,
					A2($author$project$Scroll$Cmd$scrollToTop, $author$project$Scroll$DocumentBody, $author$project$ElmUI$Scroll$ScrollToTop$Main$NoOp));
			case 'ScrollContainerToTop':
				return _Utils_Tuple2(
					model,
					A2(
						$author$project$Scroll$Cmd$scrollToTop,
						$author$project$Scroll$Container('content-container'),
						$author$project$ElmUI$Scroll$ScrollToTop$Main$NoOp));
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$ElmUI$Scroll$ScrollToTop$Main$ScrollContainerToTop = {$: 'ScrollContainerToTop'};
var $author$project$ElmUI$Scroll$ScrollToTop$Main$ScrollToTop = {$: 'ScrollToTop'};
...
var $author$project$ElmUI$Scroll$ScrollToTop$Main$button = F2(
	function (label, msg) {
		return A2(
			...
			_List_fromArray(
				[
					...
					A3($mdgriffith$elm_ui$Element$rgb, 0.2, 0.6, 0.8)),
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Background$color(
							A3($mdgriffith$elm_ui$Element$rgb, 0.1, 0.5, 0.7))
						])),
...
var $author$project$ElmUI$Scroll$ScrollToTop$Main$generateContent = function (count) {
	return A2(
		$elm$core$List$map,
		function (i) {
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Background$color(
						(!A2($elm$core$Basics$modBy, 2, i)) ? A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1) : A3($mdgriffith$elm_ui$Element$rgb, 0.95, 0.95, 1)),
						$mdgriffith$elm_ui$Element$Border$width(1),
						$mdgriffith$elm_ui$Element$Border$color(
						A3($mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8))
					]),
				$mdgriffith$elm_ui$Element$text(
					'Container Item ' + ($elm$core$String$fromInt(i) + ' - Scroll down to test the back-to-top buttons')));
		},
...
var $author$project$ElmUI$Scroll$ScrollToTop$Main$view = function (model) {
	return A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text('ScrollToTop Demo')),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
							...
							A2(
								...
								_List_fromArray(
									[
										A2($author$project$ElmUI$Scroll$ScrollToTop$Main$button, 'Document Top', $author$project$ElmUI$Scroll$ScrollToTop$Main$ScrollToTop),
										A2($author$project$ElmUI$Scroll$ScrollToTop$Main$button, 'Container Top', $author$project$ElmUI$Scroll$ScrollToTop$Main$ScrollContainerToTop)
									])))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$id('content-container'))
						]),
					A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
						...
						$author$project$ElmUI$Scroll$ScrollToTop$Main$generateContent(50))),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					A2(
						...
						function (i) {
							return A2(
								...
								$mdgriffith$elm_ui$Element$text(
									'Document Section ' + $elm$core$String$fromInt(i)));
						},
						A2($elm$core$List$range, 1, 20)))
				])));
};
var $author$project$ElmUI$Scroll$ScrollToTop$Main$main = $elm$browser$Browser$element(
	{
		init: $author$project$ElmUI$Scroll$ScrollToTop$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$Scroll$ScrollToTop$Main$update,
		view: $author$project$ElmUI$Scroll$ScrollToTop$Main$view
	});
_Platform_export({'ElmUI':{'Scroll':{'ScrollToTop':{'Main':{'init':$author$project$ElmUI$Scroll$ScrollToTop$Main$main(
