...
var $author$project$ElmUI$Scroll$DocumentX$Main$init = function (_v0) {
...
var $author$project$ElmUI$Scroll$DocumentX$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ElmUI$Scroll$DocumentX$Main$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$Scroll$DocumentX$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToSection':
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						id,
						$author$project$ElmUI$Scroll$DocumentX$Main$NoOp,
						_Utils_update(
			...
			case 'ScrollToStart':
				return _Utils_Tuple2(
					model,
					$author$project$Scroll$Document$Cmd$scrollToLeftEdge($author$project$ElmUI$Scroll$DocumentX$Main$NoOp));
			case 'ScrollToEnd':
				return _Utils_Tuple2(
					model,
					$author$project$Scroll$Document$Cmd$scrollToRightEdge($author$project$ElmUI$Scroll$DocumentX$Main$NoOp));
			case 'AddSection':
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$ElmUI$Scroll$DocumentX$Main$AddSection = {$: 'AddSection'};
var $author$project$ElmUI$Scroll$DocumentX$Main$RemoveSection = {$: 'RemoveSection'};
...
var $author$project$ElmUI$Scroll$DocumentX$Main$ScrollToEnd = {$: 'ScrollToEnd'};
var $author$project$ElmUI$Scroll$DocumentX$Main$ScrollToSection = function (a) {
	return {$: 'ScrollToSection', a: a};
};
var $author$project$ElmUI$Scroll$DocumentX$Main$ScrollToStart = {$: 'ScrollToStart'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$ElmUI$Scroll$DocumentX$Main$getButtonStyle = function (index) {
...
var $author$project$ElmUI$Scroll$DocumentX$Main$generateSectionButtons = F2(
	function (currentSection, totalSections) {
		var startButton = _List_fromArray(
			[
				_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$DocumentX$Main$ScrollToStart, 'Start')
			]);
		var sectionButtons = A2(
			$elm$core$List$map,
			function (n) {
				return _Utils_Tuple3(
					$author$project$ElmUI$Scroll$DocumentX$Main$getButtonStyle(n),
					$author$project$ElmUI$Scroll$DocumentX$Main$ScrollToSection(
		...
		var endButton = _List_fromArray(
			[
				_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$DocumentX$Main$ScrollToEnd, 'End')
			]);
		return _Utils_ap(
			startButton,
...
var $author$project$ElmUI$Scroll$DocumentX$Main$getTitleColor = function (index) {
	var _v0 = A2($elm$core$Basics$modBy, 4, index);
	switch (_v0) {
		case 0:
...
var $author$project$ElmUI$Scroll$DocumentX$Main$generateSection = F2(
	function (sectionNum, totalSections) {
		return $author$project$Common$UI$contentSection(
			{
				buttons: A2($author$project$ElmUI$Scroll$DocumentX$Main$generateSectionButtons, sectionNum, totalSections),
				centerTitle: true,
				...
				titleColor: $elm$core$Maybe$Just(
					$author$project$ElmUI$Scroll$DocumentX$Main$getTitleColor(sectionNum)),
				width: $elm$core$Maybe$Just(300)
			});
	});
var $author$project$ElmUI$Scroll$DocumentX$Main$generateStartSection = function (totalSections) {
	var sectionButtons = A2(
		$elm$core$List$map,
		function (n) {
			return _Utils_Tuple3(
...
var $author$project$ElmUI$Scroll$DocumentX$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Common$UI$htmlActionButtons(
						_List_fromArray(
							[
								_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$DocumentX$Main$AddSection, '+ Add Section'),
								_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$DocumentX$Main$RemoveSection, '− Remove Section')
							])))
				])),
			A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						$author$project$ElmUI$Scroll$DocumentX$Main$generateStartSection(model.sectionCount)
					]),
				A2(
					$elm$core$List$map,
					function (n) {
						return A2($author$project$ElmUI$Scroll$DocumentX$Main$generateSection, n, model.sectionCount);
					},
					A2($elm$core$List$range, 1, model.sectionCount))))
		]);
};
var $author$project$ElmUI$Scroll$DocumentX$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$Scroll$DocumentX$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$DocumentX$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Scroll$DocumentX$Main$init, subscriptions: $author$project$ElmUI$Scroll$DocumentX$Main$subscriptions, update: $author$project$ElmUI$Scroll$DocumentX$Main$update, view: $author$project$ElmUI$Scroll$DocumentX$Main$view});
_Platform_export({'ElmUI':{'Scroll':{'DocumentX':{'Main':{'init':$author$project$ElmUI$Scroll$DocumentX$Main$main(
