...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$init = function (_v0) {
...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToCard':
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$Scroll$HorizontalContainer$Main$NoOp,
						_Utils_update(
...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$ScrollToCard = function (a) {
	return {$: 'ScrollToCard', a: a};
};
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$ScrollToStart = {$: 'ScrollToStart'};
...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$viewCard = function (cardNum) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
							...
							[
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just(
										$author$project$ElmUI$Scroll$HorizontalContainer$Main$ScrollToCard(cardNum - 1))
								}) : A2(
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('')),
...
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$column,
					...
					A2(
						...
						function (i) {
							return _Utils_Tuple3(
								...
								$author$project$ElmUI$Scroll$HorizontalContainer$Main$ScrollToCard(i),
								'Card ' + $elm$core$String$fromInt(i));
						},
						A2($elm$core$List$range, 1, 8))),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$HorizontalContainer$Main$ScrollToStart, '← Back to Start')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$ElmUI$Scroll$HorizontalContainer$Main$viewCard,
					A2($elm$core$List$range, 1, 10))))
		]);
};
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$Scroll$HorizontalContainer$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$HorizontalContainer$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Scroll$HorizontalContainer$Main$init, subscriptions: $author$project$ElmUI$Scroll$HorizontalContainer$Main$subscriptions, update: $author$project$ElmUI$Scroll$HorizontalContainer$Main$update, view: $author$project$ElmUI$Scroll$HorizontalContainer$Main$view});
_Platform_export({'ElmUI':{'Scroll':{'HorizontalContainer':{'Main':{'init':$author$project$ElmUI$Scroll$HorizontalContainer$Main$main(
