...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$init = function (_v0) {
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$NoOp = {$: 'NoOp'};
...
var $author$project$Scroll$Internal$getClampedPositions = F5(
	function (element, viewport, scene, container, config) {
		var _v0 = A4($author$project$Scroll$Internal$getTargetPositions, element, viewport, container, config);
		var targetX = _v0.a;
		var targetY = _v0.b;
		return _Utils_Tuple2(
			A2(
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo = function (targetId) {
	return A3(
		$author$project$Scroll$Document$Cmd$scrollWithConfig,
		targetId,
		$author$project$ElmUI$Scroll$Document$Position$Both$Main$NoOp,
		_Utils_update(
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToTopLeft':
				return _Utils_Tuple2(
					model,
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo('top-left'));
			case 'ScrollToTopRight':
				return _Utils_Tuple2(
					model,
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo('top-right'));
			case 'ScrollToBottomLeft':
				return _Utils_Tuple2(
					model,
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo('bottom-left'));
			case 'ScrollToBottomRight':
				return _Utils_Tuple2(
					model,
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo('bottom-right'));
			default:
				return _Utils_Tuple2(
					model,
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$scrollTo('center'));
		}
	});
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomLeft = {$: 'ScrollToBottomLeft'};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight = {$: 'ScrollToBottomRight'};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToCenter = {$: 'ScrollToCenter'};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopLeft = {$: 'ScrollToTopLeft'};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopRight = {$: 'ScrollToTopRight'};
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$getNavigationButtons = function (currentId) {
	switch (currentId) {
		case 'top-left':
			return _List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopRight, '↗ TR'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToCenter, '🎯 C'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomLeft, '↙ BL'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight, '↘ BR')
				]);
		case 'top-right':
			return _List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopLeft, '↖ TL'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToCenter, '🎯 C'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomLeft, '↙ BL'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight, '↘ BR')
				]);
		case 'center':
			return _List_fromArray(
				[
					...
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopRight, '↗ TR'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomLeft, '↙ BL'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight, '↘ BR')
				]);
		case 'bottom-left':
			return _List_fromArray(
				[
					...
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopRight, '↗ TR'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToCenter, '🎯 C'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight, '↘ BR')
				]);
		case 'bottom-right':
			return _List_fromArray(
				[
...
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$viewCard = F4(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								$author$project$ElmUI$Scroll$Document$Position$Both$Main$getNavigationButtons(targetId)))
						]))
				]));
	});
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$viewSimpleGrid = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
			$mdgriffith$elm_ui$Element$px(1800)),
			$mdgriffith$elm_ui$Element$spacing(100),
			A2($mdgriffith$elm_ui$Element$paddingXY, 40, 80),
			$mdgriffith$elm_ui$Element$htmlAttribute(
			$elm$html$Html$Attributes$class('simple-grid'))
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					A4(
					$author$project$ElmUI$Scroll$Document$Position$Both$Main$viewCard,
					'top-left',
					'↖ TOP LEFT',
					A3($mdgriffith$elm_ui$Element$rgb255, 59, 130, 246),
					_List_fromArray(
						['This is the top-left corner of our diagonal scrolling demonstration.', 'Click the \'↖ Top Left\' button to animate diagonally to this position.', 'The Both axis scrolling moves smoothly in X and Y directions simultaneously.'])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					_List_fromArray(
						['Welcome to the top-right corner!', 'Notice how the diagonal animation moves both horizontally and vertically.', 'This demonstrates the power of Both axis configuration.']))
				])),
			A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						['This is the center position of our layout.', 'From any corner, clicking \'Center\' creates a perfect diagonal scroll.', 'The center demonstrates Both axis interpolation at its finest.'])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						['You\'ve reached the bottom-left corner.', 'Try navigating to different corners to see diagonal movement.', 'Each animation smoothly interpolates between start and end positions.'])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					_List_fromArray(
						['This is the bottom-right corner, the final destination.', 'The diagonal scrolling works perfectly in all directions!', 'Both axis scrolling makes complex layouts easy to navigate.']))
				]))
		]));
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Diagonal Both Axis Scrolling'),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Navigate Diagonally:')),
					$author$project$Common$UI$htmlActionButtons(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopLeft, '↖ Top Left'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToTopRight, '↗ Top Right'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToCenter, '🎯 Center'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomLeft, '↙ Bottom Left'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Both$Main$ScrollToBottomRight, '↘ Bottom Right')
						]))
				])),
			$author$project$ElmUI$Scroll$Document$Position$Both$Main$viewSimpleGrid
		]);
};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveScroll Diagonal Both Axis - ElmUI Example',
		$author$project$Common$UI$Diagonal,
		$author$project$ElmUI$Scroll$Document$Position$Both$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$Document$Position$Both$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$Scroll$Document$Position$Both$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$Scroll$Document$Position$Both$Main$update,
		view: $author$project$ElmUI$Scroll$Document$Position$Both$Main$view
	});
_Platform_export({'ElmUI':{'Scroll':{'Document':{'Position':{'Both':{'Main':{'init':$author$project$ElmUI$Scroll$Document$Position$Both$Main$main(
