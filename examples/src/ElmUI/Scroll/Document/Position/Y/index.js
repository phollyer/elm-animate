...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$init = function (_v0) {
...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp = {$: 'NoOp'};
...
var $author$project$Scroll$Document$Task$scrollToBottomWithConfig = function (config) {
	return A2(
		...
		function (_v0) {
			...
			var targetY = maxY - $author$project$Scroll$Internal$getOffsetY(config.axis);
			var steps = A4(
...
var $author$project$Scroll$Document$Task$scrollToTopWithConfig = function (config) {
	return A2(
		...
		function (_v0) {
			var viewport = _v0.viewport;
			var targetY = $author$project$Scroll$Internal$getOffsetY(config.axis);
			var steps = A4(
				$author$project$Internal$AnimationCore$animationSteps,
				A2(
					$author$project$Scroll$Internal$timingToSpeed,
...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToParagraphOne':
				return _Utils_Tuple2(
					model,
					A3($author$project$Scroll$Document$Cmd$scrollWithConfig, 'paragraph-one', $author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp, $author$project$Scroll$defaultConfig));
			case 'ScrollToParagraphTwo':
				return _Utils_Tuple2(
					model,
					A3($author$project$Scroll$Document$Cmd$scrollWithConfig, 'paragraph-two', $author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp, $author$project$Scroll$defaultConfig));
			case 'ScrollToParagraphThree':
				return _Utils_Tuple2(
					model,
					A3($author$project$Scroll$Document$Cmd$scrollWithConfig, 'paragraph-three', $author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp, $author$project$Scroll$defaultConfig));
			case 'ScrollToTop':
				return _Utils_Tuple2(
					model,
					$author$project$Scroll$Document$Cmd$scrollToTop($author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp));
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Scroll$Document$Cmd$scrollToBottom($author$project$ElmUI$Scroll$Document$Position$Y$Main$NoOp));
		}
	});
...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToBottom = {$: 'ScrollToBottom'};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphOne = {$: 'ScrollToParagraphOne'};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphThree = {$: 'ScrollToParagraphThree'};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphTwo = {$: 'ScrollToParagraphTwo'};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToTop = {$: 'ScrollToTop'};
...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$viewContent = function (model) {
	var contentSectionSimple = F4(
	...
	return _List_fromArray(
		[
			...
			$author$project$Common$UI$wrappedButtonRow(
				_List_fromArray(
					[
						_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphOne, 'Scroll to Paragraph One ↓'),
						_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphTwo, 'Scroll to Paragraph Two ↓'),
						_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphThree, 'Scroll to Paragraph Three ↓'),
						_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToBottom, 'Scroll to Bottom ↓')
					]))),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToTop, 'Scroll to Top ↑'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphTwo, 'Scroll to Paragraph Two ↓'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToParagraphThree, 'Scroll to Paragraph Three ↓'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Scroll$Document$Position$Y$Main$ScrollToBottom, 'Scroll to Bottom ↓')
				])),
...
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveScroll Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Scroll$Document$Position$Y$Main$viewContent(model));
};
var $author$project$ElmUI$Scroll$Document$Position$Y$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Scroll$Document$Position$Y$Main$init, subscriptions: $author$project$ElmUI$Scroll$Document$Position$Y$Main$subscriptions, update: $author$project$ElmUI$Scroll$Document$Position$Y$Main$update, view: $author$project$ElmUI$Scroll$Document$Position$Y$Main$view});
_Platform_export({'ElmUI':{'Scroll':{'Document':{'Position':{'Y':{'Main':{'init':$author$project$ElmUI$Scroll$Document$Position$Y$Main$main(
