...
var $author$project$SmoothMoveState$setInitialPosition = F4(
...
var $author$project$ElmUI$SmoothMoveStateUI$Basic$init = function (_v0) {
	var initialState = A4($author$project$SmoothMoveState$setInitialPosition, 'moving-box', 0, 0, $author$project$SmoothMoveState$init);
	return _Utils_Tuple2(
		{animationState: initialState},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMoveStateUI$Basic$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveStateUI$Basic$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$ElmUI$SmoothMoveStateUI$Basic$AnimationFrame);
};
...
var $author$project$SmoothMoveState$animateToWithConfig = F5(
	function (config, elementId, targetX, targetY, _v0) {
		...
		var currentPos = A2(
			...
			{x: 0, y: 0},
			A2(
				$author$project$SmoothMoveState$getPosition,
				elementId,
				$author$project$SmoothMoveState$State(elements)));
		...
		var animation = {config: config, currentX: currentPos.x, currentY: currentPos.y, duration: duration, elapsedTime: 0, startX: currentPos.x, startY: currentPos.y, targetX: targetX, targetY: targetY};
		var elementData = {
			animation: $elm$core$Maybe$Just(animation),
			lastX: currentPos.x,
			lastY: currentPos.y
		};
		var updatedElements = A3($elm$core$Dict$insert, elementId, elementData, elements);
...
var $author$project$SmoothMoveState$animateTo = F4(
	function (elementId, targetX, targetY, state) {
		return A5($author$project$SmoothMoveState$animateToWithConfig, $author$project$SmoothMoveState$defaultConfig, elementId, targetX, targetY, state);
	});
var $author$project$SmoothMoveState$isAnimationComplete = function (animation) {
	var tolerance = 0.1;
	var xComplete = function () {
		...
		if (_v1.$ === 'Y') {
			...
			return _Utils_cmp(
				$elm$core$Basics$abs(animation.currentX - animation.targetX),
				tolerance) < 0;
		}
	}();
	var yComplete = function () {
		...
		if (_v0.$ === 'X') {
			...
			return _Utils_cmp(
				$elm$core$Basics$abs(animation.currentY - animation.targetY),
				tolerance) < 0;
		}
	}();
...
var $author$project$SmoothMoveState$step = F2(
	function (deltaMs, _v0) {
		...
		var updateElementData = F2(
			function (_v4, elementData) {
				var _v1 = elementData.animation;
				if (_v1.$ === 'Nothing') {
					return elementData;
				} else {
					var animation = _v1.a;
					var newElapsedTime = animation.elapsedTime + deltaMs;
					var progress = A2($elm$core$Basics$min, 1.0, newElapsedTime / animation.duration);
					var easedProgress = animation.config.easing(progress);
					var newCurrentX = function () {
						var _v3 = animation.config.axis;
						if (_v3.$ === 'Y') {
							return animation.startX;
						} else {
							return animation.startX + ((animation.targetX - animation.startX) * easedProgress);
						}
					}();
					var newCurrentY = function () {
						var _v2 = animation.config.axis;
						if (_v2.$ === 'X') {
							return animation.startY;
						} else {
							return animation.startY + ((animation.targetY - animation.startY) * easedProgress);
						}
					}();
					var updatedAnimation = _Utils_update(
						animation,
						{currentX: newCurrentX, currentY: newCurrentY, elapsedTime: newElapsedTime});
					return $author$project$SmoothMoveState$isAnimationComplete(updatedAnimation) ? _Utils_update(
						elementData,
						{animation: $elm$core$Maybe$Nothing, lastX: updatedAnimation.currentX, lastY: updatedAnimation.currentY}) : _Utils_update(
						elementData,
						{
							animation: $elm$core$Maybe$Just(updatedAnimation)
						});
				}
			});
		var updatedElements = A2($elm$core$Dict$map, updateElementData, elements);
		return $author$project$SmoothMoveState$State(updatedElements);
	});
var $author$project$ElmUI$SmoothMoveStateUI$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animationState: A2($author$project$SmoothMoveState$step, deltaMs, model.animationState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveToCorner':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animationState: A4($author$project$SmoothMoveState$animateTo, 'moving-box', 100, 100, model.animationState)
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveToCenter':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animationState: A4($author$project$SmoothMoveState$animateTo, 'moving-box', 300, 200, model.animationState)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animationState: A4($author$project$SmoothMoveState$animateTo, 'moving-box', 0, 0, model.animationState)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$ElmUI$SmoothMoveStateUI$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$SmoothMoveStateUI$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveStateUI$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$SmoothMoveStateUI$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
		A2($author$project$SmoothMoveState$getPosition, 'moving-box', model.animationState));
	var isMoving = $author$project$SmoothMoveState$isAnimating(model.animationState);
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('SmoothMoveState Basic Example'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMoveState module, which provides a '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('convenience wrapper')),
							$mdgriffith$elm_ui$Element$text(' around the subscription-based animation system. It offers '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('simplified state management')),
							$mdgriffith$elm_ui$Element$text(' with helper functions while maintaining frame-rate independent positioning and smooth element transitions.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for developers who want the power of subscription-based animations with '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('reduced boilerplate')),
							$mdgriffith$elm_ui$Element$text(' and easier integration into existing Elm applications.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveStateUI$Basic$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveStateUI$Basic$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveStateUI$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$html$Html$Attributes$style,
							'transform',
							A2($author$project$SmoothMoveState$transform, position.x, position.y))),
						$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$ElmUI$SmoothMoveStateUI$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveState Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveStateUI$Basic$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveStateUI$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveStateUI$Basic$init, subscriptions: $author$project$ElmUI$SmoothMoveStateUI$Basic$subscriptions, update: $author$project$ElmUI$SmoothMoveStateUI$Basic$update, view: $author$project$ElmUI$SmoothMoveStateUI$Basic$view});
_Platform_export({'ElmUI':{'SmoothMoveStateUI':{'Basic':{'init':$author$project$ElmUI$SmoothMoveStateUI$Basic$main(
