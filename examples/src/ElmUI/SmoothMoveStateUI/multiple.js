...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$init = function (_v0) {
	var initialState = A4(
		$author$project$SmoothMoveState$setInitialPosition,
		'element-f',
		180,
		50,
		A4(
			...
			A4(
				...
				A4(
					...
					A4(
						...
						200,
						150,
						A4($author$project$SmoothMoveState$setInitialPosition, 'element-a', 150, 100, $author$project$SmoothMoveState$init))))));
	return _Utils_Tuple2(
		{animationState: initialState},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$ElmUI$SmoothMoveStateUI$Multiple$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
			...
			case 'ScatterElements':
				var newState = A4(
					$author$project$SmoothMoveState$animateTo,
					'element-f',
					350,
					320,
					A4(
						...
						A4(
							...
							A4(
								...
								A4(
									...
									80,
									280,
									A4($author$project$SmoothMoveState$animateTo, 'element-a', 320, 80, model.animationState))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						...
						A4(
							...
							A4(
								...
								A4(
									...
									200,
									150,
									A4($author$project$SmoothMoveState$animateTo, 'element-a', 150, 100, model.animationState))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animationState: newState}),
						...
						A4(
							...
							A4(
								...
								A4(
									...
									centerX + (radius * 0.5),
									centerY + (radius * 0.866),
									A4($author$project$SmoothMoveState$animateTo, 'element-a', centerX + radius, centerY, model.animationState))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animationState: newState}),
...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
		A2($author$project$SmoothMoveState$getPosition, 'element-f', model.animationState));
	var positionE = A2(
		$elm$core$Maybe$withDefault,
		{x: 300, y: 100},
		A2($author$project$SmoothMoveState$getPosition, 'element-e', model.animationState));
	var positionD = A2(
		$elm$core$Maybe$withDefault,
		{x: 250, y: 200},
		A2($author$project$SmoothMoveState$getPosition, 'element-d', model.animationState));
	var positionC = A2(
		$elm$core$Maybe$withDefault,
		{x: 100, y: 200},
		A2($author$project$SmoothMoveState$getPosition, 'element-c', model.animationState));
	var positionB = A2(
		$elm$core$Maybe$withDefault,
		{x: 200, y: 150},
		A2($author$project$SmoothMoveState$getPosition, 'element-b', model.animationState));
	var positionA = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
		A2($author$project$SmoothMoveState$getPosition, 'element-a', model.animationState));
	var isMoving = $author$project$SmoothMoveState$isAnimating(model.animationState);
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('SmoothMoveState Multiple Example'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMoveState module handling '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('multiple independent animations')),
							$mdgriffith$elm_ui$Element$text(' with comprehensive state management. It showcases '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveStateUI$Multiple$ScatterElements, 'Scatter'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveStateUI$Multiple$CircleFormation, 'Circle Formation'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveStateUI$Multiple$ResetPositions, 'Reset')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveState Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveStateUI$Multiple$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveStateUI$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveStateUI$Multiple$init, subscriptions: $author$project$ElmUI$SmoothMoveStateUI$Multiple$subscriptions, update: $author$project$ElmUI$SmoothMoveStateUI$Multiple$update, view: $author$project$ElmUI$SmoothMoveStateUI$Multiple$view});
_Platform_export({'ElmUI':{'SmoothMoveStateUI':{'Multiple':{'init':$author$project$ElmUI$SmoothMoveStateUI$Multiple$main(
