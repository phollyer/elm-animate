...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$init = function (_v0) {
	return _Utils_Tuple2(
		{smoothMove: $author$project$SmoothMoveSub$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMoveSubUI$Basic$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$ElmUI$SmoothMoveSubUI$Basic$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$update = F2(
	function (msg, model) {
		if (msg.$ === 'StartMove') {
			var x = msg.a;
			var y = msg.b;
...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$StartMove = F2(
	function (a, b) {
...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
		...
		[
			...
			_List_fromArray(
				[
					...
					A2($author$project$ElmUI$SmoothMoveSubUI$Basic$StartMove, 100, 100),
					'Move to (100, 100)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					A2($author$project$ElmUI$SmoothMoveSubUI$Basic$StartMove, 300, 200),
					'Move to (300, 200)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Purple,
					A2($author$project$ElmUI$SmoothMoveSubUI$Basic$StartMove, 0, 0),
					'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
...
var $author$project$ElmUI$SmoothMoveSubUI$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveSub Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveSubUI$Basic$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveSubUI$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveSubUI$Basic$init, subscriptions: $author$project$ElmUI$SmoothMoveSubUI$Basic$subscriptions, update: $author$project$ElmUI$SmoothMoveSubUI$Basic$update, view: $author$project$ElmUI$SmoothMoveSubUI$Basic$view});
_Platform_export({'ElmUI':{'SmoothMoveSubUI':{'Basic':{'init':$author$project$ElmUI$SmoothMoveSubUI$Basic$main(
