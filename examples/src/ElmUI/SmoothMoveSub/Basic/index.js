...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{smoothMove: $author$project$SmoothMoveSub$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$ElmUI$SmoothMoveSub$Basic$Main$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'StartMove') {
			var x = msg.a;
			var y = msg.b;
			var updatedSmoothMove = A4($author$project$SmoothMoveSub$animateTo, 'moving-box', x, y, model.smoothMove);
			return _Utils_Tuple2(
				_Utils_update(
					model,
...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$StartMove = F2(
	function (a, b) {
...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
		A2($author$project$SmoothMoveSub$getPosition, 'moving-box', model.smoothMove));
		...
		[
			...
			_List_fromArray(
				[
					...
					A2($author$project$ElmUI$SmoothMoveSub$Basic$Main$StartMove, 100, 100),
					'Move to (100, 100)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					A2($author$project$ElmUI$SmoothMoveSub$Basic$Main$StartMove, 300, 200),
					'Move to (300, 200)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Purple,
					A2($author$project$ElmUI$SmoothMoveSub$Basic$Main$StartMove, 0, 0),
					'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$html$Html$Attributes$style,
							'transform',
							A2($author$project$SmoothMoveSub$transform, position.x, position.y))),
						$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveSub Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveSub$Basic$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveSub$Basic$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveSub$Basic$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveSub$Basic$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveSub$Basic$Main$update, view: $author$project$ElmUI$SmoothMoveSub$Basic$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveSub':{'Basic':{'Main':{'init':$author$project$ElmUI$SmoothMoveSub$Basic$Main$main(
