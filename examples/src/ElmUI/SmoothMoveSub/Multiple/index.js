...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$init = function (_v0) {
	var smoothMove = A4(
			...
			A4(
				...
				A4(
					...
					A4(
						...
						200,
						150,
						A4($author$project$SmoothMoveSub$setInitialPosition, 'element-a', 150, 100, $author$project$SmoothMoveSub$init))))));
	return _Utils_Tuple2(
		{smoothMove: smoothMove},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$ElmUI$SmoothMoveSub$Multiple$Main$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
				var updatedSmoothMove = A2($author$project$SmoothMoveSub$step, deltaMs, model.smoothMove);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{smoothMove: updatedSmoothMove}),
					$elm$core$Platform$Cmd$none);
			case 'ScatterElements':
				var updatedSmoothMove = A4(
						...
						A4(
							...
							A4(
								...
								A4(
									...
									80,
									280,
									A4($author$project$SmoothMoveSub$animateTo, 'element-a', 320, 80, model.smoothMove))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{smoothMove: updatedSmoothMove}),
						...
						A4(
							...
							A4(
								...
								A4(
									...
									200,
									150,
									A4($author$project$SmoothMoveSub$animateTo, 'element-a', 150, 100, model.smoothMove))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{smoothMove: updatedSmoothMove}),
						...
						A4(
							...
							A4(
								...
								A4(
									...
									centerX + (radius * 0.5),
									centerY + (radius * 0.866),
									A4($author$project$SmoothMoveSub$animateTo, 'element-a', centerX + radius, centerY, model.smoothMove))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{smoothMove: updatedSmoothMove}),
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
		A2($author$project$SmoothMoveSub$getPosition, 'element-f', model.smoothMove));
	var positionE = A2(
		$elm$core$Maybe$withDefault,
		{x: 300, y: 100},
		A2($author$project$SmoothMoveSub$getPosition, 'element-e', model.smoothMove));
	var positionD = A2(
		$elm$core$Maybe$withDefault,
		{x: 250, y: 200},
		A2($author$project$SmoothMoveSub$getPosition, 'element-d', model.smoothMove));
	var positionC = A2(
		$elm$core$Maybe$withDefault,
		{x: 100, y: 200},
		A2($author$project$SmoothMoveSub$getPosition, 'element-c', model.smoothMove));
	var positionB = A2(
		$elm$core$Maybe$withDefault,
		{x: 200, y: 150},
		A2($author$project$SmoothMoveSub$getPosition, 'element-b', model.smoothMove));
	var positionA = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
		A2($author$project$SmoothMoveSub$getPosition, 'element-a', model.smoothMove));
	var isMoving = $author$project$SmoothMoveSub$isAnimating(model.smoothMove);
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('SmoothMoveSub Multiple Example'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMoveSub module coordinating '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('multiple elements simultaneously')),
							$mdgriffith$elm_ui$Element$text(' with subscription-based animations. Each element receives '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('frame-rate independent updates')),
							$mdgriffith$elm_ui$Element$text(', ensuring smooth formation control and synchronized movement patterns across different device capabilities.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for complex choreographed animations where '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('precise timing synchronization')),
							$mdgriffith$elm_ui$Element$text(' and real-time positioning control are essential requirements.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveSub$Multiple$Main$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveSub$Multiple$Main$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveSub$Multiple$Main$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionA.x, positionA.y)),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#10B981'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
									A2(
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionB.x, positionB.y)),
									A2($elm$html$Html$Attributes$style, 'transition', 'none'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#A855F7'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
									A2(
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionC.x, positionC.y)),
									A2($elm$html$Html$Attributes$style, 'transition', 'none'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#F56565'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
									A2(
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionD.x, positionD.y)),
									A2($elm$html$Html$Attributes$style, 'transition', 'none'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#FB923C'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
									A2(
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionE.x, positionE.y)),
									A2($elm$html$Html$Attributes$style, 'transition', 'none'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background-color', '#22C55E'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '8px'),
									A2(
									$elm$html$Html$Attributes$style,
									'transform',
									A2($author$project$SmoothMoveSub$transform, positionF.x, positionF.y)),
									A2($elm$html$Html$Attributes$style, 'transition', 'none'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveSub Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveSub$Multiple$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveSub$Multiple$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveSub$Multiple$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveSub$Multiple$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveSub$Multiple$Main$update, view: $author$project$ElmUI$SmoothMoveSub$Multiple$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveSub':{'Multiple':{'Main':{'init':$author$project$ElmUI$SmoothMoveSub$Multiple$Main$main(
