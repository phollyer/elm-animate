...
var $author$project$ElmUI$SmoothMoveSub$Multiple$init = function (_v0) {
	var smoothMove = A4(
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$ElmUI$SmoothMoveSub$Multiple$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveSub$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveSub$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveSub$Multiple$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveSub$Multiple$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveSub$Multiple$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveSub$Multiple$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveSub Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveSub$Multiple$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveSub$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveSub$Multiple$init, subscriptions: $author$project$ElmUI$SmoothMoveSub$Multiple$subscriptions, update: $author$project$ElmUI$SmoothMoveSub$Multiple$update, view: $author$project$ElmUI$SmoothMoveSub$Multiple$view});
_Platform_export({'ElmUI':{'SmoothMoveSub':{'Multiple':{'init':$author$project$ElmUI$SmoothMoveSub$Multiple$main(
