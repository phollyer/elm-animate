...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$subscriptions = function (_v0) {
	return $author$project$ElmUI$SmoothMovePorts$Multiple$Main$positionUpdates($author$project$ElmUI$SmoothMovePorts$Multiple$Main$PositionUpdateMsg);
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement = _Platform_outgoingPort('animateElement', $elm$json$Json$Encode$string);
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$PositionUpdate = F4(
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$positionDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$ElmUI$SmoothMovePorts$Multiple$Main$PositionUpdate,
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Scatter':
				var _v1 = A4($author$project$SmoothMovePorts$animateTo, 'element-a', 50.0, 80.0, model.animations);
				var newAnimations1 = _v1.a;
				var cmd1 = _v1.b;
				var _v2 = A4($author$project$SmoothMovePorts$animateTo, 'element-b', 350.0, 120.0, newAnimations1);
				var newAnimations2 = _v2.a;
				var cmd2 = _v2.b;
				var _v3 = A4($author$project$SmoothMovePorts$animateTo, 'element-c', 120.0, 250.0, newAnimations2);
				var newAnimations3 = _v3.a;
				var cmd3 = _v3.b;
				var _v4 = A4($author$project$SmoothMovePorts$animateTo, 'element-d', 300.0, 280.0, newAnimations3);
				var newAnimations4 = _v4.a;
				var cmd4 = _v4.b;
				var _v5 = A4($author$project$SmoothMovePorts$animateTo, 'element-e', 80.0, 180.0, newAnimations4);
				var newAnimations5 = _v5.a;
				var cmd5 = _v5.b;
				var _v6 = A4($author$project$SmoothMovePorts$animateTo, 'element-f', 380.0, 200.0, newAnimations5);
				var newAnimations6 = _v6.a;
				var cmd6 = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations6}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd1)),
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd2)),
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd3)),
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd4)),
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd5)),
								$author$project$ElmUI$SmoothMovePorts$Multiple$Main$animateElement(
								$author$project$SmoothMovePorts$encodeAnimationCommand(cmd6))
							])));
			case 'Reset':
				var _v7 = A4($author$project$SmoothMovePorts$animateTo, 'element-a', 50.0, 80.0, model.animations);
				var newAnimations1 = _v7.a;
				var cmd1 = _v7.b;
				var _v8 = A4($author$project$SmoothMovePorts$animateTo, 'element-b', 380.0, 50.0, newAnimations1);
				var newAnimations2 = _v8.a;
				var cmd2 = _v8.b;
				var _v9 = A4($author$project$SmoothMovePorts$animateTo, 'element-c', 120.0, 220.0, newAnimations2);
				var newAnimations3 = _v9.a;
				var cmd3 = _v9.b;
				var _v10 = A4($author$project$SmoothMovePorts$animateTo, 'element-d', 350.0, 180.0, newAnimations3);
				var newAnimations4 = _v10.a;
				var cmd4 = _v10.b;
				var _v11 = A4($author$project$SmoothMovePorts$animateTo, 'element-e', 200.0, 40.0, newAnimations4);
				var newAnimations5 = _v11.a;
				var cmd5 = _v11.b;
				var _v12 = A4($author$project$SmoothMovePorts$animateTo, 'element-f', 80.0, 140.0, newAnimations5);
				var newAnimations6 = _v12.a;
				var cmd6 = _v12.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'Circle':
				...
				var centerY = 150.0;
				var centerX = 225.0;
				var _v13 = A4($author$project$SmoothMovePorts$animateTo, 'element-a', centerX, centerY - radius, model.animations);
				var newAnimations1 = _v13.a;
				var cmd1 = _v13.b;
				var _v14 = A4($author$project$SmoothMovePorts$animateTo, 'element-b', centerX + (radius * 0.866), centerY - (radius / 2), newAnimations1);
				var newAnimations2 = _v14.a;
				var cmd2 = _v14.b;
				var _v15 = A4($author$project$SmoothMovePorts$animateTo, 'element-c', centerX + (radius * 0.866), centerY + (radius / 2), newAnimations2);
				var newAnimations3 = _v15.a;
				var cmd3 = _v15.b;
				var _v16 = A4($author$project$SmoothMovePorts$animateTo, 'element-d', centerX, centerY + radius, newAnimations3);
				var newAnimations4 = _v16.a;
				var cmd4 = _v16.b;
				var _v17 = A4($author$project$SmoothMovePorts$animateTo, 'element-e', centerX - (radius * 0.866), centerY + (radius / 2), newAnimations4);
				var newAnimations5 = _v17.a;
				var cmd5 = _v17.b;
				var _v18 = A4($author$project$SmoothMovePorts$animateTo, 'element-f', centerX - (radius * 0.866), centerY - (radius / 2), newAnimations5);
				var newAnimations6 = _v18.a;
				var cmd6 = _v18.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			default:
				var value = msg.a;
				var _v19 = A2($elm$json$Json$Decode$decodeValue, $author$project$ElmUI$SmoothMovePorts$Multiple$Main$positionDecoder, value);
				if (_v19.$ === 'Ok') {
			...
			body: _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Common$UI$getLayoutCSS(layoutType))
						])),
					A2(
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Circle = {$: 'Circle'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Reset = {$: 'Reset'};
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Scatter = {$: 'Scatter'};
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 181, y: 130},
		A2($author$project$SmoothMovePorts$getPosition, 'element-f', model.animations));
	var positionE = A2(
		$elm$core$Maybe$withDefault,
		{x: 181, y: 170},
		A2($author$project$SmoothMovePorts$getPosition, 'element-e', model.animations));
	var positionD = A2(
		$elm$core$Maybe$withDefault,
		{x: 225, y: 200},
		A2($author$project$SmoothMovePorts$getPosition, 'element-d', model.animations));
	var positionC = A2(
		$elm$core$Maybe$withDefault,
		{x: 269, y: 170},
		A2($author$project$SmoothMovePorts$getPosition, 'element-c', model.animations));
	var positionB = A2(
		$elm$core$Maybe$withDefault,
		{x: 269, y: 130},
		A2($author$project$SmoothMovePorts$getPosition, 'element-b', model.animations));
	var positionA = A2(
		$elm$core$Maybe$withDefault,
		{x: 225, y: 100},
		A2($author$project$SmoothMovePorts$getPosition, 'element-a', model.animations));
	var isAnimating = $author$project$SmoothMovePorts$isAnimating(model.animations);
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('SmoothMovePorts Multiple Example'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMovePorts module orchestrating '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('multiple elements simultaneously')),
							$mdgriffith$elm_ui$Element$text(' via the Web Animations API. Each element receives '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('real-time position feedback')),
							$mdgriffith$elm_ui$Element$text(' through JavaScript ports, enabling advanced animation coordination and platform-specific optimizations.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for complex choreographed animations requiring '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('native performance')),
							$mdgriffith$elm_ui$Element$text(' and advanced timing controls. '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							$mdgriffith$elm_ui$Element$text('⚠️ Requires smooth-move-ports.js')),
							$mdgriffith$elm_ui$Element$text(' to be loaded for full functionality.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Scatter, 'Scatter'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Circle, 'Circle Formation'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMovePorts$Multiple$Main$Reset, 'Reset')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionA.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionA.y) + 'px'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionB.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionB.y) + 'px'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionC.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionC.y) + 'px'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionD.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionD.y) + 'px'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionE.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionE.y) + 'px'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									A2($elm$html$Html$Attributes$style, 'width', '50px'),
									A2($elm$html$Html$Attributes$style, 'height', '50px'),
									A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(135deg, #06B6D4, #0891B2)'),
									A2($elm$html$Html$Attributes$style, 'border-radius', '12px'),
									A2(
									$elm$html$Html$Attributes$style,
									'left',
									$elm$core$String$fromFloat(positionF.x) + 'px'),
									A2(
									$elm$html$Html$Attributes$style,
									'top',
									$elm$core$String$fromFloat(positionF.y) + 'px'),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
...
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMovePorts Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMovePorts$Multiple$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMovePorts$Multiple$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMovePorts$Multiple$Main$init, subscriptions: $author$project$ElmUI$SmoothMovePorts$Multiple$Main$subscriptions, update: $author$project$ElmUI$SmoothMovePorts$Multiple$Main$update, view: $author$project$ElmUI$SmoothMovePorts$Multiple$Main$view});
_Platform_export({'ElmUI':{'SmoothMovePorts':{'Multiple':{'Main':{'init':$author$project$ElmUI$SmoothMovePorts$Multiple$Main$main(
