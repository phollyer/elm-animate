...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$init = function (_v0) {
	var initialAnimations = A4($author$project$SmoothMovePorts$setInitialPosition, 'moving-box', 0, 0, $author$project$SmoothMovePorts$init);
	return _Utils_Tuple2(
		{animations: initialAnimations},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$subscriptions = function (_v0) {
	return $author$project$ElmUI$SmoothMovePorts$Basic$Main$positionUpdates($author$project$ElmUI$SmoothMovePorts$Basic$Main$PositionUpdateMsg);
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$animateElement = _Platform_outgoingPort('animateElement', $elm$json$Json$Encode$string);
...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$PositionUpdate = F4(
...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$positionDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$ElmUI$SmoothMovePorts$Basic$Main$PositionUpdate,
...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				...
				return _Utils_Tuple2(
					...
					$author$project$ElmUI$SmoothMovePorts$Basic$Main$animateElement(
			...
			default:
				var value = msg.a;
				var _v4 = A2($elm$json$Json$Decode$decodeValue, $author$project$ElmUI$SmoothMovePorts$Basic$Main$positionDecoder, value);
				if (_v4.$ === 'Ok') {
					var posUpdate = _v4.a;
...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
	...
	return _List_fromArray(
		[
			...
			$author$project$Common$UI$pageHeader('SmoothMovePorts Basic Example'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMovePorts module, which integrates with the '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('Web Animations API')),
							$mdgriffith$elm_ui$Element$text(' through JavaScript ports. This approach provides access to '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('platform-specific optimizations')),
							$mdgriffith$elm_ui$Element$text(' and advanced animation features not available through pure Elm.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for complex animations requiring '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('native performance')),
							$mdgriffith$elm_ui$Element$text(' and advanced timing controls beyond what CSS transitions can provide.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMovePorts$Basic$Main$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMovePorts$Basic$Main$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMovePorts$Basic$Main$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$html$Html$Attributes$style,
							'left',
							$elm$core$String$fromFloat(position.x) + 'px')),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2(
							$elm$html$Html$Attributes$style,
							'top',
							$elm$core$String$fromFloat(position.y) + 'px'))
					]),
				$mdgriffith$elm_ui$Element$text('')))
		]);
};
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMovePorts Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMovePorts$Basic$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMovePorts$Basic$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMovePorts$Basic$Main$init, subscriptions: $author$project$ElmUI$SmoothMovePorts$Basic$Main$subscriptions, update: $author$project$ElmUI$SmoothMovePorts$Basic$Main$update, view: $author$project$ElmUI$SmoothMovePorts$Basic$Main$view});
_Platform_export({'ElmUI':{'SmoothMovePorts':{'Basic':{'Main':{'init':$author$project$ElmUI$SmoothMovePorts$Basic$Main$main(
