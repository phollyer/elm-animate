...
var $author$project$ElmUI$SmoothMovePorts$Basic$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMovePorts$Basic$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$ElmUI$SmoothMovePorts$Basic$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$SmoothMovePorts$Basic$subscriptions = function (_v0) {
	return $author$project$ElmUI$SmoothMovePorts$Basic$positionUpdates($author$project$ElmUI$SmoothMovePorts$Basic$PositionUpdateMsg);
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$ElmUI$SmoothMovePorts$Basic$animateElement = _Platform_outgoingPort('animateElement', $elm$json$Json$Encode$string);
...
var $author$project$ElmUI$SmoothMovePorts$Basic$PositionUpdate = F4(
...
var $author$project$ElmUI$SmoothMovePorts$Basic$positionDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$ElmUI$SmoothMovePorts$Basic$PositionUpdate,
...
var $author$project$ElmUI$SmoothMovePorts$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				...
				return _Utils_Tuple2(
					...
					$author$project$ElmUI$SmoothMovePorts$Basic$animateElement(
			...
			default:
				var value = msg.a;
				var _v4 = A2($elm$json$Json$Decode$decodeValue, $author$project$ElmUI$SmoothMovePorts$Basic$positionDecoder, value);
				if (_v4.$ === 'Ok') {
					var posUpdate = _v4.a;
...
var $author$project$ElmUI$SmoothMovePorts$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$SmoothMovePorts$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMovePorts$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$SmoothMovePorts$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMovePorts$Basic$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMovePorts$Basic$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMovePorts$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$SmoothMovePorts$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMovePorts Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMovePorts$Basic$viewContent(model));
};
var $author$project$ElmUI$SmoothMovePorts$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMovePorts$Basic$init, subscriptions: $author$project$ElmUI$SmoothMovePorts$Basic$subscriptions, update: $author$project$ElmUI$SmoothMovePorts$Basic$update, view: $author$project$ElmUI$SmoothMovePorts$Basic$view});
_Platform_export({'ElmUI':{'SmoothMovePorts':{'Basic':{'init':$author$project$ElmUI$SmoothMovePorts$Basic$main(
