			...
			case 'ChangeColorTo':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$CSS$animateBackgroundColor, elementId, color, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'CycleColors':
				var elementId = msg.a;
				var nextColor = function () {
					switch (elementId) {
						case 'box1':
							return $author$project$Anim$Hex('#e74c3c');
						case 'box2':
						...
						case 'box3':
							return $author$project$Anim$Hsl(
								{h: 142, l: 45, s: 71});
						default:
							return $author$project$Anim$Hex('#3498db');
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$CSS$animateBackgroundColor, elementId, nextColor, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ResetColors':
				var elementId = msg.a;
...
var $author$project$ElmUI$CSS$Color$Main$ChangeColorTo = F2(
	function (a, b) {
		return {$: 'ChangeColorTo', a: a, b: b};
	});
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Color$Main$ResetColors = function (a) {
	return {$: 'ResetColors', a: a};
};
...
var $author$project$ElmUI$CSS$Color$Main$colorBox = F3(
	function (elementId, label, model) {
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'text-shadow', '0 1px 3px rgba(0,0,0,0.5)'))
					]),
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('Hex Colors')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Common$UI$htmlActionButtons(
									_List_fromArray(
										[
											...
											A2(
												$author$project$ElmUI$CSS$Color$Main$ChangeColorTo,
												'box1',
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('RGB Colors')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('HSL Colors')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text('Reset All')),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[$mdgriffith$elm_ui$Element$centerX]),
								$author$project$Common$UI$htmlActionButtons(
									_List_fromArray(
										[
											_Utils_Tuple3(
											$author$project$Common$UI$Primary,
											$author$project$ElmUI$CSS$Color$Main$ResetColors('box1'),
											'Reset to Default')
										])))
							]))
					])),
				...
				A2(
					...
					_List_fromArray(
						[
							A3($author$project$ElmUI$CSS$Color$Main$colorBox, 'box1', 'Hex Colors', model),
							A3($author$project$ElmUI$CSS$Color$Main$colorBox, 'box2', 'RGB Colors', model),
							A3($author$project$ElmUI$CSS$Color$Main$colorBox, 'box3', 'HSL Colors', model)
						])))
			]));
};
