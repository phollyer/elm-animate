...
var $author$project$ElmUI$CSS$Color$Main$toColorBuilderWithDefaults = A2(
								...
								$author$project$Anim$Properties$Color$build(
									A2(
										...
										A2(
											...
											$author$project$ElmUI$CSS$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeToGreen':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Color$Main$AnimationComplete = {$: 'AnimationComplete'};
var $author$project$ElmUI$CSS$Color$Main$ChangeToBlue = {$: 'ChangeToBlue'};
var $author$project$ElmUI$CSS$Color$Main$ChangeToGreen = {$: 'ChangeToGreen'};
var $author$project$ElmUI$CSS$Color$Main$ChangeToOrange = {$: 'ChangeToOrange'};
var $author$project$ElmUI$CSS$Color$Main$ChangeToPurple = {$: 'ChangeToPurple'};
var $author$project$ElmUI$CSS$Color$Main$ChangeToRed = {$: 'ChangeToRed'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Color$Main$ResetColor = {$: 'ResetColor'};
...
var $author$project$ElmUI$CSS$Color$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Color$Main$ChangeToBlue, 'Blue'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Color$Main$ChangeToGreen, 'Green'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Color$Main$ChangeToOrange, 'Orange'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Color$Main$ChangeToRed, 'Red'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Color$Main$ChangeToPurple, 'Purple'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Color$Main$ResetColor, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$CSS$Color$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Color ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Color$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Color$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Color$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Color$Main$update,
		view: $author$project$ElmUI$CSS$Color$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Color':{'Main':{'init':$author$project$ElmUI$CSS$Color$Main$main(
