...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$ColorMorph = {$: 'ColorMorph'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$ComplexTransform = {$: 'ComplexTransform'};
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$FadeMove = {$: 'FadeMove'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$FullTransform = {$: 'FullTransform'};
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$SpinScale = {$: 'SpinScale'};
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartComplexTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Transitions$Mixed$Main$ComplexTransform),
			...
			case 'StartFadeMove':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Transitions$Mixed$Main$FadeMove),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Position$build(
									A3(
										$author$project$Anim$Properties$Position$toXY,
			...
			case 'StartSpinScale':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Transitions$Mixed$Main$SpinScale),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A2(
			...
			case 'StartColorMorph':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Transitions$Mixed$Main$ColorMorph),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A3(
										$author$project$Anim$Properties$Scale$toXY,
			...
			case 'StartFullTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Transitions$Mixed$Main$FullTransform),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$ResetAll = {$: 'ResetAll'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartColorMorph = {$: 'StartColorMorph'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartComplexTransform = {$: 'StartComplexTransform'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartFadeMove = {$: 'StartFadeMove'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartFullTransform = {$: 'StartFullTransform'};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartSpinScale = {$: 'StartSpinScale'};
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$viewAnimationDetail = F3(
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartComplexTransform, 'Complex Transform'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartFadeMove, 'Fade & Move')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartSpinScale, 'Spin & Scale'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartColorMorph, 'Color Morph')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Mixed$Main$StartFullTransform, 'Full Transform'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Mixed$Main$ResetAll, 'Reset All')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(
							$author$project$ElmUI$CSS$Transitions$Mixed$Main$viewAnimationDetail,
							'🔄 Complex Transform',
...
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Mixed Properties ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Mixed$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Mixed$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Mixed$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Mixed$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Mixed$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Mixed':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Mixed$Main$main(
