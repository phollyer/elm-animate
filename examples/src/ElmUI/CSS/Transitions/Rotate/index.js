...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$anim = function (animations) {
	return A2(
...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Rotate45':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Rotate$build(
									A2(
										...
										A2(
											...
											45,
											$author$project$ElmUI$CSS$Transitions$Rotate$Main$anim(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'Rotate90':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$ResetRotate = {$: 'ResetRotate'};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate180 = {$: 'Rotate180'};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate45 = {$: 'Rotate45'};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate90 = {$: 'Rotate90'};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$RotateLeft = {$: 'RotateLeft'};
...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$rotatingElement = F5(
...
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate45, '45°'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate90, '90°'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Rotate$Main$Rotate180, '180°'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Rotate$Main$RotateLeft, '← 90°'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Rotate$Main$ResetRotate, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A5($author$project$ElmUI$CSS$Transitions$Rotate$Main$rotatingElement, 'box', '→', 'Rotate Demo', $author$project$Common$Colors$primary, model)))
		]);
};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Rotate ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Rotate$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Rotate$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Rotate$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Rotate$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Rotate$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Rotate':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Rotate$Main$main(
