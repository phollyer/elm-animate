...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$animatedBox = F5(
...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Choreography$Main$ScatterElements, 'Scatter Formation'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Choreography$Main$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Choreography$Main$ResetPositions, 'Reset Formation')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				_List_fromArray(
					[
						A5(
						$author$project$ElmUI$CSS$Transitions$Choreography$Main$animatedBox,
						'elementA',
						'A',
...
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Choreography ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Choreography$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Choreography$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Choreography$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Choreography$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Choreography$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Choreography':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Choreography$Main$main(
