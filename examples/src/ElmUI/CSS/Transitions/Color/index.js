...
var $author$project$ElmUI$CSS$Transitions$Color$Main$init = function (_v0) {
...
var $author$project$Anim$Properties$Color$Hex = function (a) {
	return {$: 'Hex', a: a};
};
...
var $author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults = A2(
	$elm$core$Basics$composeR,
	$author$project$Anim$CSS$builder,
	A2(
		$elm$core$Basics$composeR,
		$author$project$Anim$duration(1000),
		A2(
			$elm$core$Basics$composeR,
			$author$project$Anim$easing($author$project$Anim$Timing$Easing$Linear),
			$author$project$Anim$Properties$Color$for('box'))));
var $author$project$ElmUI$CSS$Transitions$Color$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeToBlue':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Color$build(
									A2(
										...
										A2(
											...
											$author$project$Anim$Properties$Color$Hex('#3498db'),
											$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeToGreen':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										$author$project$Anim$Properties$Color$speed,
										25,
										A2(
											$author$project$Anim$Properties$Color$to,
											$author$project$Anim$Properties$Color$Hex('#2ecc71'),
											$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeToOrange':
							...
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										...
										A2(
											$author$project$Anim$Properties$Color$to,
											$author$project$Anim$Properties$Color$Hex('#f39c12'),
											$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeToRed':
							...
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										...
										A2(
											$author$project$Anim$Properties$Color$to,
											$author$project$Anim$Properties$Color$Hex('#e74c3c'),
											$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeToPurple':
							...
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										...
										A2(
											$author$project$Anim$Properties$Color$to,
											$author$project$Anim$Properties$Color$Hex('#9b59b6'),
											$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ResetColor':
						...
						model,
						{
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										$author$project$Anim$Properties$Color$to,
										$author$project$Anim$Properties$Color$Hex('#95a5a6'),
										$author$project$ElmUI$CSS$Transitions$Color$Main$toColorBuilderWithDefaults(model.animations))))
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$ElmUI$CSS$Transitions$Color$Main$AnimationComplete = {$: 'AnimationComplete'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToBlue = {$: 'ChangeToBlue'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToGreen = {$: 'ChangeToGreen'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToOrange = {$: 'ChangeToOrange'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToPurple = {$: 'ChangeToPurple'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToRed = {$: 'ChangeToRed'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Transitions$Color$Main$ResetColor = {$: 'ResetColor'};
...
var $author$project$ElmUI$CSS$Transitions$Color$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('Smooth color transitions using browser-native CSS animations')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToBlue, 'Blue'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToGreen, 'Green'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToOrange, 'Orange'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToRed, 'Red'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Color$Main$ChangeToPurple, 'Purple'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Color$Main$ResetColor, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$author$project$Anim$CSS$onTransitionEnd($author$project$ElmUI$CSS$Transitions$Color$Main$AnimationComplete))
						]),
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
...
var $author$project$ElmUI$CSS$Transitions$Color$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Color ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Color$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Color$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Color$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Color$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Color$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Color':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Color$Main$main(
