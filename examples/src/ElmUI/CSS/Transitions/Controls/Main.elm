...
All controls work with CSS transitions for optimal performance and browser compatibility.
...
viewContent model =
    ...
    , -- Description
      el
        ...
        (text "Demonstrating all CSS animation controls: animate, stop, pause, resume, reset, restart")
