...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$anim = function (animations) {
	return A2(
...
var $author$project$Anim$Timing$Easing$bounceInOut = $author$project$Anim$Timing$Easing$BounceInOut;
...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ScaleUp':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Scale$build(
									A2(
										...
										A3(
											...
											1.5,
											1.5,
											$author$project$ElmUI$CSS$Transitions$Scale$Main$anim(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ScaleDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A2(
										$author$project$Anim$Properties$Scale$speed,
										2.0,
										A2(
											$author$project$Anim$Properties$Scale$easing,
...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleDown = {$: 'ScaleDown'};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleReset = {$: 'ScaleReset'};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleTall = {$: 'ScaleTall'};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleUp = {$: 'ScaleUp'};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleWide = {$: 'ScaleWide'};
...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$scaledElement = F4(
...
var $author$project$ElmUI$CSS$Transitions$Scale$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('Smooth scaling transformations using hardware-accelerated CSS transforms')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleUp, 'Scale Up'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleDown, 'Scale Down'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleWide, 'Scale Wide'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleTall, 'Scale Tall'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Scale$Main$ScaleReset, 'Reset Scale')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A4($author$project$ElmUI$CSS$Transitions$Scale$Main$scaledElement, 'box', 'Scale Demo', $author$project$Common$Colors$primary, model)))
		]);
};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Scale ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Scale$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Scale$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Scale$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Scale$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Scale$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Scale':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Scale$Main$main(
