...
var $author$project$ElmUI$CSS$Transitions$Position$Main$init = function (_v0) {
...
var $author$project$Anim$Timing$Easing$Bezier = F4(
	function (a, b, c, d) {
...
var $author$project$Anim$Internal$Builders$Position$delay = F2(
	function (delay_, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Properties$Position$delay = function (delay_) {
	return $author$project$Anim$Internal$Builders$Position$delay(delay_);
};
...
var $author$project$Anim$Internal$Builders$Position$speed = F2(
	function (value, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Properties$Position$speed = $author$project$Anim$Internal$Builders$Position$speed;
...
var $author$project$ElmUI$CSS$Transitions$Position$Main$toPositionBuilder = function (animations) {
	return A2(
...
var $author$project$Anim$Internal$Properties$Position$y = function (_v0) {
	var coords = _v0.a;
	return coords.y;
};
var $author$project$Anim$Internal$Builders$Position$toX = F2(
	function (x, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$ElmUI$CSS$Transitions$Position$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToPosition':
				var x = msg.a;
								...
								$author$project$Anim$Properties$Position$build(
									A2(
										...
										A2(
											...
											A4($author$project$Anim$Timing$Easing$Bezier, 0.3, 0, 0.7, 0),
											A3(
												$author$project$Anim$Properties$Position$toXY,
												x,
												y,
												$author$project$ElmUI$CSS$Transitions$Position$Main$toPositionBuilder(model.animations))))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveLeft':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Transitions$Position$Main$MoveDown = {$: 'MoveDown'};
var $author$project$ElmUI$CSS$Transitions$Position$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$ElmUI$CSS$Transitions$Position$Main$MoveRight = {$: 'MoveRight'};
var $author$project$ElmUI$CSS$Transitions$Position$Main$MoveToPosition = F2(
	function (a, b) {
		return {$: 'MoveToPosition', a: a, b: b};
	});
var $author$project$ElmUI$CSS$Transitions$Position$Main$MoveUp = {$: 'MoveUp'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Transitions$Position$Main$ReturnToOrigin = {$: 'ReturnToOrigin'};
...
var $author$project$ElmUI$CSS$Transitions$Position$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButtonWithPath('../../../index.html'),
			$author$project$Common$UI$pageHeader('CSS Position Animations'),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3(
					$author$project$Common$UI$Primary,
					A2($author$project$ElmUI$CSS$Transitions$Position$Main$MoveToPosition, 100, 100),
					'Move to (100, 100)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					A2($author$project$ElmUI$CSS$Transitions$Position$Main$MoveToPosition, 300, 200),
					'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Position$Main$ReturnToOrigin, 'Return to Origin')
				])),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Position$Main$MoveLeft, '← Move Left'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Position$Main$MoveRight, 'Move Right →'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Position$Main$MoveUp, '↑ Move Up'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Position$Main$MoveDown, 'Move Down (with delay 1000ms) ↓')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$CSS$Transitions$Position$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Position ElmUI Examples',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Position$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Position$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Transitions$Position$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Transitions$Position$Main$update,
		view: $author$project$ElmUI$CSS$Transitions$Position$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Position':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Position$Main$main(
