...
{-| Anim.Engine.Animation.CSS Position Example using ElmUI - Element position animations with CSS transitions
...
view model =
    UI.createDocument
        "Anim.Engine.Animation.CSS Position ElmUI Examples"
        UI.Basic
        (viewContent model)
