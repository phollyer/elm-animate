...
var $author$project$ElmUI$CSS$Transitions$Events$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$CSS$init, currentTime: 0, eventCounter: 0, eventLog: _List_Nil, isAnimating: false},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$CSS$Transitions$Events$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 100, $author$project$ElmUI$CSS$Transitions$Events$Main$Tick);
};
var $author$project$Anim$Timing$Easing$QuadInOut = {$: 'QuadInOut'};
var $author$project$Anim$Timing$Easing$SineInOut = {$: 'SineInOut'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionCancel = {$: 'TransitionCancel'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionEnd = {$: 'TransitionEnd'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionRun = {$: 'TransitionRun'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionStart = {$: 'TransitionStart'};
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$addEventToLog = F3(
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$anim = function (animations) {
	return A2(
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Position$build(
									A2(
										...
										A3(
											...
											450,
											300,
											$author$project$ElmUI$CSS$Transitions$Events$Main$anim(model.animations))))),
							isAnimating: true
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveToCenter':
			...
			case 'OnTransitionStart':
				return _Utils_Tuple2(
					A3($author$project$ElmUI$CSS$Transitions$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionStart, 'Animation started', model),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionEnd':
				return _Utils_Tuple2(
					function (m) {
						...
						A3($author$project$ElmUI$CSS$Transitions$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionEnd, 'Animation completed', model)),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionRun':
				return _Utils_Tuple2(
					A3($author$project$ElmUI$CSS$Transitions$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionRun, 'Animation is running', model),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionCancel':
				return _Utils_Tuple2(
					function (m) {
						...
						A3($author$project$ElmUI$CSS$Transitions$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Transitions$Events$Main$TransitionCancel, 'Animation was cancelled', model)),
					$elm$core$Platform$Cmd$none);
			default:
				var time = msg.a;
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$ClearEventLog = {$: 'ClearEventLog'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionCancel = {$: 'OnTransitionCancel'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionEnd = {$: 'OnTransitionEnd'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionRun = {$: 'OnTransitionRun'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionStart = {$: 'OnTransitionStart'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Transitions$Events$Main$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$getEventTypeInfo = function (eventType) {
	switch (eventType.$) {
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$viewEventEntry = F2(
	function (currentCounter, entry) {
		var isRecent = (currentCounter - entry.id) <= 1;
		var eventTypeInfo = $author$project$ElmUI$CSS$Transitions$Events$Main$getEventTypeInfo(entry.eventType);
		return A2(
...
var $author$project$ElmUI$CSS$Transitions$Events$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Transitions$Events$Main$MoveToCorner, 'Move to Corner'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Transitions$Events$Main$MoveToCenter, 'Move to Center'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Transitions$Events$Main$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionStart($author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionStart)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionEnd($author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionEnd)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionRun($author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionRun)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionCancel($author$project$ElmUI$CSS$Transitions$Events$Main$OnTransitionCancel))
							]))),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Transitions$Events$Main$ClearEventLog, 'Clear Log')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
					...
					A2(
						$elm$core$List$map,
						$author$project$ElmUI$CSS$Transitions$Events$Main$viewEventEntry(model.eventCounter),
						model.eventLog))
				]))
		]);
};
var $author$project$ElmUI$CSS$Transitions$Events$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Events ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Transitions$Events$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Transitions$Events$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$CSS$Transitions$Events$Main$init, subscriptions: $author$project$ElmUI$CSS$Transitions$Events$Main$subscriptions, update: $author$project$ElmUI$CSS$Transitions$Events$Main$update, view: $author$project$ElmUI$CSS$Transitions$Events$Main$view});
_Platform_export({'ElmUI':{'CSS':{'Transitions':{'Events':{'Main':{'init':$author$project$ElmUI$CSS$Transitions$Events$Main$main(
