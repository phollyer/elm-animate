...
var $author$project$ElmUI$CSS$Scale$Main$anim = function (animations) {
	return A2(
...
var $author$project$ElmUI$CSS$Scale$Main$scaledElement = F4(
...
var $author$project$ElmUI$CSS$Scale$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Scale$Main$ScaleUp, 'Scale Up'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Scale$Main$ScaleDown, 'Scale Down'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Scale$Main$ScaleWide, 'Scale Wide'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Scale$Main$ScaleTall, 'Scale Tall'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Scale$Main$ScaleReset, 'Reset Scale')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A4($author$project$ElmUI$CSS$Scale$Main$scaledElement, 'box', 'Scale Demo', $author$project$Common$Colors$primary, model)))
		]);
};
...
var $author$project$ElmUI$CSS$Scale$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Scale$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Scale$Main$update,
		view: $author$project$ElmUI$CSS$Scale$Main$view
	});
