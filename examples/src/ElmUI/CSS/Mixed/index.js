...
var $author$project$ElmUI$CSS$Mixed$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Mixed$Main$ColorMorph = {$: 'ColorMorph'};
var $author$project$ElmUI$CSS$Mixed$Main$ComplexTransform = {$: 'ComplexTransform'};
...
var $author$project$ElmUI$CSS$Mixed$Main$FadeMove = {$: 'FadeMove'};
var $author$project$ElmUI$CSS$Mixed$Main$FullTransform = {$: 'FullTransform'};
...
var $author$project$ElmUI$CSS$Mixed$Main$SpinScale = {$: 'SpinScale'};
...
var $author$project$Anim$Properties$Color$delay = function (delay_) {
	return A2($author$project$Anim$Timing$Delay$mapInternal, $author$project$Anim$Internal$Builders$Color$delay, delay_);
};
...
var $author$project$Anim$Properties$Scale$delay = function (delay_) {
	return $author$project$Anim$Internal$Builders$Scale$delay(
		A2($author$project$Anim$Timing$Delay$mapInternal, $elm$core$Basics$identity, delay_));
};
...
var $author$project$ElmUI$CSS$Mixed$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartComplexTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Mixed$Main$ComplexTransform),
														...
														A2(
															...
															A2(
																...
																A2(
																	...
																	A2($author$project$Anim$Properties$Scale$ScaleXY, 1.5, 1.2),
																	A2(
			...
			case 'StartFadeMove':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Mixed$Main$FadeMove),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Position$build(
									A3(
										$author$project$Anim$Properties$Position$toXY,
			...
			case 'StartSpinScale':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Mixed$Main$SpinScale),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A2(
										...
										A2(
											$author$project$Anim$Properties$Scale$to,
											A2($author$project$Anim$Properties$Scale$ScaleXY, 0.8, 0.8),
											A2(
												$author$project$Anim$Properties$Scale$for,
												'mixed-box',
												$author$project$Anim$Properties$Rotation$build(
			...
			case 'StartColorMorph':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Mixed$Main$ColorMorph),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A2(
										$author$project$Anim$Properties$Scale$to,
										A2($author$project$Anim$Properties$Scale$ScaleXY, 1.3, 1.3),
										A2(
											$author$project$Anim$Properties$Scale$for,
											'mixed-box',
			...
			case 'StartFullTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Mixed$Main$FullTransform),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										$author$project$Anim$Properties$Color$delay,
										$author$project$Anim$Timing$Delay$Delay(400),
										A2(
													...
													A2(
														...
														$author$project$Anim$Properties$Opacity$build(
															A2(
																...
																$author$project$Anim$Timing$Delay$Delay(100),
																A2(
...
var $author$project$ElmUI$CSS$Mixed$Main$ResetAll = {$: 'ResetAll'};
var $author$project$ElmUI$CSS$Mixed$Main$StartColorMorph = {$: 'StartColorMorph'};
var $author$project$ElmUI$CSS$Mixed$Main$StartComplexTransform = {$: 'StartComplexTransform'};
var $author$project$ElmUI$CSS$Mixed$Main$StartFadeMove = {$: 'StartFadeMove'};
var $author$project$ElmUI$CSS$Mixed$Main$StartFullTransform = {$: 'StartFullTransform'};
var $author$project$ElmUI$CSS$Mixed$Main$StartSpinScale = {$: 'StartSpinScale'};
...
var $author$project$ElmUI$CSS$Mixed$Main$viewAnimationDetail = F3(
...
var $author$project$ElmUI$CSS$Mixed$Main$viewContent = function (model) {
	return _List_fromArray(
		[
								...
								if (_v0.$ === 'Just') {
									switch (_v0.a.$) {
										case 'ComplexTransform':
											var _v1 = _v0.a;
											return '🎬 Complex Transform: Position + Scale + Rotation';
										case 'FadeMove':
											var _v2 = _v0.a;
											return '🎬 Fade & Move: Opacity + Position';
										case 'SpinScale':
											var _v3 = _v0.a;
											return '🎬 Spin & Scale: Rotation + Scale (Delayed)';
										case 'ColorMorph':
											var _v4 = _v0.a;
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Mixed$Main$StartComplexTransform, 'Complex Transform'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Mixed$Main$StartFadeMove, 'Fade & Move')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Mixed$Main$StartSpinScale, 'Spin & Scale'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Mixed$Main$StartColorMorph, 'Color Morph')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Mixed$Main$StartFullTransform, 'Full Transform'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Mixed$Main$ResetAll, 'Reset All')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A3(
							$author$project$ElmUI$CSS$Mixed$Main$viewAnimationDetail,
							'🔄 Complex Transform',
							'Position + Scale + Rotation with different easing functions',
							_List_fromArray(
								['Position: SineInOut (800ms)', 'Scale: BackInOut (1000ms)', 'Rotation: ElasticOut (1200ms)'])),
							A3(
							$author$project$ElmUI$CSS$Mixed$Main$viewAnimationDetail,
							'👻 Fade & Move',
...
var $author$project$ElmUI$CSS$Mixed$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Mixed Properties ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Mixed$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Mixed$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Mixed$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Mixed$Main$update,
		view: $author$project$ElmUI$CSS$Mixed$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Mixed':{'Main':{'init':$author$project$ElmUI$CSS$Mixed$Main$main(
