...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$CSS$init, currentTime: 0, eventCounter: 0, eventLog: _List_Nil, isAnimating: false},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$subscriptions = function (_v0) {
	return A2($elm$time$Time$every, 100, $author$project$ElmUI$CSS$Keyframes$Events$Main$Tick);
};
var $author$project$Anim$Timing$Easing$QuadInOut = {$: 'QuadInOut'};
var $author$project$Anim$Timing$Easing$SineInOut = {$: 'SineInOut'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionCancel = {$: 'TransitionCancel'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionEnd = {$: 'TransitionEnd'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionRun = {$: 'TransitionRun'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionStart = {$: 'TransitionStart'};
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$addEventToLog = F3(
	function (eventType, description, model) {
		var newEntry = {description: description, eventType: eventType, id: model.eventCounter, timestamp: model.currentTime};
		var newLog = A2(
			$elm$core$List$take,
			10,
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$anim = function (animations) {
	return A2(
		...
		A2(
			...
			A2(
				...
				1000,
				$author$project$Anim$CSS$builder(animations))));
};
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Position$build(
									A2(
										...
										A3(
											...
											450,
											300,
											$author$project$ElmUI$CSS$Keyframes$Events$Main$anim(model.animations))))),
							isAnimating: true
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveToCenter':
			...
			case 'ClearEventLog':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{eventCounter: 0, eventLog: _List_Nil}),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionStart':
				return _Utils_Tuple2(
					A3($author$project$ElmUI$CSS$Keyframes$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionStart, 'Animation started', model),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionEnd':
				return _Utils_Tuple2(
					function (m) {
						...
						A3($author$project$ElmUI$CSS$Keyframes$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionEnd, 'Animation completed', model)),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionRun':
				return _Utils_Tuple2(
					A3($author$project$ElmUI$CSS$Keyframes$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionRun, 'Animation is running', model),
					$elm$core$Platform$Cmd$none);
			case 'OnTransitionCancel':
				return _Utils_Tuple2(
					function (m) {
						...
						A3($author$project$ElmUI$CSS$Keyframes$Events$Main$addEventToLog, $author$project$ElmUI$CSS$Keyframes$Events$Main$TransitionCancel, 'Animation was cancelled', model)),
					$elm$core$Platform$Cmd$none);
			default:
				var time = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentTime: $elm$time$Time$posixToMillis(time)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$ClearEventLog = {$: 'ClearEventLog'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionCancel = {$: 'OnTransitionCancel'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionEnd = {$: 'OnTransitionEnd'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionRun = {$: 'OnTransitionRun'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionStart = {$: 'OnTransitionStart'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$Anim$Internal$CSS$onTransitionCancel = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'transitioncancel',
		$elm$json$Json$Decode$succeed(msg));
};
var $author$project$Anim$CSS$onTransitionCancel = $author$project$Anim$Internal$CSS$onTransitionCancel;
var $author$project$Anim$Internal$CSS$onTransitionEnd = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'transitionend',
		$elm$json$Json$Decode$succeed(msg));
};
var $author$project$Anim$CSS$onTransitionEnd = $author$project$Anim$Internal$CSS$onTransitionEnd;
var $author$project$Anim$Internal$CSS$onTransitionRun = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'transitionrun',
		$elm$json$Json$Decode$succeed(msg));
};
var $author$project$Anim$CSS$onTransitionRun = $author$project$Anim$Internal$CSS$onTransitionRun;
var $author$project$Anim$Internal$CSS$onTransitionStart = function (msg) {
	return A2(
		$elm$html$Html$Events$on,
		'transitionstart',
		$elm$json$Json$Decode$succeed(msg));
};
var $author$project$Anim$CSS$onTransitionStart = $author$project$Anim$Internal$CSS$onTransitionStart;
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$getEventTypeInfo = function (eventType) {
	switch (eventType.$) {
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$viewEventEntry = F2(
	function (currentCounter, entry) {
		var isRecent = (currentCounter - entry.id) <= 1;
		var eventTypeInfo = $author$project$ElmUI$CSS$Keyframes$Events$Main$getEventTypeInfo(entry.eventType);
		return A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$text(entry.description))
							])),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
...
var $author$project$ElmUI$CSS$Keyframes$Events$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			...
			$author$project$Common$UI$pageHeader('CSS Events Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Demonstrating CSS transition events with real-time event logging')),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Keyframes$Events$Main$MoveToCorner, 'Move to Corner'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Events$Main$MoveToCenter, 'Move to Center'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Events$Main$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Border$rounded(8),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$id('event-box')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
					...
					_Utils_ap(
						A2(
							$elm$core$List$map,
							$mdgriffith$elm_ui$Element$htmlAttribute,
							A2($author$project$Anim$CSS$htmlAttributes, 'event-box', model.animations)),
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionStart($author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionStart)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionEnd($author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionEnd)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionRun($author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionRun)),
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$author$project$Anim$CSS$onTransitionCancel($author$project$ElmUI$CSS$Keyframes$Events$Main$OnTransitionCancel))
							]))),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Events$Main$ClearEventLog, 'Clear Log')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
					...
					A2(
						$elm$core$List$map,
						$author$project$ElmUI$CSS$Keyframes$Events$Main$viewEventEntry(model.eventCounter),
						model.eventLog))
				]))
		]);
};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Events Keyframes ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Keyframes$Events$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Events$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$CSS$Keyframes$Events$Main$init, subscriptions: $author$project$ElmUI$CSS$Keyframes$Events$Main$subscriptions, update: $author$project$ElmUI$CSS$Keyframes$Events$Main$update, view: $author$project$ElmUI$CSS$Keyframes$Events$Main$view});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Events':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Events$Main$main(
