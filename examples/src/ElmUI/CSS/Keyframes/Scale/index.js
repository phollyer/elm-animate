...
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ScaleUp':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Scale$build(
									A2(
										...
										A3(
											...
											1.5,
											1.5,
											$author$project$ElmUI$CSS$Keyframes$Scale$Main$anim(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ScaleDown':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleDown = {$: 'ScaleDown'};
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleReset = {$: 'ScaleReset'};
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleTall = {$: 'ScaleTall'};
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleUp = {$: 'ScaleUp'};
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleWide = {$: 'ScaleWide'};
...
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			...
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Smooth scale animations using browser-native CSS keyframes with precise timing control')
					]))),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleUp, 'Scale Up'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleDown, 'Scale Down'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleWide, 'Scale Wide'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleTall, 'Scale Tall'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Scale$Main$ScaleReset, 'Reset Scale')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$CSS$Keyframes$Scale$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Scale$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Keyframes$Scale$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Keyframes$Scale$Main$update,
		view: $author$project$ElmUI$CSS$Keyframes$Scale$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Scale':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Scale$Main$main(
