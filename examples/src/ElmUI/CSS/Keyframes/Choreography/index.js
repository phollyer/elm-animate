...
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
						...
						model,
						{
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Position$build(
									A3(
										$author$project$Anim$Properties$Position$toXY,
										centerX + $elm$core$Basics$round(radius * 0.5),
										centerY - $elm$core$Basics$round(radius * 0.866),
										A2(
											$author$project$Anim$Properties$Position$for,
											'elementF',
											$author$project$Anim$Properties$Position$build(
												A3(
													...
													A2(
														...
														$author$project$Anim$Properties$Position$build(
															A3(
																$author$project$Anim$Properties$Position$toXY,
																centerX - $elm$core$Basics$round(radius),
																centerY,
																A2(
																	$author$project$Anim$Properties$Position$for,
																	'elementD',
...
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$animatedBox = F5(
	function (elementId, label, color1, color2, model) {
		return A2(
...
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer1', model.animations)),
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer2', model.animations)),
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer3', model.animations)),
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer4', model.animations)),
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer5', model.animations)),
			$mdgriffith$elm_ui$Element$html(
			A2($author$project$Anim$CSS$keyframesStyleNodeFor, 'dancer6', model.animations)),
			$author$project$Common$UI$backButtonWithPath('../../../index.html'),
			$author$project$Common$UI$pageHeader('CSS Choreography Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Coordinated choreography with 6 elements in formation patterns')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Keyframes$Choreography$Main$ScatterElements, 'Scatter Formation'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Choreography$Main$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Choreography$Main$ResetPositions, 'Reset Formation')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				_List_fromArray(
					[
						A5(
						$author$project$ElmUI$CSS$Keyframes$Choreography$Main$animatedBox,
						'elementA',
						'A',
						...
						A3($mdgriffith$elm_ui$Element$rgb255, 234, 88, 12),
						model),
						A5(
						$author$project$ElmUI$CSS$Keyframes$Choreography$Main$animatedBox,
						'elementE',
						...
						'elementF',
						'F',
						A3($mdgriffith$elm_ui$Element$rgb255, 236, 72, 153),
						A3($mdgriffith$elm_ui$Element$rgb255, 219, 39, 119),
						model)
					])))
		]);
};
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Choreography Keyframes ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Keyframes$Choreography$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Choreography$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Keyframes$Choreography$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Keyframes$Choreography$Main$update,
		view: $author$project$ElmUI$CSS$Keyframes$Choreography$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Choreography':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Choreography$Main$main(
