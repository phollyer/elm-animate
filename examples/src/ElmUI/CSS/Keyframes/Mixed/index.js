...
var $author$project$Anim$Internal$CSS$AnimationState = function (a) {
...
var $author$project$Anim$Internal$CSS$init = $author$project$Anim$Internal$CSS$AnimationState(
	{builder: $author$project$Anim$init, elementAnimations: $elm$core$Dict$empty});
var $author$project$Anim$CSS$init = $author$project$Anim$Internal$CSS$init;
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$ColorMorph = {$: 'ColorMorph'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$ComplexTransform = {$: 'ComplexTransform'};
var $author$project$Anim$Timing$Easing$CubicInOut = {$: 'CubicInOut'};
var $author$project$Anim$Timing$Easing$ElasticInOut = {$: 'ElasticInOut'};
var $author$project$Anim$Timing$Easing$ElasticOut = {$: 'ElasticOut'};
var $author$project$Anim$Timing$Easing$ExpoInOut = {$: 'ExpoInOut'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$FadeMove = {$: 'FadeMove'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$FullTransform = {$: 'FullTransform'};
var $author$project$Anim$Timing$Easing$Linear = {$: 'Linear'};
var $author$project$Anim$Timing$Easing$QuadInOut = {$: 'QuadInOut'};
var $author$project$Anim$Timing$Easing$QuartInOut = {$: 'QuartInOut'};
var $author$project$Anim$Timing$Easing$QuintInOut = {$: 'QuintInOut'};
var $author$project$Anim$Properties$Color$Rgb = function (a) {
	return {$: 'Rgb', a: a};
};
var $author$project$Anim$Timing$Easing$SineInOut = {$: 'SineInOut'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$SpinScale = {$: 'SpinScale'};
...
var $author$project$Anim$Internal$CSS$removeDuplicates = function (list) {
	removeDuplicates:
	while (true) {
		if (!list.b) {
			return _List_Nil;
			...
			if (A2($elm$core$List$member, x, xs)) {
				...
				return A2(
					$elm$core$List$cons,
					x,
					$author$project$Anim$Internal$CSS$removeDuplicates(xs));
			}
		}
	}
};
var $author$project$Anim$Internal$CSS$extractAnimatedProperties = function (properties) {
	return $author$project$Anim$Internal$CSS$removeDuplicates(
		A2(
...
var $author$project$Anim$Internal$CSS$combineTransformStyles = function (styles) {
	var _v0 = A2(
...
var $author$project$Anim$Internal$Properties$Color$toString = function (colorValue) {
	switch (colorValue.$) {
		...
		case 'Rgba':
			...
			return 'rgba(' + ($elm$core$String$fromInt(rgba.r) + (', ' + ($elm$core$String$fromInt(rgba.g) + (', ' + ($elm$core$String$fromInt(rgba.b) + (', ' + ($elm$core$String$fromFloat(rgba.a) + ')')))))));
		case 'Hsl':
			var hsl = colorValue.a;
			return 'hsl(' + ($elm$core$String$fromFloat(hsl.h) + (', ' + ($elm$core$String$fromFloat(hsl.s) + ('%, ' + ($elm$core$String$fromFloat(hsl.l) + '%)')))));
		default:
...
var $author$project$Anim$Internal$CSS$propertyToKeyframeStyle = F2(
...
var $author$project$Anim$Internal$Properties$Scale$distance = F2(
	function (_v0, _v1) {
		var sx1 = _v0.a;
		var sy1 = _v0.b;
		var sx2 = _v1.a;
...
var $author$project$Anim$Internal$CSS$calculatePropertyDistance = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
		...
		case 'ScaleConfig':
			var config = property.a;
			var startAt = function () {
				var _v3 = config.startAt;
				if (_v3.$ === 'Just') {
					var s = _v3.a;
					return s;
				} else {
					return $author$project$Anim$Internal$Properties$Scale$fromTuple(
						_Utils_Tuple2(1, 1));
				}
			}();
			return A2($author$project$Anim$Internal$Properties$Scale$distance, startAt, config.endAt);
		case 'ColorConfig':
			var config = property.a;
			var startAt = function () {
			...
			return A2($author$project$Anim$Internal$Properties$Color$distance, startAt, config.endAt);
		default:
			var config = property.a;
			var startAt = function () {
...
var $author$project$Anim$Internal$CSS$groupByTiming = F2(
	function (_v0, groups) {
		var timing = _v0.a;
		var property = _v0.b;
		var _v1 = A2($author$project$Anim$Internal$CSS$findMatchingGroup, timing, groups);
		if (_v1.$ === 'Just') {
			var group = _v1.a;
			return A2(
				$elm$core$List$map,
...
var $author$project$Anim$Internal$CSS$groupPropertiesByTiming = function (properties) {
	return A2(
		$elm$core$List$map,
		function (group) {
		...
		A3(
			$elm$core$List$foldl,
			$author$project$Anim$Internal$CSS$groupByTiming,
			_List_Nil,
			A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$extractPropertyTiming, properties)));
};
var $author$project$Anim$Internal$CSS$generateAnimationLayers = F2(
	function (elementId, properties) {
		if ($elm$core$List$isEmpty(properties)) {
			return _List_Nil;
		} else {
			var timingGroups = $author$project$Anim$Internal$CSS$groupPropertiesByTiming(properties);
			var layersFromGroups = A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				A2(
					$elm$core$List$indexedMap,
					$author$project$Anim$Internal$CSS$createAnimationLayerFromGroup(elementId),
					timingGroups));
			return layersFromGroups;
		}
	});
var $author$project$Anim$Internal$CSS$colorStyleFromProperty = function (property) {
	switch (property.$) {
		case 'ColorConfig':
			var config = property.a;
			return $elm$core$Maybe$Just(
...
var $author$project$Anim$Internal$CSS$generateColorStyles = function (properties) {
	return A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$colorStyleFromProperty, properties);
};
var $author$project$Anim$Internal$CSS$transformFromProperty = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
			return $elm$core$Maybe$Just(
...
var $author$project$Anim$Internal$CSS$generateTransforms = function (properties) {
	var transformParts = A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$transformFromProperty, properties);
	return A2($elm$core$String$join, ' ', transformParts);
};
var $author$project$Anim$Internal$CSS$chooseSmallerDelay = F2(
	function (a, b) {
		return (_Utils_cmp(a, b) < 1) ? a : b;
	});
var $author$project$Anim$Internal$CSS$extractDelay = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
			return config.delay;
...
var $author$project$Anim$Internal$CSS$findEarliestDelay = function (properties) {
	var delays = A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$extractDelay, properties);
	if (!delays.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Just(
			A3($elm$core$List$foldl, $author$project$Anim$Internal$CSS$chooseSmallerDelay, 999999, delays));
	}
};
var $author$project$Anim$Internal$CSS$extractEasing = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
...
var $author$project$Anim$Internal$CSS$findLatestEasing = function (properties) {
	return A2(
		$elm$core$Maybe$withDefault,
		$author$project$Anim$Internal$Timing$Easing$Linear,
		$elm$core$List$head(
			$elm$core$List$reverse(
				A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$extractEasing, properties))));
};
var $author$project$Anim$Internal$CSS$extractDistance = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
...
var $author$project$Anim$Internal$CSS$findLongestDistance = function (properties) {
	var distances = A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$extractDistance, properties);
	if (!distances.b) {
		return 0.0;
	} else {
		return A2(
...
var $author$project$Anim$Internal$CSS$extractTiming = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			var config = property.a;
		...
		function (prop) {
			return A2(
				...
				function (timeSpec) {
					return _Utils_Tuple2(
						timeSpec,
						$author$project$Anim$Internal$CSS$calculatePropertyDistance(prop));
				},
				$author$project$Anim$Internal$CSS$extractTiming(prop));
		},
		properties);
			...
			A3(
				...
				F2(
					function (_v2, acc) {
						...
						var dist = _v2.b;
						return A3(
							$author$project$Anim$Internal$CSS$chooseLongerDuration,
							function (ts) {
...
var $author$project$Anim$Internal$CSS$consolidateTransformTiming = function (transformProps) {
	if (!transformProps.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		var longestDuration = $author$project$Anim$Internal$CSS$findLongestDuration(transformProps);
		var longestDistance = $author$project$Anim$Internal$CSS$findLongestDistance(transformProps);
		var latestEasing = $author$project$Anim$Internal$CSS$findLatestEasing(transformProps);
		var earliestDelay = $author$project$Anim$Internal$CSS$findEarliestDelay(transformProps);
		return $elm$core$Maybe$Just(
...
var $author$project$Anim$Internal$CSS$isTransformProperty = function (property) {
	switch (property.$) {
		case 'PositionConfig':
			return true;
		case 'RotateConfig':
...
var $author$project$Anim$Internal$Builder$ColorConfig = function (a) {
	return {$: 'ColorConfig', a: a};
};
var $author$project$Anim$Internal$Builder$OpacityConfig = function (a) {
	return {$: 'OpacityConfig', a: a};
};
var $author$project$Anim$Internal$CSS$transitionFromNonTransformProperty = function (property) {
	switch (property.$) {
		case 'ColorConfig':
			var config = property.a;
			var distance = $author$project$Anim$Internal$CSS$calculatePropertyDistance(
				$author$project$Anim$Internal$Builder$ColorConfig(config));
			return $elm$core$Maybe$Just(
				'background-color ' + (A2($author$project$Anim$Internal$Timing$TimeSpec$toCssString, distance, config.timing) + (' ' + ($author$project$Anim$Internal$Timing$Easing$toCSS(config.easing) + (' ' + $author$project$Anim$Internal$Timing$Delay$toCssString(config.delay))))));
		case 'OpacityConfig':
			var config = property.a;
			var distance = $author$project$Anim$Internal$CSS$calculatePropertyDistance(
				$author$project$Anim$Internal$Builder$OpacityConfig(config));
			return $elm$core$Maybe$Just(
				'opacity ' + (A2($author$project$Anim$Internal$Timing$TimeSpec$toCssString, distance, config.timing) + (' ' + ($author$project$Anim$Internal$Timing$Easing$toCSS(config.easing) + (' ' + $author$project$Anim$Internal$Timing$Delay$toCssString(config.delay))))));
		default:
			return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Anim$Internal$CSS$generateTransitions = function (properties) {
	var transformProperties = A2($elm$core$List$filter, $author$project$Anim$Internal$CSS$isTransformProperty, properties);
	var transformTransition = function () {
		var _v0 = $author$project$Anim$Internal$CSS$consolidateTransformTiming(transformProperties);
		if (_v0.$ === 'Just') {
	...
	var nonTransformTransitions = A2($elm$core$List$filterMap, $author$project$Anim$Internal$CSS$transitionFromNonTransformProperty, properties);
	var allTransitions = _Utils_ap(transformTransition, nonTransformTransitions);
	return A2($elm$core$String$join, ', ', allTransitions);
};
var $author$project$Anim$Internal$CSS$generateElementAnimation = F2(
	function (elementId, elementConfig) {
		var transitions = $author$project$Anim$Internal$CSS$generateTransitions(elementConfig.properties);
		var transforms = $author$project$Anim$Internal$CSS$generateTransforms(elementConfig.properties);
		var colors = $author$project$Anim$Internal$CSS$generateColorStyles(elementConfig.properties);
		var animationLayers = A2($author$project$Anim$Internal$CSS$generateAnimationLayers, elementId, elementConfig.properties);
		var allStyles = A2(
			$elm$core$List$filter,
			function (_v0) {
				var value = _v0.b;
...
var $author$project$Anim$Internal$CSS$animate = function (builder_) {
	...
	var elementAnimations = A2($elm$core$Dict$map, $author$project$Anim$Internal$CSS$generateElementAnimation, elementsDict);
	return $author$project$Anim$Internal$CSS$AnimationState(
		{builder: builder_, elementAnimations: elementAnimations});
};
var $author$project$Anim$CSS$animate = $author$project$Anim$Internal$CSS$animate;
...
var $author$project$Anim$Internal$Builders$Color$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	var newColorConfig = $author$project$Anim$Internal$Builder$ColorConfig(config);
...
var $author$project$Anim$Internal$Builders$Opacity$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	var newOpacityConfig = $author$project$Anim$Internal$Builder$OpacityConfig(config);
...
var $author$project$Anim$Internal$Builders$Scale$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	var newScaleConfig = $author$project$Anim$Internal$Builder$ScaleConfig(config);
	return A2($author$project$Anim$Internal$Builders$Property$upsert, newScaleConfig, builder);
};
var $author$project$Anim$Properties$Scale$build = $author$project$Anim$Internal$Builders$Scale$build;
var $author$project$Anim$Internal$CSS$builder = function (_v0) {
	var state = _v0.a;
	return state.builder;
};
var $author$project$Anim$CSS$builder = $author$project$Anim$Internal$CSS$builder;
var $author$project$Anim$Internal$Builders$Color$ColorBuilder = F2(
	function (a, b) {
		return {$: 'ColorBuilder', a: a, b: b};
	});
var $author$project$Anim$Internal$Builders$Color$delay = F2(
	function (dly, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Properties$Color$delay = function (delay_) {
	return $author$project$Anim$Internal$Builders$Color$delay(delay_);
};
...
var $author$project$Anim$Properties$Scale$delay = $author$project$Anim$Internal$Builders$Scale$delay;
...
var $author$project$Anim$duration = F2(
	function (ms, builder) {
		return A2($author$project$Anim$Internal$Builder$duration, ms, builder);
	});
var $author$project$Anim$Internal$Builders$Color$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Properties$Color$duration = function (milliseconds) {
	return $author$project$Anim$Internal$Builders$Color$duration(milliseconds);
};
...
var $author$project$Anim$Properties$Position$duration = $author$project$Anim$Internal$Builders$Position$duration;
...
var $author$project$Anim$Internal$Builders$Scale$duration = F2(
	function (ms, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Internal$Timing$Easing$BackIn = {$: 'BackIn'};
var $author$project$Anim$Internal$Timing$Easing$BackInOut = {$: 'BackInOut'};
var $author$project$Anim$Internal$Timing$Easing$BackOut = {$: 'BackOut'};
var $author$project$Anim$Internal$Timing$Easing$Bezier = F4(
	function (a, b, c, d) {
...
var $author$project$Anim$Internal$Timing$Easing$CubicIn = {$: 'CubicIn'};
var $author$project$Anim$Internal$Timing$Easing$CubicInOut = {$: 'CubicInOut'};
var $author$project$Anim$Internal$Timing$Easing$CubicOut = {$: 'CubicOut'};
var $author$project$Anim$Internal$Timing$Easing$Custom = function (a) {
	return {$: 'Custom', a: a};
};
var $author$project$Anim$Internal$Timing$Easing$Ease = {$: 'Ease'};
var $author$project$Anim$Internal$Timing$Easing$EaseIn = {$: 'EaseIn'};
var $author$project$Anim$Internal$Timing$Easing$EaseInOut = {$: 'EaseInOut'};
var $author$project$Anim$Internal$Timing$Easing$EaseOut = {$: 'EaseOut'};
var $author$project$Anim$Internal$Timing$Easing$ElasticIn = {$: 'ElasticIn'};
var $author$project$Anim$Internal$Timing$Easing$ElasticInOut = {$: 'ElasticInOut'};
var $author$project$Anim$Internal$Timing$Easing$ElasticOut = {$: 'ElasticOut'};
...
var $author$project$Anim$Internal$Timing$Easing$QuartIn = {$: 'QuartIn'};
var $author$project$Anim$Internal$Timing$Easing$QuartInOut = {$: 'QuartInOut'};
var $author$project$Anim$Internal$Timing$Easing$QuartOut = {$: 'QuartOut'};
var $author$project$Anim$Internal$Timing$Easing$QuintIn = {$: 'QuintIn'};
var $author$project$Anim$Internal$Timing$Easing$QuintInOut = {$: 'QuintInOut'};
var $author$project$Anim$Internal$Timing$Easing$QuintOut = {$: 'QuintOut'};
var $author$project$Anim$Internal$Timing$Easing$SineIn = {$: 'SineIn'};
var $author$project$Anim$Internal$Timing$Easing$SineInOut = {$: 'SineInOut'};
var $author$project$Anim$Internal$Timing$Easing$SineOut = {$: 'SineOut'};
var $author$project$Anim$Timing$Easing$toInternal = function (easing) {
	switch (easing.$) {
		case 'Bezier':
			var p1x = easing.a;
			var p1y = easing.b;
			var p2x = easing.c;
			var p2y = easing.d;
			return A4($author$project$Anim$Internal$Timing$Easing$Bezier, p1x, p1y, p2x, p2y);
		case 'Linear':
			return $author$project$Anim$Internal$Timing$Easing$Linear;
		case 'Ease':
			return $author$project$Anim$Internal$Timing$Easing$Ease;
		case 'EaseIn':
			return $author$project$Anim$Internal$Timing$Easing$EaseIn;
		case 'EaseOut':
			return $author$project$Anim$Internal$Timing$Easing$EaseOut;
		case 'EaseInOut':
			return $author$project$Anim$Internal$Timing$Easing$EaseInOut;
		case 'SineIn':
			return $author$project$Anim$Internal$Timing$Easing$SineIn;
		case 'SineOut':
			return $author$project$Anim$Internal$Timing$Easing$SineOut;
		case 'SineInOut':
			return $author$project$Anim$Internal$Timing$Easing$SineInOut;
		case 'QuadIn':
			return $author$project$Anim$Internal$Timing$Easing$QuadIn;
		case 'QuadOut':
			return $author$project$Anim$Internal$Timing$Easing$QuadOut;
		case 'QuadInOut':
			return $author$project$Anim$Internal$Timing$Easing$QuadInOut;
		case 'CubicIn':
			return $author$project$Anim$Internal$Timing$Easing$CubicIn;
		case 'CubicOut':
			return $author$project$Anim$Internal$Timing$Easing$CubicOut;
		case 'CubicInOut':
			return $author$project$Anim$Internal$Timing$Easing$CubicInOut;
		case 'QuartIn':
			return $author$project$Anim$Internal$Timing$Easing$QuartIn;
		case 'QuartOut':
			return $author$project$Anim$Internal$Timing$Easing$QuartOut;
		case 'QuartInOut':
			return $author$project$Anim$Internal$Timing$Easing$QuartInOut;
		case 'QuintIn':
			return $author$project$Anim$Internal$Timing$Easing$QuintIn;
		case 'QuintOut':
			return $author$project$Anim$Internal$Timing$Easing$QuintOut;
		case 'QuintInOut':
			return $author$project$Anim$Internal$Timing$Easing$QuintInOut;
		case 'ExpoIn':
			return $author$project$Anim$Internal$Timing$Easing$ExpoIn;
		case 'ExpoOut':
			return $author$project$Anim$Internal$Timing$Easing$ExpoOut;
		case 'ExpoInOut':
			return $author$project$Anim$Internal$Timing$Easing$ExpoInOut;
		case 'CircIn':
			return $author$project$Anim$Internal$Timing$Easing$CircIn;
		case 'CircOut':
			return $author$project$Anim$Internal$Timing$Easing$CircOut;
		case 'CircInOut':
			return $author$project$Anim$Internal$Timing$Easing$CircInOut;
		case 'BackIn':
			return $author$project$Anim$Internal$Timing$Easing$BackIn;
		case 'BackOut':
			return $author$project$Anim$Internal$Timing$Easing$BackOut;
		case 'BackInOut':
			return $author$project$Anim$Internal$Timing$Easing$BackInOut;
		case 'ElasticIn':
			return $author$project$Anim$Internal$Timing$Easing$ElasticIn;
		case 'ElasticOut':
			return $author$project$Anim$Internal$Timing$Easing$ElasticOut;
		case 'ElasticInOut':
			return $author$project$Anim$Internal$Timing$Easing$ElasticInOut;
		case 'BounceIn':
			return $author$project$Anim$Internal$Timing$Easing$BounceIn;
		case 'BounceOut':
			return $author$project$Anim$Internal$Timing$Easing$BounceOut;
		case 'BounceInOut':
			return $author$project$Anim$Internal$Timing$Easing$BounceInOut;
		default:
			var str = easing.a;
			return $author$project$Anim$Internal$Timing$Easing$Custom(str);
	}
};
var $author$project$Anim$Timing$Easing$mapInternal = function (fn) {
	return A2($elm$core$Basics$composeL, fn, $author$project$Anim$Timing$Easing$toInternal);
};
var $author$project$Anim$easing = F2(
	...
	function (ease, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					easing: $elm$core$Maybe$Just(ease)
				}),
			builder);
	});
var $author$project$Anim$Properties$Color$easing = function (easing_) {
	return A2($author$project$Anim$Timing$Easing$mapInternal, $author$project$Anim$Internal$Builders$Color$easing, easing_);
};
...
var $author$project$Anim$Properties$Opacity$easing = function (easing_) {
	return $author$project$Anim$Internal$Builders$Opacity$easing(
...
var $author$project$Anim$Properties$Position$easing = function (easing_) {
...
var $author$project$Anim$Internal$Builders$Scale$easing = F2(
	function (easing_, _v0) {
		var config = _v0.a;
		var builder = _v0.b;
		return A2(
...
var $author$project$Anim$Properties$Scale$easing = function (easing_) {
	return $author$project$Anim$Internal$Builders$Scale$easing(
		A2($author$project$Anim$Timing$Easing$mapInternal, $elm$core$Basics$identity, easing_));
};
...
var $author$project$Anim$Internal$Builders$Color$defaultConfig = {
	...
	endAt: A3($author$project$Anim$Internal$Properties$Color$rgb255, 0, 0, 0),
	speed: 0,
...
var $author$project$Anim$Internal$Builders$Color$for = F2(
	function (elementId, builder) {
		...
		var newConfig = function () {
			if (existingConfig.$ === 'Just') {
				...
				return A2($author$project$Anim$Internal$Builders$Property$applyGlobalDefaults, builder, $author$project$Anim$Internal$Builders$Color$defaultConfig);
			}
		}();
		return A2(
			$author$project$Anim$Internal$Builders$Color$ColorBuilder,
...
var $author$project$Anim$Internal$Builders$Opacity$defaultConfig = {
	delay: $elm$core$Maybe$Nothing,
	distance: 0,
	duration: 0,
	easing: $elm$core$Maybe$Nothing,
	endAt: $author$project$Anim$Internal$Properties$Opacity$fromFloat(1),
	speed: 0,
	startAt: $elm$core$Maybe$Nothing,
	timing: $elm$core$Maybe$Nothing
};
...
var $author$project$Anim$Internal$Builders$Position$defaultConfig = {
	delay: $elm$core$Maybe$Nothing,
	distance: 0,
	duration: 0,
	easing: $elm$core$Maybe$Nothing,
...
var $author$project$Anim$Internal$Builders$Scale$defaultConfig = {
	delay: $elm$core$Maybe$Nothing,
	distance: 0,
	duration: 0,
	easing: $elm$core$Maybe$Nothing,
	endAt: $author$project$Anim$Internal$Properties$Scale$fromTuple(
		_Utils_Tuple2(0, 0)),
	speed: 0,
	startAt: $elm$core$Maybe$Nothing,
	timing: $elm$core$Maybe$Nothing
	...
	function (elementId, builder) {
		...
		var newConfig = function () {
			if (existingConfig.$ === 'Just') {
				...
				return A2($author$project$Anim$Internal$Builders$Property$applyGlobalDefaults, builder, $author$project$Anim$Internal$Builders$Scale$defaultConfig);
			}
		}();
		return A2(
			$author$project$Anim$Internal$Builders$Scale$ScaleBuilder,
...
var $author$project$Anim$Properties$Scale$for = function (elementId) {
	return $author$project$Anim$Internal$Builders$Scale$for(elementId);
};
	...
	function (color, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					distance: A2($author$project$Anim$Internal$Properties$Color$distance, startPos, color),
					endAt: color,
...
var $author$project$Anim$Properties$Color$toInternal = function (color) {
	switch (color.$) {
		case 'Hex':
			...
			return $author$project$Anim$Internal$Properties$Color$Hex(hexString);
		case 'Rgb':
			var rgb = color.a;
			return $author$project$Anim$Internal$Properties$Color$Rgb(rgb);
		case 'Rgba':
			var rgba = color.a;
			return $author$project$Anim$Internal$Properties$Color$Rgba(rgba);
		case 'Hsl':
			var hsl = color.a;
			return $author$project$Anim$Internal$Properties$Color$Hsl(hsl);
		default:
			var hsla = color.a;
			return $author$project$Anim$Internal$Properties$Color$Hsla(hsla);
	}
};
...
var $author$project$Anim$Properties$Position$toXY = F2(
	function (x, y) {
		return $author$project$Anim$Internal$Builders$Position$to(
			$author$project$Anim$Internal$Properties$Position$fromTuple(
				_Utils_Tuple2(x, y)));
	});
	...
	function (scaleX, scaleY, _v0) {
		...
		return A2(
			...
			_Utils_update(
				config,
				{
					distance: A2($author$project$Anim$Internal$Properties$Scale$distance, startPos, scale),
					endAt: scale,
					startAt: $elm$core$Maybe$Just(startPos)
				}),
			builder);
...
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartComplexTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Keyframes$Mixed$Main$ComplexTransform),
								...
								$author$project$Anim$Properties$Rotate$build(
									A2(
										...
										A2(
											...
											$author$project$Anim$Timing$Easing$ElasticOut,
											A2(
			...
			case 'StartFadeMove':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Keyframes$Mixed$Main$FadeMove),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Position$build(
									A3(
										$author$project$Anim$Properties$Position$toXY,
											...
											$author$project$Anim$Properties$Opacity$build(
												A2(
													...
													A2(
														...
														A2(
															$author$project$Anim$easing,
															$author$project$Anim$Timing$Easing$CubicInOut,
															A2(
																$author$project$Anim$duration,
																800,
																$author$project$Anim$CSS$builder(model.animations)))))))))),
			...
			case 'StartSpinScale':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Keyframes$Mixed$Main$SpinScale),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A2(
			...
			case 'StartColorMorph':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Keyframes$Mixed$Main$ColorMorph),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Scale$build(
									A3(
										$author$project$Anim$Properties$Scale$toXY,
											...
											$author$project$Anim$Properties$Color$build(
												A2(
													...
													A2(
														...
														A2(
															$author$project$Anim$easing,
															$author$project$Anim$Timing$Easing$QuartInOut,
															A2(
																$author$project$Anim$duration,
																900,
																$author$project$Anim$CSS$builder(model.animations)))))))))),
			...
			case 'StartFullTransform':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							activeAnimation: $elm$core$Maybe$Just($author$project$ElmUI$CSS$Keyframes$Mixed$Main$FullTransform),
							animations: $author$project$Anim$CSS$animate(
								$author$project$Anim$Properties$Color$build(
									A2(
										$author$project$Anim$Properties$Color$delay,
										400,
										A2(
											...
											A2(
												...
												$author$project$Anim$Timing$Easing$QuintInOut,
												A2(
													$author$project$Anim$Properties$Color$to,
													$author$project$Anim$Properties$Color$Rgb(
														{b: 200, g: 255, r: 100}),
...
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$ResetAll = {$: 'ResetAll'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartColorMorph = {$: 'StartColorMorph'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartComplexTransform = {$: 'StartComplexTransform'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartFadeMove = {$: 'StartFadeMove'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartFullTransform = {$: 'StartFullTransform'};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartSpinScale = {$: 'StartSpinScale'};
...
var $author$project$Anim$Internal$CSS$htmlAttributes = F2(
	function (elementId, animationResult) {
		return A2(
			...
			A2($author$project$Anim$Internal$CSS$getElementStyles, elementId, animationResult));
	});
var $author$project$Anim$CSS$htmlAttributes = $author$project$Anim$Internal$CSS$htmlAttributes;
...
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail = F3(
	function (title, description, properties) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					...
					A2(
						...
						function (property) {
							return A2(
								...
								$mdgriffith$elm_ui$Element$text('• ' + property));
						},
						properties))
				]));
	});
...
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			...
			$author$project$Common$UI$pageHeader('CSS Mixed Properties Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Combining multiple CSS properties creates rich, complex animations. Each property can have independent timing and easing for sophisticated effects.')
					]))),
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
					...
					$mdgriffith$elm_ui$Element$text(
						function () {
							if (model.isAnimating) {
								var _v0 = model.activeAnimation;
								if (_v0.$ === 'Just') {
									switch (_v0.a.$) {
										case 'ComplexTransform':
											var _v1 = _v0.a;
											return '🎬 Complex Transform: Position + Scale + Rotate';
										case 'FadeMove':
											var _v2 = _v0.a;
											return '🎬 Fade & Move: Opacity + Position';
										case 'SpinScale':
											var _v3 = _v0.a;
											return '🎬 Spin & Scale: Rotate + Scale (Delayed)';
										case 'ColorMorph':
											var _v4 = _v0.a;
											return '🎬 Color Morph: Background + Scale';
										default:
											var _v5 = _v0.a;
											return '🎬 Full Transform: All Properties (Staggered)';
									}
								} else {
									return '🎬 Resetting All Properties...';
								}
							} else {
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartComplexTransform, 'Complex Transform'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartFadeMove, 'Fade & Move')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartSpinScale, 'Spin & Scale'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartColorMorph, 'Color Morph')
						])),
					$author$project$Common$UI$wrappedButtonRow(
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$StartFullTransform, 'Full Transform'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Mixed$Main$ResetAll, 'Reset All')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Border$rounded(12),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$id('mixed-box')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
					...
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
						A2($author$project$Anim$CSS$htmlAttributes, 'mixed-box', model.animations))),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('🎭 Animation Combinations')),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							A3(
							$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail,
							'🔄 Complex Transform',
							'Position + Scale + Rotate with different easing functions',
							_List_fromArray(
								['Position: SineInOut (800ms)', 'Scale: BackInOut (1000ms)', 'Rotate: ElasticOut (1200ms)'])),
							A3(
							$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail,
							'👻 Fade & Move',
							'Synchronized opacity and position changes',
							_List_fromArray(
								['Opacity: CubicInOut (800ms)', 'Position: CubicInOut (800ms)'])),
							A3(
							$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail,
							'🌪️ Spin & Scale',
							'Rotate with delayed scale animation',
							_List_fromArray(
								['Rotation: BounceOut (1000ms)', 'Scale: BounceOut (1000ms, 200ms delay)'])),
							A3(
							$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail,
							'🎨 Color Morph',
							'Color transition with coordinated scaling',
							_List_fromArray(
								['Background: QuartInOut (900ms)', 'Scale: QuartInOut (900ms)'])),
							A3(
							$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewAnimationDetail,
							'⭐ Full Transform',
							'All properties with staggered timing (transform order handled automatically by API)',
							_List_fromArray(
								['Position: ExpoInOut (1200ms, 0ms delay)', 'Opacity: Linear (800ms, 100ms delay)', 'Scale: CircInOut (1000ms, 200ms delay)', 'Rotation: ElasticInOut (1400ms, 300ms delay)', 'Color: QuintInOut (1100ms, 400ms delay)']))
						]))
				]))
		]);
};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Mixed Keyframes ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Keyframes$Mixed$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Mixed$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Keyframes$Mixed$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Keyframes$Mixed$Main$update,
		view: $author$project$ElmUI$CSS$Keyframes$Mixed$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Mixed':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Mixed$Main$main(
