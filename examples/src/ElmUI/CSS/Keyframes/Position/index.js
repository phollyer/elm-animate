...
var $author$project$ElmUI$CSS$Keyframes$Position$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Keyframes$Position$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToPosition':
				var x = msg.a;
									...
									A2(
										...
										A2(
											...
											A3(
												...
												x,
												y,
												$author$project$ElmUI$CSS$Keyframes$Position$Main$anim(model.animations))))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveLeft':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveDown = {$: 'MoveDown'};
var $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveRight = {$: 'MoveRight'};
var $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveToPosition = F2(
	function (a, b) {
		return {$: 'MoveToPosition', a: a, b: b};
	});
var $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveUp = {$: 'MoveUp'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Keyframes$Position$Main$ReturnToOrigin = {$: 'ReturnToOrigin'};
...
var $author$project$ElmUI$CSS$Keyframes$Position$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			...
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Smooth position animations using browser-native CSS keyframes with precise timing control')
					]))),
			...
			_List_fromArray(
				[
					...
					A2($author$project$ElmUI$CSS$Keyframes$Position$Main$MoveToPosition, 100, 100),
					'Move to (100, 100)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					A2($author$project$ElmUI$CSS$Keyframes$Position$Main$MoveToPosition, 300, 200),
					'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Position$Main$ReturnToOrigin, 'Return to Origin')
				])),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveLeft, '← Move Left'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveRight, 'Move Right →'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveUp, '↑ Move Up'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Position$Main$MoveDown, 'Move Down (with delay 1000ms) ↓')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$CSS$Keyframes$Position$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.CSS Position Keyframes ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$CSS$Keyframes$Position$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Position$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Keyframes$Position$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Keyframes$Position$Main$update,
		view: $author$project$ElmUI$CSS$Keyframes$Position$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Position':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Position$Main$main(
