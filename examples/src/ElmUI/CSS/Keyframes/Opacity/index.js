...
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$init = function (_v0) {
...
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FadeIn':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeIn = {$: 'FadeIn'};
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeOut = {$: 'FadeOut'};
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeToHalf = {$: 'FadeToHalf'};
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeToQuarter = {$: 'FadeToQuarter'};
...
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$mdgriffith$elm_ui$Element$html(
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeIn, 'Fade In'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeOut, 'Fade Out'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeToHalf, '50% Opacity'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Keyframes$Opacity$Main$FadeToQuarter, '25% Opacity'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Keyframes$Opacity$Main$ShowFully, 'Show Fully')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$CSS$Keyframes$Opacity$Main$viewContent(model));
};
var $author$project$ElmUI$CSS$Keyframes$Opacity$Main$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$CSS$Keyframes$Opacity$Main$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$CSS$Keyframes$Opacity$Main$update,
		view: $author$project$ElmUI$CSS$Keyframes$Opacity$Main$view
	});
_Platform_export({'ElmUI':{'CSS':{'Keyframes':{'Opacity':{'Main':{'init':$author$project$ElmUI$CSS$Keyframes$Opacity$Main$main(
