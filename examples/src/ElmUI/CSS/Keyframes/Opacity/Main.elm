...
{-| Anim.Engine.Animation.CSS Opacity Example using ElmUI - Element opacity animations with CSS keyframes
...
view model =
    UI.createDocument
        "Anim.Engine.Animation.CSS Opacity Keyframe ElmUI Example"
        UI.Basic
        (viewContent model)
