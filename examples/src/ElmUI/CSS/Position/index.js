...
var $author$project$ElmUI$CSS$Position$Main$anim = function (animations) {
	return A2(
...
var $author$project$ElmUI$CSS$Position$Main$MoveDown = {$: 'MoveDown'};
var $author$project$ElmUI$CSS$Position$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$ElmUI$CSS$Position$Main$MoveRight = {$: 'MoveRight'};
var $author$project$ElmUI$CSS$Position$Main$MoveToPosition = F2(
	function (a, b) {
		return {$: 'MoveToPosition', a: a, b: b};
	});
var $author$project$ElmUI$CSS$Position$Main$MoveUp = {$: 'MoveUp'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$CSS$Position$Main$ReturnToOrigin = {$: 'ReturnToOrigin'};
	...
	function (elementId, _v0) {
		...
		return A2(
			...
			A2(
				...
				A2(
					$elm$core$Maybe$andThen,
					$elm$core$Dict$get('position'),
					A2($elm$core$Dict$get, elementId, state.currentValues))));
	});
var $author$project$Anim$CSS$getStoredPosition = F2(
	function (elementId, animationState) {
		return A2($author$project$Anim$CSS$getCurrentPosition, elementId, animationState);
	});
var $author$project$Anim$CSS$extractPositionFromProperty = F2(
	function (property, currentPos) {
		if (property.$ === 'PositionConfig') {
			var config = property.a;
			return $author$project$Anim$Internal$Properties$Position$toRecord(config.endAt);
		} else {
			return currentPos;
		}
	});
var $author$project$Anim$CSS$getTargetPositionFromConfig = function (elementConfig) {
	return A3(
		$elm$core$List$foldl,
		$author$project$Anim$CSS$extractPositionFromProperty,
		{x: 0, y: 0},
		elementConfig.properties);
};
var $author$project$Anim$CSS$getElementPosition = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		var elementsDict = $author$project$Anim$Internal$Builder$elements(state.builder);
		return A2(
			$elm$core$Maybe$withDefault,
			A2(
				$author$project$Anim$CSS$getStoredPosition,
				elementId,
				$author$project$Anim$CSS$AnimationState(state)),
			A2(
				$elm$core$Maybe$map,
				$author$project$Anim$CSS$getTargetPositionFromConfig,
...
var $author$project$ElmUI$CSS$Position$Main$viewContent = function (model) {
	var currentPos = A2($author$project$Anim$CSS$getElementPosition, 'box', model.animations);
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text(
				'Position: (' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(currentPos.x)) + (', ' + ($elm$core$String$fromInt(
					$elm$core$Basics$round(currentPos.y)) + ')'))))),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3(
					$author$project$Common$UI$Primary,
					A2($author$project$ElmUI$CSS$Position$Main$MoveToPosition, 100, 100),
					'Move to (100, 100)'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					A2($author$project$ElmUI$CSS$Position$Main$MoveToPosition, 300, 200),
					'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$CSS$Position$Main$ReturnToOrigin, 'Return to Origin')
				])),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Position$Main$MoveLeft, '← Move Left'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$CSS$Position$Main$MoveRight, 'Move Right →'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Position$Main$MoveUp, '↑ Move Up'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$CSS$Position$Main$MoveDown, 'Move Down (with delay 1000ms) ↓')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
