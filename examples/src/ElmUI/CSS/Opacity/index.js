			...
			case 'FadeIn':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$CSS$animateOpacity, elementId, 1.0, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'FadeOut':
				var elementId = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$CSS$animateOpacity, elementId, 0.0, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'FadeToggle':
				var elementId = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$CSS$animateOpacity, elementId, 0.5, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$ElmUI$CSS$Opacity$Main$FadeIn = function (a) {
	return {$: 'FadeIn', a: a};
};
var $author$project$ElmUI$CSS$Opacity$Main$FadeOut = function (a) {
	return {$: 'FadeOut', a: a};
};
var $author$project$ElmUI$CSS$Opacity$Main$FadeToggle = function (a) {
	return {$: 'FadeToggle', a: a};
};
		...
		_List_fromArray(
			[
						...
						$author$project$Common$UI$htmlActionButtons(
							_List_fromArray(
								[
									...
									$author$project$ElmUI$CSS$Opacity$Main$FadeIn('box1'),
									'Fade In Box 1'),
									_Utils_Tuple3(
									$author$project$Common$UI$Warning,
									$author$project$ElmUI$CSS$Opacity$Main$FadeOut('box1'),
									'Fade Out Box 1'),
									_Utils_Tuple3(
									$author$project$Common$UI$Primary,
									$author$project$ElmUI$CSS$Opacity$Main$FadeToggle('box1'),
									'Toggle Box 1')
								]))),
						A2(
						$mdgriffith$elm_ui$Element$el,
						...
						$author$project$Common$UI$htmlActionButtons(
							_List_fromArray(
								[
									_Utils_Tuple3(
									$author$project$Common$UI$Success,
									$author$project$ElmUI$CSS$Opacity$Main$FadeIn('box2'),
									'Fade In Box 2'),
									_Utils_Tuple3(
									$author$project$Common$UI$Warning,
									$author$project$ElmUI$CSS$Opacity$Main$FadeOut('box2'),
									'Fade Out Box 2'),
									_Utils_Tuple3(
									$author$project$Common$UI$Primary,
									$author$project$ElmUI$CSS$Opacity$Main$FadeToggle('box2'),
									'Toggle Box 2')
								]))),
						A2(
						$mdgriffith$elm_ui$Element$el,
						...
						$author$project$Common$UI$htmlActionButtons(
							_List_fromArray(
								[
									_Utils_Tuple3(
									$author$project$Common$UI$Success,
									$author$project$ElmUI$CSS$Opacity$Main$FadeIn('box3'),
									'Fade In Box 3'),
									_Utils_Tuple3(
									$author$project$Common$UI$Warning,
									$author$project$ElmUI$CSS$Opacity$Main$FadeOut('box3'),
									'Fade Out Box 3'),
									_Utils_Tuple3(
									$author$project$Common$UI$Primary,
									$author$project$ElmUI$CSS$Opacity$Main$FadeToggle('box3'),
									'Toggle Box 3')
								])))
					])),
				A2(
				...
				A2(
					...
					_List_fromArray(
						[
							A4($author$project$ElmUI$CSS$Opacity$Main$animatedBox, 'box1', 'Fast Fade (0.3s)', $author$project$Common$Colors$primary, model),
							A4($author$project$ElmUI$CSS$Opacity$Main$animatedBox, 'box2', 'Medium Fade (0.6s)', $author$project$Common$Colors$success, model),
							A4($author$project$ElmUI$CSS$Opacity$Main$animatedBox, 'box3', 'Slow Fade (1.2s)', $author$project$Common$Colors$warning, model)
						])))
			]));
};
