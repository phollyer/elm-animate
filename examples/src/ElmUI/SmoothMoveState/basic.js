...
var $author$project$ElmUI$SmoothMoveState$Basic$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveState$Basic$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveState$Basic$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$ElmUI$SmoothMoveState$Basic$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveState$Basic$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$ElmUI$SmoothMoveState$Basic$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$SmoothMoveState$Basic$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveState$Basic$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$SmoothMoveState$Basic$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveState$Basic$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveState$Basic$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveState$Basic$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveState$Basic$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveState Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveState$Basic$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveState$Basic$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveState$Basic$init, subscriptions: $author$project$ElmUI$SmoothMoveState$Basic$subscriptions, update: $author$project$ElmUI$SmoothMoveState$Basic$update, view: $author$project$ElmUI$SmoothMoveState$Basic$view});
_Platform_export({'ElmUI':{'SmoothMoveState':{'Basic':{'init':$author$project$ElmUI$SmoothMoveState$Basic$main(
