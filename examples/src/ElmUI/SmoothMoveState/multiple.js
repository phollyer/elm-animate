...
var $author$project$ElmUI$SmoothMoveState$Multiple$init = function (_v0) {
	var initialState = A4(
...
var $author$project$ElmUI$SmoothMoveState$Multiple$AnimationFrame = function (a) {
...
var $author$project$ElmUI$SmoothMoveState$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveState$subscriptions, model.animationState, $author$project$ElmUI$SmoothMoveState$Multiple$AnimationFrame);
};
...
var $author$project$ElmUI$SmoothMoveState$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$ElmUI$SmoothMoveState$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveState$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveState$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveState$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveState$Multiple$ScatterElements, 'Scatter'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveState$Multiple$CircleFormation, 'Circle Formation'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveState$Multiple$ResetPositions, 'Reset')
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveState$Multiple$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveState Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveState$Multiple$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveState$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveState$Multiple$init, subscriptions: $author$project$ElmUI$SmoothMoveState$Multiple$subscriptions, update: $author$project$ElmUI$SmoothMoveState$Multiple$update, view: $author$project$ElmUI$SmoothMoveState$Multiple$view});
_Platform_export({'ElmUI':{'SmoothMoveState':{'Multiple':{'init':$author$project$ElmUI$SmoothMoveState$Multiple$main(
