...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToCard':
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$NoOp,
						_Utils_update(
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$ScrollToCard = function (a) {
	return {$: 'ScrollToCard', a: a};
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$ScrollToStart = {$: 'ScrollToStart'};
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$viewCard = function (cardNum) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
							...
							[
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just(
										$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$ScrollToCard(cardNum - 1))
								}) : A2(
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('')),
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$column,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$Font$semiBold]),
									$mdgriffith$elm_ui$Element$text('horizontal container scrolling')),
									$mdgriffith$elm_ui$Element$text(' using '),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$Font$semiBold]),
									$mdgriffith$elm_ui$Element$text('{ axis = X, container = containerElement \"scroll-container\" }')),
									$mdgriffith$elm_ui$Element$text('. The scrolling is constrained to a specific container element rather than the entire document.')
								])),
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_Nil,
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$text('Each card scrolls smoothly into view within the horizontal container.')
								]))
						]))
				])),
			A2(
					...
					A2(
						...
						function (i) {
							return _Utils_Tuple3(
								...
								$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$ScrollToCard(i),
								'Card ' + $elm$core$String$fromInt(i));
						},
						A2($elm$core$List$range, 1, 8))),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$ScrollToStart, '← Back to Start')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$viewCard,
					A2($elm$core$List$range, 1, 10))))
		]);
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$update, view: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveScroll':{'HorizontalContainer':{'Main':{'init':$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$Main$main(
