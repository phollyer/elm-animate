...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToCard':
				...
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$NoOp,
						_Utils_update(
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$ScrollToCard = function (a) {
	return {$: 'ScrollToCard', a: a};
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$ScrollToStart = {$: 'ScrollToStart'};
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$viewCard = function (cardNum) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
							...
							[
									...
									]),
								{
									...
									onPress: $elm$core$Maybe$Just(
										$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$ScrollToCard(cardNum - 1))
								}) : A2(
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('')),
...
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$viewContent = function (model) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$column,
					...
					A2(
						...
						function (i) {
							return _Utils_Tuple3(
								...
								$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$ScrollToCard(i),
								'Card ' + $elm$core$String$fromInt(i));
						},
						A2($elm$core$List$range, 1, 8))),
					A3($author$project$Common$UI$actionButton, $author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$ScrollToStart, '← Back to Start')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$viewCard,
					A2($elm$core$List$range, 1, 10))))
		]);
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$init, subscriptions: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$subscriptions, update: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$update, view: $author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$view});
_Platform_export({'ElmUI':{'SmoothMoveScroll':{'HorizontalContainer':{'init':$author$project$ElmUI$SmoothMoveScroll$HorizontalContainer$main(
