...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$SmoothMoveScroll$Both = {$: 'Both'};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToTopLeft':
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$NoOp,
						_Utils_update(
							$author$project$SmoothMoveScroll$defaultConfig,
							{axis: $author$project$SmoothMoveScroll$Both, offsetX: 20, offsetY: 20, speed: 25}),
						'top-left'));
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToBottomLeft = {$: 'ScrollToBottomLeft'};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToBottomRight = {$: 'ScrollToBottomRight'};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToCenter = {$: 'ScrollToCenter'};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToTopLeft = {$: 'ScrollToTopLeft'};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToTopRight = {$: 'ScrollToTopRight'};
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewCorner = F4(
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewSimpleGrid = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A4(
					$author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewCorner,
					'top-left',
					'↖ TOP LEFT',
...
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewContent = function (model) {
	return _List_fromArray(
		[
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Common$UI$highlight('diagonal scrolling'),
							$mdgriffith$elm_ui$Element$text(' using '),
							$author$project$Common$UI$highlight('{ axis = Both }'),
							$mdgriffith$elm_ui$Element$text('. Click any corner or center button to see smooth diagonal movement that combines X and Y axis scrolling.')
						])),
					$author$project$Common$UI$techParagraph(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for layouts with both horizontal and vertical navigation, creating natural diagonal paths between any two points on the page.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToTopLeft, '↖ Top Left'),
							_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToTopRight, '↗ Top Right'),
							_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToCenter, '🎯 Center'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToBottomLeft, '↙ Bottom Left'),
							_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$ScrollToBottomRight, '↘ Bottom Right')
						]))
				])),
			$author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewSimpleGrid
		]);
};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$view = function (model) {
	return A3(
		...
		$author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$update, view: $author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveScroll':{'DiagonalBoth':{'Main':{'init':$author$project$ElmUI$SmoothMoveScroll$DiagonalBoth$Main$main(
