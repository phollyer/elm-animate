...
var $author$project$ElmUI$SmoothMoveScroll$Container$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveScroll$Container$NoOp = {$: 'NoOp'};
...
var $author$project$ElmUI$SmoothMoveScroll$Container$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
			...
			case 'ScrollToTop':
				return _Utils_Tuple2(
					...
					A3(
						...
						$author$project$ElmUI$SmoothMoveScroll$Container$NoOp,
						A2(
...
var $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToBottom = {$: 'ScrollToBottom'};
var $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToMiddle = {$: 'ScrollToMiddle'};
var $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToTop = {$: 'ScrollToTop'};
...
var $author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint = function (text_) {
	return A2(
...
var $author$project$ElmUI$SmoothMoveScroll$Container$contentBlock = F2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('Each block adds to the scrollable height'),
								$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('The gradient background shows scroll position'),
								$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('Smooth scrolling animates between positions')
							]))
					])));
	});
...
var $author$project$ElmUI$SmoothMoveScroll$Container$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToTop, 'Scroll to Top'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToMiddle, 'Scroll to Middle'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveScroll$Container$ScrollToBottom, 'Scroll to Bottom')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 1, 'This is content block 1. Each block adds to the scrollable height and demonstrates ElmUI styling.'),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 2, 'Content block 2 continues the gradient transition from white to dark with ElmUI elements.'),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 3, 'Content block 3 shows the middle section of our scrollable content using ElmUI layout.'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('This block serves as the middle anchor point'),
												$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('The gradient background shows scroll position'),
												$author$project$ElmUI$SmoothMoveScroll$Container$bulletPoint('Smooth scrolling animates between positions')
											]))
									]))),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 5, 'Content block 5 continues toward the bottom of the container with ElmUI.'),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 6, 'Content block 6 shows we\'re getting closer to the bottom using ElmUI layout.'),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 7, 'Content block 7 is near the end with darker background colors in ElmUI.'),
							A2($author$project$ElmUI$SmoothMoveScroll$Container$contentBlock, 8, 'Content block 8 is almost at the bottom of the scrollable ElmUI content.'),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
...
var $author$project$ElmUI$SmoothMoveScroll$Container$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveScroll - Container Scrolling (ElmUI)',
		$author$project$Common$UI$Container,
		$author$project$ElmUI$SmoothMoveScroll$Container$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveScroll$Container$main = $elm$browser$Browser$document(
	{
		init: $author$project$ElmUI$SmoothMoveScroll$Container$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$ElmUI$SmoothMoveScroll$Container$update,
		view: $author$project$ElmUI$SmoothMoveScroll$Container$view
	});
_Platform_export({'ElmUI':{'SmoothMoveScroll':{'Container':{'init':$author$project$ElmUI$SmoothMoveScroll$Container$main(
