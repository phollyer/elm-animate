			...
			case 'Rotate45':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateRotation, 'box', 45, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Rotate90':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateRotation, 'box', 90, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'Rotate180':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateRotation, 'box', 180, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			case 'RotateLeft':
				return _Utils_Tuple2(
			...
			case 'ResetRotation':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateRotation, 'box', 0, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var deltaTime = msg.a;
