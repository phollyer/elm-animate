...
var $author$project$ElmUI$Sub$Rotation$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Sub$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Sub$Rotation$Main$AnimationMsg = function (a) {
...
var $author$project$ElmUI$Sub$Rotation$Main$subscriptions = function (model) {
	return A2(
		$elm$core$Platform$Sub$map,
		$author$project$ElmUI$Sub$Rotation$Main$AnimationMsg,
...
var $author$project$ElmUI$Sub$Rotation$Main$anim = function (animation) {
	return A2(
		$author$project$Anim$Properties$Rotate$for,
		'box',
		$author$project$Anim$Sub$builder(animation));
};
...
var $author$project$ElmUI$Sub$Rotation$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Rotate45':
				return _Utils_Tuple2(
								...
								$author$project$Anim$Properties$Rotate$build(
									A2(
										...
										A2(
											...
											45,
											$author$project$ElmUI$Sub$Rotation$Main$anim(model.animations)))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'Rotate90':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$Sub$Rotation$Main$ResetRotation = {$: 'ResetRotation'};
var $author$project$ElmUI$Sub$Rotation$Main$Rotate180 = {$: 'Rotate180'};
var $author$project$ElmUI$Sub$Rotation$Main$Rotate45 = {$: 'Rotate45'};
var $author$project$ElmUI$Sub$Rotation$Main$Rotate90 = {$: 'Rotate90'};
var $author$project$ElmUI$Sub$Rotation$Main$RotateLeft = {$: 'RotateLeft'};
...
var $author$project$ElmUI$Sub$Rotation$Main$rotatingElement = F5(
...
var $author$project$ElmUI$Sub$Rotation$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('ElmUI & Subscription Rotation Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Smooth rotation transformations using hardware-accelerated Subscription-Based transforms')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Rotation$Main$Rotate45, '45°'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Rotation$Main$Rotate90, '90°'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Sub$Rotation$Main$Rotate180, '180°'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Rotation$Main$RotateLeft, '← 90°'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Sub$Rotation$Main$ResetRotation, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A5($author$project$ElmUI$Sub$Rotation$Main$rotatingElement, 'box', '→', 'Rotation Demo', $author$project$Common$Colors$primary, model)))
		]);
};
var $author$project$ElmUI$Sub$Rotation$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Sub Rotation ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Rotation$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Rotation$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Rotation$Main$init, subscriptions: $author$project$ElmUI$Sub$Rotation$Main$subscriptions, update: $author$project$ElmUI$Sub$Rotation$Main$update, view: $author$project$ElmUI$Sub$Rotation$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Rotation':{'Main':{'init':$author$project$ElmUI$Sub$Rotation$Main$main(
