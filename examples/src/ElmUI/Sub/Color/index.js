...
var $author$project$ElmUI$Sub$Color$Main$AnimationFrame = function (a) {
...
var $author$project$ElmUI$Sub$Color$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Sub$subscriptions, $author$project$ElmUI$Sub$Color$Main$AnimationFrame, model.animations);
};
					...
					_Utils_update(
						model,
						{
							animations: function (animation) {
								return A2($author$project$Anim$Sub$animate, animation, model.animations);
							}(
								$author$project$Anim$easeInOut(
									A2(
...
var $author$project$ElmUI$Sub$Color$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Common$UI$pageHeader('Subscription-Based Color Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_Utils_ap(
					...
					A2(
						...
						A2($author$project$Anim$Sub$styleProperties, 'box', model.animations))),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
