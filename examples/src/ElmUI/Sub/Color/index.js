...
var $author$project$Anim$Internal$Builders$Color$build = function (_v0) {
	var config = _v0.a;
	var builder = _v0.b;
	var newColorConfig = $author$project$Anim$Internal$Builder$BackgroundColorConfig(config);
...
var $author$project$ElmUI$Sub$Color$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ChangeToBlue':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$Sub$Color$Main$ChangeToBlue = {$: 'ChangeToBlue'};
var $author$project$ElmUI$Sub$Color$Main$ChangeToGreen = {$: 'ChangeToGreen'};
var $author$project$ElmUI$Sub$Color$Main$ChangeToOrange = {$: 'ChangeToOrange'};
var $author$project$ElmUI$Sub$Color$Main$ChangeToPurple = {$: 'ChangeToPurple'};
var $author$project$ElmUI$Sub$Color$Main$ChangeToRed = {$: 'ChangeToRed'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$Sub$Color$Main$ResetColor = {$: 'ResetColor'};
...
var $author$project$ElmUI$Sub$Color$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('ElmUI & Subscription Color Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Smooth color transitions using browser-native Subscription-Based animations')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Sub$Color$Main$ChangeToBlue, 'Blue'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Color$Main$ChangeToGreen, 'Green'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Color$Main$ChangeToOrange, 'Orange'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Color$Main$ChangeToRed, 'Red'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Sub$Color$Main$ChangeToPurple, 'Purple'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Sub$Color$Main$ResetColor, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'background-color', '#95a5a6'))
						]),
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
...
var $author$project$ElmUI$Sub$Color$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Sub Color ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Color$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Color$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Color$Main$init, subscriptions: $author$project$ElmUI$Sub$Color$Main$subscriptions, update: $author$project$ElmUI$Sub$Color$Main$update, view: $author$project$ElmUI$Sub$Color$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Color':{'Main':{'init':$author$project$ElmUI$Sub$Color$Main$main(
