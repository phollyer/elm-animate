...
var $author$project$ElmUI$Sub$Opacity$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Sub$init, isVisible: true},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Sub$Opacity$Main$AnimationMsg = function (a) {
...
var $author$project$ElmUI$Sub$Opacity$Main$subscriptions = function (model) {
	return A2(
		$elm$core$Platform$Sub$map,
		$author$project$ElmUI$Sub$Opacity$Main$AnimationMsg,
...
var $author$project$ElmUI$Sub$Opacity$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FadeIn':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$Sub$Opacity$Main$FadeIn = {$: 'FadeIn'};
var $author$project$ElmUI$Sub$Opacity$Main$FadeOut = {$: 'FadeOut'};
var $author$project$ElmUI$Sub$Opacity$Main$FadeToggle = {$: 'FadeToggle'};
...
var $author$project$ElmUI$Sub$Opacity$Main$animatedBox = F4(
...
var $author$project$ElmUI$Sub$Opacity$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('ElmUI & Subscription Opacity Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Opacity$Main$FadeIn, 'Fade In'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Opacity$Main$FadeOut, 'Fade Out'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Sub$Opacity$Main$FadeToggle, 'Toggle Visibility')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A4($author$project$ElmUI$Sub$Opacity$Main$animatedBox, 'box', 'Opacity Demo', $author$project$Common$Colors$primary, model)))
		]);
};
var $author$project$ElmUI$Sub$Opacity$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Sub Opacity ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Opacity$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Opacity$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Opacity$Main$init, subscriptions: $author$project$ElmUI$Sub$Opacity$Main$subscriptions, update: $author$project$ElmUI$Sub$Opacity$Main$update, view: $author$project$ElmUI$Sub$Opacity$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Opacity':{'Main':{'init':$author$project$ElmUI$Sub$Opacity$Main$main(
