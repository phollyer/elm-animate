...
var $author$project$ElmUI$Sub$Opacity$Main$AnimationFrame = function (a) {
...
var $author$project$ElmUI$Sub$Opacity$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Sub$subscriptions, $author$project$ElmUI$Sub$Opacity$Main$AnimationFrame, model.animations);
};
...
var $author$project$ElmUI$Sub$Opacity$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Common$UI$pageHeader('Subscription-Based Opacity Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
