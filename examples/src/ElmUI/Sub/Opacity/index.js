			...
			case 'FadeIn':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateOpacity, 'box', 1.0, model.animations),
							isVisible: true
						}),
					$elm$core$Platform$Cmd$none);
			case 'FadeOut':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateOpacity, 'box', 0.0, model.animations),
							isVisible: false
						}),
					$elm$core$Platform$Cmd$none);
			case 'FadeToggle':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A3($author$project$Anim$Sub$animateOpacity, 'box', newOpacity, model.animations),
