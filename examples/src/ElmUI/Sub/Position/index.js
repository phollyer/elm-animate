...
var $author$project$Anim$Internal$Sub$PositionAnimationValue = function (a) {
	return {$: 'PositionAnimationValue', a: a};
};
var $author$project$Anim$Internal$Sub$RotateAnimationValue = function (a) {
	return {$: 'RotateAnimationValue', a: a};
};
var $author$project$Anim$Internal$Sub$ScaleAnimationValue = function (a) {
	return {$: 'ScaleAnimationValue', a: a};
};
...
var $author$project$Anim$Internal$Sub$createPropertyAnimationState = F2(
	function (startValues, property) {
		switch (property.$) {
			case 'ProcessedPositionConfig':
				var config = property.a;
				var startPosition = $author$project$Anim$Internal$Properties$Position$fromTuple(
					_Utils_Tuple2(startValues.position.x, startValues.position.y));
				...
				return $elm$core$Maybe$Just(
					{
						currentValue: $author$project$Anim$Internal$Sub$PositionAnimationValue(actualStart),
						delay: config.delay,
						...
						speed: config.speed,
						startValue: $author$project$Anim$Internal$Sub$PositionAnimationValue(actualStart),
						targetValue: $author$project$Anim$Internal$Sub$PositionAnimationValue(config.endAt)
					});
			case 'ProcessedRotateConfig':
				var config = property.a;
				var startRotate = $author$project$Anim$Internal$Properties$Rotate$fromFloat(startValues.rotate);
				var actualStart = function () {
				...
				return $elm$core$Maybe$Just(
					{
						currentValue: $author$project$Anim$Internal$Sub$RotateAnimationValue(actualStart),
						delay: config.delay,
						distance: config.distance,
						duration: config.duration,
						easing: config.easing,
						...
						propertyType: 'rotate',
						speed: config.speed,
						startValue: $author$project$Anim$Internal$Sub$RotateAnimationValue(actualStart),
						targetValue: $author$project$Anim$Internal$Sub$RotateAnimationValue(config.endAt)
					});
			case 'ProcessedScaleConfig':
				var config = property.a;
				var startScale = $author$project$Anim$Internal$Properties$Scale$fromTuple(
					_Utils_Tuple2(startValues.scale.x, startValues.scale.y));
				var actualStart = function () {
				...
				return $elm$core$Maybe$Just(
					{
						currentValue: $author$project$Anim$Internal$Sub$ScaleAnimationValue(actualStart),
						delay: config.delay,
						distance: config.distance,
						duration: config.duration,
						easing: config.easing,
						...
						propertyType: 'scale',
						speed: config.speed,
						startValue: $author$project$Anim$Internal$Sub$ScaleAnimationValue(actualStart),
						targetValue: $author$project$Anim$Internal$Sub$ScaleAnimationValue(config.endAt)
					});
			case 'ProcessedColorConfig':
				var config = property.a;
				var startColor = startValues.color;
				var actualStart = function () {
				...
				return $elm$core$Maybe$Just(
					{
						currentValue: $author$project$Anim$Internal$Sub$ColorAnimationValue(actualStart),
						delay: config.delay,
						distance: config.distance,
						duration: config.duration,
						easing: config.easing,
						...
						propertyType: 'color',
						speed: config.speed,
						startValue: $author$project$Anim$Internal$Sub$ColorAnimationValue(actualStart),
						targetValue: $author$project$Anim$Internal$Sub$ColorAnimationValue(config.endAt)
					});
			default:
				var config = property.a;
				var startOpacity = $author$project$Anim$Internal$Properties$Opacity$fromFloat(startValues.opacity);
				var actualStart = function () {
				...
				return $elm$core$Maybe$Just(
					{
						currentValue: $author$project$Anim$Internal$Sub$OpacityAnimationValue(actualStart),
						delay: config.delay,
						distance: config.distance,
						duration: config.duration,
						easing: config.easing,
						...
						speed: config.speed,
						startValue: $author$project$Anim$Internal$Sub$OpacityAnimationValue(actualStart),
						targetValue: $author$project$Anim$Internal$Sub$OpacityAnimationValue(config.endAt)
					});
		}
	});
...
var $author$project$Anim$Internal$Sub$createElementAnimationState = F3(
	function (startValues, _v0, elementConfig) {
		return {
			isComplete: false,
			properties: A2(
				$elm$core$List$filterMap,
				$author$project$Anim$Internal$Sub$createPropertyAnimationState(startValues),
...
var $author$project$Anim$Internal$Builder$ProcessedColorConfig = function (a) {
	return {$: 'ProcessedColorConfig', a: a};
};
...
var $author$project$Anim$Internal$Builder$resolveDelayWithDefault = F3(
...
var $author$project$Anim$Internal$Builder$resolveEasingWithDefault = F3(
	function (local, global, _default) {
		if (local.$ === 'Just') {
			var easing_ = local.a;
			return easing_;
...
var $author$project$Anim$Internal$Builder$resolveTimingWithDefault = F3(
	function (local, global, _default) {
		if (local.$ === 'Just') {
			var timing = local.a;
			return timing;
	...
	function (globalData, property) {
		switch (property.$) {
			case 'PositionConfig':
				...
				if (config.isDirty) {
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedPositionConfig(
							{
								delay: 0,
								distance: 0,
								duration: 0,
					...
					var distance = A2($author$project$Anim$Internal$Properties$Position$distance, startAt, config.endAt);
					var duration_ = A2(
						$elm$core$Maybe$withDefault,
						0.0,
						A2(
							$elm$core$Maybe$map,
							$author$project$Anim$Internal$Properties$Position$duration(distance),
							config.timing));
					var speed_ = A2(
						$elm$core$Maybe$withDefault,
						0.0,
						A2(
							$elm$core$Maybe$map,
							A2($author$project$Anim$Internal$Properties$Position$speed, distance, duration_),
							config.timing));
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedPositionConfig(
							{
			...
			case 'RotateConfig':
				...
				if (config.isDirty) {
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedRotateConfig(
							{
								delay: 0,
								distance: 0,
								duration: 0,
					...
					var startAt = function () {
						...
						if (_v2.$ === 'Just') {
							...
							return $author$project$Anim$Internal$Properties$Rotate$fromFloat(0.0);
						}
					}();
					var distance = A2($author$project$Anim$Internal$Properties$Rotate$distance, startAt, config.endAt);
					var duration_ = A2(
						$elm$core$Maybe$withDefault,
						0.0,
						A2(
							$elm$core$Maybe$map,
							$author$project$Anim$Internal$Properties$Rotate$duration(distance),
							config.timing));
					var speed_ = A2(
						$elm$core$Maybe$withDefault,
						0.0,
						A2(
							$elm$core$Maybe$map,
							A2($author$project$Anim$Internal$Properties$Rotate$speed, distance, duration_),
							config.timing));
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedRotateConfig(
							{
			...
			case 'ScaleConfig':
				...
				if (config.isDirty) {
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedScaleConfig(
							{
								delay: 0,
								distance: 0,
								duration: 0,
					...
					var distance = A2($author$project$Anim$Internal$Properties$Scale$distance, startAt, config.endAt);
					var speed_ = (duration_ > 0) ? (distance / (duration_ / 1000.0)) : 0.0;
					return $elm$core$Maybe$Just(
						$author$project$Anim$Internal$Builder$ProcessedScaleConfig(
							{
								delay: A3($author$project$Anim$Internal$Builder$resolveDelayWithDefault, config.delay, globalData.globalDelay, 0),
...
var $author$project$Anim$Internal$Builder$processElement = F3(
	function (globalData, _v0, elementConfig) {
		return {
			properties: A2(
				$elm$core$List$filterMap,
...
var $author$project$Anim$Internal$Builder$processAnimationData = function (_v0) {
	...
	var processedElements = A2(
		$elm$core$Dict$map,
		$author$project$Anim$Internal$Builder$processElement(data),
		data.elements);
...
var $author$project$Anim$Internal$Sub$extractCurrentValuesFromBuilder = function (animBuilder) {
	var processedData = $author$project$Anim$Internal$Builder$processAnimationData(animBuilder);
	var extractFromElements = A3(
		$elm$core$List$foldl,
		$author$project$Anim$Internal$Sub$extractFromProperty,
...
var $author$project$Anim$Internal$Sub$animate = function (animBuilder) {
	...
	var elementStates = A2(
		$elm$core$Dict$map,
		$author$project$Anim$Internal$Sub$createElementAnimationState(startValues),
...
var $author$project$Anim$Sub$animate = $author$project$Anim$Internal$Sub$animate;
...
var $author$project$ElmUI$Sub$Position$Main$init = function (_v0) {
...
var $author$project$ElmUI$Sub$Position$Main$AnimationMsg = function (a) {
...
var $author$project$ElmUI$Sub$Position$Main$subscriptions = function (model) {
	return A2(
...
var $author$project$Anim$Internal$Sub$interpolateValue = F3(
	function (progress, startValue, targetValue) {
		var _v0 = _Utils_Tuple2(startValue, targetValue);
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 'PositionAnimationValue':
					if (_v0.b.$ === 'PositionAnimationValue') {
						var start = _v0.a.a;
						var target = _v0.b.a;
						var targetTuple = $author$project$Anim$Internal$Properties$Position$toTuple(target);
						var startTuple = $author$project$Anim$Internal$Properties$Position$toTuple(start);
						var _v1 = targetTuple;
						var targetX = _v1.a;
						var targetY = _v1.b;
						var _v2 = startTuple;
						...
						var newY = startY + (progress * (targetY - startY));
				...
				case 'RotateAnimationValue':
					if (_v0.b.$ === 'RotateAnimationValue') {
						var start = _v0.a.a;
						var target = _v0.b.a;
						...
						var newFloat = startFloat + (progress * (targetFloat - startFloat));
						return $author$project$Anim$Internal$Sub$RotateAnimationValue(
							$author$project$Anim$Internal$Properties$Rotate$fromFloat(newFloat));
					} else {
						break _v0$5;
					}
				case 'ScaleAnimationValue':
					if (_v0.b.$ === 'ScaleAnimationValue') {
						var start = _v0.a.a;
						var target = _v0.b.a;
						var targetTuple = $author$project$Anim$Internal$Properties$Scale$toTuple(target);
						var startTuple = $author$project$Anim$Internal$Properties$Scale$toTuple(start);
						var _v3 = targetTuple;
						var targetX = _v3.a;
						var targetY = _v3.b;
						var _v4 = startTuple;
						...
						var newX = startX + (progress * (targetX - startX));
						var newY = startY + (progress * (targetY - startY));
						return $author$project$Anim$Internal$Sub$ScaleAnimationValue(
							$author$project$Anim$Internal$Properties$Scale$fromTuple(
								_Utils_Tuple2(newX, newY)));
					} else {
						break _v0$5;
					}
				case 'ColorAnimationValue':
					if (_v0.b.$ === 'ColorAnimationValue') {
						var target = _v0.b.a;
						return $author$project$Anim$Internal$Sub$ColorAnimationValue(target);
					} else {
						break _v0$5;
					}
				default:
					if (_v0.b.$ === 'OpacityAnimationValue') {
						var start = _v0.a.a;
						var target = _v0.b.a;
						...
						var newFloat = startFloat + (progress * (targetFloat - startFloat));
						return $author$project$Anim$Internal$Sub$OpacityAnimationValue(
							$author$project$Anim$Internal$Properties$Opacity$fromFloat(newFloat));
					} else {
						break _v0$5;
					}
			}
...
var $author$project$Anim$Internal$Sub$updatePropertyAnimation = F2(
	function (deltaMs, propertyState) {
		if (propertyState.isComplete) {
			...
			var newElapsed = propertyState.elapsed + deltaMs;
			var delay = propertyState.delay;
			if (_Utils_cmp(newElapsed, delay) < 0) {
				return _Utils_update(
					propertyState,
					{elapsed: newElapsed});
			} else {
				var animationElapsed = newElapsed - delay;
				var progress = A2($elm$core$Basics$min, 1.0, animationElapsed / propertyState.duration);
				var easedProgress = A2($author$project$Anim$Internal$Timing$Easing$toFunction, propertyState.easing, progress);
				var newCurrentValue = A3($author$project$Anim$Internal$Sub$interpolateValue, easedProgress, propertyState.startValue, propertyState.targetValue);
				var isComplete = progress >= 1.0;
				return _Utils_update(
					propertyState,
					{currentValue: newCurrentValue, elapsed: newElapsed, isComplete: isComplete});
			}
		}
	});
										...
										A2(
											...
											A3(
												...
												A2(
													...
													'box',
													$author$project$Anim$Sub$builder(model.animations)))))))
						}),
					$elm$core$Platform$Cmd$none);
			case 'MoveToCenter':
				return _Utils_Tuple2(
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A2($author$project$Anim$Sub$update, subMsg, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$ElmUI$Sub$Position$Main$MoveDown = {$: 'MoveDown'};
var $author$project$ElmUI$Sub$Position$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$ElmUI$Sub$Position$Main$MoveRight = {$: 'MoveRight'};
var $author$project$ElmUI$Sub$Position$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$Sub$Position$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$ElmUI$Sub$Position$Main$MoveUp = {$: 'MoveUp'};
...
var $author$project$Common$UI$backButton = $author$project$Common$UI$backButtonWithPath('../../index.html');
...
var $author$project$Anim$Internal$Sub$getPosition = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		return A2(
...
var $author$project$Anim$Sub$getPosition = $author$project$Anim$Internal$Sub$getPosition;
...
var $author$project$Anim$Internal$Sub$propertyToStyles = function (propertyState) {
	var _v0 = propertyState.currentValue;
	switch (_v0.$) {
		case 'PositionAnimationValue':
			var pos = _v0.a;
			var _v1 = $author$project$Anim$Internal$Properties$Position$toTuple(pos);
			var x = _v1.a;
			var y = _v1.b;
			return _List_fromArray(
				[
		...
		case 'RotateAnimationValue':
			var rotate = _v0.a;
			var degrees = $author$project$Anim$Internal$Properties$Rotate$toFloat(rotate);
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'transform',
					'rotate(' + ($elm$core$String$fromFloat(degrees) + 'deg)'))
				]);
		case 'ScaleAnimationValue':
			var scale = _v0.a;
			var _v2 = $author$project$Anim$Internal$Properties$Scale$toTuple(scale);
			var x = _v2.a;
			var y = _v2.b;
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'transform',
					'scale(' + ($elm$core$String$fromFloat(x) + (', ' + ($elm$core$String$fromFloat(y) + ')'))))
				]);
		case 'ColorAnimationValue':
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'background-color',
					$author$project$Anim$Internal$Properties$Color$toString(colorValue))
				]);
		default:
			var opacity = _v0.a;
			var opacityValue = $author$project$Anim$Internal$Properties$Opacity$toFloat(opacity);
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'opacity',
					$elm$core$String$fromFloat(opacityValue))
				]);
	}
};
var $author$project$Anim$Internal$Sub$getElementStyles = F2(
	function (elementId, _v0) {
		var state = _v0.a;
		return A2(
			$elm$core$Maybe$withDefault,
			...
			A2(
				$elm$core$Maybe$map,
				$elm$core$List$concatMap($author$project$Anim$Internal$Sub$propertyToStyles),
				A2(
					$elm$core$Maybe$map,
					function ($) {
						return $.properties;
...
var $author$project$Anim$Internal$Sub$htmlAttributes = F2(
	function (elementId, animationResult) {
		return A2(
			...
			A2($author$project$Anim$Internal$Sub$getElementStyles, elementId, animationResult));
	});
var $author$project$Anim$Sub$htmlAttributes = $author$project$Anim$Internal$Sub$htmlAttributes;
...
var $author$project$ElmUI$Sub$Position$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			$author$project$Common$UI$pageHeader('ElmUI & Subscription Position Example'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Sub$Position$Main$MoveRight, 'Move Right →'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Position$Main$MoveUp, '↑ Move Up'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Position$Main$MoveDown, 'Move Down ↓')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				_Utils_ap(
					...
					A2(
						$elm$core$List$map,
						$mdgriffith$elm_ui$Element$htmlAttribute,
						A2($author$project$Anim$Sub$htmlAttributes, 'box', model.animations))),
				$mdgriffith$elm_ui$Element$text('')))
		]);
};
var $author$project$ElmUI$Sub$Position$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Sub Position ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Position$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Position$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Position$Main$init, subscriptions: $author$project$ElmUI$Sub$Position$Main$subscriptions, update: $author$project$ElmUI$Sub$Position$Main$update, view: $author$project$ElmUI$Sub$Position$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Position':{'Main':{'init':$author$project$ElmUI$Sub$Position$Main$main(
