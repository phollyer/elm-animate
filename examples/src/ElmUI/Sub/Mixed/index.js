...
var $author$project$ElmUI$Sub$Mixed$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Sub$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Sub$Mixed$Main$AnimationFrame = function (a) {
...
var $author$project$ElmUI$Sub$Mixed$Main$subscriptions = function (model) {
	return A2($author$project$Anim$Sub$subscriptions, $author$project$ElmUI$Sub$Mixed$Main$AnimationFrame, model.animations);
};
...
var $author$project$Anim$Sub$calculateRgbColorDistance = F2(
	function (start, target) {
		var dr = target.r - start.r;
		var dg = target.g - start.g;
		var db = target.b - start.b;
		var distance = $elm$core$Basics$sqrt(((dr * dr) + (dg * dg)) + (db * db));
		return distance / 4.41;
	});
var $author$project$Anim$Sub$hexCharToInt = function (_char) {
...
var $author$project$Anim$Sub$hexStringToInt = function (hexStr) {
	var _v0 = $elm$core$String$toList(hexStr);
	if ((_v0.b && _v0.b.b) && (!_v0.b.b.b)) {
		var h1 = _v0.a;
		var _v1 = _v0.b;
		var h2 = _v1.a;
		return ($author$project$Anim$Sub$hexCharToInt(h1) * 16) + $author$project$Anim$Sub$hexCharToInt(h2);
	} else {
		return 0;
	}
};
...
var $author$project$Anim$Sub$hexToRgb = function (hex) {
	var cleanHex = A3($elm$core$String$replace, '#', '', hex);
	var g = $author$project$Anim$Sub$hexStringToInt(
		A3($elm$core$String$slice, 2, 4, cleanHex));
	var r = $author$project$Anim$Sub$hexStringToInt(
		A3($elm$core$String$slice, 0, 2, cleanHex));
	var b = $author$project$Anim$Sub$hexStringToInt(
		A3($elm$core$String$slice, 4, 6, cleanHex));
	return {b: b, g: g, r: r};
};
var $author$project$Anim$Sub$calculateHexColorDistance = F2(
	function (startHex, targetHex) {
		var targetRgb = $author$project$Anim$Sub$hexToRgb(targetHex);
		var startRgb = $author$project$Anim$Sub$hexToRgb(startHex);
		return A2($author$project$Anim$Sub$calculateRgbColorDistance, startRgb, targetRgb);
	});
var $author$project$Anim$Sub$calculateRgbaColorDistance = F2(
	function (start, target) {
		var rgbDistance = A2(
			$author$project$Anim$Sub$calculateRgbColorDistance,
			{b: start.b, g: start.g, r: start.r},
			{b: target.b, g: target.g, r: target.r});
		var alphaDistance = $elm$core$Basics$abs(target.a - start.a) * 100;
		return (rgbDistance + alphaDistance) / 2;
	});
var $author$project$Anim$Sub$calculateColorDistance = F2(
	function (startColor, targetColor) {
		var _v0 = _Utils_Tuple2(startColor, targetColor);
		_v0$5:
		while (true) {
			switch (_v0.a.$) {
				case 'Rgba':
					if (_v0.b.$ === 'Rgba') {
						...
						return A2($author$project$Anim$Sub$calculateRgbaColorDistance, startRgba, targetRgba);
					} else {
						break _v0$5;
					}
				case 'Hex':
					switch (_v0.b.$) {
						case 'Hex':
							...
							var targetHex = _v0.b.a;
							return A2($author$project$Anim$Sub$calculateHexColorDistance, startHex, targetHex);
						case 'Rgb':
							var startHex = _v0.a.a;
			...
			switch (_v0.a.$) {
				...
				case 'ToOpacity':
					if (_v0.b.$ === 'ToOpacity') {
						...
						return $elm$core$Basics$abs(targetOp - startOp);
					} else {
						break _v0$7;
					}
				case 'ToScale':
					if (_v0.b.$ === 'ToScale') {
						...
						return $elm$core$Basics$abs(targetScale.x - startScale.x) + $elm$core$Basics$abs(targetScale.y - startScale.y);
					} else {
						break _v0$7;
					}
				case 'ToRotation':
				...
				case 'ToBackgroundColor':
					if (_v0.b.$ === 'ToBackgroundColor') {
						...
						return A2($author$project$Anim$Sub$calculateColorDistance, startColor, targetColor);
					} else {
						break _v0$7;
					}
				default:
...
var $author$project$Anim$Sub$animate = F2(
	function (animation, _v0) {
		...
		var distance = A2($author$project$Anim$Sub$calculateTargetDistance, currentValue, target);
		var duration = A2($author$project$Anim$Internal$animationToMilliseconds, animation, distance);
		var animationState = {delayMs: delayMs, duration: duration, easing: easing, startValue: currentValue, startedAt: 0, target: target};
...
var $author$project$Anim$ColorStepsPerSecond = function (a) {
	return {$: 'ColorStepsPerSecond', a: a};
};
var $author$project$Anim$EaseOut = {$: 'EaseOut'};
var $author$project$Anim$EasePreset = function (a) {
	return {$: 'EasePreset', a: a};
};
var $author$project$Anim$colorStepsPerSecond = F2(
	function (speed, _v0) {
		var elementId = _v0.a;
		var value = _v0.b;
		return $author$project$Anim$Animation(
			{
				...
				timing: $author$project$Anim$ColorStepsPerSecond(speed)
			});
	});
var $author$project$Anim$DegreesPerSecond = function (a) {
	return {$: 'DegreesPerSecond', a: a};
};
var $author$project$Anim$degreesPerSecond = F2(
	function (speed, _v0) {
		var elementId = _v0.a;
		var value = _v0.b;
		return $author$project$Anim$Animation(
			{
				...
				timing: $author$project$Anim$DegreesPerSecond(speed)
			});
	});
...
var $author$project$Anim$OpacityPerSecond = function (a) {
	return {$: 'OpacityPerSecond', a: a};
};
var $author$project$Anim$opacityPerSecond = F2(
	function (speed, _v0) {
		var elementId = _v0.a;
		var value = _v0.b;
		return $author$project$Anim$Animation(
			{
				...
				timing: $author$project$Anim$OpacityPerSecond(speed)
			});
	});
...
var $author$project$Anim$ScalePerSecond = function (a) {
	return {$: 'ScalePerSecond', a: a};
};
var $author$project$Anim$scalePerSecond = F2(
	function (speed, _v0) {
		var elementId = _v0.a;
		var value = _v0.b;
		return $author$project$Anim$Animation(
			{
				...
				timing: $author$project$Anim$ScalePerSecond(speed)
			});
	});
	...
	function (delta, _v0) {
		...
		var updateElement = function (elementData) {
			...
			if (_v2.$ === 'Nothing') {
				...
				var easedProgress = A2($author$project$Anim$Internal$easingToEaseFunction, animState.easing, progress);
		...
		var updatedDict = A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, elementData) {
					return updateElement(elementData);
				}),
			elementsDict);
		return $author$project$Anim$Sub$Model(updatedDict);
	});
var $author$project$ElmUI$Sub$Mixed$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartComplexAnimation':
				var elementId = msg.a;
				var scaleAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$scalePerSecond,
						2.0,
						A2(
							$author$project$Anim$scale,
							elementId,
							{x: 1.5, y: 1.9})));
				var rotationAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$degreesPerSecond,
						120.0,
						A2($author$project$Anim$rotation, elementId, 90)));
				var positionAnimation = $author$project$Anim$easeOut(
					A2(
				...
				var animations = A2(
					...
					A2(
						$author$project$Anim$Sub$animate,
						scaleAnimation,
						A2($author$project$Anim$Sub$animate, positionAnimation, model.animations)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				var positionAnimation = $author$project$Anim$easeOut(
					A2(
						...
						A2(
							...
							elementId,
							{x: 250, y: 80})));
				var opacityAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$opacityPerSecond,
						2.0,
						A2($author$project$Anim$opacity, elementId, 0.3)));
				var animations = A2(
					$author$project$Anim$Sub$animate,
					positionAnimation,
					A2($author$project$Anim$Sub$animate, opacityAnimation, model.animations));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: animations}),
			...
			case 'StartSpinScale':
				var elementId = msg.a;
				var scaleAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$scalePerSecond,
						1.5,
						A2(
				...
				var rotationAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$degreesPerSecond,
						180.0,
						A2($author$project$Anim$rotation, elementId, 180)));
				var colorAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$colorStepsPerSecond,
						300.0,
						A2(
				...
				var animations = A2(
					...
					A2(
						$author$project$Anim$Sub$animate,
						scaleAnimation,
						A2($author$project$Anim$Sub$animate, rotationAnimation, model.animations)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: animations}),
			...
			case 'StartColorMorph':
				...
				var opacityAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$opacityPerSecond,
						1.5,
						A2($author$project$Anim$opacity, elementId, 0.8)));
				var colorAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$colorStepsPerSecond,
						300.0,
						A2(
				...
				var animations = A2(
					...
					A2(
						$author$project$Anim$Sub$animate,
						scaleAnimation,
						A2($author$project$Anim$Sub$animate, colorAnimation, model.animations)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: animations}),
			...
			case 'StartFullTransform':
				...
				var rotationAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$degreesPerSecond,
						180.0,
						A2($author$project$Anim$rotation, elementId, 270)));
				var positionAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$pixelsPerSecond,
						200.0,
						A2(
				...
				var opacityAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$opacityPerSecond,
						1.0,
						A2($author$project$Anim$opacity, elementId, 0.7)));
				var colorAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$colorStepsPerSecond,
						300.0,
			...
			case 'ResetAll':
				...
				var rotationAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$degreesPerSecond,
						180.0,
						A2($author$project$Anim$rotation, 'mixed-box', 0)));
				var positionAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$pixelsPerSecond,
						200.0,
						A2(
							...
							'mixed-box',
							{x: 0, y: 0})));
				var opacityAnimation = $author$project$Anim$easeInOut(
					A2(
						$author$project$Anim$opacityPerSecond,
						1.5,
						A2($author$project$Anim$opacity, 'mixed-box', 1.0)));
				var colorAnimation = $author$project$Anim$easeOut(
					A2(
						$author$project$Anim$colorStepsPerSecond,
						300.0,
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							animations: A2($author$project$Anim$Sub$step, deltaTime, model.animations)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$ElmUI$Sub$Mixed$Main$ResetAll = {$: 'ResetAll'};
var $author$project$ElmUI$Sub$Mixed$Main$StartColorMorph = function (a) {
	return {$: 'StartColorMorph', a: a};
};
var $author$project$ElmUI$Sub$Mixed$Main$StartComplexAnimation = function (a) {
	return {$: 'StartComplexAnimation', a: a};
};
var $author$project$ElmUI$Sub$Mixed$Main$StartFadeMove = function (a) {
	return {$: 'StartFadeMove', a: a};
};
var $author$project$ElmUI$Sub$Mixed$Main$StartFullTransform = function (a) {
	return {$: 'StartFullTransform', a: a};
};
var $author$project$ElmUI$Sub$Mixed$Main$StartSpinScale = function (a) {
...
var $author$project$Anim$Sub$colorValueToCss = function (color) {
	switch (color.$) {
		case 'Hex':
			var hex = color.a;
			return hex;
...
var $author$project$Anim$Sub$filterValueToCss = function (filter) {
	switch (filter.$) {
		case 'Blur':
			var blur = filter.a;
...
var $author$project$Anim$Sub$transformElement = function (position) {
	return 'translate(' + ($elm$core$String$fromFloat(position.x) + ('px, ' + ($elm$core$String$fromFloat(position.y) + 'px)')));
};
var $author$project$Anim$Sub$animationTargetToCssProperty = function (target) {
	switch (target.$) {
		case 'ToPosition':
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'transform',
					$author$project$Anim$Sub$transformElement(position))
				]);
		case 'ToOpacity':
		...
		case 'ToBackgroundColor':
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'background-color',
					$author$project$Anim$Sub$colorValueToCss(color))
				]);
		case 'ToTextColor':
			var color = target.a;
			return _List_fromArray(
		...
		default:
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(
					'filter',
					$author$project$Anim$Sub$filterValueToCss(filter))
				]);
	}
};
...
var $author$project$Anim$Sub$styleProperties = F2(
			...
			return A3(
				...
				F3(
					function (_v2, target, acc) {
						return _Utils_ap(
							$author$project$Anim$Sub$animationTargetToCssProperty(target),
							acc);
					}),
				_List_Nil,
...
var $author$project$ElmUI$Sub$Mixed$Main$mixedAnimationBox = function (model) {
	return A2(
		...
		_Utils_ap(
			...
			A2(
				...
				A2($author$project$Anim$Sub$styleProperties, 'mixed-box', model.animations))),
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
...
var $author$project$ElmUI$Sub$Mixed$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Subscription-Based Mixed Property Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Combining multiple Subscription-Based properties in single animations for complex transformations')),
			$author$project$Common$UI$wrappedButtonRow(
			_List_fromArray(
				[
					_Utils_Tuple3(
					$author$project$Common$UI$Primary,
					$author$project$ElmUI$Sub$Mixed$Main$StartComplexAnimation('mixed-box'),
					'Move + Scale + Rotate'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					$author$project$ElmUI$Sub$Mixed$Main$StartFadeMove('mixed-box'),
					'Fade + Move'),
					_Utils_Tuple3(
					$author$project$Common$UI$Warning,
					$author$project$ElmUI$Sub$Mixed$Main$StartSpinScale('mixed-box'),
					'Spin + Scale + Color'),
					_Utils_Tuple3(
					$author$project$Common$UI$Purple,
					$author$project$ElmUI$Sub$Mixed$Main$StartColorMorph('mixed-box'),
					'Color + Shape + Opacity'),
					_Utils_Tuple3(
					$author$project$Common$UI$Primary,
					$author$project$ElmUI$Sub$Mixed$Main$StartFullTransform('mixed-box'),
					'ALL Properties!'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Sub$Mixed$Main$ResetAll, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			$author$project$ElmUI$Sub$Mixed$Main$mixedAnimationBox(model))
		]);
};
var $author$project$ElmUI$Sub$Mixed$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Sub Mixed Properties ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Sub$Mixed$Main$viewContent(model));
};
var $author$project$ElmUI$Sub$Mixed$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Sub$Mixed$Main$init, subscriptions: $author$project$ElmUI$Sub$Mixed$Main$subscriptions, update: $author$project$ElmUI$Sub$Mixed$Main$update, view: $author$project$ElmUI$Sub$Mixed$Main$view});
_Platform_export({'ElmUI':{'Sub':{'Mixed':{'Main':{'init':$author$project$ElmUI$Sub$Mixed$Main$main(
