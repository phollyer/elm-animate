...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$subscriptions = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveCSS$Multiple$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveCSS$Multiple$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveCSS$Multiple$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveCSS Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveCSS$Multiple$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveCSS$Multiple$init, subscriptions: $author$project$ElmUI$SmoothMoveCSS$Multiple$subscriptions, update: $author$project$ElmUI$SmoothMoveCSS$Multiple$update, view: $author$project$ElmUI$SmoothMoveCSS$Multiple$view});
_Platform_export({'ElmUI':{'SmoothMoveCSS':{'Multiple':{'init':$author$project$ElmUI$SmoothMoveCSS$Multiple$main(
