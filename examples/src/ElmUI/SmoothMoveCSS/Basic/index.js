...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$init = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$subscriptions = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				return _Utils_Tuple2(
...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$viewContent = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 0, y: 0},
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMoveCSS module, which leverages '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('native CSS transitions')),
							$mdgriffith$elm_ui$Element$text(' for optimal performance. The browser handles all animation calculations using '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('hardware acceleration')),
							$mdgriffith$elm_ui$Element$text(', resulting in smooth, efficient animations with minimal JavaScript overhead.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for battery-efficient mobile animations and high-performance transitions where '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('native browser optimization')),
							$mdgriffith$elm_ui$Element$text(' provides the best user experience.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveCSS$Basic$Main$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveCSS$Basic$Main$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveCSS$Basic$Main$StopAnimation, 'Return to Origin')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveCSS Basic ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveCSS$Basic$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveCSS$Basic$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveCSS$Basic$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveCSS$Basic$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveCSS$Basic$Main$update, view: $author$project$ElmUI$SmoothMoveCSS$Basic$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveCSS':{'Basic':{'Main':{'init':$author$project$ElmUI$SmoothMoveCSS$Basic$Main$main(
