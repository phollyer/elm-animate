...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$init = function (_v0) {
	var initialAnimations = A4(
		$author$project$SmoothMoveCSS$setInitialPosition,
		'element-f',
		180,
		50,
		A4(
			...
			A4(
				...
				A4(
					...
					A4(
						...
						200,
						150,
						A4($author$project$SmoothMoveCSS$setInitialPosition, 'element-a', 150, 100, $author$project$SmoothMoveCSS$init))))));
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$subscriptions = function (_v0) {
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ScatterElements':
				var newAnimations = A4(
					$author$project$SmoothMoveCSS$animateTo,
					'element-f',
					350,
					320,
					A4(
						...
						A4(
							...
							A4(
								...
								A4(
									...
									80,
									280,
									A4($author$project$SmoothMoveCSS$animateTo, 'element-a', 320, 80, model.animations))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						...
						A4(
							...
							A4(
								...
								A4(
									...
									200,
									150,
									A4($author$project$SmoothMoveCSS$animateTo, 'element-a', 150, 100, model.animations))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations}),
						...
						A4(
							...
							A4(
								...
								A4(
									...
									centerX + (radius * 0.5),
									centerY + (radius * 0.866),
									A4($author$project$SmoothMoveCSS$animateTo, 'element-a', centerX + radius, centerY, model.animations))))));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{animations: newAnimations}),
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$ResetPositions = {$: 'ResetPositions'};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-f', model.animations));
	var positionE = A2(
		$elm$core$Maybe$withDefault,
		{x: 300, y: 100},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-e', model.animations));
	var positionD = A2(
		$elm$core$Maybe$withDefault,
		{x: 250, y: 200},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-d', model.animations));
	var positionC = A2(
		$elm$core$Maybe$withDefault,
		{x: 100, y: 200},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-c', model.animations));
	var positionB = A2(
		$elm$core$Maybe$withDefault,
		{x: 200, y: 150},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-b', model.animations));
	var positionA = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
		A2($author$project$SmoothMoveCSS$getPosition, 'element-a', model.animations));
	var cssStylesF = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-f', model.animations);
	var cssStylesE = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-e', model.animations);
	var cssStylesD = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-d', model.animations);
	var cssStylesC = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-c', model.animations);
	var cssStylesB = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-b', model.animations);
	var cssStylesA = A2($author$project$SmoothMoveCSS$cssTransitionStyle, 'element-a', model.animations);
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('This example demonstrates the SmoothMoveCSS module coordinating '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('multiple CSS transitions')),
							$mdgriffith$elm_ui$Element$text(' simultaneously. Each element uses native browser optimization with '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('hardware acceleration')),
							$mdgriffith$elm_ui$Element$text(', eliminating animation frame subscriptions while maintaining smooth formation control.')
						])),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Perfect for complex multi-element choreography where '),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$semiBold]),
							$mdgriffith$elm_ui$Element$text('battery efficiency')),
							$mdgriffith$elm_ui$Element$text(' and native performance are critical requirements.')
						]))
				])),
			A2(
			$mdgriffith$elm_ui$Element$column,
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionA.x) + ('px, ' + ($elm$core$String$fromFloat(positionA.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesA),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionB.x) + ('px, ' + ($elm$core$String$fromFloat(positionB.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesB),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionC.x) + ('px, ' + ($elm$core$String$fromFloat(positionC.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesC),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionD.x) + ('px, ' + ($elm$core$String$fromFloat(positionD.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesD),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionE.x) + ('px, ' + ($elm$core$String$fromFloat(positionE.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesE),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$style,
									'transform',
									'translate(' + ($elm$core$String$fromFloat(positionF.x) + ('px, ' + ($elm$core$String$fromFloat(positionF.y) + 'px)')))),
									A2($elm$html$Html$Attributes$style, 'transition', cssStylesF),
									A2($elm$html$Html$Attributes$style, 'display', 'flex'),
									A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
									A2($elm$html$Html$Attributes$style, 'justify-content', 'center'),
									A2($elm$html$Html$Attributes$style, 'color', 'white'),
...
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'SmoothMoveCSS Multiple ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$SmoothMoveCSS$Multiple$Main$viewContent(model));
};
var $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$init, subscriptions: $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$subscriptions, update: $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$update, view: $author$project$ElmUI$SmoothMoveCSS$Multiple$Main$view});
_Platform_export({'ElmUI':{'SmoothMoveCSS':{'Multiple':{'Main':{'init':$author$project$ElmUI$SmoothMoveCSS$Multiple$Main$main(
