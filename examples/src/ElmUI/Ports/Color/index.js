...
var $author$project$ElmUI$Ports$Color$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Ports$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Ports$Color$Main$AnimationComplete = function (a) {
	return {$: 'AnimationComplete', a: a};
};
var $author$project$ElmUI$Ports$Color$Main$PositionUpdateReceived = function (a) {
	return {$: 'PositionUpdateReceived', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ElmUI$Ports$Color$Main$animationComplete = _Platform_incomingPort('animationComplete', $elm$json$Json$Decode$string);
...
var $author$project$ElmUI$Ports$Color$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$Ports$Color$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$ElmUI$Ports$Color$Main$positionUpdates(
				A2($elm$core$Basics$composeL, $author$project$ElmUI$Ports$Color$Main$PositionUpdateReceived, $author$project$Anim$Ports$handlePropertyUpdateFromJson)),
				$author$project$ElmUI$Ports$Color$Main$animationComplete($author$project$ElmUI$Ports$Color$Main$AnimationComplete)
			]));
};
...
var $author$project$ElmUI$Ports$Color$Main$animateElement = _Platform_outgoingPort('animateElement', $elm$core$Basics$identity);
...
var $author$project$Anim$Ports$sendAnimationCommand = F2(
	function (portFunction, command) {
		return portFunction(
				...
				if (maybeCommand.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newModel}),
						A2($author$project$Anim$Ports$sendAnimationCommand, $author$project$ElmUI$Ports$Color$Main$animateElement, command));
				} else {
...
var $author$project$ElmUI$Ports$Color$Main$ChangeToBlue = {$: 'ChangeToBlue'};
var $author$project$ElmUI$Ports$Color$Main$ChangeToGreen = {$: 'ChangeToGreen'};
var $author$project$ElmUI$Ports$Color$Main$ChangeToOrange = {$: 'ChangeToOrange'};
var $author$project$ElmUI$Ports$Color$Main$ChangeToPurple = {$: 'ChangeToPurple'};
var $author$project$ElmUI$Ports$Color$Main$ChangeToRed = {$: 'ChangeToRed'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$Ports$Color$Main$ResetColor = {$: 'ResetColor'};
...
var $author$project$ElmUI$Ports$Color$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Ports Color Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Ports$Color$Main$ChangeToBlue, 'Blue'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Color$Main$ChangeToGreen, 'Green'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Color$Main$ChangeToOrange, 'Orange'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Color$Main$ChangeToRed, 'Red'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Ports$Color$Main$ChangeToPurple, 'Purple'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Ports$Color$Main$ResetColor, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				_Utils_ap(
					...
					A2(
						...
						A2($author$project$Anim$Ports$styleProperties, 'box', model.animations))),
				A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
...
var $author$project$ElmUI$Ports$Color$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Ports Color ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Ports$Color$Main$viewContent(model));
};
var $author$project$ElmUI$Ports$Color$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Ports$Color$Main$init, subscriptions: $author$project$ElmUI$Ports$Color$Main$subscriptions, update: $author$project$ElmUI$Ports$Color$Main$update, view: $author$project$ElmUI$Ports$Color$Main$view});
_Platform_export({'ElmUI':{'Ports':{'Color':{'Main':{'init':$author$project$ElmUI$Ports$Color$Main$main(
