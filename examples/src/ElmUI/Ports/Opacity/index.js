...
var $author$project$ElmUI$Ports$Opacity$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Ports$init, isVisible: true},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Ports$Opacity$Main$AnimationComplete = function (a) {
	return {$: 'AnimationComplete', a: a};
};
var $author$project$ElmUI$Ports$Opacity$Main$PositionUpdateReceived = function (a) {
	return {$: 'PositionUpdateReceived', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ElmUI$Ports$Opacity$Main$animationComplete = _Platform_incomingPort('animationComplete', $elm$json$Json$Decode$string);
...
var $author$project$ElmUI$Ports$Opacity$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$Ports$Opacity$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$ElmUI$Ports$Opacity$Main$positionUpdates(
				A2($elm$core$Basics$composeL, $author$project$ElmUI$Ports$Opacity$Main$PositionUpdateReceived, $author$project$Anim$Ports$handlePropertyUpdateFromJson)),
				$author$project$ElmUI$Ports$Opacity$Main$animationComplete($author$project$ElmUI$Ports$Opacity$Main$AnimationComplete)
			]));
};
...
var $author$project$ElmUI$Ports$Opacity$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'FadeIn':
				var _v1 = A3($author$project$Anim$Ports$animateOpacity, 'box', 1.0, model.animations);
				var newModel = _v1.a;
				...
				if (maybeCommand.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newModel, isVisible: true}),
						A3($author$project$Anim$Ports$sendAnimationCommand, $author$project$ElmUI$Ports$Opacity$Main$animateElement, $author$project$Anim$Ports$encodeAnimationCommand, command));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'FadeOut':
				var _v3 = A3($author$project$Anim$Ports$animateOpacity, 'box', 0.0, model.animations);
				var newModel = _v3.a;
				...
				if (maybeCommand.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newModel, isVisible: false}),
						A3($author$project$Anim$Ports$sendAnimationCommand, $author$project$ElmUI$Ports$Opacity$Main$animateElement, $author$project$Anim$Ports$encodeAnimationCommand, command));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'FadeToggle':
				...
				var _v5 = A3($author$project$Anim$Ports$animateOpacity, 'box', newOpacity, model.animations);
				var newModel = _v5.a;
				...
				if (maybeCommand.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newModel, isVisible: newVisible}),
						A3($author$project$Anim$Ports$sendAnimationCommand, $author$project$ElmUI$Ports$Opacity$Main$animateElement, $author$project$Anim$Ports$encodeAnimationCommand, command));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$ElmUI$Ports$Opacity$Main$FadeToggle = {$: 'FadeToggle'};
...
var $author$project$ElmUI$Ports$Opacity$Main$animatedBox = F4(
...
var $author$project$ElmUI$Ports$Opacity$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Opacity$Main$FadeIn, 'Fade In'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Opacity$Main$FadeOut, 'Fade Out'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Ports$Opacity$Main$FadeToggle, 'Toggle Visibility')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A4($author$project$ElmUI$Ports$Opacity$Main$animatedBox, 'box', 'Opacity Demo', $author$project$Common$Colors$primary, model)))
		]);
};
