...
var $author$project$ElmUI$Ports$Rotation$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Ports$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Ports$Rotation$Main$AnimationComplete = function (a) {
	return {$: 'AnimationComplete', a: a};
};
var $author$project$ElmUI$Ports$Rotation$Main$PositionUpdateReceived = function (a) {
	return {$: 'PositionUpdateReceived', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ElmUI$Ports$Rotation$Main$animationComplete = _Platform_incomingPort('animationComplete', $elm$json$Json$Decode$string);
...
var $author$project$ElmUI$Ports$Rotation$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$Ports$Rotation$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$ElmUI$Ports$Rotation$Main$positionUpdates(
				A2($elm$core$Basics$composeL, $author$project$ElmUI$Ports$Rotation$Main$PositionUpdateReceived, $author$project$Anim$Ports$handlePropertyUpdateFromJson)),
				$author$project$ElmUI$Ports$Rotation$Main$animationComplete($author$project$ElmUI$Ports$Rotation$Main$AnimationComplete)
			]));
};
var $author$project$ElmUI$Ports$Rotation$Main$animateElement = _Platform_outgoingPort('animateElement', $elm$core$Basics$identity);
...
var $author$project$ElmUI$Ports$Rotation$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Rotate45':
				var _v1 = A3($author$project$Anim$Ports$animateRotation, 'box', 45, model.animations);
				var newModel = _v1.a;
				...
				if (maybeCommand.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newModel}),
						A3($author$project$Anim$Ports$sendAnimationCommand, $author$project$ElmUI$Ports$Rotation$Main$animateElement, $author$project$Anim$Ports$encodeAnimationCommand, command));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'Rotate90':
				var _v3 = A3($author$project$Anim$Ports$animateRotation, 'box', 90, model.animations);
				var newModel = _v3.a;
			...
			case 'Rotate180':
				var _v5 = A3($author$project$Anim$Ports$animateRotation, 'box', 180, model.animations);
				var newModel = _v5.a;
			...
			case 'RotateLeft':
				var _v7 = A3($author$project$Anim$Ports$animateRotation, 'box', -90, model.animations);
				var newModel = _v7.a;
			...
			case 'RotateRight':
				var _v9 = A3($author$project$Anim$Ports$animateRotation, 'box', 90, model.animations);
				var newModel = _v9.a;
			...
			case 'ResetRotation':
				var _v11 = A3($author$project$Anim$Ports$animateRotation, 'box', 0, model.animations);
				var newModel = _v11.a;
...
var $author$project$ElmUI$Ports$Rotation$Main$ResetRotation = {$: 'ResetRotation'};
var $author$project$ElmUI$Ports$Rotation$Main$Rotate180 = {$: 'Rotate180'};
var $author$project$ElmUI$Ports$Rotation$Main$Rotate45 = {$: 'Rotate45'};
var $author$project$ElmUI$Ports$Rotation$Main$Rotate90 = {$: 'Rotate90'};
var $author$project$ElmUI$Ports$Rotation$Main$RotateLeft = {$: 'RotateLeft'};
...
var $author$project$ElmUI$Ports$Rotation$Main$rotatingElement = F5(
...
var $author$project$ElmUI$Ports$Rotation$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Ports Rotation Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Rotation$Main$Rotate45, '45°'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Rotation$Main$Rotate90, '90°'),
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Ports$Rotation$Main$Rotate180, '180°'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Rotation$Main$RotateLeft, '← 90°'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Ports$Rotation$Main$ResetRotation, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			A2(
				...
				A5($author$project$ElmUI$Ports$Rotation$Main$rotatingElement, 'box', '→', 'Rotation Demo', $author$project$Common$Colors$primary, model)))
		]);
};
var $author$project$ElmUI$Ports$Rotation$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Ports Rotation ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Ports$Rotation$Main$viewContent(model));
};
var $author$project$ElmUI$Ports$Rotation$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Ports$Rotation$Main$init, subscriptions: $author$project$ElmUI$Ports$Rotation$Main$subscriptions, update: $author$project$ElmUI$Ports$Rotation$Main$update, view: $author$project$ElmUI$Ports$Rotation$Main$view});
_Platform_export({'ElmUI':{'Ports':{'Rotation':{'Main':{'init':$author$project$ElmUI$Ports$Rotation$Main$main(
