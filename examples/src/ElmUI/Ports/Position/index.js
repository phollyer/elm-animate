...
var $author$project$ElmUI$Ports$Position$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Ports$init, isAnimating: false},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Ports$Position$Main$AnimationComplete = function (a) {
	return {$: 'AnimationComplete', a: a};
};
var $author$project$ElmUI$Ports$Position$Main$PositionUpdateReceived = function (a) {
	return {$: 'PositionUpdateReceived', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ElmUI$Ports$Position$Main$animationComplete = _Platform_incomingPort('animationComplete', $elm$json$Json$Decode$string);
...
var $author$project$ElmUI$Ports$Position$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$Ports$Position$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$ElmUI$Ports$Position$Main$positionUpdates(
				A2($elm$core$Basics$composeL, $author$project$ElmUI$Ports$Position$Main$PositionUpdateReceived, $author$project$Anim$Ports$handlePropertyUpdateFromJson)),
...
var $author$project$ElmUI$Ports$Position$Main$MoveDown = {$: 'MoveDown'};
var $author$project$ElmUI$Ports$Position$Main$MoveLeft = {$: 'MoveLeft'};
var $author$project$ElmUI$Ports$Position$Main$MoveRight = {$: 'MoveRight'};
var $author$project$ElmUI$Ports$Position$Main$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ElmUI$Ports$Position$Main$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$ElmUI$Ports$Position$Main$MoveUp = {$: 'MoveUp'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$ElmUI$Ports$Position$Main$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ElmUI$Ports$Position$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Ports Position Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			function () {
				var _v0 = A2($author$project$Anim$Ports$getPosition, 'box', model.animations);
				if (_v0.$ === 'Just') {
					var position = _v0.a;
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$ElmUI$Ports$Position$Main$MoveToCorner, 'Move to (100, 100)'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Position$Main$MoveToCenter, 'Move to (300, 200)'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$ElmUI$Ports$Position$Main$StopAnimation, 'Return to Origin')
				])),
			$author$project$Common$UI$htmlActionButtons(
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Position$Main$MoveLeft, '← Move Left'),
					_Utils_Tuple3($author$project$Common$UI$Warning, $author$project$ElmUI$Ports$Position$Main$MoveRight, 'Move Right →'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Position$Main$MoveUp, '↑ Move Up'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Position$Main$MoveDown, 'Move Down ↓')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$ElmUI$Ports$Position$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Ports Position ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Ports$Position$Main$viewContent(model));
};
var $author$project$ElmUI$Ports$Position$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Ports$Position$Main$init, subscriptions: $author$project$ElmUI$Ports$Position$Main$subscriptions, update: $author$project$ElmUI$Ports$Position$Main$update, view: $author$project$ElmUI$Ports$Position$Main$view});
_Platform_export({'ElmUI':{'Ports':{'Position':{'Main':{'init':$author$project$ElmUI$Ports$Position$Main$main(
