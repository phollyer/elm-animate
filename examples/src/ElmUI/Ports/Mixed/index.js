...
var $author$project$ElmUI$Ports$Mixed$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$Anim$Ports$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ElmUI$Ports$Mixed$Main$AnimationComplete = function (a) {
	return {$: 'AnimationComplete', a: a};
};
var $author$project$ElmUI$Ports$Mixed$Main$PositionUpdateReceived = function (a) {
	return {$: 'PositionUpdateReceived', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$ElmUI$Ports$Mixed$Main$animationComplete = _Platform_incomingPort('animationComplete', $elm$json$Json$Decode$string);
...
var $author$project$ElmUI$Ports$Mixed$Main$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ElmUI$Ports$Mixed$Main$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$ElmUI$Ports$Mixed$Main$positionUpdates(
				A2($elm$core$Basics$composeL, $author$project$ElmUI$Ports$Mixed$Main$PositionUpdateReceived, $author$project$Anim$Ports$handlePropertyUpdateFromJson)),
				$author$project$ElmUI$Ports$Mixed$Main$animationComplete($author$project$ElmUI$Ports$Mixed$Main$AnimationComplete)
			]));
};
...
var $author$project$ElmUI$Ports$Mixed$Main$animateElement = _Platform_outgoingPort('animateElement', $elm$core$Basics$identity);
...
var $author$project$Anim$Ports$batchAnimationCommands = F2(
	function (portFunction, commands) {
		return $elm$core$Platform$Cmd$batch(
			A2(
				$elm$core$List$map,
				A2($elm$core$Basics$composeL, portFunction, $author$project$Anim$Ports$encodeAnimationCommand),
				commands));
	});
...
var $author$project$Anim$toAnimations = F2(
	function (config, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		var createAnimation = function (spec) {
			switch (spec.$) {
				case 'PositionSpec':
					var pos = spec.a;
					return $author$project$Anim$Animation(
						{
							...
							timing: $author$project$Anim$Duration(config.duration)
						});
				case 'OpacitySpec':
					var value = spec.a;
					return $author$project$Anim$Animation(
		...
		return A2($elm$core$List$map, createAnimation, specs);
	});
var $author$project$Anim$Ports$animateMultiple = F3(
	function (model, config, elementBuilder) {
		var animations = A2(
			$author$project$Anim$toAnimations,
			{duration: config.duration, easing: config.easing},
			elementBuilder);
		var _v0 = A3(
			$elm$core$List$foldl,
			F2(
				function (animation, _v1) {
					var accModel = _v1.a;
					var accCommands = _v1.b;
					var _v2 = A2($author$project$Anim$Ports$animate, animation, accModel);
					var updatedModel = _v2.a;
					var maybeCommand = _v2.b;
		...
		var newModel = _v0.a;
		var commands = _v0.b;
		var batchCmd = A2($author$project$Anim$Ports$batchAnimationCommands, config.portFunction, commands);
		return _Utils_Tuple2(newModel, batchCmd);
	});
var $author$project$Anim$ElementBuilder = F2(
	function (a, b) {
		return {$: 'ElementBuilder', a: a, b: b};
	});
var $author$project$Anim$element = function (elementId) {
	return A2($author$project$Anim$ElementBuilder, elementId, _List_Nil);
};
...
var $author$project$Anim$BackgroundColorSpec = function (a) {
	return {$: 'BackgroundColorSpec', a: a};
};
var $author$project$Anim$withBackgroundColor = F2(
	function (value, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		return A2(
			$author$project$Anim$ElementBuilder,
			elementId,
			A2(
				$elm$core$List$cons,
				$author$project$Anim$BackgroundColorSpec(value),
				specs));
	});
var $author$project$Anim$OpacitySpec = function (a) {
	return {$: 'OpacitySpec', a: a};
};
var $author$project$Anim$withOpacity = F2(
	function (value, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Anim$OpacitySpec(value),
				specs));
	});
var $author$project$Anim$PositionSpec = function (a) {
	return {$: 'PositionSpec', a: a};
};
var $author$project$Anim$withPosition = F2(
	function (pos, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Anim$PositionSpec(pos),
				specs));
	});
var $author$project$Anim$RotationSpec = function (a) {
	return {$: 'RotationSpec', a: a};
};
var $author$project$Anim$withRotation = F2(
	function (value, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Anim$RotationSpec(value),
				specs));
	});
var $author$project$Anim$ScaleSpec = function (a) {
	return {$: 'ScaleSpec', a: a};
};
var $author$project$Anim$withScale = F2(
	function (value, _v0) {
		var elementId = _v0.a;
		var specs = _v0.b;
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$author$project$Anim$ScaleSpec(value),
				specs));
	});
var $author$project$ElmUI$Ports$Mixed$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartComplexAnimation':
				var elementId = msg.a;
				var _v1 = A3(
					$author$project$Anim$Ports$animateMultiple,
					model.animations,
					{
						duration: 1000,
						easing: $author$project$Anim$EasePreset($author$project$Anim$EaseInOut),
						portFunction: $author$project$ElmUI$Ports$Mixed$Main$animateElement
					},
					A2(
						$author$project$Anim$withRotation,
						90,
						A2(
							$author$project$Anim$withScale,
							{x: 1.5, y: 1.9},
							A2(
								$author$project$Anim$withPosition,
								A2($author$project$Anim$Position, 200, 100),
								$author$project$Anim$element(elementId)))));
				var newModel = _v1.a;
				var cmd = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'StartFadeMove':
				...
				var _v2 = A3(
					...
					A2(
						$author$project$Anim$withPosition,
						A2($author$project$Anim$Position, 250, 80),
						A2(
							$author$project$Anim$withOpacity,
							0.3,
							$author$project$Anim$element(elementId))));
				var newModel = _v2.a;
				var cmd = _v2.b;
			...
			case 'StartSpinScale':
				...
				var _v3 = A3(
					...
					A2(
						$author$project$Anim$withBackgroundColor,
						...
						A2(
							...
							A2(
								...
								A2(
									...
									A2(
										$author$project$Anim$withPosition,
										A2($author$project$Anim$Position, 200, 200),
										$author$project$Anim$element(elementId)))))));
				var newModel = _v5.a;
				var cmd = _v5.b;
				return _Utils_Tuple2(
							...
							A2(
								...
								A2(
									...
									A2(
										...
										$author$project$Anim$element('mixed-box')))))));
				var newModel = _v6.a;
				var cmd = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$ElmUI$Ports$Mixed$Main$ResetAll = {$: 'ResetAll'};
var $author$project$ElmUI$Ports$Mixed$Main$StartColorMorph = function (a) {
	return {$: 'StartColorMorph', a: a};
};
var $author$project$ElmUI$Ports$Mixed$Main$StartComplexAnimation = function (a) {
	return {$: 'StartComplexAnimation', a: a};
};
var $author$project$ElmUI$Ports$Mixed$Main$StartFadeMove = function (a) {
	return {$: 'StartFadeMove', a: a};
};
var $author$project$ElmUI$Ports$Mixed$Main$StartFullTransform = function (a) {
	return {$: 'StartFullTransform', a: a};
};
var $author$project$ElmUI$Ports$Mixed$Main$StartSpinScale = function (a) {
...
var $author$project$ElmUI$Ports$Mixed$Main$mixedAnimationBox = function (model) {
	return A2(
		...
		_Utils_ap(
			...
			A2(
				...
				A2($author$project$Anim$Ports$styleProperties, 'mixed-box', model.animations))),
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
...
var $author$project$ElmUI$Ports$Mixed$Main$viewContent = function (model) {
	return _List_fromArray(
		[
			$author$project$Common$UI$backButton,
			$author$project$Common$UI$pageHeader('Ports Mixed Property Animations'),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$author$project$ElmUI$Ports$Mixed$Main$StartComplexAnimation('mixed-box'),
					'Move + Scale + Rotate'),
					_Utils_Tuple3(
					$author$project$Common$UI$Success,
					$author$project$ElmUI$Ports$Mixed$Main$StartFadeMove('mixed-box'),
					'Fade + Move'),
					_Utils_Tuple3(
					$author$project$Common$UI$Warning,
					$author$project$ElmUI$Ports$Mixed$Main$StartSpinScale('mixed-box'),
					'Spin + Scale + Color'),
					_Utils_Tuple3(
					$author$project$Common$UI$Purple,
					$author$project$ElmUI$Ports$Mixed$Main$StartColorMorph('mixed-box'),
					'Color + Shape + Opacity'),
					_Utils_Tuple3(
					$author$project$Common$UI$Primary,
					$author$project$ElmUI$Ports$Mixed$Main$StartFullTransform('mixed-box'),
					'ALL Properties!'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$ElmUI$Ports$Mixed$Main$ResetAll, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
			...
			$author$project$ElmUI$Ports$Mixed$Main$mixedAnimationBox(model))
		]);
};
var $author$project$ElmUI$Ports$Mixed$Main$view = function (model) {
	return A3(
		$author$project$Common$UI$createDocument,
		'Anim.Ports Mixed Properties ElmUI Example',
		$author$project$Common$UI$Basic,
		$author$project$ElmUI$Ports$Mixed$Main$viewContent(model));
};
var $author$project$ElmUI$Ports$Mixed$Main$main = $elm$browser$Browser$document(
	{init: $author$project$ElmUI$Ports$Mixed$Main$init, subscriptions: $author$project$ElmUI$Ports$Mixed$Main$subscriptions, update: $author$project$ElmUI$Ports$Mixed$Main$update, view: $author$project$ElmUI$Ports$Mixed$Main$view});
_Platform_export({'ElmUI':{'Ports':{'Mixed':{'Main':{'init':$author$project$ElmUI$Ports$Mixed$Main$main(
