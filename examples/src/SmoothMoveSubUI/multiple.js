...
var $author$project$SmoothMoveSubUI$Multiple$init = function (_v0) {
	var smoothMove = A4(
...
var $author$project$SmoothMoveSubUI$Multiple$AnimationFrame = function (a) {
...
var $author$project$SmoothMoveSubUI$Multiple$subscriptions = function (model) {
	return A2($author$project$SmoothMoveSub$subscriptions, model.smoothMove, $author$project$SmoothMoveSubUI$Multiple$AnimationFrame);
};
...
var $author$project$SmoothMoveSubUI$Multiple$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AnimationFrame':
				var deltaMs = msg.a;
...
var $author$project$SmoothMoveSubUI$Multiple$CircleFormation = {$: 'CircleFormation'};
var $author$project$Common$UI$Primary = {$: 'Primary'};
var $author$project$Common$UI$Purple = {$: 'Purple'};
var $author$project$SmoothMoveSubUI$Multiple$ResetPositions = {$: 'ResetPositions'};
var $author$project$SmoothMoveSubUI$Multiple$ScatterElements = {$: 'ScatterElements'};
...
var $author$project$SmoothMoveSubUI$Multiple$viewContent = function (model) {
	var positionF = A2(
		$elm$core$Maybe$withDefault,
		{x: 180, y: 50},
	...
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple3($author$project$Common$UI$Primary, $author$project$SmoothMoveSubUI$Multiple$ScatterElements, 'Scatter'),
					_Utils_Tuple3($author$project$Common$UI$Success, $author$project$SmoothMoveSubUI$Multiple$CircleFormation, 'Circle Formation'),
					_Utils_Tuple3($author$project$Common$UI$Purple, $author$project$SmoothMoveSubUI$Multiple$ResetPositions, 'Reset')
				])),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$SmoothMoveSubUI$Multiple$view = function (model) {
	return A3(
		...
		$author$project$SmoothMoveSubUI$Multiple$viewContent(model));
};
var $author$project$SmoothMoveSubUI$Multiple$main = $elm$browser$Browser$document(
	{init: $author$project$SmoothMoveSubUI$Multiple$init, subscriptions: $author$project$SmoothMoveSubUI$Multiple$subscriptions, update: $author$project$SmoothMoveSubUI$Multiple$update, view: $author$project$SmoothMoveSubUI$Multiple$view});
_Platform_export({'SmoothMoveSubUI':{'Multiple':{'init':$author$project$SmoothMoveSubUI$Multiple$main(
